...
class FeedItemSetServiceClient(metaclass=FeedItemSetServiceClientMeta):
    ...
    def get_feed_item_set(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetFeedItemSetRequest`):
                The request object.
                Request message for
                [FeedItemSetService.GetFeedItemSet][google.ads.googleads.v7.services.FeedItemSetService.GetFeedItemSet].
        ...
        Returns:
            google.ads.googleads.v7.resources.types.FeedItemSet:
    ...
    def mutate_feed_item_sets(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.MutateFeedItemSetsRequest`):
                The request object.
                Request message for
                [FeedItemSetService.MutateFeedItemSets][google.ads.googleads.v7.services.FeedItemSetService.MutateFeedItemSets].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.FeedItemSetOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateFeedItemSetsResponse:
