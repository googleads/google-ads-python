...
"""Accesses the google.ads.googleads.v3.services MobileDeviceConstantService API."""
...
from google.ads.google_ads.v3.services import mobile_device_constant_service_client_config
from google.ads.google_ads.v3.services.transports import mobile_device_constant_service_grpc_transport
from google.ads.google_ads.v3.proto.services import mobile_device_constant_service_pb2
...
class MobileDeviceConstantServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v3.services.MobileDeviceConstantService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=mobile_device_constant_service_grpc_transport.MobileDeviceConstantServiceGrpcTransport,
                )
            else:
                if credentials:
                    raise ValueError(
    ...
    def get_mobile_device_constant(
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.MobileDeviceConstant` instance.
        ...
        if 'get_mobile_device_constant' not in self._inner_api_calls:
            self._inner_api_calls['get_mobile_device_constant'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_mobile_device_constant,
                default_retry=self._method_configs['GetMobileDeviceConstant'].retry,
                default_timeout=self._method_configs['GetMobileDeviceConstant'].timeout,
        ...
        return self._inner_api_calls['get_mobile_device_constant'](request, retry=retry, timeout=timeout, metadata=metadata)
