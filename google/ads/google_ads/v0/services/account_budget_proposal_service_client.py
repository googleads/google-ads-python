...
"""Accesses the google.ads.googleads.v0.services AccountBudgetProposalService API."""
...
from google.ads.google_ads.v0.services import account_budget_proposal_service_client_config
...
class AccountBudgetProposalServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v0.services.AccountBudgetProposalService'
    ...
    def get_account_budget_proposal(
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.AccountBudgetProposal` instance.
    ...
    def mutate_account_budget_proposal(
        ...
        Args:
            ...
            operation_ (Union[dict, ~google.ads.googleads_v0.types.AccountBudgetProposalOperation]): The operation to perform on an individual account-level budget proposal.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v0.types.AccountBudgetProposalOperation`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.MutateAccountBudgetProposalResponse` instance.
