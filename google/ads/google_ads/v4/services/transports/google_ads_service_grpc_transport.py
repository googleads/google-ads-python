...
from google.ads.google_ads.v4.proto.services import google_ads_service_pb2_grpc


class GoogleAdsServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v4.services GoogleAdsService API.
    ...
    def search_stream(self):
        """Return the gRPC stub for :meth:`GoogleAdsServiceClient.search_stream`.
        ...
        Returns:
            Callable: A callable which accepts the appropriate
                ...
                deserialized response object.
        """
        return self._stubs['google_ads_service_stub'].SearchStream
