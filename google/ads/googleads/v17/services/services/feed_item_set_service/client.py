...
class FeedItemSetServiceClient(metaclass=FeedItemSetServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, FeedItemSetServiceTransport]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, FeedItemSetServiceTransport]]): The
    ...
    def mutate_feed_item_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateFeedItemSetsRequest, dict, None]):
