...
from google.ads.googleads.v4.services.services.campaign_draft_service import (
    pagers,
)
...
class CampaignDraftServiceClient(metaclass=CampaignDraftServiceClientMeta):
    ...
    def get_campaign_draft(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetCampaignDraftRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.CampaignDraft:
                A campaign draft.
        """
    ...
    def mutate_campaign_drafts(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateCampaignDraftsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.CampaignDraftOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateCampaignDraftsResponse:
    ...
    def list_campaign_draft_async_errors(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.ListCampaignDraftAsyncErrorsRequest`):
                The request object. Request message for
                [CampaignDraftService.ListCampaignDraftAsyncErrors][google.ads.googleads.v4.services.CampaignDraftService.ListCampaignDraftAsyncErrors].
            resource_name (:class:`str`):
        ...
        Returns:
            google.ads.googleads.v4.services.services.campaign_draft_service.pagers.ListCampaignDraftAsyncErrorsPager:
