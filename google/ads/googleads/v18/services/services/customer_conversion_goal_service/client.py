...
class CustomerConversionGoalServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, CustomerConversionGoalServiceTransport]]): The
    ...
    def mutate_customer_conversion_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateCustomerConversionGoalsRequest, dict, None]):
