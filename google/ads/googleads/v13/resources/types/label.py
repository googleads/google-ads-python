...
from google.ads.googleads.v13.common.types import text_label as gagc_text_label
from google.ads.googleads.v13.enums.types import label_status
...
class Label(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v13.enums.types.LabelStatusEnum.LabelStatus):
            Output only. Status of the label. Read only.
        text_label (google.ads.googleads.v13.common.types.TextLabel):
