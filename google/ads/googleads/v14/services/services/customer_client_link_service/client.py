...
class CustomerClientLinkServiceClient(
    ...
    def mutate_customer_client_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateCustomerClientLinkRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateCustomerClientLinkResponse:
