...
from google.ads.googleads.v18.resources.types import asset_group_asset
...
class AssetGroupAssetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v18.resources.types.AssetGroupAsset):
            Create operation: No resource name is
            expected for the new asset group asset.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v18.resources.types.AssetGroupAsset):
