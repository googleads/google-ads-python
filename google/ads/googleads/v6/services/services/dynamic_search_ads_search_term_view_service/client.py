...
class DynamicSearchAdsSearchTermViewServiceClient(
    ...
    def get_dynamic_search_ads_search_term_view(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetDynamicSearchAdsSearchTermViewRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.DynamicSearchAdsSearchTermView:
