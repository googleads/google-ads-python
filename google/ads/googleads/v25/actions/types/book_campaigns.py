...
from google.ads.googleads.v25.enums.types import reservation_request_type
...
class BookCampaignsOperation(proto.Message):
    ...
    Attributes:
        campaigns (MutableSequence[google.ads.googleads.v25.actions.types.BookCampaignsOperation.Campaign]):
    ...
    class Campaign(proto.Message):
        ...
        Attributes:
            ...
            request_type (google.ads.googleads.v25.enums.types.ReservationRequestTypeEnum.ReservationRequestType):
