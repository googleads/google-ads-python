...
class CampaignExtensionSettingServiceClient(
    ...
    def get_campaign_extension_setting(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCampaignExtensionSettingRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CampaignExtensionSetting:
    ...
    def mutate_campaign_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCampaignExtensionSettingsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CampaignExtensionSettingOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCampaignExtensionSettingsResponse:
