...
class CampaignFeedServiceClient(metaclass=CampaignFeedServiceClientMeta):
    ...
    def get_campaign_feed(
        self,
        request: Union[
            campaign_feed_service.GetCampaignFeedRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCampaignFeedRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CampaignFeed:
                A campaign feed.
        """
    ...
    def mutate_campaign_feeds(
        self,
        request: Union[
            campaign_feed_service.MutateCampaignFeedsRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCampaignFeedsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CampaignFeedOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCampaignFeedsResponse:
