...
class MerchantCenterLinkServiceClient(
    ...
    def list_merchant_center_links(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.ListMerchantCenterLinksRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v7.services.types.ListMerchantCenterLinksResponse:
    ...
    def get_merchant_center_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetMerchantCenterLinkRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v7.resources.types.MerchantCenterLink:
    ...
    def mutate_merchant_center_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.MutateMerchantCenterLinkRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v7.services.types.MerchantCenterLinkOperation`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateMerchantCenterLinkResponse:
