...
class FeedItemTargetServiceClient(metaclass=FeedItemTargetServiceClientMeta):
    ...
    def mutate_feed_item_targets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateFeedItemTargetsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v13.services.types.FeedItemTargetOperation]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateFeedItemTargetsResponse:
