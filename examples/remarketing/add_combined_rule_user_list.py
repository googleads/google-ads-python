...
def main(client, customer_id):
    ...
    # AND_NOT.
    combined_rule_user_list_info = client.get_type(
        "CombinedRuleUserListInfo", version="v6"
    )
    combined_rule_user_list_info.left_operand.CopyFrom(rule_infos[0])
    combined_rule_user_list_info.right_operand.CopyFrom(rule_infos[1])
    combined_rule_user_list_info.rule_operator = client.get_type(
        "UserListCombinedRuleOperatorEnum", version="v6"
    ).AND
    ...
    rule_based_user_list_info.combined_rule_user_list.CopyFrom(
