...
class ListPlannableLocationsResponse(proto.Message):
    ...
    Attributes:
        plannable_locations (MutableSequence[google.ads.googleads.v19.services.types.PlannableLocation]):
...
class ListPlannableProductsResponse(proto.Message):
    ...
    Attributes:
        product_metadata (MutableSequence[google.ads.googleads.v19.services.types.ProductMetadata]):
...
class ProductMetadata(proto.Message):
    ...
    Attributes:
        ...
        plannable_targeting (google.ads.googleads.v19.services.types.PlannableTargeting):
...
class PlannableTargeting(proto.Message):
    ...
    Attributes:
        age_ranges (MutableSequence[google.ads.googleads.v19.enums.types.ReachPlanAgeRangeEnum.ReachPlanAgeRange]):
        ...
        genders (MutableSequence[google.ads.googleads.v19.common.types.GenderInfo]):
            Targetable genders for the ad product.
        devices (MutableSequence[google.ads.googleads.v19.common.types.DeviceInfo]):
            ...
            products.
        networks (MutableSequence[google.ads.googleads.v19.enums.types.ReachPlanNetworkEnum.ReachPlanNetwork]):
            Targetable networks for the ad product.
        youtube_select_lineups (MutableSequence[google.ads.googleads.v19.services.types.YouTubeSelectLineUp]):
            Targetable YouTube Select Lineups for the ad
            product.
        surface_targeting (google.ads.googleads.v19.services.types.SurfaceTargetingCombinations):
...
class GenerateReachForecastRequest(proto.Message):
    ...
    Attributes:
        ...
        campaign_duration (google.ads.googleads.v19.services.types.CampaignDuration):
        ...
        cookie_frequency_cap_setting (google.ads.googleads.v19.services.types.FrequencyCap):
            Chosen cookie frequency cap to be applied to each planned
            product. This is equivalent to the frequency cap exposed in
            Google Ads when creating a campaign, it represents the
            maximum number of times an ad can be shown to the same user
        ...
        effective_frequency_limit (google.ads.googleads.v19.services.types.EffectiveFrequencyLimit):
        ...
        targeting (google.ads.googleads.v19.services.types.Targeting):
        ...
        planned_products (MutableSequence[google.ads.googleads.v19.services.types.PlannedProduct]):
            Required. The products to be forecast.
            The max number of allowed planned products is
            15.
        forecast_metric_options (google.ads.googleads.v19.services.types.ForecastMetricOptions):
...
class FrequencyCap(proto.Message):
    ...
    Attributes:
        impressions (int):
            ...
            inclusive.
        time_unit (google.ads.googleads.v19.enums.types.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit):
...
class Targeting(proto.Message):
    ...
    Attributes:
        ...
        age_range (google.ads.googleads.v19.enums.types.ReachPlanAgeRangeEnum.ReachPlanAgeRange):
            Targeted age range.
        ...
        devices (MutableSequence[google.ads.googleads.v19.common.types.DeviceInfo]):
            ...
            [ReachPlanService.ListPlannableProducts][google.ads.googleads.v19.services.ReachPlanService.ListPlannableProducts].
        network (google.ads.googleads.v19.enums.types.ReachPlanNetworkEnum.ReachPlanNetwork):
            ...
            [ReachPlanService.ListPlannableProducts][google.ads.googleads.v19.services.ReachPlanService.ListPlannableProducts].
        audience_targeting (google.ads.googleads.v19.services.types.AudienceTargeting):
            Targeted audiences.
...
class CampaignDuration(proto.Message):
    ...
    Attributes:
        ...
        date_range (google.ads.googleads.v19.common.types.DateRange):
...
class GenerateReachForecastResponse(proto.Message):
    ...
    Attributes:
        on_target_audience_metrics (google.ads.googleads.v19.services.types.OnTargetAudienceMetrics):
            Reference on target audiences for this curve.
        reach_curve (google.ads.googleads.v19.services.types.ReachCurve):
...
class ReachCurve(proto.Message):
    ...
    Attributes:
        reach_forecasts (MutableSequence[google.ads.googleads.v19.services.types.ReachForecast]):
...
class ReachForecast(proto.Message):
    ...
    Attributes:
        cost_micros (int):
            The cost in micros.
        forecast (google.ads.googleads.v19.services.types.Forecast):
            Forecasted traffic metrics for this point.
        planned_product_reach_forecasts (MutableSequence[google.ads.googleads.v19.services.types.PlannedProductReachForecast]):
...
class Forecast(proto.Message):
    ...
    Attributes:
        ...
        effective_frequency_breakdowns (MutableSequence[google.ads.googleads.v19.services.types.EffectiveFrequencyBreakdown]):
...
class PlannedProductReachForecast(proto.Message):
    ...
    Attributes:
        ...
        planned_product_forecast (google.ads.googleads.v19.services.types.PlannedProductForecast):
...
class AudienceTargeting(proto.Message):
    ...
    Attributes:
        user_interest (MutableSequence[google.ads.googleads.v19.common.types.UserInterestInfo]):
...
class AdvancedProductTargeting(proto.Message):
    ...
    Attributes:
        surface_targeting_settings (google.ads.googleads.v19.services.types.SurfaceTargeting):
            Surface targeting settings for this product.
        target_frequency_settings (google.ads.googleads.v19.services.types.TargetFrequencySettings):
        ...
        youtube_select_settings (google.ads.googleads.v19.services.types.YouTubeSelectSettings):
...
class SurfaceTargetingCombinations(proto.Message):
    ...
    Attributes:
        default_targeting (google.ads.googleads.v19.services.types.SurfaceTargeting):
            Default surface targeting applied to the ad
            product.
        available_targeting_combinations (MutableSequence[google.ads.googleads.v19.services.types.SurfaceTargeting]):
...
class SurfaceTargeting(proto.Message):
    ...
    Attributes:
        surfaces (MutableSequence[google.ads.googleads.v19.enums.types.ReachPlanSurfaceEnum.ReachPlanSurface]):
...
class TargetFrequencySettings(proto.Message):
    ...
    Attributes:
        time_unit (google.ads.googleads.v19.enums.types.TargetFrequencyTimeUnitEnum.TargetFrequencyTimeUnit):
