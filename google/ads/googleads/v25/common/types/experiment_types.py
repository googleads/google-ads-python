...
class VideoExperimentInfo(proto.Message):
    ...
    Attributes:
        video_experiment_subtype (google.ads.googleads.v25.enums.types.VideoExperimentSubtypeEnum.VideoExperimentSubtype):
...
class OptimizeAssetsExperimentInfo(proto.Message):
    ...
    Attributes:
        optimize_assets_experiment_subtype (google.ads.googleads.v25.enums.types.OptimizeAssetsExperimentSubtypeEnum.OptimizeAssetsExperimentSubtype):
