...
class FeedItemSetServiceClient(metaclass=FeedItemSetServiceClientMeta):
    ...
    def mutate_feed_item_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateFeedItemSetsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v14.services.types.FeedItemSetOperation]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateFeedItemSetsResponse:
