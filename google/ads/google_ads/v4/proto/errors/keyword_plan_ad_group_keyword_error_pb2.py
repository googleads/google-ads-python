...
# source: google/ads/googleads_v4/proto/errors/keyword_plan_ad_group_keyword_error.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v4/proto/errors/keyword_plan_ad_group_keyword_error.proto',
...
KeywordPlanAdGroupKeywordErrorEnum = _reflection.GeneratedProtocolMessageType('KeywordPlanAdGroupKeywordErrorEnum', (_message.Message,), dict(
  DESCRIPTOR = _KEYWORDPLANADGROUPKEYWORDERRORENUM,
  __module__ = 'google.ads.googleads_v4.proto.errors.keyword_plan_ad_group_keyword_error_pb2'
  ,
  __doc__ = """Container for enum describing possible errors from applying an ad group
