...
class MutateAdGroupFeedsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v11.services.types.AdGroupFeedOperation]):
...
class AdGroupFeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v11.resources.types.AdGroupFeed):
            Create operation: No resource name is
            expected for the new ad group feed.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v11.resources.types.AdGroupFeed):
...
class MutateAdGroupFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v11.services.types.MutateAdGroupFeedResult]):
