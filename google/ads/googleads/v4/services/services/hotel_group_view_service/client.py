...
class HotelGroupViewServiceClient(metaclass=HotelGroupViewServiceClientMeta):
    ...
    def get_hotel_group_view(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetHotelGroupViewRequest`):
                The request object. Request message for
                [HotelGroupViewService.GetHotelGroupView][google.ads.googleads.v4.services.HotelGroupViewService.GetHotelGroupView].
        ...
        Returns:
            google.ads.googleads.v4.resources.types.HotelGroupView:
                A hotel group view.
        """
