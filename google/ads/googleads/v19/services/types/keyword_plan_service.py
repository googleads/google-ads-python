...
from google.ads.googleads.v19.resources.types import keyword_plan
...
class KeywordPlanOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v19.resources.types.KeywordPlan):
            Create operation: No resource name is
            expected for the new keyword plan.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v19.resources.types.KeywordPlan):
...
class MutateKeywordPlansResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v19.services.types.MutateKeywordPlansResult]):
