...
from google.ads.googleads.v13.resources.types import batch_job
from google.ads.googleads.v13.services.services.batch_job_service import pagers
from google.ads.googleads.v13.services.types import batch_job_service
...
class BatchJobServiceClient(metaclass=BatchJobServiceClientMeta):
    ...
    def mutate_batch_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateBatchJobRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v13.services.types.BatchJobOperation):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateBatchJobResponse:
    ...
    def list_batch_job_results(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.ListBatchJobResultsRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v13.services.services.batch_job_service.pagers.ListBatchJobResultsPager:
                Response message for
                   [BatchJobService.ListBatchJobResults][google.ads.googleads.v13.services.BatchJobService.ListBatchJobResults].
    ...
    def run_batch_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.RunBatchJobRequest, dict, None]):
                The request object. Request message for
    ...
    def add_batch_job_operations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.AddBatchJobOperationsRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v13.services.types.AddBatchJobOperationsResponse:
                Response message for
                   [BatchJobService.AddBatchJobOperations][google.ads.googleads.v13.services.BatchJobService.AddBatchJobOperations].
