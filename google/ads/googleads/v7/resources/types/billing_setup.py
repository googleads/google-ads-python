...
class BillingSetup(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v7.enums.types.BillingSetupStatusEnum.BillingSetupStatus):
        ...
        payments_account_info (google.ads.googleads.v7.resources.types.BillingSetup.PaymentsAccountInfo):
        ...
        start_date_time (str):
            ...
            time is allowed.
        start_time_type (google.ads.googleads.v7.enums.types.TimeTypeEnum.TimeType):
