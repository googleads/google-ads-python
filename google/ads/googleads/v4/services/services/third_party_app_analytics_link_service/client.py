...
class ThirdPartyAppAnalyticsLinkServiceClient(
    ...
    def get_third_party_app_analytics_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetThirdPartyAppAnalyticsLinkRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.ThirdPartyAppAnalyticsLink:
