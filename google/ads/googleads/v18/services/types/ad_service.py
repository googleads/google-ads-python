...
class MutateAdsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            are being modified.
        operations (MutableSequence[google.ads.googleads.v18.services.types.AdOperation]):
...
class AdOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v18.resources.types.Ad):
...
class MutateAdsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v18.services.types.MutateAdResult]):
