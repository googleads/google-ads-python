...
class AdGroupServiceClient(metaclass=AdGroupServiceClientMeta):
    ...
    def mutate_ad_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAdGroupsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v13.services.types.AdGroupOperation]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateAdGroupsResponse:
