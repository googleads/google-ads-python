...
class MediaFileServiceClient(metaclass=MediaFileServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, MediaFileServiceTransport]]): The
    ...
    def mutate_media_files(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateMediaFilesRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateMediaFilesResponse:
