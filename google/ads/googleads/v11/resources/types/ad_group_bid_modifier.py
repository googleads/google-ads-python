...
class AdGroupBidModifier(proto.Message):
    ...
    Attributes:
        ...
        bid_modifier_source (google.ads.googleads.v11.enums.types.BidModifierSourceEnum.BidModifierSource):
        ...
        hotel_advance_booking_window (google.ads.googleads.v11.common.types.HotelAdvanceBookingWindowInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        hotel_length_of_stay (google.ads.googleads.v11.common.types.HotelLengthOfStayInfo):
            Immutable. Criterion for length of hotel stay
            in nights.

            This field is a member of `oneof`_ ``criterion``.
        hotel_check_in_day (google.ads.googleads.v11.common.types.HotelCheckInDayInfo):
            Immutable. Criterion for day of the week the
            booking is for.

            This field is a member of `oneof`_ ``criterion``.
        device (google.ads.googleads.v11.common.types.DeviceInfo):
            Immutable. A device criterion.

            This field is a member of `oneof`_ ``criterion``.
        preferred_content (google.ads.googleads.v11.common.types.PreferredContentInfo):
            Immutable. A preferred content criterion.

            This field is a member of `oneof`_ ``criterion``.
        hotel_check_in_date_range (google.ads.googleads.v11.common.types.HotelCheckInDateRangeInfo):
