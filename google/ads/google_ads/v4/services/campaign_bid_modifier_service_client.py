...
"""Accesses the google.ads.googleads.v4.services CampaignBidModifierService API."""
...
from google.ads.google_ads.v4.services import campaign_bid_modifier_service_client_config
from google.ads.google_ads.v4.services.transports import campaign_bid_modifier_service_grpc_transport
from google.ads.google_ads.v4.proto.services import campaign_bid_modifier_service_pb2
...
class CampaignBidModifierServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v4.services.CampaignBidModifierService'
    ...
    def get_campaign_bid_modifier(
        ...
        Returns:
            A :class:`~google.ads.googleads_v4.types.CampaignBidModifier` instance.
    ...
    def mutate_campaign_bid_modifiers(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v4.types.CampaignBidModifierOperation]]): Required. The list of operations to perform on individual campaign bid modifiers.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v4.types.CampaignBidModifierOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v4.types.MutateCampaignBidModifiersResponse` instance.
