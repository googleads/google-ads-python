...
class CampaignExtensionSettingServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, CampaignExtensionSettingServiceTransport]]): The
    ...
    def mutate_campaign_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateCampaignExtensionSettingsRequest, dict, None]):
