...
from google.ads.googleads.v18.enums.types import click_type as gage_click_type
from google.ads.googleads.v18.enums.types import (
...
from google.ads.googleads.v18.enums.types import device as gage_device
from google.ads.googleads.v18.enums.types import (
...
from google.ads.googleads.v18.enums.types import slot as gage_slot
...
class Segments(proto.Message):
    ...
    Attributes:
        ...
        ad_destination_type (google.ads.googleads.v18.enums.types.AdDestinationTypeEnum.AdDestinationType):
            Ad Destination type.
        ad_format_type (google.ads.googleads.v18.enums.types.AdFormatTypeEnum.AdFormatType):
            Ad Format type.
        ad_network_type (google.ads.googleads.v18.enums.types.AdNetworkTypeEnum.AdNetworkType):
            Ad network type.
        ad_group (str):
        ...
        budget_campaign_association_status (google.ads.googleads.v18.common.types.BudgetCampaignAssociationStatus):
            Budget campaign association status.
        campaign (str):
            Resource name of the campaign.

            This field is a member of `oneof`_ ``_campaign``.
        click_type (google.ads.googleads.v18.enums.types.ClickTypeEnum.ClickType):
            Click type.
        conversion_action (str):
            Resource name of the conversion action.

            This field is a member of `oneof`_ ``_conversion_action``.
        conversion_action_category (google.ads.googleads.v18.enums.types.ConversionActionCategoryEnum.ConversionActionCategory):
        ...
        conversion_attribution_event_type (google.ads.googleads.v18.enums.types.ConversionAttributionEventTypeEnum.ConversionAttributionEventType):
            Conversion attribution event type.
        conversion_lag_bucket (google.ads.googleads.v18.enums.types.ConversionLagBucketEnum.ConversionLagBucket):
            An enum value representing the number of days
            between the impression and the conversion.
        conversion_or_adjustment_lag_bucket (google.ads.googleads.v18.enums.types.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket):
            An enum value representing the number of days
        ...
        device (google.ads.googleads.v18.enums.types.DeviceEnum.Device):
            Device to which metrics apply.
        external_conversion_source (google.ads.googleads.v18.enums.types.ExternalConversionSourceEnum.ExternalConversionSource):
        ...
        hotel_check_in_day_of_week (google.ads.googleads.v18.enums.types.DayOfWeekEnum.DayOfWeek):
        ...
        hotel_date_selection_type (google.ads.googleads.v18.enums.types.HotelDateSelectionTypeEnum.HotelDateSelectionType):
        ...
        hotel_rate_type (google.ads.googleads.v18.enums.types.HotelRateTypeEnum.HotelRateType):
            Hotel rate type.
        hotel_price_bucket (google.ads.googleads.v18.enums.types.HotelPriceBucketEnum.HotelPriceBucket):
            Hotel price bucket.
        hotel_state (str):
            Hotel state.
        ...
        keyword (google.ads.googleads.v18.common.types.Keyword):
            Keyword criterion.
        month (str):
        ...
        month_of_year (google.ads.googleads.v18.enums.types.MonthOfYearEnum.MonthOfYear):
        ...
        product_channel (google.ads.googleads.v18.enums.types.ProductChannelEnum.ProductChannel):
            Channel of the product.
        product_channel_exclusivity (google.ads.googleads.v18.enums.types.ProductChannelExclusivityEnum.ProductChannelExclusivity):
            Channel exclusivity of the product.
        product_condition (google.ads.googleads.v18.enums.types.ProductConditionEnum.ProductCondition):
        ...
        recommendation_type (google.ads.googleads.v18.enums.types.RecommendationTypeEnum.RecommendationType):
            Recommendation type.
        search_engine_results_page_type (google.ads.googleads.v18.enums.types.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType):
        ...
        search_term_match_type (google.ads.googleads.v18.enums.types.SearchTermMatchTypeEnum.SearchTermMatchType):
            Match type of the keyword that triggered the
            ad, including variants.
        slot (google.ads.googleads.v18.enums.types.SlotEnum.Slot):
            Position of the ad.
        conversion_value_rule_primary_dimension (google.ads.googleads.v18.enums.types.ConversionValueRulePrimaryDimensionEnum.ConversionValueRulePrimaryDimension):
        ...
        sk_ad_network_user_type (google.ads.googleads.v18.enums.types.SkAdNetworkUserTypeEnum.SkAdNetworkUserType):
            iOS Store Kit Ad Network user type.
        sk_ad_network_ad_event_type (google.ads.googleads.v18.enums.types.SkAdNetworkAdEventTypeEnum.SkAdNetworkAdEventType):
            iOS Store Kit Ad Network ad event type.
        sk_ad_network_source_app (google.ads.googleads.v18.common.types.SkAdNetworkSourceApp):
        ...
        sk_ad_network_attribution_credit (google.ads.googleads.v18.enums.types.SkAdNetworkAttributionCreditEnum.SkAdNetworkAttributionCredit):
            iOS Store Kit Ad Network attribution credit
        sk_ad_network_coarse_conversion_value (google.ads.googleads.v18.enums.types.SkAdNetworkCoarseConversionValueEnum.SkAdNetworkCoarseConversionValue):
        ...
        sk_ad_network_source_type (google.ads.googleads.v18.enums.types.SkAdNetworkSourceTypeEnum.SkAdNetworkSourceType):
        ...
        asset_interaction_target (google.ads.googleads.v18.common.types.AssetInteractionTarget):
        ...
        new_versus_returning_customers (google.ads.googleads.v18.enums.types.ConvertingUserPriorEngagementTypeAndLtvBucketEnum.ConvertingUserPriorEngagementTypeAndLtvBucket):
    ...
    ad_format_type: gage_ad_format_type.AdFormatTypeEnum.AdFormatType = proto.Field(
        proto.ENUM,
        number=191,
        enum=gage_ad_format_type.AdFormatTypeEnum.AdFormatType,
    )
    ad_network_type: gage_ad_network_type.AdNetworkTypeEnum.AdNetworkType = proto.Field(
        proto.ENUM,
        number=3,
        enum=gage_ad_network_type.AdNetworkTypeEnum.AdNetworkType,
    )
    ad_group: str = proto.Field(
        proto.STRING, number=158, optional=True,
    )
    asset_group: str = proto.Field(
        proto.STRING, number=159, optional=True,
    )
    auction_insight_domain: str = proto.Field(
        proto.STRING, number=145, optional=True,
    )
    budget_campaign_association_status: "BudgetCampaignAssociationStatus" = proto.Field(
        proto.MESSAGE, number=134, message="BudgetCampaignAssociationStatus",
    )
    campaign: str = proto.Field(
        proto.STRING, number=157, optional=True,
    )
    ...
    conversion_action: str = proto.Field(
        proto.STRING, number=113, optional=True,
    )
    ...
    date: str = proto.Field(
        proto.STRING, number=79, optional=True,
    )
    ...
    geo_target_region: str = proto.Field(
        proto.STRING, number=126, optional=True,
    )
    ...
    hotel_check_in_day_of_week: gage_day_of_week.DayOfWeekEnum.DayOfWeek = proto.Field(
    ...
    hotel_rate_type: gage_hotel_rate_type.HotelRateTypeEnum.HotelRateType = proto.Field(
        proto.ENUM,
        number=74,
    ...
    hotel_state: str = proto.Field(
        proto.STRING, number=87, optional=True,
    )
    ...
    keyword: "Keyword" = proto.Field(
        proto.MESSAGE, number=61, message="Keyword",
    )
    ...
    product_category_level3: str = proto.Field(
        proto.STRING, number=163, optional=True,
    )
    product_category_level4: str = proto.Field(
        proto.STRING, number=164, optional=True,
    )
    product_category_level5: str = proto.Field(
        proto.STRING, number=165, optional=True,
    )
    product_brand: str = proto.Field(
        proto.STRING, number=97, optional=True,
    )
    product_channel: gage_product_channel.ProductChannelEnum.ProductChannel = proto.Field(
        proto.ENUM,
        number=30,
    ...
    product_store_id: str = proto.Field(
        proto.STRING, number=106, optional=True,
    )
    ...
    search_subcategory: str = proto.Field(
        proto.STRING, number=155, optional=True,
    )
    search_term: str = proto.Field(
        proto.STRING, number=156, optional=True,
    )
    ...
    slot: gage_slot.SlotEnum.Slot = proto.Field(
        proto.ENUM, number=23, enum=gage_slot.SlotEnum.Slot,
    )
    ...
    sk_ad_network_redistributed_fine_conversion_value: int = proto.Field(
        proto.INT64, number=190, optional=True,
    )
    ...
    sk_ad_network_source_domain: str = proto.Field(
        proto.STRING, number=152, optional=True,
    )
    ...
    sk_ad_network_version: str = proto.Field(
        proto.STRING, number=192, optional=True,
    )
...
class Keyword(proto.Message):
    ...
    Attributes:
        ...
        info (google.ads.googleads.v18.common.types.KeywordInfo):
            Keyword info.
    """
...
class BudgetCampaignAssociationStatus(proto.Message):
    ...
    Attributes:
        campaign (str):
            ...
            This field is a member of `oneof`_ ``_campaign``.
        status (google.ads.googleads.v18.enums.types.BudgetCampaignAssociationStatusEnum.BudgetCampaignAssociationStatus):
            Budget campaign association status.
    """
