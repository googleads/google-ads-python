...
"""Accesses the google.ads.googleads.v2.services ConversionAdjustmentUploadService API."""
...
from google.ads.google_ads.v2.services import conversion_adjustment_upload_service_client_config
...
class ConversionAdjustmentUploadServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.ConversionAdjustmentUploadService'
    ...
    def upload_conversion_adjustments(
        ...
        Args:
            ...
            conversion_adjustments (list[Union[dict, ~google.ads.googleads_v2.types.ConversionAdjustment]]): The conversion adjustments that are being uploaded.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.ConversionAdjustment`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.UploadConversionAdjustmentsResponse` instance.
