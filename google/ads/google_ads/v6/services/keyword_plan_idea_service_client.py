...
"""Accesses the google.ads.googleads.v6.services KeywordPlanIdeaService API."""
...
from google.ads.google_ads.v6.services import keyword_plan_idea_service_client_config
from google.ads.google_ads.v6.services.transports import keyword_plan_idea_service_grpc_transport
from google.ads.google_ads.v6.proto.services import keyword_plan_idea_service_pb2
...
class KeywordPlanIdeaServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v6.services.KeywordPlanIdeaService'
    ...
    def generate_keyword_ideas(
        ...
        Args:
            ...
            keyword_and_url_seed (Union[dict, ~google.ads.googleads_v6.types.KeywordAndUrlSeed]): A Keyword and a specific Url to generate ideas from
                ...
                message :class:`~google.ads.googleads_v6.types.KeywordAndUrlSeed`
            keyword_seed (Union[dict, ~google.ads.googleads_v6.types.KeywordSeed]): A Keyword or phrase to generate ideas from, e.g. cars.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v6.types.KeywordSeed`
            url_seed (Union[dict, ~google.ads.googleads_v6.types.UrlSeed]): A specific url to generate ideas from, e.g. www.example.com/cars.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v6.types.UrlSeed`
            site_seed (Union[dict, ~google.ads.googleads_v6.types.SiteSeed]): The site to generate ideas from, e.g. www.example.com.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v6.types.SiteSeed`
        ...
        Returns:
            ...
            An iterable of :class:`~google.ads.googleads_v6.types.GenerateKeywordIdeaResult` instances.
