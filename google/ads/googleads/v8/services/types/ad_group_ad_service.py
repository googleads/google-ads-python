...
class MutateAdGroupAdsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            are being modified.
        operations (Sequence[google.ads.googleads.v8.services.types.AdGroupAdOperation]):
...
class AdGroupAdOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v8.resources.types.AdGroupAd):
            Create operation: No resource name is
            expected for the new ad.
        update (google.ads.googleads.v8.resources.types.AdGroupAd):
...
class MutateAdGroupAdsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v8.services.types.MutateAdGroupAdResult]):
