...
class CustomerExtensionSettingServiceClient(
    ...
    def get_customer_extension_setting(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCustomerExtensionSettingRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CustomerExtensionSetting:
    ...
    def mutate_customer_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCustomerExtensionSettingsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CustomerExtensionSettingOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCustomerExtensionSettingsResponse:
