...
"""Accesses the google.ads.googleads.v2.services AdGroupSimulationService API."""
...
from google.ads.google_ads.v2.services import ad_group_simulation_service_client_config
...
class AdGroupSimulationServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.AdGroupSimulationService'
    ...
    def get_ad_group_simulation(
        ...
        Args:
            resource_name (str): The resource name of the ad group simulation to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.AdGroupSimulation` instance.
