...
class CampaignBidModifierServiceClient(
    ...
    def mutate_campaign_bid_modifiers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateCampaignBidModifiersRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateCampaignBidModifiersResponse:
