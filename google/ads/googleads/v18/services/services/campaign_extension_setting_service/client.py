...
class CampaignExtensionSettingServiceClient(
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                CampaignExtensionSettingServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = CampaignExtensionSettingServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        ) = CampaignExtensionSettingServiceClient._read_environment_variables()
        self._client_cert_source = (
            CampaignExtensionSettingServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            CampaignExtensionSettingServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CampaignExtensionSettingServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                CampaignExtensionSettingServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CampaignExtensionSettingServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v18.services.CampaignExtensionSettingServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaign_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateCampaignExtensionSettingsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v18.services.types.CampaignExtensionSettingOperation]):
    ...
    def __enter__(self) -> "CampaignExtensionSettingServiceClient":
        return self
