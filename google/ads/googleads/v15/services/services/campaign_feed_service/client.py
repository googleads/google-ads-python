...
class CampaignFeedServiceClient(metaclass=CampaignFeedServiceClientMeta):
    ...
    def mutate_campaign_feeds(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateCampaignFeedsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateCampaignFeedsResponse:
