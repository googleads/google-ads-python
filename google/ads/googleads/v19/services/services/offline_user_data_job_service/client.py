...
class OfflineUserDataJobServiceClient(
    ...
    def create_offline_user_data_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.CreateOfflineUserDataJobRequest, dict, None]):
    ...
    def add_offline_user_data_job_operations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.AddOfflineUserDataJobOperationsRequest, dict, None]):
                The request object. Request message for
    ...
    def run_offline_user_data_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.RunOfflineUserDataJobRequest, dict, None]):
                The request object. Request message for
