...
from google.ads.googleads.v10.enums.types import manager_link_status
...
class CustomerManagerLink(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v10.enums.types.ManagerLinkStatusEnum.ManagerLinkStatus):
