...
from google.ads.googleads.v17.enums.types import local_services_lead_status
from google.ads.googleads.v17.enums.types import local_services_lead_type
...
class LocalServicesLead(proto.Message):
    ...
    Attributes:
        ...
        contact_details (google.ads.googleads.v17.resources.types.ContactDetails):
            Output only. Lead's contact details.
        lead_type (google.ads.googleads.v17.enums.types.LocalServicesLeadTypeEnum.LeadType):
            Output only. Type of Local Services lead:
            phone, message, booking, etc.
        lead_status (google.ads.googleads.v17.enums.types.LocalServicesLeadStatusEnum.LeadStatus):
        ...
        note (google.ads.googleads.v17.resources.types.Note):
        ...
        credit_details (google.ads.googleads.v17.resources.types.CreditDetails):
