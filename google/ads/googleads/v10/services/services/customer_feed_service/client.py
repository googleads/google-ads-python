...
class CustomerFeedServiceClient(metaclass=CustomerFeedServiceClientMeta):
    ...
    def mutate_customer_feeds(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.MutateCustomerFeedsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v10.services.types.MutateCustomerFeedsResponse:
