...
class Segments(proto.Message):
    ...
    Attributes:
        ...
        new_versus_returning_customers (google.ads.googleads.v14.enums.types.ConvertingUserPriorEngagementTypeAndLtvBucketEnum.ConvertingUserPriorEngagementTypeAndLtvBucket):
