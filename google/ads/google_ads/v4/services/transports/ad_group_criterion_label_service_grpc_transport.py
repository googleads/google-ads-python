...
from google.ads.google_ads.v4.proto.services import ad_group_criterion_label_service_pb2_grpc


class AdGroupCriterionLabelServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v4.services AdGroupCriterionLabelService API.
