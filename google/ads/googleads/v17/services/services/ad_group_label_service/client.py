...
class AdGroupLabelServiceClient(metaclass=AdGroupLabelServiceClientMeta):
    ...
    def mutate_ad_group_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateAdGroupLabelsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v17.services.types.AdGroupLabelOperation]):
        ...
        Returns:
            google.ads.googleads.v17.services.types.MutateAdGroupLabelsResponse:
