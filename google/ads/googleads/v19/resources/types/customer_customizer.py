...
class CustomerCustomizer(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v19.enums.types.CustomizerValueStatusEnum.CustomizerValueStatus):
            Output only. The status of the customer
            customizer attribute.
        value (google.ads.googleads.v19.common.types.CustomizerValue):
