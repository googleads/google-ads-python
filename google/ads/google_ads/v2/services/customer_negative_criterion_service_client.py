...
"""Accesses the google.ads.googleads.v2.services CustomerNegativeCriterionService API."""
...
from google.ads.google_ads.v2.services import customer_negative_criterion_service_client_config
...
class CustomerNegativeCriterionServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.CustomerNegativeCriterionService'
    ...
    def get_customer_negative_criterion(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.CustomerNegativeCriterion` instance.
    ...
    def mutate_customer_negative_criteria(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.CustomerNegativeCriterionOperation]]): The list of operations to perform on individual criteria.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.CustomerNegativeCriterionOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateCustomerNegativeCriteriaResponse` instance.
