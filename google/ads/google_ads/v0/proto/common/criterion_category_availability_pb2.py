...
# source: google/ads/googleads_v0/proto/common/criterion_category_availability.proto
...
from google.ads.google_ads.v0.proto.enums import criterion_category_channel_availability_mode_pb2 as google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_criterion__category__channel__availability__mode__pb2
from google.ads.google_ads.v0.proto.enums import criterion_category_locale_availability_mode_pb2 as google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_criterion__category__locale__availability__mode__pb2
...
_CRITERIONCATEGORYAVAILABILITY = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.common.CriterionCategoryAvailability',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='channel', full_name='google.ads.googleads.v0.common.CriterionCategoryAvailability.channel', index=0,
...
_CRITERIONCATEGORYCHANNELAVAILABILITY = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.common.CriterionCategoryChannelAvailability',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='availability_mode', full_name='google.ads.googleads.v0.common.CriterionCategoryChannelAvailability.availability_mode', index=0,
...
_CRITERIONCATEGORYLOCALEAVAILABILITY = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.common.CriterionCategoryLocaleAvailability',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='availability_mode', full_name='google.ads.googleads.v0.common.CriterionCategoryLocaleAvailability.availability_mode', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CRITERIONCATEGORYCHANNELAVAILABILITY.fields_by_name['availability_mode'].enum_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_criterion__category__channel__availability__mode__pb2._CRITERIONCATEGORYCHANNELAVAILABILITYMODEENUM_CRITERIONCATEGORYCHANNELAVAILABILITYMODE
_CRITERIONCATEGORYCHANNELAVAILABILITY.fields_by_name['advertising_channel_type'].enum_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_advertising__channel__type__pb2._ADVERTISINGCHANNELTYPEENUM_ADVERTISINGCHANNELTYPE
_CRITERIONCATEGORYCHANNELAVAILABILITY.fields_by_name['advertising_channel_sub_type'].enum_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_advertising__channel__sub__type__pb2._ADVERTISINGCHANNELSUBTYPEENUM_ADVERTISINGCHANNELSUBTYPE
...
_CRITERIONCATEGORYLOCALEAVAILABILITY.fields_by_name['availability_mode'].enum_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_criterion__category__locale__availability__mode__pb2._CRITERIONCATEGORYLOCALEAVAILABILITYMODEENUM_CRITERIONCATEGORYLOCALEAVAILABILITYMODE
...
CriterionCategoryChannelAvailability = _reflection.GeneratedProtocolMessageType('CriterionCategoryChannelAvailability', (_message.Message,), dict(
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v0.common.CriterionCategoryChannelAvailability)
  ))
