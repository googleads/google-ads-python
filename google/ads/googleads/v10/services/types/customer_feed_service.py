...
class MutateCustomerFeedsRequest(proto.Message):
    ...
    [CustomerFeedService.MutateCustomerFeeds][google.ads.googleads.v10.services.CustomerFeedService.MutateCustomerFeeds].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            customer feeds are being modified.
        operations (Sequence[google.ads.googleads.v10.services.types.CustomerFeedOperation]):
...
class CustomerFeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v10.resources.types.CustomerFeed):
            Create operation: No resource name is
            expected for the new customer feed.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v10.resources.types.CustomerFeed):
...
class MutateCustomerFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v10.services.types.MutateCustomerFeedResult]):
