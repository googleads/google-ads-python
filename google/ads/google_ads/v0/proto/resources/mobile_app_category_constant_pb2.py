...
# source: google/ads/googleads_v0/proto/resources/mobile_app_category_constant.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v0/proto/resources/mobile_app_category_constant.proto',
  package='google.ads.googleads.v0.resources',
  syntax='proto3',
  serialized_options=_b('\n%com.google.ads.googleads.v0.resourcesB\036MobileAppCategoryConstantProtoP\001ZJgoogle.golang.org/genproto/googleapis/ads/googleads/v0/resources;resources\242\002\003GAA\252\002!Google.Ads.GoogleAds.V0.Resources\312\002!Google\\Ads\\GoogleAds\\V0\\Resources\352\002%Google::Ads::GoogleAds::V0::Resources'),
...
_MOBILEAPPCATEGORYCONSTANT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.resources.MobileAppCategoryConstant',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v0.resources.MobileAppCategoryConstant.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v0.resources.MobileAppCategoryConstant.id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='google.ads.googleads.v0.resources.MobileAppCategoryConstant.name', index=2,
...
MobileAppCategoryConstant = _reflection.GeneratedProtocolMessageType('MobileAppCategoryConstant', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v0.proto.resources.mobile_app_category_constant_pb2'
  ,
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v0.resources.MobileAppCategoryConstant)
  ))
