...
class FeedItemSetServiceGrpcAsyncIOTransport(FeedItemSetServiceTransport):
    """gRPC AsyncIO backend transport for FeedItemSetService.
    ...
    def mutate_feed_item_sets(
        ...
        Returns:
            Callable[[~.MutateFeedItemSetsRequest],
                    Awaitable[~.MutateFeedItemSetsResponse]]:
        ...
        if "mutate_feed_item_sets" not in self._stubs:
            self._stubs["mutate_feed_item_sets"] = (
                self._logged_channel.unary_unary(
                    "/google.ads.googleads.v18.services.FeedItemSetService/MutateFeedItemSets",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_feed_item_sets: self._wrap_method(
...
__all__ = ("FeedItemSetServiceGrpcAsyncIOTransport",)
