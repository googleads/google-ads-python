...
"""Accesses the google.ads.googleads.v6.services AdGroupService API."""
...
from google.ads.google_ads.v6.services import ad_group_service_client_config
from google.ads.google_ads.v6.services.transports import ad_group_service_grpc_transport
from google.ads.google_ads.v6.proto.services import ad_group_service_pb2
...
class AdGroupServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v6.services.AdGroupService'
    ...
    def get_ad_group(
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.AdGroup` instance.
    ...
    def mutate_ad_groups(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v6.types.AdGroupOperation]]): Required. The list of operations to perform on individual ad groups.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v6.types.AdGroupOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.MutateAdGroupsResponse` instance.
