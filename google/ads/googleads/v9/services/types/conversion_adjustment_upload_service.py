...
from google.ads.googleads.v9.enums.types import conversion_adjustment_type
...
class UploadConversionAdjustmentsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            ads/api/docs/best-practices/partial-failures for
            more information about partial failure.
        results (Sequence[google.ads.googleads.v9.services.types.ConversionAdjustmentResult]):
...
class ConversionAdjustment(proto.Message):
    ...
    Attributes:
        gclid_date_time_pair (google.ads.googleads.v9.services.types.GclidDateTimePair):
        ...
        adjustment_type (google.ads.googleads.v9.enums.types.ConversionAdjustmentTypeEnum.ConversionAdjustmentType):
            The adjustment type.
        restatement_value (google.ads.googleads.v9.services.types.RestatementValue):
