...
from .transports.grpc_asyncio import CustomerFeedServiceGrpcAsyncIOTransport
...
class CustomerFeedServiceClient(metaclass=CustomerFeedServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CustomerFeedServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                CustomerFeedServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CustomerFeedServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = CustomerFeedServiceClient._read_environment_variables()
        self._client_cert_source = (
            CustomerFeedServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = CustomerFeedServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, CustomerFeedServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(CustomerFeedServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CustomerFeedServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CustomerFeedServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., CustomerFeedServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v17.services.CustomerFeedServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customer_feeds(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateCustomerFeedsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v17.services.types.CustomerFeedOperation]):
