...
class ProductLinkInvitationServiceClient(
    ...
    def create_product_link_invitation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.CreateProductLinkInvitationRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v19.services.types.CreateProductLinkInvitationResponse:
    ...
    def update_product_link_invitation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.UpdateProductLinkInvitationRequest, dict, None]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            product_link_invitation_status (google.ads.googleads.v19.enums.types.ProductLinkInvitationStatusEnum.ProductLinkInvitationStatus):
                Required. The product link invitation
                to be created.
        ...
        Returns:
            google.ads.googleads.v19.services.types.UpdateProductLinkInvitationResponse:
                Response message for product link
                invitation update.
    ...
    def remove_product_link_invitation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.RemoveProductLinkInvitationRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v19.services.types.RemoveProductLinkInvitationResponse:
                Response message for product link
                invitation removeal.
