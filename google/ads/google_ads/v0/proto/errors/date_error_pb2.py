...
_DATEERRORENUM_DATEERROR = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EARLIER_THAN_MINIMUM_DATE', index=7, number=7,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LATER_THAN_MAXIMUM_DATE', index=8, number=8,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DATE_RANGE_MINIMUM_DATE_LATER_THAN_MAXIMUM_DATE', index=9, number=9,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DATE_RANGE_MINIMUM_AND_MAXIMUM_DATES_BOTH_NULL', index=10, number=10,
      serialized_options=None,
      type=None),
  ],
