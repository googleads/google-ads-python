...
class MultiPartyAuthReviewServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v22.services.MultiPartyAuthReviewServiceClient`.",
                    extra=(
                        {
    ...
    def resolve_multi_party_auth_review(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v22.services.types.ResolveMultiPartyAuthReviewRequest, dict]):
