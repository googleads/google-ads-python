...
class CustomerUserAccessInvitationServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v17.services.CustomerUserAccessInvitationServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def mutate_customer_user_access_invitation(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v17.services.types.MutateCustomerUserAccessInvitationRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operation (:class:`google.ads.googleads.v17.services.types.CustomerUserAccessInvitationOperation`):
        ...
        Returns:
            google.ads.googleads.v17.services.types.MutateCustomerUserAccessInvitationResponse:
