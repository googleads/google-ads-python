...
from google.ads.googleads.v14.enums.types import target_frequency_time_unit
...
class TargetCpm(proto.Message):
    ...
    Attributes:
        target_frequency_goal (google.ads.googleads.v14.common.types.TargetCpmTargetFrequencyGoal):
...
class TargetCpmTargetFrequencyGoal(proto.Message):
    ...
    Attributes:
        ...
        time_unit (google.ads.googleads.v14.enums.types.TargetFrequencyTimeUnitEnum.TargetFrequencyTimeUnit):
