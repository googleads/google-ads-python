...
from google.ads.google_ads.v1.proto.services import gender_view_service_pb2_grpc


class GenderViewServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v1.services GenderViewService API.
