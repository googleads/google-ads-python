...
class CampaignBudgetServiceClient(metaclass=CampaignBudgetServiceClientMeta):
    ...
    def mutate_campaign_budgets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateCampaignBudgetsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v16.services.types.CampaignBudgetOperation]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateCampaignBudgetsResponse:
