...
class AssetGroupSignalServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, AssetGroupSignalServiceTransport]]): The
    ...
    def mutate_asset_group_signals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateAssetGroupSignalsRequest, dict, None]):
