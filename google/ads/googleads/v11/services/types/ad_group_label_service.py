...
from google.ads.googleads.v11.resources.types import ad_group_label
...
class MutateAdGroupLabelsRequest(proto.Message):
    ...
    [AdGroupLabelService.MutateAdGroupLabels][google.ads.googleads.v11.services.AdGroupLabelService.MutateAdGroupLabels].

    Attributes:
        customer_id (str):
            Required. ID of the customer whose ad group
            labels are being modified.
        operations (Sequence[google.ads.googleads.v11.services.types.AdGroupLabelOperation]):
...
class AdGroupLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v11.resources.types.AdGroupLabel):
...
class MutateAdGroupLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v11.services.types.MutateAdGroupLabelResult]):
