...
class ExtensionFeedItemServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v18.services.ExtensionFeedItemServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_extension_feed_items(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateExtensionFeedItemsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v18.services.types.ExtensionFeedItemOperation]):
