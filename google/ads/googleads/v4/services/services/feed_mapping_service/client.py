...
class FeedMappingServiceClient(metaclass=FeedMappingServiceClientMeta):
    ...
    def get_feed_mapping(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetFeedMappingRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.FeedMapping:
                A feed mapping.
        """
    ...
    def mutate_feed_mappings(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateFeedMappingsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.FeedMappingOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateFeedMappingsResponse:
