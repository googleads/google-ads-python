...
class ConversionAdjustmentUploadServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, ConversionAdjustmentUploadServiceTransport]]): The
    ...
    def upload_conversion_adjustments(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.UploadConversionAdjustmentsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.UploadConversionAdjustmentsResponse:
