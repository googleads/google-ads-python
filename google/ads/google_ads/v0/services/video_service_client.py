...
"""Accesses the google.ads.googleads.v0.services VideoService API."""
...
from google.ads.google_ads.v0.services import video_service_client_config
...
class VideoServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v0.services.VideoService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=video_service_grpc_transport.
    ...
    def get_video(self,
        ...
        Returns:
            A :class:`~google.ads.google_ads.v0.types.Video` instance.
        ...
        if 'get_video' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_video'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['get_video'](
