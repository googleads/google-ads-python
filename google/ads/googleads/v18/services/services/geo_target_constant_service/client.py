...
class GeoTargetConstantServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, GeoTargetConstantServiceTransport]]): The
    ...
    def suggest_geo_target_constants(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.SuggestGeoTargetConstantsRequest, dict, None]):
