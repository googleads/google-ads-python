...
"""Accesses the google.ads.googleads.v2.services CampaignCriterionService API."""
...
from google.ads.google_ads.v2.services import campaign_criterion_service_client_config
...
class CampaignCriterionServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.CampaignCriterionService'
    ...
    def get_campaign_criterion(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.CampaignCriterion` instance.
    ...
    def mutate_campaign_criteria(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.CampaignCriterionOperation]]): The list of operations to perform on individual criteria.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.CampaignCriterionOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateCampaignCriteriaResponse` instance.
