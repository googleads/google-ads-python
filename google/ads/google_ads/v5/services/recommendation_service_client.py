...
"""Accesses the google.ads.googleads.v5.services RecommendationService API."""
...
from google.ads.google_ads.v5.services import recommendation_service_client_config
from google.ads.google_ads.v5.services.transports import recommendation_service_grpc_transport
from google.ads.google_ads.v5.proto.services import recommendation_service_pb2
...
class RecommendationServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v5.services.RecommendationService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=recommendation_service_grpc_transport.RecommendationServiceGrpcTransport,
    ...
    def get_recommendation(
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.Recommendation` instance.
    ...
    def apply_recommendation(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v5.types.ApplyRecommendationOperation]]): Required. The list of operations to apply recommendations. If
                partial\_failure=false all recommendations should be of the same type
                There is a limit of 100 operations per request.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v5.types.ApplyRecommendationOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.ApplyRecommendationResponse` instance.
        ...
        if 'apply_recommendation' not in self._inner_api_calls:
            self._inner_api_calls['apply_recommendation'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.apply_recommendation,
                default_retry=self._method_configs['ApplyRecommendation'].retry,
                default_timeout=self._method_configs['ApplyRecommendation'].timeout,
                client_info=self._client_info,
            )
        ...
        return self._inner_api_calls['apply_recommendation'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def dismiss_recommendation(
        ...
        Args:
            customer_id (str): Required. The ID of the customer with the recommendation.
            operations (list[Union[dict, ~google.ads.googleads_v5.types.DismissRecommendationOperation]]): Required. The list of operations to dismiss recommendations. If
                partial\_failure=false all recommendations should be of the same type
                There is a limit of 100 operations per request.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v5.types.DismissRecommendationOperation`
            partial_failure (bool): If true, successful operations will be carried out and invalid
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.DismissRecommendationResponse` instance.
        ...
        if 'dismiss_recommendation' not in self._inner_api_calls:
            self._inner_api_calls['dismiss_recommendation'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.dismiss_recommendation,
                default_retry=self._method_configs['DismissRecommendation'].retry,
                default_timeout=self._method_configs['DismissRecommendation'].timeout,
                client_info=self._client_info,
            )
        ...
        return self._inner_api_calls['dismiss_recommendation'](request, retry=retry, timeout=timeout, metadata=metadata)
