...
class MutateConversionActionsRequest(proto.Message):
    ...
    [ConversionActionService.MutateConversionActions][google.ads.googleads.v10.services.ConversionActionService.MutateConversionActions].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            conversion actions are being modified.
        operations (Sequence[google.ads.googleads.v10.services.types.ConversionActionOperation]):
...
class ConversionActionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v10.resources.types.ConversionAction):
            Create operation: No resource name is
            expected for the new conversion action.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v10.resources.types.ConversionAction):
...
class MutateConversionActionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v10.services.types.MutateConversionActionResult]):
