...
"""Accesses the google.ads.googleads.v1.services AgeRangeViewService API."""
...
from google.ads.google_ads.v1.services import age_range_view_service_client_config
...
class AgeRangeViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.AgeRangeViewService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=age_range_view_service_grpc_transport.
    ...
    def get_age_range_view(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.AgeRangeView` instance.
        ...
        if 'get_age_range_view' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_age_range_view'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_age_range_view,
                    default_retry=self._method_configs['GetAgeRangeView'].
                    retry,
                    default_timeout=self._method_configs['GetAgeRangeView'].
                    timeout,
        ...
        return self._inner_api_calls['get_age_range_view'](
