...
class FeedServiceClient(metaclass=FeedServiceClientMeta):
    ...
    def mutate_feeds(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateFeedsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v15.services.types.FeedOperation]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateFeedsResponse:
