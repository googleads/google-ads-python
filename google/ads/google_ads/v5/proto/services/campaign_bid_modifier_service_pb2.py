...
# source: google/ads/googleads_v5/proto/services/campaign_bid_modifier_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v5/proto/services/campaign_bid_modifier_service.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads__v5_dot_proto_dot_resources_dot_campaign__bid__modifier__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_protobuf_dot_field__mask__pb2.DESCRIPTOR,google_dot_rpc_dot_status__pb2.DESCRIPTOR,])
...
_CAMPAIGNBIDMODIFIEROPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v5_dot_proto_dot_resources_dot_campaign__bid__modifier__pb2._CAMPAIGNBIDMODIFIER
_CAMPAIGNBIDMODIFIEROPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v5_dot_proto_dot_resources_dot_campaign__bid__modifier__pb2._CAMPAIGNBIDMODIFIER
...
GetCampaignBidModifierRequest = _reflection.GeneratedProtocolMessageType('GetCampaignBidModifierRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads_v5.proto.services.campaign_bid_modifier_service_pb2'
  ,
  '__doc__': """Request message for [CampaignBidModifierService.GetCampaignBidModifier
  ][google.ads.googleads.v5.services.CampaignBidModifierService.GetCampa
  ignBidModifier].
  
  Attributes:
      resource_name:
          Required. The resource name of the campaign bid modifier to
          fetch.
  """,
...
MutateCampaignBidModifiersRequest = _reflection.GeneratedProtocolMessageType('MutateCampaignBidModifiersRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads_v5.proto.services.campaign_bid_modifier_service_pb2'
  ,
  '__doc__': """Request message for [CampaignBidModifierService.MutateCampaignBidModif
  iers][google.ads.googleads.v5.services.CampaignBidModifierService.Muta
  teCampaignBidModifiers].
  
  Attributes:
      customer_id:
          Required. ID of the customer whose campaign bid modifiers are
          being modified.
      operations:
...
CampaignBidModifierOperation = _reflection.GeneratedProtocolMessageType('CampaignBidModifierOperation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads_v5.proto.services.campaign_bid_modifier_service_pb2'
  ,
  '__doc__': """A single operation (create, remove, update) on a campaign bid
  modifier.
...
_CAMPAIGNBIDMODIFIERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v5_dot_proto_dot_resources_dot_campaign__bid__modifier__pb2._CAMPAIGNBIDMODIFIER,
