...
class ListMerchantCenterLinksResponse(proto.Message):
    ...
    Attributes:
        merchant_center_links (MutableSequence[google.ads.googleads.v13.resources.types.MerchantCenterLink]):
            Merchant Center links available for the
            requested customer
    """

    merchant_center_links: MutableSequence[
...
class MerchantCenterLinkOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v13.resources.types.MerchantCenterLink):
...
class MutateMerchantCenterLinkResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v13.services.types.MutateMerchantCenterLinkResult):
