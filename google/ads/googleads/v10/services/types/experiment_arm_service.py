...
class MutateExperimentArmsRequest(proto.Message):
    ...
    [ExperimentArmService.MutateExperimentArms][google.ads.googleads.v10.services.ExperimentArmService.MutateExperimentArms].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            experiments are being modified.
        operations (Sequence[google.ads.googleads.v10.services.types.ExperimentArmOperation]):
...
class ExperimentArmOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v10.resources.types.ExperimentArm):
            Create operation

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v10.resources.types.ExperimentArm):
...
class MutateExperimentArmsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v10.services.types.MutateExperimentArmResult]):
