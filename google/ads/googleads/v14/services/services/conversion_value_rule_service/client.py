...
class ConversionValueRuleServiceClient(
    ...
    def mutate_conversion_value_rules(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateConversionValueRulesRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v14.services.types.ConversionValueRuleOperation]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateConversionValueRulesResponse:
