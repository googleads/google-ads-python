...
class ListBatchJobResultsPager:
    ...
    :class:`google.ads.googleads.v25.services.types.ListBatchJobResultsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v25.services.types.ListBatchJobResultsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.ads.googleads.v25.services.types.ListBatchJobResultsRequest):
                The initial request object.
            response (google.ads.googleads.v25.services.types.ListBatchJobResultsResponse):
