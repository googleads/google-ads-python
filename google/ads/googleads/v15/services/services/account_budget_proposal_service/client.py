...
class AccountBudgetProposalServiceClient(
    ...
    def mutate_account_budget_proposal(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateAccountBudgetProposalRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v15.services.types.AccountBudgetProposalOperation):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateAccountBudgetProposalResponse:
