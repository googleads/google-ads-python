...
from google.ads.googleads.v16.enums.types import customer_status
from google.ads.googleads.v16.enums.types import (
...
class Customer(proto.Message):
    ...
    Attributes:
        ...
        call_reporting_setting (google.ads.googleads.v16.resources.types.CallReportingSetting):
            Call reporting setting for a customer. Only mutable in an
            ``update`` operation.
        conversion_tracking_setting (google.ads.googleads.v16.resources.types.ConversionTrackingSetting):
            Output only. Conversion tracking setting for
            a customer.
        remarketing_setting (google.ads.googleads.v16.resources.types.RemarketingSetting):
            Output only. Remarketing setting for a
            customer.
        pay_per_conversion_eligibility_failure_reasons (MutableSequence[google.ads.googleads.v16.enums.types.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason]):
        ...
        optimization_score_weight (float):
            ...
            This field is read-only.
        status (google.ads.googleads.v16.enums.types.CustomerStatusEnum.CustomerStatus):
        ...
        customer_agreement_setting (google.ads.googleads.v16.resources.types.CustomerAgreementSetting):
...
class LocalServicesSettings(proto.Message):
    ...
    Attributes:
        granular_license_statuses (MutableSequence[google.ads.googleads.v16.resources.types.GranularLicenseStatus]):
            Output only. A read-only list of geo vertical
            level license statuses.
        granular_insurance_statuses (MutableSequence[google.ads.googleads.v16.resources.types.GranularInsuranceStatus]):
            Output only. A read-only list of geo vertical
...
class GranularLicenseStatus(proto.Message):
    ...
    Attributes:
        ...
        verification_status (google.ads.googleads.v16.enums.types.LocalServicesVerificationStatusEnum.LocalServicesVerificationStatus):
