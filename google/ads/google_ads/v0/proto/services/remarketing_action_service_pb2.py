...
# source: google/ads/googleads_v0/proto/services/remarketing_action_service.proto
...
_GETREMARKETINGACTIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.GetRemarketingActionRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v0.services.GetRemarketingActionRequest.resource_name', index=0,
...
_MUTATEREMARKETINGACTIONSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.MutateRemarketingActionsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v0.services.MutateRemarketingActionsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v0.services.MutateRemarketingActionsRequest.operations', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v0.services.MutateRemarketingActionsRequest.partial_failure', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v0.services.MutateRemarketingActionsRequest.validate_only', index=3,
...
_REMARKETINGACTIONOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.RemarketingActionOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v0.services.RemarketingActionOperation.update_mask', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v0.services.RemarketingActionOperation.create', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v0.services.RemarketingActionOperation.update', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v0.services.RemarketingActionOperation.operation',
...
_MUTATEREMARKETINGACTIONSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.MutateRemarketingActionsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v0.services.MutateRemarketingActionsResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v0.services.MutateRemarketingActionsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEREMARKETINGACTIONRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.MutateRemarketingActionResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v0.services.MutateRemarketingActionResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REMARKETINGACTIONOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_resources_dot_remarketing__action__pb2._REMARKETINGACTION
_REMARKETINGACTIONOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_resources_dot_remarketing__action__pb2._REMARKETINGACTION
...
RemarketingActionOperation = _reflection.GeneratedProtocolMessageType('RemarketingActionOperation', (_message.Message,), dict(
  ...
  Attributes:
      ...
      update:
          ...
          valid resource name.
  """,
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v0.services.RemarketingActionOperation)
  ))
...
_REMARKETINGACTIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v0.services.RemarketingActionService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v0.services.RemarketingActionService.GetRemarketingAction',
    index=0,
    containing_service=None,
    input_type=_GETREMARKETINGACTIONREQUEST,
    output_type=google_dot_ads_dot_googleads__v0_dot_proto_dot_resources_dot_remarketing__action__pb2._REMARKETINGACTION,
    serialized_options=_b('\202\323\344\223\0026\0224/v0/{resource_name=customers/*/remarketingActions/*}'),
  ),
  _descriptor.MethodDescriptor(
    name='MutateRemarketingActions',
    full_name='google.ads.googleads.v0.services.RemarketingActionService.MutateRemarketingActions',
    index=1,
    containing_service=None,
    input_type=_MUTATEREMARKETINGACTIONSREQUEST,
    output_type=_MUTATEREMARKETINGACTIONSRESPONSE,
    serialized_options=_b('\202\323\344\223\002<\"7/v0/customers/{customer_id=*}/remarketingActions:mutate:\001*'),
  ),
])
