...
class CustomerCustomizerServiceClient(
    ...
    def mutate_customer_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateCustomerCustomizersRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateCustomerCustomizersResponse:
