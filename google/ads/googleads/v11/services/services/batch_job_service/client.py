...
from google.ads.googleads.v11.resources.types import batch_job
from google.ads.googleads.v11.services.services.batch_job_service import pagers
...
class BatchJobServiceClient(metaclass=BatchJobServiceClientMeta):
    ...
    def mutate_batch_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.MutateBatchJobRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v11.services.types.BatchJobOperation):
        ...
        Returns:
            google.ads.googleads.v11.services.types.MutateBatchJobResponse:
    ...
    def list_batch_job_results(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.ListBatchJobResultsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v11.services.services.batch_job_service.pagers.ListBatchJobResultsPager:
                Response message for
                [BatchJobService.ListBatchJobResults][google.ads.googleads.v11.services.BatchJobService.ListBatchJobResults].
    ...
    def run_batch_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.RunBatchJobRequest, dict]):
                The request object. Request message for
                [BatchJobService.RunBatchJob][google.ads.googleads.v11.services.BatchJobService.RunBatchJob].
            resource_name (str):
                Required. The resource name of the
                BatchJob to run.
    ...
    def add_batch_job_operations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.AddBatchJobOperationsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v11.services.types.AddBatchJobOperationsResponse:
                Response message for
                [BatchJobService.AddBatchJobOperations][google.ads.googleads.v11.services.BatchJobService.AddBatchJobOperations].
