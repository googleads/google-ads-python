...
class MutateConversionGoalCampaignConfigsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v10.services.types.ConversionGoalCampaignConfigOperation]):
...
class ConversionGoalCampaignConfigOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v10.resources.types.ConversionGoalCampaignConfig):
...
class MutateConversionGoalCampaignConfigsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v10.services.types.MutateConversionGoalCampaignConfigResult]):
