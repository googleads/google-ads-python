...
class BatchJobServiceClient(metaclass=BatchJobServiceClientMeta):
    ...
    def mutate_batch_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateBatchJobRequest, dict]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operation (:class:`google.ads.googleads.v9.services.types.BatchJobOperation`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateBatchJobResponse:
    ...
    def get_batch_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetBatchJobRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v9.resources.types.BatchJob:
    ...
    def list_batch_job_results(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.ListBatchJobResultsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v9.services.services.batch_job_service.pagers.ListBatchJobResultsPager:
                Response message for
                [BatchJobService.ListBatchJobResults][google.ads.googleads.v9.services.BatchJobService.ListBatchJobResults].
    ...
    def run_batch_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.RunBatchJobRequest, dict]):
                The request object. Request message for
    ...
    def add_batch_job_operations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.AddBatchJobOperationsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v9.services.types.AddBatchJobOperationsResponse:
                Response message for
                [BatchJobService.AddBatchJobOperations][google.ads.googleads.v9.services.BatchJobService.AddBatchJobOperations].
