...
from google.ads.googleads.v10.enums.types import feed_link_status
...
class CustomerFeed(proto.Message):
    ...
    Attributes:
        ...
        placeholder_types (Sequence[google.ads.googleads.v10.enums.types.PlaceholderTypeEnum.PlaceholderType]):
        ...
        status (google.ads.googleads.v10.enums.types.FeedLinkStatusEnum.FeedLinkStatus):
