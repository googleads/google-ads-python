...
"""Accesses the google.ads.googleads.v2.services CustomerLabelService API."""
...
from google.ads.google_ads.v2.services import customer_label_service_client_config
...
class CustomerLabelServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.CustomerLabelService'
    ...
    def __init__(self, transport=None, channel=None, credentials=None,
        ...
        Args:
            transport (Union[~.CustomerLabelServiceGrpcTransport,
                    Callable[[~.Credentials, type], ~.CustomerLabelServiceGrpcTransport]): A transport
        ...
        if client_config is not None:
            ...
            client_config = customer_label_service_client_config.config
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=customer_label_service_grpc_transport.CustomerLabelServiceGrpcTransport,
                )
            else:
                if credentials:
                    raise ValueError(
            ...
            self.transport = customer_label_service_grpc_transport.CustomerLabelServiceGrpcTransport(
    ...
    def get_customer_label(
        ...
        Args:
            resource_name (str): The resource name of the customer-label relationship to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.CustomerLabel` instance.
        ...
        if 'get_customer_label' not in self._inner_api_calls:
            self._inner_api_calls['get_customer_label'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_customer_label,
                default_retry=self._method_configs['GetCustomerLabel'].retry,
                default_timeout=self._method_configs['GetCustomerLabel'].timeout,
                client_info=self._client_info,
            )

        request = customer_label_service_pb2.GetCustomerLabelRequest(
        ...
        return self._inner_api_calls['get_customer_label'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def mutate_customer_labels(
        ...
        Args:
            customer_id (str): ID of the customer whose customer-label relationships are being modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.CustomerLabelOperation]]): The list of operations to perform on customer-label relationships.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.CustomerLabelOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateCustomerLabelsResponse` instance.
        ...
        """
        # Wrap the transport method to add retry and timeout logic.
        if 'mutate_customer_labels' not in self._inner_api_calls:
            self._inner_api_calls['mutate_customer_labels'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.mutate_customer_labels,
                default_retry=self._method_configs['MutateCustomerLabels'].retry,
                default_timeout=self._method_configs['MutateCustomerLabels'].timeout,
                client_info=self._client_info,
            )

        request = customer_label_service_pb2.MutateCustomerLabelsRequest(
        ...
        return self._inner_api_calls['mutate_customer_labels'](request, retry=retry, timeout=timeout, metadata=metadata)
