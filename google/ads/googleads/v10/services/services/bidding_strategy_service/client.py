...
class BiddingStrategyServiceClient(metaclass=BiddingStrategyServiceClientMeta):
    ...
    def mutate_bidding_strategies(
        self,
        request: Union[
            bidding_strategy_service.MutateBiddingStrategiesRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.MutateBiddingStrategiesRequest, dict]):
                The request object. Request message for
                [BiddingStrategyService.MutateBiddingStrategies][google.ads.googleads.v10.services.BiddingStrategyService.MutateBiddingStrategies].
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v10.services.types.BiddingStrategyOperation]):
        ...
        Returns:
            google.ads.googleads.v10.services.types.MutateBiddingStrategiesResponse:
