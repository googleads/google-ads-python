...
from google.ads.googleads.v17.enums.types import ad_group_criterion_status
from google.ads.googleads.v17.enums.types import bidding_source
from google.ads.googleads.v17.enums.types import criterion_system_serving_status
from google.ads.googleads.v17.enums.types import criterion_type
from google.ads.googleads.v17.enums.types import quality_score_bucket
...
class AdGroupCriterion(proto.Message):
    ...
    Attributes:
        ...
        display_name (str):
            ...
            criterion.
            This field is ignored for mutates.
        status (google.ads.googleads.v17.enums.types.AdGroupCriterionStatusEnum.AdGroupCriterionStatus):
            ...
            added.
        quality_info (google.ads.googleads.v17.resources.types.AdGroupCriterion.QualityInfo):
        ...
        type_ (google.ads.googleads.v17.enums.types.CriterionTypeEnum.CriterionType):
        ...
        system_serving_status (google.ads.googleads.v17.enums.types.CriterionSystemServingStatusEnum.CriterionSystemServingStatus):
            Output only. Serving status of the criterion.
        approval_status (google.ads.googleads.v17.enums.types.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatus):
        ...
        effective_cpc_bid_source (google.ads.googleads.v17.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective CPC bid.
        effective_cpm_bid_source (google.ads.googleads.v17.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective CPM bid.
        effective_cpv_bid_source (google.ads.googleads.v17.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective CPV bid.
        effective_percent_cpc_bid_source (google.ads.googleads.v17.enums.types.BiddingSourceEnum.BiddingSource):
            Output only. Source of the effective Percent
            CPC bid.
        position_estimates (google.ads.googleads.v17.resources.types.AdGroupCriterion.PositionEstimates):
        ...
        url_custom_parameters (MutableSequence[google.ads.googleads.v17.common.types.CustomParameter]):
            ...
            ``mobile_final_urls``.
        primary_status (google.ads.googleads.v17.enums.types.AdGroupCriterionPrimaryStatusEnum.AdGroupCriterionPrimaryStatus):
            Output only. The primary status for the ad
            group criterion.

            This field is a member of `oneof`_ ``_primary_status``.
        primary_status_reasons (MutableSequence[google.ads.googleads.v17.enums.types.AdGroupCriterionPrimaryStatusReasonEnum.AdGroupCriterionPrimaryStatusReason]):
        ...
        placement (google.ads.googleads.v17.common.types.PlacementInfo):
            Immutable. Placement.

            This field is a member of `oneof`_ ``criterion``.
        mobile_app_category (google.ads.googleads.v17.common.types.MobileAppCategoryInfo):
            Immutable. Mobile app category.

            This field is a member of `oneof`_ ``criterion``.
        mobile_application (google.ads.googleads.v17.common.types.MobileApplicationInfo):
            Immutable. Mobile application.

            This field is a member of `oneof`_ ``criterion``.
        listing_group (google.ads.googleads.v17.common.types.ListingGroupInfo):
        ...
        parental_status (google.ads.googleads.v17.common.types.ParentalStatusInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        user_list (google.ads.googleads.v17.common.types.UserListInfo):
            Immutable. User List.

            This field is a member of `oneof`_ ``criterion``.
        youtube_video (google.ads.googleads.v17.common.types.YouTubeVideoInfo):
        ...
        youtube_channel (google.ads.googleads.v17.common.types.YouTubeChannelInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        topic (google.ads.googleads.v17.common.types.TopicInfo):
            Immutable. Topic.
        ...
        user_interest (google.ads.googleads.v17.common.types.UserInterestInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        webpage (google.ads.googleads.v17.common.types.WebpageInfo):
            Immutable. Webpage

            This field is a member of `oneof`_ ``criterion``.
        app_payment_model (google.ads.googleads.v17.common.types.AppPaymentModelInfo):
            Immutable. App Payment Model.

            This field is a member of `oneof`_ ``criterion``.
        custom_affinity (google.ads.googleads.v17.common.types.CustomAffinityInfo):
            Immutable. Custom Affinity.

            This field is a member of `oneof`_ ``criterion``.
        custom_intent (google.ads.googleads.v17.common.types.CustomIntentInfo):
            Immutable. Custom Intent.

            This field is a member of `oneof`_ ``criterion``.
        custom_audience (google.ads.googleads.v17.common.types.CustomAudienceInfo):
            Immutable. Custom Audience.

            This field is a member of `oneof`_ ``criterion``.
        combined_audience (google.ads.googleads.v17.common.types.CombinedAudienceInfo):
            Immutable. Combined Audience.

            This field is a member of `oneof`_ ``criterion``.
        audience (google.ads.googleads.v17.common.types.AudienceInfo):
            Immutable. Audience.
        ...
        location (google.ads.googleads.v17.common.types.LocationInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        language (google.ads.googleads.v17.common.types.LanguageInfo):
            Immutable. Language.
    ...
    class QualityInfo(proto.Message):
        ...
        Attributes:
            ...
            creative_quality_score (google.ads.googleads.v17.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
                Output only. The performance of the ad
                compared to other advertisers.
            post_click_quality_score (google.ads.googleads.v17.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
                Output only. The quality score of the landing
                page.
            search_predicted_ctr (google.ads.googleads.v17.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
