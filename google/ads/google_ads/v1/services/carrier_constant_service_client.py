...
"""Accesses the google.ads.googleads.v1.services CarrierConstantService API."""
...
from google.ads.google_ads.v1.services import carrier_constant_service_client_config
...
class CarrierConstantServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.CarrierConstantService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=carrier_constant_service_grpc_transport.
    ...
    def get_carrier_constant(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.CarrierConstant` instance.
        ...
        return self._inner_api_calls['get_carrier_constant'](
