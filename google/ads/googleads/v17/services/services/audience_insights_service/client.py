...
class AudienceInsightsServiceClient(
    ...
    def generate_insights_finder_report(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.GenerateInsightsFinderReportRequest, dict, None]):
    ...
    def list_audience_insights_attributes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.ListAudienceInsightsAttributesRequest, dict, None]):
                The request object. Request message for
    ...
    def list_insights_eligible_dates(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.ListInsightsEligibleDatesRequest, dict, None]):
                The request object. Request message for
    ...
    def generate_audience_composition_insights(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.GenerateAudienceCompositionInsightsRequest, dict, None]):
                The request object. Request message for
    ...
    def generate_suggested_targeting_insights(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.GenerateSuggestedTargetingInsightsRequest, dict, None]):
                The request object. Request message for
    ...
    def generate_audience_overlap_insights(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.GenerateAudienceOverlapInsightsRequest, dict, None]):
                The request object. Request message for
