...
from google.ads.googleads.v25.actions.types import generate_shareable_previews
...
class GenerateShareablePreviewsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            previews request.
        operation (google.ads.googleads.v25.actions.types.GenerateShareablePreviewsOperation):
...
class GenerateShareablePreviewsResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v25.actions.types.GenerateShareablePreviewsResult):
