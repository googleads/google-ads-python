...
class CustomAudienceServiceClient(metaclass=CustomAudienceServiceClientMeta):
    ...
    def mutate_custom_audiences(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.MutateCustomAudiencesRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v19.services.types.CustomAudienceOperation]):
        ...
        Returns:
            google.ads.googleads.v19.services.types.MutateCustomAudiencesResponse:
