...
from google.ads.googleads.v16.enums.types import asset_set_link_status
...
class CustomerAssetSet(proto.Message):
    ...
    Attributes:
        ...
        customer (str):
            ...
            set is linked.
        status (google.ads.googleads.v16.enums.types.AssetSetLinkStatusEnum.AssetSetLinkStatus):
