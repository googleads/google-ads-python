...
# source: google/ads/googleads_v0/proto/resources/google_ads_field.proto
...
from google.ads.google_ads.v0.proto.enums import google_ads_field_category_pb2 as google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_google__ads__field__category__pb2
from google.ads.google_ads.v0.proto.enums import google_ads_field_data_type_pb2 as google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_google__ads__field__data__type__pb2
...
_GOOGLEADSFIELD = _descriptor.Descriptor(
  name='GoogleAdsField',
  full_name='google.ads.googleads.v0.resources.GoogleAdsField',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v0.resources.GoogleAdsField.resource_name', index=0,
...
_GOOGLEADSFIELD.fields_by_name['category'].enum_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_google__ads__field__category__pb2._GOOGLEADSFIELDCATEGORYENUM_GOOGLEADSFIELDCATEGORY
...
_GOOGLEADSFIELD.fields_by_name['data_type'].enum_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_google__ads__field__data__type__pb2._GOOGLEADSFIELDDATATYPEENUM_GOOGLEADSFIELDDATATYPE
...
GoogleAdsField = _reflection.GeneratedProtocolMessageType('GoogleAdsField', (_message.Message,), dict(
  ...
  Attributes:
      ...
      metrics:
          The names of all metrics that are selectable with the
          described artifact.  This field is only set for artifacts
          whose category is either RESOURCE or SEGMENT.
      segments:
          The names of all artifacts, whether a segment or another
          resource, that segment metrics when included in search
          queries.  This field is only set for artifacts of category
          RESOURCE, SEGMENT or METRIC.
      enum_values:
