...
"""Accesses the google.ads.googleads.v5.services CampaignCriterionSimulationService API."""
...
from google.ads.google_ads.v5.services import campaign_criterion_simulation_service_client_config
from google.ads.google_ads.v5.services.transports import campaign_criterion_simulation_service_grpc_transport
from google.ads.google_ads.v5.proto.services import campaign_criterion_simulation_service_pb2
...
class CampaignCriterionSimulationServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v5.services.CampaignCriterionSimulationService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=campaign_criterion_simulation_service_grpc_transport.CampaignCriterionSimulationServiceGrpcTransport,
    ...
    def get_campaign_criterion_simulation(
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.CampaignCriterionSimulation` instance.
        ...
        if 'get_campaign_criterion_simulation' not in self._inner_api_calls:
            self._inner_api_calls['get_campaign_criterion_simulation'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_campaign_criterion_simulation,
                default_retry=self._method_configs['GetCampaignCriterionSimulation'].retry,
                default_timeout=self._method_configs['GetCampaignCriterionSimulation'].timeout,
        ...
        return self._inner_api_calls['get_campaign_criterion_simulation'](request, retry=retry, timeout=timeout, metadata=metadata)
