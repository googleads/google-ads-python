...
class MutateFeedItemsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v13.services.types.FeedItemOperation]):
...
class FeedItemOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v13.resources.types.FeedItem):
            Create operation: No resource name is
            expected for the new feed item.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v13.resources.types.FeedItem):
...
class MutateFeedItemsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v13.services.types.MutateFeedItemResult]):
