...
class MediaFileServiceClient(metaclass=MediaFileServiceClientMeta):
    ...
    def mutate_media_files(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.MutateMediaFilesRequest, dict]):
                The request object. Request message for
                [MediaFileService.MutateMediaFiles][google.ads.googleads.v10.services.MediaFileService.MutateMediaFiles]
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v10.services.types.MediaFileOperation]):
        ...
        Returns:
            google.ads.googleads.v10.services.types.MutateMediaFilesResponse:
