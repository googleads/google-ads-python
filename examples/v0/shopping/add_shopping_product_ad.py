...
def main(client, customer_id, merchant_center_account_id,
    ...
    add_shopping_product_ad_group_ad(client, customer_id, ad_group_resource_name)
...
def add_shopping_product_ad_group_ad(client, customer_id, ad_group_resource_name):
    ...
    ad_group_ad.ad.shopping_product_ad.CopyFrom(client.get_type('ShoppingProductAdInfo'))
    ...
    print('Created shopping product ad group ad %s.' % ad_group_ad_resource_name)
...
def add_shopping_product_ad_group(client, customer_id, campaign_resource_name):
    ...
    ad_group.type = client.get_type('AdGroupTypeEnum').SHOPPING_PRODUCT_ADS
...
def add_default_shopping_listing_group(client, customer_id,
    ...
    print('Added an ad group criterion containing a listing group with resource name:  %s.'
