...
"""Accesses the google.ads.googleads.v3.services KeywordPlanService API."""
...
from google.ads.google_ads.v3.services import keyword_plan_service_client_config
from google.ads.google_ads.v3.services.transports import keyword_plan_service_grpc_transport
from google.ads.google_ads.v3.proto.services import keyword_plan_service_pb2
...
class KeywordPlanServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v3.services.KeywordPlanService'
    ...
    def get_keyword_plan(
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.KeywordPlan` instance.
    ...
    def mutate_keyword_plans(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v3.types.KeywordPlanOperation]]): Required. The list of operations to perform on individual keyword plans.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.KeywordPlanOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.MutateKeywordPlansResponse` instance.
    ...
    def generate_forecast_metrics(
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.GenerateForecastMetricsResponse` instance.
    ...
    def generate_historical_metrics(
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.GenerateHistoricalMetricsResponse` instance.
