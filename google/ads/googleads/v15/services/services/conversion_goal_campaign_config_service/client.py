...
class ConversionGoalCampaignConfigServiceClient(
    ...
    def mutate_conversion_goal_campaign_configs(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateConversionGoalCampaignConfigsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateConversionGoalCampaignConfigsResponse:
