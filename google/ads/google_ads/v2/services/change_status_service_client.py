...
"""Accesses the google.ads.googleads.v2.services ChangeStatusService API."""
...
from google.ads.google_ads.v2.services import change_status_service_client_config
...
class ChangeStatusServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.ChangeStatusService'
    ...
    def get_change_status(
        ...
        Args:
            resource_name (str): The resource name of the change status to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.ChangeStatus` instance.
