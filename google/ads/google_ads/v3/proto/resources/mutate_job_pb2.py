...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads__v3_dot_proto_dot_enums_dot_mutate__job__status__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_protobuf_dot_wrappers__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,])
...
MutateJob = _reflection.GeneratedProtocolMessageType('MutateJob', (_message.Message,), dict(
  ...
  MutateJobMetadata = _reflection.GeneratedProtocolMessageType('MutateJobMetadata', (_message.Message,), dict(
    ...
    Attributes:
        ...
        estimated_completion_ratio:
            ...
            started running yet.
        operation_count:
            Output only. The number of mutate operations in the mutate
            job.
        executed_operation_count:
            Output only. The number of mutate operations executed by the
            mutate job. Present only if the job has started running.
    """,
  ...
  Attributes:
      resource_name:
          Immutable. The resource name of the mutate job. Mutate job
      ...
      next_add_sequence_token:
          ...
          operations. Only set when the mutate job status is PENDING.
      metadata:
          Output only. Contains additional information about this mutate
          job.
      status:
      ...
      long_running_operation:
          ...
          mutate job status is RUNNING or DONE.
  """,
