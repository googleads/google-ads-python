...
# source: google/ads/googleads_v3/proto/services/keyword_plan_keyword_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v3/proto/services/keyword_plan_keyword_service.proto',
...
_KEYWORDPLANKEYWORDOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v3_dot_proto_dot_resources_dot_keyword__plan__keyword__pb2._KEYWORDPLANKEYWORD
_KEYWORDPLANKEYWORDOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v3_dot_proto_dot_resources_dot_keyword__plan__keyword__pb2._KEYWORDPLANKEYWORD
...
GetKeywordPlanKeywordRequest = _reflection.GeneratedProtocolMessageType('GetKeywordPlanKeywordRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v3.proto.services.keyword_plan_keyword_service_pb2'
  ,
  __doc__ = """Request message for
  [KeywordPlanKeywordService.GetKeywordPlanKeyword][google.ads.googleads.v3.services.KeywordPlanKeywordService.GetKeywordPlanKeyword].
...
MutateKeywordPlanKeywordsRequest = _reflection.GeneratedProtocolMessageType('MutateKeywordPlanKeywordsRequest', (_message.Message,), dict(
  ...
  ,
  __doc__ = """Request message for
  [KeywordPlanKeywordService.MutateKeywordPlanKeywords][google.ads.googleads.v3.services.KeywordPlanKeywordService.MutateKeywordPlanKeywords].
  
  
  Attributes:
      customer_id:
          Required. The ID of the customer whose Keyword Plan keywords
          are being modified.
      operations:
...
_KEYWORDPLANKEYWORDSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v3_dot_proto_dot_resources_dot_keyword__plan__keyword__pb2._KEYWORDPLANKEYWORD,
    serialized_options=_b('\202\323\344\223\0027\0225/v3/{resource_name=customers/*/keywordPlanKeywords/*}\332A\rresource_name'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002=\"8/v3/customers/{customer_id=*}/keywordPlanKeywords:mutate:\001*\332A\026customer_id,operations'),
  ),
])
