...
"""Accesses the google.ads.googleads.v6.services SharedCriterionService API."""
...
from google.ads.google_ads.v6.services import shared_criterion_service_client_config
from google.ads.google_ads.v6.services.transports import shared_criterion_service_grpc_transport
from google.ads.google_ads.v6.proto.services import shared_criterion_service_pb2
...
class SharedCriterionServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v6.services.SharedCriterionService'
    ...
    def get_shared_criterion(
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.SharedCriterion` instance.
    ...
    def mutate_shared_criteria(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v6.types.SharedCriterionOperation]]): Required. The list of operations to perform on individual shared criteria.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v6.types.SharedCriterionOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.MutateSharedCriteriaResponse` instance.
