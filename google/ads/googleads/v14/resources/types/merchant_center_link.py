...
from google.ads.googleads.v14.enums.types import merchant_center_link_status
...
class MerchantCenterLink(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v14.enums.types.MerchantCenterLinkStatusEnum.MerchantCenterLinkStatus):
    ...
    merchant_center_account_name: str = proto.Field(
        proto.STRING,
        number=7,
        optional=True,
    )
    status: merchant_center_link_status.MerchantCenterLinkStatusEnum.MerchantCenterLinkStatus = proto.Field(
        proto.ENUM,
        number=5,
