...
class FeedItemSetLinkServiceGrpcAsyncIOTransport(
    FeedItemSetLinkServiceTransport
):
    """gRPC AsyncIO backend transport for FeedItemSetLinkService.
    ...
    def mutate_feed_item_set_links(
        ...
        Returns:
            Callable[[~.MutateFeedItemSetLinksRequest],
                    Awaitable[~.MutateFeedItemSetLinksResponse]]:
        ...
        if "mutate_feed_item_set_links" not in self._stubs:
            self._stubs["mutate_feed_item_set_links"] = (
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_feed_item_set_links: self._wrap_method(
...
__all__ = ("FeedItemSetLinkServiceGrpcAsyncIOTransport",)
