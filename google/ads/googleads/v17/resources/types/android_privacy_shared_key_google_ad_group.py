...
class AndroidPrivacySharedKeyGoogleAdGroup(proto.Message):
    ...
    Attributes:
        ...
        campaign_id (int):
            ...
            share key encoding.
        android_privacy_interaction_type (google.ads.googleads.v17.enums.types.AndroidPrivacyInteractionTypeEnum.AndroidPrivacyInteractionType):
        ...
        android_privacy_network_type (google.ads.googleads.v17.enums.types.AndroidPrivacyNetworkTypeEnum.AndroidPrivacyNetworkType):
