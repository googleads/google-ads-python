...
"""Accesses the google.ads.googleads.v4.services DisplayKeywordViewService API."""
...
from google.ads.google_ads.v4.services import display_keyword_view_service_client_config
from google.ads.google_ads.v4.services.transports import display_keyword_view_service_grpc_transport
from google.ads.google_ads.v4.proto.services import display_keyword_view_service_pb2
...
class DisplayKeywordViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v4.services.DisplayKeywordViewService'
    ...
    def get_display_keyword_view(
        ...
        Returns:
            A :class:`~google.ads.googleads_v4.types.DisplayKeywordView` instance.
