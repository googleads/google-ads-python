...
class KeywordPlanAdGroupServiceClient(
    ...
    def mutate_keyword_plan_ad_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateKeywordPlanAdGroupsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateKeywordPlanAdGroupsResponse:
