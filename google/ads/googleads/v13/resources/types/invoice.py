...
from google.ads.googleads.v13.enums.types import invoice_type
...
class Invoice(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v13.enums.types.InvoiceTypeEnum.InvoiceType):
        ...
        service_date_range (google.ads.googleads.v13.common.types.DateRange):
        ...
        account_budget_summaries (MutableSequence[google.ads.googleads.v13.resources.types.Invoice.AccountBudgetSummary]):
            Output only. The list of summarized account
            budget information associated with this invoice.
        account_summaries (MutableSequence[google.ads.googleads.v13.resources.types.Invoice.AccountSummary]):
            Output only. The list of summarized account
    ...
    class AccountBudgetSummary(proto.Message):
        ...
        Attributes:
            ...
            total_amount_micros (int):
                ...
                This field is a member of `oneof`_ ``_total_amount_micros``.
            billable_activity_date_range (google.ads.googleads.v13.common.types.DateRange):
            ...
            invalid_activity_summaries (MutableSequence[google.ads.googleads.v13.resources.types.Invoice.InvalidActivitySummary]):
    ...
    class InvalidActivitySummary(proto.Message):
        ...
        Attributes:
            original_month_of_service (google.ads.googleads.v13.enums.types.MonthOfYearEnum.MonthOfYear):
