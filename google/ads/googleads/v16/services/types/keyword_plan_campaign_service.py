...
from google.ads.googleads.v16.resources.types import keyword_plan_campaign
...
class MutateKeywordPlanCampaignsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v16.services.types.KeywordPlanCampaignOperation]):
...
class KeywordPlanCampaignOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v16.resources.types.KeywordPlanCampaign):
            Create operation: No resource name is
            expected for the new Keyword Plan campaign.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v16.resources.types.KeywordPlanCampaign):
...
class MutateKeywordPlanCampaignsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v16.services.types.MutateKeywordPlanCampaignResult]):
