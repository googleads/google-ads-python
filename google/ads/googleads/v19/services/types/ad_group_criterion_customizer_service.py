...
class MutateAdGroupCriterionCustomizersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v19.services.types.AdGroupCriterionCustomizerOperation]):
...
class AdGroupCriterionCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v19.resources.types.AdGroupCriterionCustomizer):
...
class MutateAdGroupCriterionCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v19.services.types.MutateAdGroupCriterionCustomizerResult]):
