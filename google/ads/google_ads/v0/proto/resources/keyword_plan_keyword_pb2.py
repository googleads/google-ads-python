...
# source: google/ads/googleads_v0/proto/resources/keyword_plan_keyword.proto
...
_KEYWORDPLANKEYWORD = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.resources.KeywordPlanKeyword',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v0.resources.KeywordPlanKeyword.resource_name', index=0,
...
_KEYWORDPLANKEYWORD.fields_by_name['match_type'].enum_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_keyword__match__type__pb2._KEYWORDMATCHTYPEENUM_KEYWORDMATCHTYPE
