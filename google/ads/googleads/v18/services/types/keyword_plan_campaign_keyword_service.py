...
class MutateKeywordPlanCampaignKeywordsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v18.services.types.KeywordPlanCampaignKeywordOperation]):
...
class KeywordPlanCampaignKeywordOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v18.resources.types.KeywordPlanCampaignKeyword):
            Create operation: No resource name is
            expected for the new Keyword Plan campaign
            keyword.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v18.resources.types.KeywordPlanCampaignKeyword):
    ...
    create: keyword_plan_campaign_keyword.KeywordPlanCampaignKeyword = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
        message=keyword_plan_campaign_keyword.KeywordPlanCampaignKeyword,
    )
    update: keyword_plan_campaign_keyword.KeywordPlanCampaignKeyword = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=keyword_plan_campaign_keyword.KeywordPlanCampaignKeyword,
...
class MutateKeywordPlanCampaignKeywordsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v18.services.types.MutateKeywordPlanCampaignKeywordResult]):
