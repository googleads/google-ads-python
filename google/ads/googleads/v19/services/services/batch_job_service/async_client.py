...
from google.ads.googleads.v19.services.services.batch_job_service import pagers
...
class BatchJobServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v19.services.BatchJobServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def mutate_batch_job(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.MutateBatchJobRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operation (:class:`google.ads.googleads.v19.services.types.BatchJobOperation`):
        ...
        Returns:
            google.ads.googleads.v19.services.types.MutateBatchJobResponse:
    ...
    async def list_batch_job_results(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.ListBatchJobResultsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v19.services.services.batch_job_service.pagers.ListBatchJobResultsAsyncPager:
                Response message for
                   [BatchJobService.ListBatchJobResults][google.ads.googleads.v19.services.BatchJobService.ListBatchJobResults].
    ...
    async def run_batch_job(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.RunBatchJobRequest, dict]]):
                The request object. Request message for
    ...
    async def add_batch_job_operations(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.AddBatchJobOperationsRequest, dict]]):
                The request object. Request message for
            ...
            sequence_token (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            mutate_operations (:class:`MutableSequence[google.ads.googleads.v19.services.types.MutateOperation]`):
        ...
        Returns:
            google.ads.googleads.v19.services.types.AddBatchJobOperationsResponse:
                Response message for
                   [BatchJobService.AddBatchJobOperations][google.ads.googleads.v19.services.BatchJobService.AddBatchJobOperations].
