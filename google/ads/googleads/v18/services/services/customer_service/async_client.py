...
from google.ads.googleads.v18.resources.types import customer
...
class CustomerServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v18.services.CustomerServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def mutate_customer(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v18.services.types.MutateCustomerRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operation (:class:`google.ads.googleads.v18.services.types.CustomerOperation`):
        ...
        Returns:
            google.ads.googleads.v18.services.types.MutateCustomerResponse:
    ...
    async def list_accessible_customers(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v18.services.types.ListAccessibleCustomersRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v18.services.types.ListAccessibleCustomersResponse:
    ...
    async def create_customer_client(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v18.services.types.CreateCustomerClientRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            customer_client (:class:`google.ads.googleads.v18.resources.types.Customer`):
        ...
        Returns:
            google.ads.googleads.v18.services.types.CreateCustomerClientResponse:
                Response message for
