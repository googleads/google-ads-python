...
from google.ads.googleads.v10.enums.types import keyword_plan_keyword_annotation
...
class GenerateKeywordIdeasRequest(proto.Message):
    ...
    [KeywordPlanIdeaService.GenerateKeywordIdeas][google.ads.googleads.v10.services.KeywordPlanIdeaService.GenerateKeywordIdeas].
    ...
    Attributes:
        ...
        page_size (int):
            ...
            results.
        keyword_plan_network (google.ads.googleads.v10.enums.types.KeywordPlanNetworkEnum.KeywordPlanNetwork):
            Targeting network.
        keyword_annotation (Sequence[google.ads.googleads.v10.enums.types.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotation]):
        ...
        keyword_and_url_seed (google.ads.googleads.v10.services.types.KeywordAndUrlSeed):
            A Keyword and a specific Url to generate
            ideas from e.g. cars, www.example.com/cars.

            This field is a member of `oneof`_ ``seed``.
        keyword_seed (google.ads.googleads.v10.services.types.KeywordSeed):
            A Keyword or phrase to generate ideas from,
            e.g. cars.

            This field is a member of `oneof`_ ``seed``.
        url_seed (google.ads.googleads.v10.services.types.UrlSeed):
            A specific url to generate ideas from, e.g.
            www.example.com/cars.

            This field is a member of `oneof`_ ``seed``.
        site_seed (google.ads.googleads.v10.services.types.SiteSeed):
...
class GenerateKeywordIdeaResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v10.services.types.GenerateKeywordIdeaResult]):
...
class GenerateKeywordIdeaResult(proto.Message):
    ...
    Attributes:
        ...
        keyword_idea_metrics (google.ads.googleads.v10.common.types.KeywordPlanHistoricalMetrics):
            The historical metrics for the keyword.
        keyword_annotations (google.ads.googleads.v10.common.types.KeywordAnnotations):
