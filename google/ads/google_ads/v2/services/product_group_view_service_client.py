...
"""Accesses the google.ads.googleads.v2.services ProductGroupViewService API."""
...
from google.ads.google_ads.v2.services import product_group_view_service_client_config
...
class ProductGroupViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.ProductGroupViewService'
    ...
    def get_product_group_view(
        ...
        Args:
            resource_name (str): The resource name of the product group view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.ProductGroupView` instance.
