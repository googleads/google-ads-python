...
class UserListServiceClient(metaclass=UserListServiceClientMeta):
    ...
    def get_user_list(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.UserList:
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.UserListOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateUserListsResponse:
