...
"""Accesses the google.ads.googleads.v2.services AssetService API."""
...
from google.ads.google_ads.v2.services import asset_service_client_config
...
class AssetServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.AssetService'
    ...
    def get_asset(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.Asset` instance.
    ...
    def mutate_assets(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.AssetOperation]]): The list of operations to perform on individual assets.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.AssetOperation`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateAssetsResponse` instance.
