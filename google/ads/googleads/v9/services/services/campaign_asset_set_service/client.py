...
class CampaignAssetSetServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, CampaignAssetSetServiceTransport, None] = None,
        client_options: Optional[client_options_lib.ClientOptions] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiate the campaign asset set service client.
        ...
        Args:
            ...
            transport (Union[str, ~.CampaignAssetSetServiceTransport]): The
        ...
        if isinstance(transport, CampaignAssetSetServiceTransport):
            ...
            self._transport = CampaignAssetSetServiceGrpcTransport(
    ...
    def mutate_campaign_asset_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCampaignAssetSetsRequest, dict]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CampaignAssetSetOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCampaignAssetSetsResponse:
        ...
        # in a campaign_asset_set_service.MutateCampaignAssetSetsRequest.
