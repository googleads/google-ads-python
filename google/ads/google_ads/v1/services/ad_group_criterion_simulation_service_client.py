...
"""Accesses the google.ads.googleads.v1.services AdGroupCriterionSimulationService API."""
...
from google.ads.google_ads.v1.services import ad_group_criterion_simulation_service_client_config
...
class AdGroupCriterionSimulationServiceClient(object):
    ...
    @classmethod
    def ad_group_criterion_simulation_path(cls, customer,
    ...
    def get_ad_group_criterion_simulation(
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.AdGroupCriterionSimulation` instance.
        ...
        if 'get_ad_group_criterion_simulation' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_ad_group_criterion_simulation'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_ad_group_criterion_simulation,
                    default_retry=self.
                    _method_configs['GetAdGroupCriterionSimulation'].retry,
                    default_timeout=self.
                    _method_configs['GetAdGroupCriterionSimulation'].timeout,
                    client_info=self._client_info,
                )

        request = ad_group_criterion_simulation_service_pb2.GetAdGroupCriterionSimulationRequest(
            resource_name=resource_name, )
        return self._inner_api_calls['get_ad_group_criterion_simulation'](
