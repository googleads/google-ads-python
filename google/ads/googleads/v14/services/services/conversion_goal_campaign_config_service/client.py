...
class ConversionGoalCampaignConfigServiceClient(
    ...
    def mutate_conversion_goal_campaign_configs(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateConversionGoalCampaignConfigsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v14.services.types.ConversionGoalCampaignConfigOperation]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateConversionGoalCampaignConfigsResponse:
