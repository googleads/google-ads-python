...
from google.ads.googleads.v17.resources.types import batch_job
from google.ads.googleads.v17.services.services.batch_job_service import pagers
...
class BatchJobServiceAsyncClient:
    ...
    ad_group_extension_setting_path = staticmethod(
        BatchJobServiceClient.ad_group_extension_setting_path
    )
    parse_ad_group_extension_setting_path = staticmethod(
        BatchJobServiceClient.parse_ad_group_extension_setting_path
    )
    ad_group_feed_path = staticmethod(BatchJobServiceClient.ad_group_feed_path)
    parse_ad_group_feed_path = staticmethod(
        BatchJobServiceClient.parse_ad_group_feed_path
    )
    ...
    campaign_extension_setting_path = staticmethod(
        BatchJobServiceClient.campaign_extension_setting_path
    )
    parse_campaign_extension_setting_path = staticmethod(
        BatchJobServiceClient.parse_campaign_extension_setting_path
    )
    campaign_feed_path = staticmethod(BatchJobServiceClient.campaign_feed_path)
    parse_campaign_feed_path = staticmethod(
        BatchJobServiceClient.parse_campaign_feed_path
    )
    ...
    customer_extension_setting_path = staticmethod(
        BatchJobServiceClient.customer_extension_setting_path
    )
    parse_customer_extension_setting_path = staticmethod(
        BatchJobServiceClient.parse_customer_extension_setting_path
    )
    customer_feed_path = staticmethod(BatchJobServiceClient.customer_feed_path)
    parse_customer_feed_path = staticmethod(
        BatchJobServiceClient.parse_customer_feed_path
    )
    ...
    extension_feed_item_path = staticmethod(
        BatchJobServiceClient.extension_feed_item_path
    )
    parse_extension_feed_item_path = staticmethod(
        BatchJobServiceClient.parse_extension_feed_item_path
    )
    feed_path = staticmethod(BatchJobServiceClient.feed_path)
    parse_feed_path = staticmethod(BatchJobServiceClient.parse_feed_path)
    feed_item_path = staticmethod(BatchJobServiceClient.feed_item_path)
    parse_feed_item_path = staticmethod(
        BatchJobServiceClient.parse_feed_item_path
    )
    feed_item_set_path = staticmethod(BatchJobServiceClient.feed_item_set_path)
    parse_feed_item_set_path = staticmethod(
        BatchJobServiceClient.parse_feed_item_set_path
    )
    feed_item_set_link_path = staticmethod(
        BatchJobServiceClient.feed_item_set_link_path
    )
    parse_feed_item_set_link_path = staticmethod(
        BatchJobServiceClient.parse_feed_item_set_link_path
    )
    feed_item_target_path = staticmethod(
        BatchJobServiceClient.feed_item_target_path
    )
    parse_feed_item_target_path = staticmethod(
        BatchJobServiceClient.parse_feed_item_target_path
    )
    feed_mapping_path = staticmethod(BatchJobServiceClient.feed_mapping_path)
    parse_feed_mapping_path = staticmethod(
        BatchJobServiceClient.parse_feed_mapping_path
    )
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v17.services.BatchJobServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def mutate_batch_job(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v17.services.types.MutateBatchJobRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operation (:class:`google.ads.googleads.v17.services.types.BatchJobOperation`):
        ...
        Returns:
            google.ads.googleads.v17.services.types.MutateBatchJobResponse:
    ...
    async def list_batch_job_results(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v17.services.types.ListBatchJobResultsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v17.services.services.batch_job_service.pagers.ListBatchJobResultsAsyncPager:
                Response message for
                   [BatchJobService.ListBatchJobResults][google.ads.googleads.v17.services.BatchJobService.ListBatchJobResults].
    ...
    async def run_batch_job(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v17.services.types.RunBatchJobRequest, dict]]):
                The request object. Request message for
    ...
    async def add_batch_job_operations(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v17.services.types.AddBatchJobOperationsRequest, dict]]):
                The request object. Request message for
            ...
            sequence_token (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            mutate_operations (:class:`MutableSequence[google.ads.googleads.v17.services.types.MutateOperation]`):
        ...
        Returns:
            google.ads.googleads.v17.services.types.AddBatchJobOperationsResponse:
                Response message for
                   [BatchJobService.AddBatchJobOperations][google.ads.googleads.v17.services.BatchJobService.AddBatchJobOperations].
