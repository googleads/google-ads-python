...
from google.ads.googleads.v25.resources.types import payments_account
...
class ListPaymentsAccountsResponse(proto.Message):
    ...
    Attributes:
        payments_accounts (MutableSequence[google.ads.googleads.v25.resources.types.PaymentsAccount]):
