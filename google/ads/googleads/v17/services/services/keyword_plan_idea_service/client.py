...
class KeywordPlanIdeaServiceClient(metaclass=KeywordPlanIdeaServiceClientMeta):
    ...
    def generate_keyword_ideas(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.GenerateKeywordIdeasRequest, dict, None]):
    ...
    def generate_keyword_historical_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.GenerateKeywordHistoricalMetricsRequest, dict, None]):
                The request object. Request message for
    ...
    def generate_ad_group_themes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.GenerateAdGroupThemesRequest, dict, None]):
                The request object. Request message for
    ...
    def generate_keyword_forecast_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.GenerateKeywordForecastMetricsRequest, dict, None]):
                The request object. Request message for
