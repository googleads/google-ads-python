...
"""Accesses the google.ads.googleads.v2.services AdScheduleViewService API."""
...
from google.ads.google_ads.v2.services import ad_schedule_view_service_client_config
...
class AdScheduleViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.AdScheduleViewService'
    ...
    def get_ad_schedule_view(
        ...
        Args:
            resource_name (str): The resource name of the ad schedule view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.AdScheduleView` instance.
