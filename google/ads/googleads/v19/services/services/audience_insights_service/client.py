...
class AudienceInsightsServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v19.services.AudienceInsightsServiceClient`.",
                    extra=(
                        {
    ...
    def generate_insights_finder_report(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GenerateInsightsFinderReportRequest, dict]):
    ...
    def list_audience_insights_attributes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.ListAudienceInsightsAttributesRequest, dict]):
                The request object. Request message for
    ...
    def list_insights_eligible_dates(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.ListInsightsEligibleDatesRequest, dict]):
                The request object. Request message for
    ...
    def generate_audience_composition_insights(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GenerateAudienceCompositionInsightsRequest, dict]):
                The request object. Request message for
    ...
    def generate_suggested_targeting_insights(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GenerateSuggestedTargetingInsightsRequest, dict]):
                The request object. Request message for
    ...
    def generate_audience_overlap_insights(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GenerateAudienceOverlapInsightsRequest, dict]):
                The request object. Request message for
    ...
    def generate_targeting_suggestion_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GenerateTargetingSuggestionMetricsRequest, dict]):
                The request object. Request message for
