...
from .transports.grpc_asyncio import AdGroupFeedServiceGrpcAsyncIOTransport
...
class AdGroupFeedServiceClientMeta(type):
    ...
    _transport_registry["grpc_asyncio"] = AdGroupFeedServiceGrpcAsyncIOTransport
...
class AdGroupFeedServiceClient(metaclass=AdGroupFeedServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = AdGroupFeedServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                AdGroupFeedServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AdGroupFeedServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = AdGroupFeedServiceClient._read_environment_variables()
        self._client_cert_source = (
            AdGroupFeedServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = AdGroupFeedServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, AdGroupFeedServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(AdGroupFeedServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AdGroupFeedServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                AdGroupFeedServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., AdGroupFeedServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v18.services.AdGroupFeedServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_ad_group_feeds(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateAdGroupFeedsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v18.services.types.AdGroupFeedOperation]):
