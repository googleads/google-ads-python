...
"""Accesses the google.ads.googleads.v4.services BatchJobService API."""
...
from google.ads.google_ads.v4.services import batch_job_service_client_config
from google.ads.google_ads.v4.services.transports import batch_job_service_grpc_transport
from google.ads.google_ads.v4.proto.resources import batch_job_pb2
from google.ads.google_ads.v4.proto.services import batch_job_service_pb2
...
class BatchJobServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v4.services.BatchJobService'
    ...
    def mutate_batch_job(
        ...
        Args:
            ...
            operation_ (Union[dict, ~google.ads.googleads_v4.types.BatchJobOperation]): Required. The operation to perform on an individual batch job.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v4.types.BatchJobOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v4.types.MutateBatchJobResponse` instance.
    ...
    def get_batch_job(
        ...
        Returns:
            A :class:`~google.ads.googleads_v4.types.BatchJob` instance.
    ...
    def list_batch_job_results(
        ...
        Returns:
            ...
            is an iterable of :class:`~google.ads.googleads_v4.types.BatchJobResult` instances.
    ...
    def add_batch_job_operations(
        ...
        Args:
            ...
            mutate_operations (list[Union[dict, ~google.ads.googleads_v4.types.MutateOperation]]): Required. The list of mutates being added.
                ...
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v4.types.MutateOperation`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v4.types.AddBatchJobOperationsResponse` instance.
