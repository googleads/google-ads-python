...
class CustomerManagerLinkServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, CustomerManagerLinkServiceTransport]]): The
    ...
    def mutate_customer_manager_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateCustomerManagerLinkRequest, dict, None]):
    ...
    def move_manager_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MoveManagerLinkRequest, dict, None]):
                The request object. Request message for
