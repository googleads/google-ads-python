...
"""Accesses the google.ads.googleads.v6.services CampaignDraftService API."""
...
from google.ads.google_ads.v6.services import campaign_draft_service_client_config
from google.ads.google_ads.v6.services.transports import campaign_draft_service_grpc_transport
from google.ads.google_ads.v6.proto.services import campaign_draft_service_pb2
...
class CampaignDraftServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v6.services.CampaignDraftService'
    ...
    def get_campaign_draft(
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.CampaignDraft` instance.
    ...
    def mutate_campaign_drafts(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v6.types.CampaignDraftOperation]]): Required. The list of operations to perform on individual campaign drafts.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v6.types.CampaignDraftOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.MutateCampaignDraftsResponse` instance.
    ...
    def list_campaign_draft_async_errors(
        ...
        Returns:
            ...
            An iterable of :class:`~google.ads.googleads_v6.types.Status` instances.
