...
class ResolveMultiPartyAuthReviewResponse(proto.Message):
    ...
    Attributes:
        result_or_error (MutableSequence[google.ads.googleads.v24.services.types.ResolveMultiPartyAuthReviewResultOrError]):
...
class ResolveMultiPartyAuthReviewOperation(proto.Message):
    ...
    Attributes:
        ...
        new_status (google.ads.googleads.v24.enums.types.MultiPartyAuthReviewStatusEnum.MultiPartyAuthReviewStatus):
...
class ResolveMultiPartyAuthReviewResultOrError(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v24.services.types.ResolveMultiPartyAuthReviewResult):
