...
class FeedItemTarget(proto.Message):
    ...
    Attributes:
        ...
        feed_item_target_type (google.ads.googleads.v9.enums.types.FeedItemTargetTypeEnum.FeedItemTargetType):
        ...
        status (google.ads.googleads.v9.enums.types.FeedItemTargetStatusEnum.FeedItemTargetStatus):
        ...
        geo_target_constant (str):
            ...
            This field is a member of `oneof`_ ``target``.
        device (google.ads.googleads.v9.enums.types.FeedItemTargetDeviceEnum.FeedItemTargetDevice):
