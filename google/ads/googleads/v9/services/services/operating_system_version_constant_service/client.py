...
class OperatingSystemVersionConstantServiceClient(
    ...
    def get_operating_system_version_constant(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetOperatingSystemVersionConstantRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.OperatingSystemVersionConstant:
