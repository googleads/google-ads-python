...
from google.ads.googleads.v17.services.types import product_link_service
...
class ProductLinkServiceClient(metaclass=ProductLinkServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, ProductLinkServiceTransport]]): The
        ...
        if isinstance(transport, ProductLinkServiceTransport):
    ...
    def create_product_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.CreateProductLinkRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v17.services.types.CreateProductLinkResponse:
        ...
        has_flattened_params = any([customer_id, product_link])
        ...
        # in a product_link_service.CreateProductLinkRequest.
    ...
    def remove_product_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.RemoveProductLinkRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v17.services.types.RemoveProductLinkResponse:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a product_link_service.RemoveProductLinkRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(
