...
class AssetServiceClient(metaclass=AssetServiceClientMeta):
    ...
    def mutate_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAssetsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v13.services.types.AssetOperation]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateAssetsResponse:
