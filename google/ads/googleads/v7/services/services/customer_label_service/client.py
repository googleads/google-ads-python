...
class CustomerLabelServiceClient(metaclass=CustomerLabelServiceClientMeta):
    ...
    def get_customer_label(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CustomerLabel:
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.CustomerLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateCustomerLabelsResponse:
