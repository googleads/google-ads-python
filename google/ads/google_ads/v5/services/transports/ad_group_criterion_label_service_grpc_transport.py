...
from google.ads.google_ads.v5.proto.services import ad_group_criterion_label_service_pb2_grpc


class AdGroupCriterionLabelServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v5.services AdGroupCriterionLabelService API.
