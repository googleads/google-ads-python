...
from google.ads.googleads.v11.resources.types import customer_label
...
class MutateCustomerLabelsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v11.services.types.CustomerLabelOperation]):
...
class CustomerLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v11.resources.types.CustomerLabel):
...
class MutateCustomerLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v11.services.types.MutateCustomerLabelResult]):
