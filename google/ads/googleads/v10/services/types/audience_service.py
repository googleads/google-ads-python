...
class MutateAudiencesRequest(proto.Message):
    ...
    [AudienceService.MutateAudiences][google.ads.googleads.v10.services.AudienceService.MutateAudiences].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            audiences are being modified.
        operations (Sequence[google.ads.googleads.v10.services.types.AudienceOperation]):
...
class MutateAudiencesResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v10.services.types.MutateAudienceResult]):
...
class AudienceOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v10.resources.types.Audience):
            Create operation: No resource name is
            expected for the new audience

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v10.resources.types.Audience):
