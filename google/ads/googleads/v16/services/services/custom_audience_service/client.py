...
class CustomAudienceServiceClient(metaclass=CustomAudienceServiceClientMeta):
    ...
    def mutate_custom_audiences(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateCustomAudiencesRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v16.services.types.CustomAudienceOperation]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateCustomAudiencesResponse:
