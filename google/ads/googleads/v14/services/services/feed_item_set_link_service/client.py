...
class FeedItemSetLinkServiceClient(metaclass=FeedItemSetLinkServiceClientMeta):
    ...
    def mutate_feed_item_set_links(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateFeedItemSetLinksRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v14.services.types.FeedItemSetLinkOperation]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateFeedItemSetLinksResponse:
