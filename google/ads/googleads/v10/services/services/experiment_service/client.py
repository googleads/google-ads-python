...
class ExperimentServiceClient(metaclass=ExperimentServiceClientMeta):
    ...
    def mutate_experiments(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.MutateExperimentsRequest, dict]):
                The request object. Request message for
                [ExperimentService.MutateExperiments][google.ads.googleads.v10.services.ExperimentService.MutateExperiments].
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v10.services.types.ExperimentOperation]):
        ...
        Returns:
            google.ads.googleads.v10.services.types.MutateExperimentsResponse:
    ...
    def end_experiment(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.EndExperimentRequest, dict]):
                The request object. Request message for
                [ExperimentService.EndExperiment][google.ads.googleads.v10.services.ExperimentService.EndExperiment].
            experiment (str):
    ...
    def list_experiment_async_errors(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.ListExperimentAsyncErrorsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v10.services.services.experiment_service.pagers.ListExperimentAsyncErrorsPager:
    ...
    def graduate_experiment(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.GraduateExperimentRequest, dict]):
                The request object. Request message for
                [ExperimentService.GraduateExperiment][google.ads.googleads.v10.services.ExperimentService.GraduateExperiment].
            experiment (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            campaign_budget_mappings (Sequence[google.ads.googleads.v10.services.types.CampaignBudgetMapping]):
    ...
    def schedule_experiment(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.ScheduleExperimentRequest, dict]):
                The request object. Request message for
                [ExperimentService.ScheduleExperiment][google.ads.googleads.v10.services.ExperimentService.ScheduleExperiment].
            resource_name (str):
    ...
    def promote_experiment(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.PromoteExperimentRequest, dict]):
                The request object. Request message for
                [ExperimentService.PromoteExperiment][google.ads.googleads.v10.services.ExperimentService.PromoteExperiment].
            resource_name (str):
                Required. The resource name of the
