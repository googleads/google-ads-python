...
class CampaignSharedSetServiceClient(
    ...
    def mutate_campaign_shared_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCampaignSharedSetsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v13.services.types.CampaignSharedSetOperation]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateCampaignSharedSetsResponse:
