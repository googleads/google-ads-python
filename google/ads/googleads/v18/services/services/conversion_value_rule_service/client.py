...
class ConversionValueRuleServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, ConversionValueRuleServiceTransport]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, ConversionValueRuleServiceTransport]]): The
    ...
    def mutate_conversion_value_rules(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateConversionValueRulesRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v18.services.types.MutateConversionValueRulesResponse:
