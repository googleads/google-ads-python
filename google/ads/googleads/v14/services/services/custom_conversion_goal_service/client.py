...
class CustomConversionGoalServiceClient(
    ...
    def mutate_custom_conversion_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateCustomConversionGoalsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateCustomConversionGoalsResponse:
