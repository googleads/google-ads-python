...
"""Accesses the google.ads.googleads.v2.services KeywordPlanIdeaService API."""
...
from google.ads.google_ads.v2.services import keyword_plan_idea_service_client_config
...
class KeywordPlanIdeaServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.KeywordPlanIdeaService'
    ...
    def generate_keyword_ideas(
        ...
        Args:
            ...
            language (Union[dict, ~google.ads.googleads_v2.types.StringValue]): The resource name of the language to target.
                Required

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.StringValue`
            geo_target_constants (list[Union[dict, ~google.ads.googleads_v2.types.StringValue]]): The resource names of the location to target.
                Max 10

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.StringValue`
            keyword_plan_network (~google.ads.googleads_v2.types.KeywordPlanNetwork): Targeting network.
            keyword_and_url_seed (Union[dict, ~google.ads.googleads_v2.types.KeywordAndUrlSeed]): A Keyword and a specific Url to generate ideas from
                e.g. cars, www.example.com/cars.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.KeywordAndUrlSeed`
            keyword_seed (Union[dict, ~google.ads.googleads_v2.types.KeywordSeed]): A Keyword or phrase to generate ideas from, e.g. cars.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.KeywordSeed`
            url_seed (Union[dict, ~google.ads.googleads_v2.types.UrlSeed]): A specific url to generate ideas from, e.g. www.example.com/cars.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.UrlSeed`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.GenerateKeywordIdeaResponse` instance.
