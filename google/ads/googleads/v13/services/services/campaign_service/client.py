...
class CampaignServiceClient(metaclass=CampaignServiceClientMeta):
    ...
    def mutate_campaigns(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCampaignsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v13.services.types.CampaignOperation]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateCampaignsResponse:
