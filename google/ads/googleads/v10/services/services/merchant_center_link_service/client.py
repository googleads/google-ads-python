...
class MerchantCenterLinkServiceClient(
    ...
    def list_merchant_center_links(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.ListMerchantCenterLinksRequest, dict]):
                The request object. Request message for
                [MerchantCenterLinkService.ListMerchantCenterLinks][google.ads.googleads.v10.services.MerchantCenterLinkService.ListMerchantCenterLinks].
            customer_id (str):
        ...
        Returns:
            google.ads.googleads.v10.services.types.ListMerchantCenterLinksResponse:
    ...
    def get_merchant_center_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.GetMerchantCenterLinkRequest, dict]):
                The request object. Request message for
                [MerchantCenterLinkService.GetMerchantCenterLink][google.ads.googleads.v10.services.MerchantCenterLinkService.GetMerchantCenterLink].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v10.resources.types.MerchantCenterLink:
    ...
    def mutate_merchant_center_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.MutateMerchantCenterLinkRequest, dict]):
                The request object. Request message for
                [MerchantCenterLinkService.MutateMerchantCenterLink][google.ads.googleads.v10.services.MerchantCenterLinkService.MutateMerchantCenterLink].
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (google.ads.googleads.v10.services.types.MerchantCenterLinkOperation):
        ...
        Returns:
            google.ads.googleads.v10.services.types.MutateMerchantCenterLinkResponse:
