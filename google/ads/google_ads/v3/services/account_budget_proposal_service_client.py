...
"""Accesses the google.ads.googleads.v3.services AccountBudgetProposalService API."""
...
from google.ads.google_ads.v3.services import account_budget_proposal_service_client_config
from google.ads.google_ads.v3.services.transports import account_budget_proposal_service_grpc_transport
from google.ads.google_ads.v3.proto.services import account_budget_proposal_service_pb2
...
class AccountBudgetProposalServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v3.services.AccountBudgetProposalService'
    ...
    def get_account_budget_proposal(
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.AccountBudgetProposal` instance.
    ...
    def mutate_account_budget_proposal(
        ...
        Args:
            ...
            operation_ (Union[dict, ~google.ads.googleads_v3.types.AccountBudgetProposalOperation]): Required. The operation to perform on an individual account-level budget proposal.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.AccountBudgetProposalOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.MutateAccountBudgetProposalResponse` instance.
