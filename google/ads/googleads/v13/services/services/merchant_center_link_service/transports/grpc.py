    ...
    def get_merchant_center_link(
        ...
        if "get_merchant_center_link" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v13.services.MerchantCenterLinkService/GetMerchantCenterLink",
    ...
    def mutate_merchant_center_link(
        ...
        if "mutate_merchant_center_link" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v13.services.MerchantCenterLinkService/MutateMerchantCenterLink",
