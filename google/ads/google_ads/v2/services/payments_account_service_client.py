...
"""Accesses the google.ads.googleads.v2.services PaymentsAccountService API."""
...
from google.ads.google_ads.v2.services import payments_account_service_client_config
...
class PaymentsAccountServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.PaymentsAccountService'
    ...
    def list_payments_accounts(
        ...
        Args:
            customer_id (str): The ID of the customer to apply the PaymentsAccount list operation to.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.ListPaymentsAccountsResponse` instance.
