...
class AssetSetAssetServiceClient(metaclass=AssetSetAssetServiceClientMeta):
    ...
    def mutate_asset_set_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateAssetSetAssetsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v14.services.types.AssetSetAssetOperation]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateAssetSetAssetsResponse:
