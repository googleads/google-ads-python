...
"""Accesses the google.ads.googleads.v2.services CampaignSharedSetService API."""
...
from google.ads.google_ads.v2.services import campaign_shared_set_service_client_config
...
class CampaignSharedSetServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.CampaignSharedSetService'
    ...
    def __init__(self, transport=None, channel=None, credentials=None,
        ...
        Args:
            transport (Union[~.CampaignSharedSetServiceGrpcTransport,
                    Callable[[~.Credentials, type], ~.CampaignSharedSetServiceGrpcTransport]): A transport
        ...
        if client_config is not None:
            ...
            client_config = campaign_shared_set_service_client_config.config
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=campaign_shared_set_service_grpc_transport.CampaignSharedSetServiceGrpcTransport,
                )
            else:
                if credentials:
                    raise ValueError(
            ...
            self.transport = campaign_shared_set_service_grpc_transport.CampaignSharedSetServiceGrpcTransport(
    ...
    def get_campaign_shared_set(
        ...
        Args:
            resource_name (str): The resource name of the campaign shared set to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.CampaignSharedSet` instance.
        ...
        if 'get_campaign_shared_set' not in self._inner_api_calls:
            self._inner_api_calls['get_campaign_shared_set'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_campaign_shared_set,
                default_retry=self._method_configs['GetCampaignSharedSet'].retry,
                default_timeout=self._method_configs['GetCampaignSharedSet'].timeout,
                client_info=self._client_info,
            )

        request = campaign_shared_set_service_pb2.GetCampaignSharedSetRequest(
        ...
        return self._inner_api_calls['get_campaign_shared_set'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def mutate_campaign_shared_sets(
        ...
        Args:
            customer_id (str): The ID of the customer whose campaign shared sets are being modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.CampaignSharedSetOperation]]): The list of operations to perform on individual campaign shared sets.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.CampaignSharedSetOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateCampaignSharedSetsResponse` instance.
        ...
        """
        # Wrap the transport method to add retry and timeout logic.
        if 'mutate_campaign_shared_sets' not in self._inner_api_calls:
            self._inner_api_calls['mutate_campaign_shared_sets'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.mutate_campaign_shared_sets,
                default_retry=self._method_configs['MutateCampaignSharedSets'].retry,
                default_timeout=self._method_configs['MutateCampaignSharedSets'].timeout,
                client_info=self._client_info,
            )

        request = campaign_shared_set_service_pb2.MutateCampaignSharedSetsRequest(
