...
from google.ads.google_ads.v4.proto.services import managed_placement_view_service_pb2_grpc


class ManagedPlacementViewServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v4.services ManagedPlacementViewService API.
