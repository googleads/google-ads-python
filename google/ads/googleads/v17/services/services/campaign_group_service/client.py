...
class CampaignGroupServiceClient(metaclass=CampaignGroupServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v17.services.CampaignGroupServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaign_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateCampaignGroupsRequest, dict]):
