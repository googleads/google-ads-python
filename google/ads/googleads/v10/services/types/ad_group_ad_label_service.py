...
from google.ads.googleads.v10.resources.types import ad_group_ad_label
...
class AdGroupAdLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v10.resources.types.AdGroupAdLabel):
...
class MutateAdGroupAdLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v10.services.types.MutateAdGroupAdLabelResult]):
