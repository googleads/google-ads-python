...
class MutateAdGroupAssetSetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v25.services.types.AdGroupAssetSetOperation]):
...
class AdGroupAssetSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v25.resources.types.AdGroupAssetSet):
...
class MutateAdGroupAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v25.services.types.MutateAdGroupAssetSetResult]):
