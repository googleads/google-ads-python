...
"""Accesses the google.ads.googleads.v2.services GenderViewService API."""
...
from google.ads.google_ads.v2.services import gender_view_service_client_config
...
class GenderViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.GenderViewService'
    ...
    def get_gender_view(
        ...
        Args:
            resource_name (str): The resource name of the gender view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.GenderView` instance.
