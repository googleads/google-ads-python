...
class MutateCustomerExtensionSettingsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v14.services.types.CustomerExtensionSettingOperation]):
...
class CustomerExtensionSettingOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v14.resources.types.CustomerExtensionSetting):
            Create operation: No resource name is
            expected for the new customer extension setting.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v14.resources.types.CustomerExtensionSetting):
    ...
    create: gagr_customer_extension_setting.CustomerExtensionSetting = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
        message=gagr_customer_extension_setting.CustomerExtensionSetting,
    )
    update: gagr_customer_extension_setting.CustomerExtensionSetting = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_customer_extension_setting.CustomerExtensionSetting,
...
class MutateCustomerExtensionSettingsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v14.services.types.MutateCustomerExtensionSettingResult]):
