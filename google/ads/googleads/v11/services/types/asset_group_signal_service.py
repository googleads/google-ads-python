...
class MutateAssetGroupSignalsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v11.services.types.AssetGroupSignalOperation]):
...
class AssetGroupSignalOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v11.resources.types.AssetGroupSignal):
...
class MutateAssetGroupSignalsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v11.services.types.MutateAssetGroupSignalResult]):
