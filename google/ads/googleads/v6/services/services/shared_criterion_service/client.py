...
class SharedCriterionServiceClient(metaclass=SharedCriterionServiceClientMeta):
    ...
    def get_shared_criterion(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetSharedCriterionRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.SharedCriterion:
    ...
    def mutate_shared_criteria(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateSharedCriteriaRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.SharedCriterionOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateSharedCriteriaResponse:
