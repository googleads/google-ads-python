...
class GroupPlacementViewServiceClientMeta(type):
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[GroupPlacementViewServiceTransport]]
...
class GroupPlacementViewServiceClient(
    metaclass=GroupPlacementViewServiceClientMeta
):
    ...
    def get_group_placement_view(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetGroupPlacementViewRequest`):
                The request object.
                Request message for
                [GroupPlacementViewService.GetGroupPlacementView][google.ads.googleads.v7.services.GroupPlacementViewService.GetGroupPlacementView].
        ...
        Returns:
            google.ads.googleads.v7.resources.types.GroupPlacementView:
        ...
        rpc = self._transport._wrapped_methods[
            self._transport.get_group_placement_view
        ]
...
__all__ = ("GroupPlacementViewServiceClient",)
