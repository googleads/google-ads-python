...
class MutateAssetSetsRequest(proto.Message):
    ...
    [AssetSetService.MutateAssetSets][google.ads.googleads.v11.services.AssetSetService.MutateAssetSets].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose asset
            sets are being modified.
        operations (Sequence[google.ads.googleads.v11.services.types.AssetSetOperation]):
...
class AssetSetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v11.resources.types.AssetSet):
            Create operation: No resource name is
            expected for the new asset set

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v11.resources.types.AssetSet):
...
class MutateAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v11.services.types.MutateAssetSetResult]):
