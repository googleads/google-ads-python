...
"""Accesses the google.ads.googleads.v0.services KeywordPlanService API."""
...
from google.ads.google_ads.v0.services import keyword_plan_service_client_config
...
class KeywordPlanServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v0.services.KeywordPlanService'
    ...
    def get_keyword_plan(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.KeywordPlan` instance.
    ...
    def mutate_keyword_plans(self,
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v0.types.KeywordPlanOperation]]): The list of operations to perform on individual keyword plans.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v0.types.KeywordPlanOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.MutateKeywordPlansResponse` instance.
    ...
    def generate_forecast_metrics(
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.GenerateForecastMetricsResponse` instance.
    ...
    def generate_historical_metrics(
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.GenerateHistoricalMetricsResponse` instance.
