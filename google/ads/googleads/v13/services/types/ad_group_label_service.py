...
from google.ads.googleads.v13.resources.types import ad_group_label
...
class AdGroupLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v13.resources.types.AdGroupLabel):
...
class MutateAdGroupLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v13.services.types.MutateAdGroupLabelResult]):
