...
"""Accesses the google.ads.googleads.v2.services KeywordPlanAdGroupService API."""
...
from google.ads.google_ads.v2.services import keyword_plan_ad_group_service_client_config
...
class KeywordPlanAdGroupServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.KeywordPlanAdGroupService'
    ...
    def get_keyword_plan_ad_group(
        ...
        Args:
            resource_name (str): The resource name of the Keyword Plan ad group to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.KeywordPlanAdGroup` instance.
    ...
    def mutate_keyword_plan_ad_groups(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.KeywordPlanAdGroupOperation]]): The list of operations to perform on individual Keyword Plan ad groups.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.KeywordPlanAdGroupOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateKeywordPlanAdGroupsResponse` instance.
