...
# source: google/ads/googleads_v0/proto/services/keyword_view_service.proto
...
_GETKEYWORDVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.GetKeywordViewRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v0.services.GetKeywordViewRequest.resource_name', index=0,
...
_KEYWORDVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetKeywordView',
    full_name='google.ads.googleads.v0.services.KeywordViewService.GetKeywordView',
    index=0,
