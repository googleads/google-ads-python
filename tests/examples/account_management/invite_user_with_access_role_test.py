...
from google.ads.googleads.v19.services.services.customer_user_access_invitation_service import (
...
class TestInviteUserWithAccessRole(unittest.TestCase):
    ...
    @patch(
        "examples.account_management.invite_user_with_access_role.GoogleAdsClient"
    )
    def test_main_invites_user_correctly(self, mock_google_ads_client_class):
        ...
        mock_invitation_service = MagicMock(
            spec=CustomerUserAccessInvitationServiceClient
        )
        ...
        mock_admin_enum_member.value = (
            AccessRoleEnum.AccessRole.ADMIN.value
        )  # Actual int value
        ...
        mock_mutate_response.result.resource_name = (
            "customers/123/customerUserAccessInvitations/456"
        )
        mock_invitation_service.mutate_customer_user_access_invitation.return_value = (
        ...
        call_args = (
            mock_invitation_service.mutate_customer_user_access_invitation.call_args
        )
        ...
        self.assertEqual(
            actual_operation_arg, mock_operation
        )  # Ensure the correct operation object was passed
        ...
        self.assertEqual(
            mock_operation.create.access_role, expected_access_role_int_value
        )
