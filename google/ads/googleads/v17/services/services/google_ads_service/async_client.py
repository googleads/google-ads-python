...
class GoogleAdsServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v17.services.GoogleAdsServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def search(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v17.services.types.SearchGoogleAdsRequest, dict]]):
        ...
        Returns:
            google.ads.googleads.v17.services.services.google_ads_service.pagers.SearchAsyncPager:
    ...
    def search_stream(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v17.services.types.SearchGoogleAdsStreamRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            AsyncIterable[google.ads.googleads.v17.services.types.SearchGoogleAdsStreamResponse]:
                Response message for
                   [GoogleAdsService.SearchStream][google.ads.googleads.v17.services.GoogleAdsService.SearchStream].
    ...
    async def mutate(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v17.services.types.MutateGoogleAdsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v17.services.types.MutateGoogleAdsResponse:
                Response message for
                   [GoogleAdsService.Mutate][google.ads.googleads.v17.services.GoogleAdsService.Mutate].
