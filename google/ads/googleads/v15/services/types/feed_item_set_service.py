...
from google.ads.googleads.v15.resources.types import feed_item_set
...
class FeedItemSetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v15.resources.types.FeedItemSet):
            Create operation: No resource name is
            expected for the new feed item set

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v15.resources.types.FeedItemSet):
...
class MutateFeedItemSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v15.services.types.MutateFeedItemSetResult]):
