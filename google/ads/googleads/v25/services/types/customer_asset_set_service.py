...
class MutateCustomerAssetSetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v25.services.types.CustomerAssetSetOperation]):
...
class CustomerAssetSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v25.resources.types.CustomerAssetSet):
...
class MutateCustomerAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v25.services.types.MutateCustomerAssetSetResult]):
