...
class CampaignLabelServiceClient(metaclass=CampaignLabelServiceClientMeta):
    ...
    def mutate_campaign_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.MutateCampaignLabelsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v19.services.types.CampaignLabelOperation]):
        ...
        Returns:
            google.ads.googleads.v19.services.types.MutateCampaignLabelsResponse:
