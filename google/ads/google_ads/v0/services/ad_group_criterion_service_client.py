...
"""Accesses the google.ads.googleads.v0.services AdGroupCriterionService API."""
...
from google.ads.google_ads.v0.services import ad_group_criterion_service_client_config
...
class AdGroupCriterionServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v0.services.AdGroupCriterionService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=ad_group_criterion_service_grpc_transport.
    ...
    def get_ad_group_criterion(self,
        ...
        Example:
            ...
            >>>
            >>> client = googleads_v0.AdGroupCriterionServiceClient()
            >>>
            >>> resource_name = client.ad_group_criteria_path('[CUSTOMER]', '[AD_GROUP_CRITERIA]')
            >>>
        ...
        Returns:
            A :class:`~google.cloud.ads.googleads_v0.types.AdGroupCriterion` instance.
        ...
        if 'get_ad_group_criterion' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_ad_group_criterion'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_ad_group_criterion,
                    default_retry=self._method_configs[
                        'GetAdGroupCriterion'].retry,
                    default_timeout=self._method_configs['GetAdGroupCriterion']
                    .timeout,
        ...
        return self._inner_api_calls['get_ad_group_criterion'](
    ...
    def mutate_ad_group_criteria(
        ...
        Args:
            customer_id (str): ID of the customer whose criteria are being modified.
            operations (list[Union[dict, ~google.cloud.ads.googleads_v0.types.AdGroupCriterionOperation]]): The list of operations to perform on individual criteria.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.cloud.ads.googleads_v0.types.AdGroupCriterionOperation`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.cloud.ads.googleads_v0.types.MutateAdGroupCriteriaResponse` instance.
        ...
        if 'mutate_ad_group_criteria' not in self._inner_api_calls:
            self._inner_api_calls[
                'mutate_ad_group_criteria'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.mutate_ad_group_criteria,
                    default_retry=self._method_configs['MutateAdGroupCriteria']
                    .retry,
                    default_timeout=self._method_configs[
                        'MutateAdGroupCriteria'].timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['mutate_ad_group_criteria'](
            request, retry=retry, timeout=timeout, metadata=metadata)
