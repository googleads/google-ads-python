...
# source: google/ads/googleads_v4/proto/services/feed_mapping_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v4/proto/services/feed_mapping_service.proto',
...
_FEEDMAPPINGOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_feed__mapping__pb2._FEEDMAPPING
...
GetFeedMappingRequest = _reflection.GeneratedProtocolMessageType('GetFeedMappingRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v4.proto.services.feed_mapping_service_pb2'
  ,
...
_FEEDMAPPINGSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_feed__mapping__pb2._FEEDMAPPING,
    serialized_options=_b('\202\323\344\223\0020\022./v4/{resource_name=customers/*/feedMappings/*}\332A\rresource_name'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0026\"1/v4/customers/{customer_id=*}/feedMappings:mutate:\001*\332A\026customer_id,operations'),
  ),
])
