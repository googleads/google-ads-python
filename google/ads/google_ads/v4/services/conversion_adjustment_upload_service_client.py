...
"""Accesses the google.ads.googleads.v4.services ConversionAdjustmentUploadService API."""
...
from google.ads.google_ads.v4.services import conversion_adjustment_upload_service_client_config
from google.ads.google_ads.v4.services.transports import conversion_adjustment_upload_service_grpc_transport
from google.ads.google_ads.v4.proto.services import conversion_adjustment_upload_service_pb2
...
class ConversionAdjustmentUploadServiceClient(object):
    ...
    def upload_conversion_adjustments(
        ...
        Args:
            ...
            conversion_adjustments (list[Union[dict, ~google.ads.googleads_v4.types.ConversionAdjustment]]): Required. The conversion adjustments that are being uploaded.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v4.types.ConversionAdjustment`
        ...
        Returns:
            A :class:`~google.ads.googleads_v4.types.UploadConversionAdjustmentsResponse` instance.
