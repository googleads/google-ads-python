...
class AdGroupCustomizer(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v18.enums.types.CustomizerValueStatusEnum.CustomizerValueStatus):
            Output only. The status of the ad group
            customizer.
        value (google.ads.googleads.v18.common.types.CustomizerValue):
