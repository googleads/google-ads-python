...
class AdGroupCustomizerServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, AdGroupCustomizerServiceTransport, None] = None,
        client_options: Optional[client_options_lib.ClientOptions] = None,
        client_info: gapic_v1.client_info.ClientInfo = DEFAULT_CLIENT_INFO,
    ) -> None:
        """Instantiate the ad group customizer service client.
        ...
        Args:
            ...
            transport (Union[str, ~.AdGroupCustomizerServiceTransport]): The
        ...
        if isinstance(transport, AdGroupCustomizerServiceTransport):
            ...
            self._transport = AdGroupCustomizerServiceGrpcTransport(
    ...
    def mutate_ad_group_customizers(
        self,
        request: Union[
            ad_group_customizer_service.MutateAdGroupCustomizersRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateAdGroupCustomizersRequest, dict]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.AdGroupCustomizerOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateAdGroupCustomizersResponse:
        ...
        # in a ad_group_customizer_service.MutateAdGroupCustomizersRequest.
