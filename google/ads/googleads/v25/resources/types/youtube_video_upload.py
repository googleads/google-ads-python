...
from google.ads.googleads.v25.enums.types import youtube_video_privacy
from google.ads.googleads.v25.enums.types import youtube_video_upload_state
...
class YouTubeVideoUpload(proto.Message):
    ...
    Attributes:
        ...
        video_id (str):
            ...
            uploaded video.
        state (google.ads.googleads.v25.enums.types.YouTubeVideoUploadStateEnum.YouTubeVideoUploadState):
