...
from google.ads.googleads.v10.enums.types import asset_set_link_status
...
class CampaignAssetSet(proto.Message):
    ...
    Attributes:
        ...
        asset_set (str):
            ...
            the campaign.
        status (google.ads.googleads.v10.enums.types.AssetSetLinkStatusEnum.AssetSetLinkStatus):
