...
from google.ads.googleads.v25.enums.types import data_link_status
from google.ads.googleads.v25.enums.types import data_link_type
...
class DataLink(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v25.enums.types.DataLinkTypeEnum.DataLinkType):
            Output only. The type of the data.
        status (google.ads.googleads.v25.enums.types.DataLinkStatusEnum.DataLinkStatus):
            Output only. The status of the data link.
        youtube_video (google.ads.googleads.v25.resources.types.YoutubeVideoIdentifier):
            Immutable. A data link to YouTube video.

            This field is a member of `oneof`_ ``data_link_entity``.
        youtube_link_metadata (google.ads.googleads.v25.resources.types.YoutubeLinkMetadata):
            Immutable. Metadata for a YouTube link.

            This field is a member of `oneof`_ ``data_link_metadata``.
    """
    ...
    youtube_link_metadata: "YoutubeLinkMetadata" = proto.Field(
        proto.MESSAGE,
        number=7,
...
class YoutubeLinkMetadata(proto.Message):
    r"""Metadata specific to YouTube links.

    .. _oneof: https://proto-plus-python.readthedocs.io/en/stable/fields.html#oneofs-mutually-exclusive-fields

    Attributes:
        brand_channel_id (str):
            Immutable. The ID of a YouTube brand channel
            to help creators understand your brand. The
            channel must be linked to this account. This is
            a string value with “UC” prefix. For example,
            "UCK8sQmJBp8GCxrOtXWBpyEA".

            This field is a member of `oneof`_ ``_brand_channel_id``.
    """

    brand_channel_id: str = proto.Field(
        proto.STRING,
        number=1,
        optional=True,
    )
