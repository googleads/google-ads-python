...
class SmartCampaignSettingServiceClient(
    ...
    def get_smart_campaign_setting(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetSmartCampaignSettingRequest, dict]):
                The request object. Request message for
                [SmartCampaignSettingService.GetSmartCampaignSetting][google.ads.googleads.v9.services.SmartCampaignSettingService.GetSmartCampaignSetting].
        ...
        Returns:
            google.ads.googleads.v9.resources.types.SmartCampaignSetting:
    ...
    def mutate_smart_campaign_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateSmartCampaignSettingsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.SmartCampaignSettingOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateSmartCampaignSettingsResponse:
