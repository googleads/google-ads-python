...
class ExtensionFeedItemServiceClient(
    ...
    def mutate_extension_feed_items(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateExtensionFeedItemsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateExtensionFeedItemsResponse:
