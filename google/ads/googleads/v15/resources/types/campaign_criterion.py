...
from google.ads.googleads.v15.enums.types import campaign_criterion_status
...
class CampaignCriterion(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v15.enums.types.CampaignCriterionStatusEnum.CampaignCriterionStatus):
        ...
        location (google.ads.googleads.v15.common.types.LocationInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        device (google.ads.googleads.v15.common.types.DeviceInfo):
            Immutable. Device.

            This field is a member of `oneof`_ ``criterion``.
        ad_schedule (google.ads.googleads.v15.common.types.AdScheduleInfo):
        ...
        youtube_channel (google.ads.googleads.v15.common.types.YouTubeChannelInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        proximity (google.ads.googleads.v15.common.types.ProximityInfo):
            Immutable. Proximity.
        ...
        topic (google.ads.googleads.v15.common.types.TopicInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        listing_scope (google.ads.googleads.v15.common.types.ListingScopeInfo):
        ...
        language (google.ads.googleads.v15.common.types.LanguageInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        ip_block (google.ads.googleads.v15.common.types.IpBlockInfo):
            Immutable. IpBlock.

            This field is a member of `oneof`_ ``criterion``.
        content_label (google.ads.googleads.v15.common.types.ContentLabelInfo):
            Immutable. ContentLabel.

            This field is a member of `oneof`_ ``criterion``.
        carrier (google.ads.googleads.v15.common.types.CarrierInfo):
            Immutable. Carrier.
        ...
        webpage (google.ads.googleads.v15.common.types.WebpageInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        operating_system_version (google.ads.googleads.v15.common.types.OperatingSystemVersionInfo):
            Immutable. Operating system version.

            This field is a member of `oneof`_ ``criterion``.
        mobile_device (google.ads.googleads.v15.common.types.MobileDeviceInfo):
            Immutable. Mobile Device.

            This field is a member of `oneof`_ ``criterion``.
        location_group (google.ads.googleads.v15.common.types.LocationGroupInfo):
        ...
        combined_audience (google.ads.googleads.v15.common.types.CombinedAudienceInfo):
            ...
            This field is a member of `oneof`_ ``criterion``.
        keyword_theme (google.ads.googleads.v15.common.types.KeywordThemeInfo):
            Immutable. Smart Campaign Keyword Theme.

            This field is a member of `oneof`_ ``criterion``.
        local_service_id (google.ads.googleads.v15.common.types.LocalServiceIdInfo):
            Immutable. GLS service campaign criterion.

            This field is a member of `oneof`_ ``criterion``.
        brand_list (google.ads.googleads.v15.common.types.BrandListInfo):
