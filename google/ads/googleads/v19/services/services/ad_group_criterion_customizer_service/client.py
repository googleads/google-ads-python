...
class AdGroupCriterionCustomizerServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v19.services.AdGroupCriterionCustomizerServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_ad_group_criterion_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.MutateAdGroupCriterionCustomizersRequest, dict]):
