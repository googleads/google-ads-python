...
class BiddingSeasonalityAdjustmentServiceClient(
    ...
    def get_bidding_seasonality_adjustment(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.BiddingSeasonalityAdjustment:
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.BiddingSeasonalityAdjustmentOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateBiddingSeasonalityAdjustmentsResponse:
