...
class CampaignConversionGoalServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v17.services.CampaignConversionGoalServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaign_conversion_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateCampaignConversionGoalsRequest, dict]):
