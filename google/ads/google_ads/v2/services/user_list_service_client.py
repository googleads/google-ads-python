...
"""Accesses the google.ads.googleads.v2.services UserListService API."""
...
from google.ads.google_ads.v2.services import user_list_service_client_config
...
class UserListServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.UserListService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=user_list_service_grpc_transport.UserListServiceGrpcTransport,
                )
            else:
                if credentials:
                    raise ValueError(
    ...
    def get_user_list(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.UserList` instance.
    ...
    def mutate_user_lists(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.UserListOperation]]): The list of operations to perform on individual user lists.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.UserListOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateUserListsResponse` instance.
