...
class CampaignDraftServiceClient(metaclass=CampaignDraftServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v25.services.CampaignDraftServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaign_drafts(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.MutateCampaignDraftsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v25.services.types.CampaignDraftOperation]):
    ...
    def promote_campaign_draft(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.PromoteCampaignDraftRequest, dict]):
                The request object. Request message for
    ...
    def list_campaign_draft_async_errors(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.ListCampaignDraftAsyncErrorsRequest, dict]):
                The request object. Request message for
                [CampaignDraftService.ListCampaignDraftAsyncErrors][google.ads.googleads.v25.services.CampaignDraftService.ListCampaignDraftAsyncErrors].
            resource_name (str):
        ...
        Returns:
            google.ads.googleads.v25.services.services.campaign_draft_service.pagers.ListCampaignDraftAsyncErrorsPager:
