...
class AssetSetAssetServiceClient(metaclass=AssetSetAssetServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v17.services.AssetSetAssetServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_asset_set_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateAssetSetAssetsRequest, dict]):
