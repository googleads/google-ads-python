...
from google.ads.google_ads.v4.proto.services import campaign_bid_modifier_service_pb2_grpc


class CampaignBidModifierServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v4.services CampaignBidModifierService API.
