...
"""Accesses the google.ads.googleads.v1.services CustomerClientLinkService API."""
...
from google.ads.google_ads.v1.services import customer_client_link_service_client_config
...
class CustomerClientLinkServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.CustomerClientLinkService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=customer_client_link_service_grpc_transport.
    ...
    def get_customer_client_link(
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.CustomerClientLink` instance.
    ...
    def mutate_customer_client_link(
        ...
        Args:
            ...
            operation_ (Union[dict, ~google.ads.googleads_v1.types.CustomerClientLinkOperation]): The operation to perform on the individual CustomerClientLink.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.CustomerClientLinkOperation`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.MutateCustomerClientLinkResponse` instance.
