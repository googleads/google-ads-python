...
class AdGroupCriterionLabelServiceClient(
    ...
    def mutate_ad_group_criterion_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateAdGroupCriterionLabelsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateAdGroupCriterionLabelsResponse:
