...
from google.ads.googleads.v14.resources.types import custom_audience
...
class MutateCustomAudiencesResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v14.services.types.MutateCustomAudienceResult]):
