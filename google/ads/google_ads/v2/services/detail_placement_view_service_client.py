...
"""Accesses the google.ads.googleads.v2.services DetailPlacementViewService API."""
...
from google.ads.google_ads.v2.services import detail_placement_view_service_client_config
...
class DetailPlacementViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.DetailPlacementViewService'
    ...
    def get_detail_placement_view(
        ...
        Args:
            resource_name (str): The resource name of the Detail Placement view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.DetailPlacementView` instance.
