...
# source: google/ads/googleads_v3/proto/services/mutate_job_service.proto
...
from google.ads.google_ads.v3.proto.services import google_ads_service_pb2 as google_dot_ads_dot_googleads__v3_dot_proto_dot_services_dot_google__ads__service__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v3/proto/services/mutate_job_service.proto',
...
_MUTATEJOBRESULT.fields_by_name['mutate_operation_response'].message_type = google_dot_ads_dot_googleads__v3_dot_proto_dot_services_dot_google__ads__service__pb2._MUTATEOPERATIONRESPONSE
...
CreateMutateJobRequest = _reflection.GeneratedProtocolMessageType('CreateMutateJobRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v3.proto.services.mutate_job_service_pb2'
  ,
  ...
  Attributes:
      customer_id:
          Required. The ID of the customer for which to create a mutate
          job.
  """,
...
GetMutateJobRequest = _reflection.GeneratedProtocolMessageType('GetMutateJobRequest', (_message.Message,), dict(
  ...
  [MutateJobService.GetMutateJob][google.ads.googleads.v3.services.MutateJobService.GetMutateJob]
...
RunMutateJobRequest = _reflection.GeneratedProtocolMessageType('RunMutateJobRequest', (_message.Message,), dict(
  ...
  ,
  __doc__ = """Request message for
  [MutateJobService.RunMutateJob][google.ads.googleads.v3.services.MutateJobService.RunMutateJob]
...
AddMutateJobOperationsRequest = _reflection.GeneratedProtocolMessageType('AddMutateJobOperationsRequest', (_message.Message,), dict(
  ...
  ,
  __doc__ = """Request message for
  [MutateJobService.AddMutateJobOperations][google.ads.googleads.v3.services.MutateJobService.AddMutateJobOperations]
  ...
  Attributes:
      ...
      mutate_operations:
          ...
          entities created in this MutateJob. For example, a customer
...
ListMutateJobResultsRequest = _reflection.GeneratedProtocolMessageType('ListMutateJobResultsRequest', (_message.Message,), dict(
  ...
  ,
  __doc__ = """Request message for
  [MutateJobService.ListMutateJobResults][google.ads.googleads.v3.services.MutateJobService.ListMutateJobResults].
  
  
  Attributes:
      resource_name:
          Required. The resource name of the MutateJob whose results are
          being listed.
      page_token:
...
_MUTATEJOBSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0024\"//v3/customers/{customer_id=*}/mutateJobs:create:\001*\332A\013customer_id'),
  ),
  _descriptor.MethodDescriptor(
    name='GetMutateJob',
    ...
    output_type=google_dot_ads_dot_googleads__v3_dot_proto_dot_resources_dot_mutate__job__pb2._MUTATEJOB,
    serialized_options=_b('\202\323\344\223\002.\022,/v3/{resource_name=customers/*/mutateJobs/*}\332A\rresource_name'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002:\0228/v3/{resource_name=customers/*/mutateJobs/*}:listResults\332A\rresource_name'),
  ),
  _descriptor.MethodDescriptor(
    name='RunMutateJob',
    ...
    serialized_options=_b('\202\323\344\223\0025\"0/v3/{resource_name=customers/*/mutateJobs/*}:run:\001*\332A\rresource_name\312AV\n\025google.protobuf.Empty\022=google.ads.googleads.v3.resources.MutateJob.MutateJobMetadata'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002?\":/v3/{resource_name=customers/*/mutateJobs/*}:addOperations:\001*\332A.resource_name,sequence_token,mutate_operations\332A\037resource_name,mutate_operations'),
  ),
])
