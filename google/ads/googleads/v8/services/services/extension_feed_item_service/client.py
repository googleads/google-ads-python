...
class ExtensionFeedItemServiceClient(
    ...
    def get_extension_feed_item(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.ExtensionFeedItem:
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.ExtensionFeedItemOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateExtensionFeedItemsResponse:
