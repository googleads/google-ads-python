...
from google.ads.google_ads.v3.proto.services import customer_client_service_pb2_grpc


class CustomerClientServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v3.services CustomerClientService API.
