...
# source: google/ads/googleads_v0/proto/errors/shared_set_error.proto
...
_SHAREDSETERRORENUM_SHAREDSETERROR = _descriptor.EnumDescriptor(
  name='SharedSetError',
  full_name='google.ads.googleads.v0.errors.SharedSetErrorEnum.SharedSetError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SHAREDSETERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.errors.SharedSetErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
