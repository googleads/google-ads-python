...
class AccessibleBiddingStrategy(proto.Message):
    ...
    Attributes:
        ...
        name (str):
            ...
            strategy.
        type_ (google.ads.googleads.v9.enums.types.BiddingStrategyTypeEnum.BiddingStrategyType):
        ...
        owner_descriptive_name (str):
            ...
            bidding strategy.
        maximize_conversion_value (google.ads.googleads.v9.resources.types.AccessibleBiddingStrategy.MaximizeConversionValue):
