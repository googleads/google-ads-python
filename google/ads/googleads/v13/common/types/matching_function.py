...
from google.ads.googleads.v13.enums.types import matching_function_context_type
from google.ads.googleads.v13.enums.types import matching_function_operator
...
class MatchingFunction(proto.Message):
    ...
    Attributes:
        ...
        operator (google.ads.googleads.v13.enums.types.MatchingFunctionOperatorEnum.MatchingFunctionOperator):
            Operator for a function.
        left_operands (MutableSequence[google.ads.googleads.v13.common.types.Operand]):
        ...
        right_operands (MutableSequence[google.ads.googleads.v13.common.types.Operand]):
...
class Operand(proto.Message):
    ...
    Attributes:
        constant_operand (google.ads.googleads.v13.common.types.Operand.ConstantOperand):
            A constant operand in a matching function.

            This field is a member of `oneof`_ ``function_argument_operand``.
        feed_attribute_operand (google.ads.googleads.v13.common.types.Operand.FeedAttributeOperand):
            This operand specifies a feed attribute in
            feed.

            This field is a member of `oneof`_ ``function_argument_operand``.
        function_operand (google.ads.googleads.v13.common.types.Operand.FunctionOperand):
            A function operand in a matching function.
            Used to represent nested functions.

            This field is a member of `oneof`_ ``function_argument_operand``.
        request_context_operand (google.ads.googleads.v13.common.types.Operand.RequestContextOperand):
    ...
    class RequestContextOperand(proto.Message):
        ...
        Attributes:
            context_type (google.ads.googleads.v13.enums.types.MatchingFunctionContextTypeEnum.MatchingFunctionContextType):
