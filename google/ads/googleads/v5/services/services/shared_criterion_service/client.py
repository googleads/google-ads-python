...
class SharedCriterionServiceClient(metaclass=SharedCriterionServiceClientMeta):
    ...
    def get_shared_criterion(
        ...
        *,
        ...
        r"""Returns the requested shared criterion in full
        detail.

        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetSharedCriterionRequest`):
                The request object. Request message for
                [SharedCriterionService.GetSharedCriterion][google.ads.googleads.v5.services.SharedCriterionService.GetSharedCriterion].
        ...
        Returns:
            google.ads.googleads.v5.resources.types.SharedCriterion:
    ...
    def mutate_shared_criteria(
        ...
        *,
        ...
        r"""Creates or removes shared criteria. Operation
        statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateSharedCriteriaRequest`):
                The request object. Request message for
                [SharedCriterionService.MutateSharedCriteria][google.ads.googleads.v5.services.SharedCriterionService.MutateSharedCriteria].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.SharedCriterionOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateSharedCriteriaResponse:
