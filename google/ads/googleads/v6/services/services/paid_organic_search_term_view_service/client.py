...
class PaidOrganicSearchTermViewServiceClient(
    ...
    def get_paid_organic_search_term_view(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetPaidOrganicSearchTermViewRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.PaidOrganicSearchTermView:
