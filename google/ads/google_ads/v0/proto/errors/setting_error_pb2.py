...
# source: google/ads/googleads_v0/proto/errors/setting_error.proto
...
_SETTINGERRORENUM_SETTINGERROR = _descriptor.EnumDescriptor(
  name='SettingError',
  full_name='google.ads.googleads.v0.errors.SettingErrorEnum.SettingError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_SETTINGERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.errors.SettingErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
SettingErrorEnum = _reflection.GeneratedProtocolMessageType('SettingErrorEnum', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v0.proto.errors.setting_error_pb2'
  ,
