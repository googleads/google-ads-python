...
class AccountBudgetProposalServiceClient(
    ...
    def get_account_budget_proposal(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetAccountBudgetProposalRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.AccountBudgetProposal:
    ...
    def mutate_account_budget_proposal(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateAccountBudgetProposalRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v4.services.types.AccountBudgetProposalOperation`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateAccountBudgetProposalResponse:
