...
class KeywordPlanIdeaServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v19.services.KeywordPlanIdeaServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def generate_keyword_ideas(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.GenerateKeywordIdeasRequest, dict]]):
        ...
        Returns:
            google.ads.googleads.v19.services.services.keyword_plan_idea_service.pagers.GenerateKeywordIdeasAsyncPager:
    ...
    async def generate_keyword_historical_metrics(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.GenerateKeywordHistoricalMetricsRequest, dict]]):
                The request object. Request message for
    ...
    async def generate_ad_group_themes(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.GenerateAdGroupThemesRequest, dict]]):
                The request object. Request message for
    ...
    async def generate_keyword_forecast_metrics(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.GenerateKeywordForecastMetricsRequest, dict]]):
                The request object. Request message for
                [KeywordPlanIdeaService.GenerateKeywordForecastMetrics].
            campaign (:class:`google.ads.googleads.v19.services.types.CampaignToForecast`):
