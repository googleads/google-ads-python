...
class MutateConversionGoalCampaignConfigsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v16.services.types.ConversionGoalCampaignConfigOperation]):
...
class ConversionGoalCampaignConfigOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v16.resources.types.ConversionGoalCampaignConfig):
...
class MutateConversionGoalCampaignConfigsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v16.services.types.MutateConversionGoalCampaignConfigResult]):
