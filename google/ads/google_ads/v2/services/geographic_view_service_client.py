...
"""Accesses the google.ads.googleads.v2.services GeographicViewService API."""
...
from google.ads.google_ads.v2.services import geographic_view_service_client_config
...
class GeographicViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.GeographicViewService'
    ...
    def get_geographic_view(
        ...
        Args:
            resource_name (str): The resource name of the geographic view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.GeographicView` instance.
