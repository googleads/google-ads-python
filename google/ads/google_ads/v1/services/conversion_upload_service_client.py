...
"""Accesses the google.ads.googleads.v1.services ConversionUploadService API."""
...
from google.ads.google_ads.v1.services import conversion_upload_service_client_config
...
class ConversionUploadServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.ConversionUploadService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=conversion_upload_service_grpc_transport.
    ...
    def upload_click_conversions(
        ...
        Args:
            ...
            conversions (list[Union[dict, ~google.ads.googleads_v1.types.ClickConversion]]): The conversions that are being uploaded.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.ClickConversion`
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.UploadClickConversionsResponse` instance.
        ...
        if 'upload_click_conversions' not in self._inner_api_calls:
            self._inner_api_calls[
                'upload_click_conversions'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.upload_click_conversions,
                    default_retry=self.
                    _method_configs['UploadClickConversions'].retry,
                    default_timeout=self.
                    _method_configs['UploadClickConversions'].timeout,
