...
class CustomConversionGoalServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the custom conversion goal service client.
        ...
        if isinstance(transport, CustomConversionGoalServiceTransport):
            ...
            self._transport = CustomConversionGoalServiceGrpcTransport(
    ...
    def mutate_custom_conversion_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCustomConversionGoalsRequest, dict]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CustomConversionGoalOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCustomConversionGoalsResponse:
