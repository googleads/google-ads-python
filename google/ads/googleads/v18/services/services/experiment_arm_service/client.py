...
class ExperimentArmServiceClient(metaclass=ExperimentArmServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v18.services.ExperimentArmServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_experiment_arms(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateExperimentArmsRequest, dict]):
