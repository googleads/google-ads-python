...
"""Accesses the google.ads.googleads.v5.services SharedCriterionService API."""
...
from google.ads.google_ads.v5.services import shared_criterion_service_client_config
from google.ads.google_ads.v5.services.transports import shared_criterion_service_grpc_transport
from google.ads.google_ads.v5.proto.services import shared_criterion_service_pb2
...
class SharedCriterionServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v5.services.SharedCriterionService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=shared_criterion_service_grpc_transport.SharedCriterionServiceGrpcTransport,
    ...
    def get_shared_criterion(
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.SharedCriterion` instance.
        ...
        if 'get_shared_criterion' not in self._inner_api_calls:
            self._inner_api_calls['get_shared_criterion'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_shared_criterion,
                default_retry=self._method_configs['GetSharedCriterion'].retry,
                default_timeout=self._method_configs['GetSharedCriterion'].timeout,
        ...
        return self._inner_api_calls['get_shared_criterion'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def mutate_shared_criteria(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v5.types.SharedCriterionOperation]]): Required. The list of operations to perform on individual shared criteria.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v5.types.SharedCriterionOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.MutateSharedCriteriaResponse` instance.
        ...
        if 'mutate_shared_criteria' not in self._inner_api_calls:
            self._inner_api_calls['mutate_shared_criteria'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.mutate_shared_criteria,
                default_retry=self._method_configs['MutateSharedCriteria'].retry,
                default_timeout=self._method_configs['MutateSharedCriteria'].timeout,
                client_info=self._client_info,
            )
        ...
        return self._inner_api_calls['mutate_shared_criteria'](request, retry=retry, timeout=timeout, metadata=metadata)
