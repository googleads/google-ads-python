...
from google.ads.googleads.v14.enums.types import linked_product_type
...
class ProductLink(proto.Message):
    ...
    Attributes:
        ...
        type_ (google.ads.googleads.v14.enums.types.LinkedProductTypeEnum.LinkedProductType):
            Output only. The type of the linked product.
        data_partner (google.ads.googleads.v14.resources.types.DataPartnerIdentifier):
            Immutable. Data partner link.

            This field is a member of `oneof`_ ``linked_product``.
        google_ads (google.ads.googleads.v14.resources.types.GoogleAdsIdentifier):
