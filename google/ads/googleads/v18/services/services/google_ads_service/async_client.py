...
class GoogleAdsServiceAsyncClient:
    ...
    ad_group_extension_setting_path = staticmethod(
        GoogleAdsServiceClient.ad_group_extension_setting_path
    )
    parse_ad_group_extension_setting_path = staticmethod(
        GoogleAdsServiceClient.parse_ad_group_extension_setting_path
    )
    ad_group_feed_path = staticmethod(GoogleAdsServiceClient.ad_group_feed_path)
    parse_ad_group_feed_path = staticmethod(
        GoogleAdsServiceClient.parse_ad_group_feed_path
    )
    ...
    campaign_extension_setting_path = staticmethod(
        GoogleAdsServiceClient.campaign_extension_setting_path
    )
    parse_campaign_extension_setting_path = staticmethod(
        GoogleAdsServiceClient.parse_campaign_extension_setting_path
    )
    campaign_feed_path = staticmethod(GoogleAdsServiceClient.campaign_feed_path)
    parse_campaign_feed_path = staticmethod(
        GoogleAdsServiceClient.parse_campaign_feed_path
    )
    ...
    customer_extension_setting_path = staticmethod(
        GoogleAdsServiceClient.customer_extension_setting_path
    )
    parse_customer_extension_setting_path = staticmethod(
        GoogleAdsServiceClient.parse_customer_extension_setting_path
    )
    customer_feed_path = staticmethod(GoogleAdsServiceClient.customer_feed_path)
    parse_customer_feed_path = staticmethod(
        GoogleAdsServiceClient.parse_customer_feed_path
    )
    ...
    extension_feed_item_path = staticmethod(
        GoogleAdsServiceClient.extension_feed_item_path
    )
    parse_extension_feed_item_path = staticmethod(
        GoogleAdsServiceClient.parse_extension_feed_item_path
    )
    feed_path = staticmethod(GoogleAdsServiceClient.feed_path)
    parse_feed_path = staticmethod(GoogleAdsServiceClient.parse_feed_path)
    feed_item_path = staticmethod(GoogleAdsServiceClient.feed_item_path)
    parse_feed_item_path = staticmethod(
        GoogleAdsServiceClient.parse_feed_item_path
    )
    feed_item_set_path = staticmethod(GoogleAdsServiceClient.feed_item_set_path)
    parse_feed_item_set_path = staticmethod(
        GoogleAdsServiceClient.parse_feed_item_set_path
    )
    feed_item_set_link_path = staticmethod(
        GoogleAdsServiceClient.feed_item_set_link_path
    )
    parse_feed_item_set_link_path = staticmethod(
        GoogleAdsServiceClient.parse_feed_item_set_link_path
    )
    feed_item_target_path = staticmethod(
        GoogleAdsServiceClient.feed_item_target_path
    )
    parse_feed_item_target_path = staticmethod(
        GoogleAdsServiceClient.parse_feed_item_target_path
    )
    feed_mapping_path = staticmethod(GoogleAdsServiceClient.feed_mapping_path)
    parse_feed_mapping_path = staticmethod(
        GoogleAdsServiceClient.parse_feed_mapping_path
    )
    feed_placeholder_view_path = staticmethod(
        GoogleAdsServiceClient.feed_placeholder_view_path
    )
    parse_feed_placeholder_view_path = staticmethod(
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v18.services.GoogleAdsServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def search(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v18.services.types.SearchGoogleAdsRequest, dict]]):
        ...
        Returns:
            google.ads.googleads.v18.services.services.google_ads_service.pagers.SearchAsyncPager:
    ...
    def search_stream(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v18.services.types.SearchGoogleAdsStreamRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            AsyncIterable[google.ads.googleads.v18.services.types.SearchGoogleAdsStreamResponse]:
                Response message for
                   [GoogleAdsService.SearchStream][google.ads.googleads.v18.services.GoogleAdsService.SearchStream].
    ...
    async def mutate(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v18.services.types.MutateGoogleAdsRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            mutate_operations (:class:`MutableSequence[google.ads.googleads.v18.services.types.MutateOperation]`):
        ...
        Returns:
            google.ads.googleads.v18.services.types.MutateGoogleAdsResponse:
                Response message for
                   [GoogleAdsService.Mutate][google.ads.googleads.v18.services.GoogleAdsService.Mutate].
