...
class CustomConversionGoalServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, CustomConversionGoalServiceTransport]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, CustomConversionGoalServiceTransport]]): The
    ...
    def mutate_custom_conversion_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateCustomConversionGoalsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateCustomConversionGoalsResponse:
