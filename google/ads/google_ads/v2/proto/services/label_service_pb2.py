...
# source: google/ads/googleads_v2/proto/services/label_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v2/proto/services/label_service.proto',
...
_LABELOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v2_dot_proto_dot_resources_dot_label__pb2._LABEL
_LABELOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v2_dot_proto_dot_resources_dot_label__pb2._LABEL
...
GetLabelRequest = _reflection.GeneratedProtocolMessageType('GetLabelRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v2.proto.services.label_service_pb2'
  ,
  __doc__ = """Request message for
  [LabelService.GetLabel][google.ads.googleads.v2.services.LabelService.GetLabel].
...
MutateLabelsRequest = _reflection.GeneratedProtocolMessageType('MutateLabelsRequest', (_message.Message,), dict(
  ...
  ,
  __doc__ = """Request message for
  [LabelService.MutateLabels][google.ads.googleads.v2.services.LabelService.MutateLabels].
...
_LABELSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v2_dot_proto_dot_resources_dot_label__pb2._LABEL,
    serialized_options=_b('\202\323\344\223\002*\022(/v2/{resource_name=customers/*/labels/*}'),
  ),
  _descriptor.MethodDescriptor(
    name='MutateLabels',
    ...
    serialized_options=_b('\202\323\344\223\0020\"+/v2/customers/{customer_id=*}/labels:mutate:\001*'),
  ),
])
