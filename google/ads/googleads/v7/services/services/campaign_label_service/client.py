...
class CampaignLabelServiceClient(metaclass=CampaignLabelServiceClientMeta):
    ...
    def get_campaign_label(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CampaignLabel:
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.CampaignLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateCampaignLabelsResponse:
