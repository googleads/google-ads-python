...
class AdGroupCriterionLabelServiceClient(
    ...
    def get_ad_group_criterion_label(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetAdGroupCriterionLabelRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.AdGroupCriterionLabel:
    ...
    def mutate_ad_group_criterion_labels(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateAdGroupCriterionLabelsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.AdGroupCriterionLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateAdGroupCriterionLabelsResponse:
