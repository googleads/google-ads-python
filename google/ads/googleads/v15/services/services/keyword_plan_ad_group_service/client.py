...
class KeywordPlanAdGroupServiceClient(
    ...
    def mutate_keyword_plan_ad_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateKeywordPlanAdGroupsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateKeywordPlanAdGroupsResponse:
