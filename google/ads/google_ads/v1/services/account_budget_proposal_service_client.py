...
"""Accesses the google.ads.googleads.v1.services AccountBudgetProposalService API."""
...
from google.ads.google_ads.v1.services import account_budget_proposal_service_client_config
...
class AccountBudgetProposalServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.AccountBudgetProposalService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=account_budget_proposal_service_grpc_transport
    ...
    def get_account_budget_proposal(
        ...
        Args:
            resource_name (str): The resource name of the account-level budget proposal to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.AccountBudgetProposal` instance.
        ...
        if 'get_account_budget_proposal' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_account_budget_proposal'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_account_budget_proposal,
                    default_retry=self.
                    _method_configs['GetAccountBudgetProposal'].retry,
                    default_timeout=self.
                    _method_configs['GetAccountBudgetProposal'].timeout,
                    client_info=self._client_info,
                )

        request = account_budget_proposal_service_pb2.GetAccountBudgetProposalRequest(
            resource_name=resource_name, )
        return self._inner_api_calls['get_account_budget_proposal'](
    ...
    def mutate_account_budget_proposal(
        ...
        Args:
            ...
            operation_ (Union[dict, ~google.ads.googleads_v1.types.AccountBudgetProposalOperation]): The operation to perform on an individual account-level budget proposal.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.AccountBudgetProposalOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.MutateAccountBudgetProposalResponse` instance.
        ...
        if 'mutate_account_budget_proposal' not in self._inner_api_calls:
            self._inner_api_calls[
                'mutate_account_budget_proposal'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.mutate_account_budget_proposal,
                    default_retry=self.
                    _method_configs['MutateAccountBudgetProposal'].retry,
                    default_timeout=self.
                    _method_configs['MutateAccountBudgetProposal'].timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['mutate_account_budget_proposal'](
            request, retry=retry, timeout=timeout, metadata=metadata)
