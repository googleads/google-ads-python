...
"""Accesses the google.ads.googleads.v2.services RemarketingActionService API."""
...
from google.ads.google_ads.v2.services import remarketing_action_service_client_config
...
class RemarketingActionServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.RemarketingActionService'
    ...
    def get_remarketing_action(
        ...
        Args:
            resource_name (str): The resource name of the remarketing action to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.RemarketingAction` instance.
    ...
    def mutate_remarketing_actions(
        ...
        Args:
            customer_id (str): The ID of the customer whose remarketing actions are being modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.RemarketingActionOperation]]): The list of operations to perform on individual remarketing actions.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.RemarketingActionOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateRemarketingActionsResponse` instance.
