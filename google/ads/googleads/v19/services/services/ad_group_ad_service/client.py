...
class AdGroupAdServiceClient(metaclass=AdGroupAdServiceClientMeta):
    ...
    def mutate_ad_group_ads(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.MutateAdGroupAdsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v19.services.types.AdGroupAdOperation]):
        ...
        Returns:
            google.ads.googleads.v19.services.types.MutateAdGroupAdsResponse:
    ...
    def remove_automatically_created_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.RemoveAutomaticallyCreatedAssetsRequest, dict, None]):
                The request object. Request message for
            ...
            ad_group_ad (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            assets_with_field_type (MutableSequence[google.ads.googleads.v19.services.types.AssetsWithFieldType]):
