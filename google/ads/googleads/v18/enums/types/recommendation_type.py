...
class RecommendationTypeEnum(proto.Message):
    ...
    class RecommendationType(proto.Enum):
        ...
        Values:
            ...
            CAMPAIGN_BUDGET (2):
                Budget recommendation for campaigns that are currently
                budget-constrained (as opposed to the
                FORECASTING_CAMPAIGN_BUDGET recommendation, which applies to
                campaigns that are expected to become budget-constrained in
                the future).
            KEYWORD (3):
