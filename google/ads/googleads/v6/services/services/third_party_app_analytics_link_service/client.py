...
class ThirdPartyAppAnalyticsLinkServiceClient(
    ...
    def get_third_party_app_analytics_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetThirdPartyAppAnalyticsLinkRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.ThirdPartyAppAnalyticsLink:
    ...
    def regenerate_shareable_link_id(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.RegenerateShareableLinkIdRequest`):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v6.services.types.RegenerateShareableLinkIdResponse:
