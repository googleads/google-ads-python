...
def main(client, customer_id, ad_group_id):
    ...
    try:
        ...
        search_response = google_ads_service.search(customer_id, query)

        targeting_dimension_enum = client.get_type(
            "TargetingDimensionEnum", version="v6"
        ).TargetingDimension

        # Create an empty TargetingSetting instance.
        targeting_setting = client.get_type("TargetingSetting", version="v6")
        ...
        for target_restriction in target_restrictions:
            ...
            print(
                ...
                f"'{targeting_dimension_enum.Name(targeting_dimension)}' "
