...
class ProductLinkServiceClient(metaclass=ProductLinkServiceClientMeta):
    ...
    def create_product_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.CreateProductLinkRequest, dict, None]):
    ...
    def remove_product_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.RemoveProductLinkRequest, dict, None]):
                The request object. Request message for
