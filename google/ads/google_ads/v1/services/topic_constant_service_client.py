...
"""Accesses the google.ads.googleads.v1.services TopicConstantService API."""
...
from google.ads.google_ads.v1.services import topic_constant_service_client_config
...
class TopicConstantServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.TopicConstantService'
    ...
    def get_topic_constant(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.TopicConstant` instance.
        ...
        if 'get_topic_constant' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_topic_constant'] = google.api_core.gapic_v1.method.wrap_method(
                    ...
                    default_retry=self._method_configs['GetTopicConstant'].
                    retry,
