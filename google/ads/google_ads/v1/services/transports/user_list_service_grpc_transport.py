...
from google.ads.google_ads.v1.proto.services import user_list_service_pb2_grpc


class UserListServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v1.services UserListService API.
    ...
    def get_user_list(self):
        ...
        """
        return self._stubs['user_list_service_stub'].GetUserList
    ...
    def mutate_user_lists(self):
        ...
        Returns:
            Callable: A callable which accepts the appropriate
                ...
                deserialized response object.
        """
        return self._stubs['user_list_service_stub'].MutateUserLists
