...
class ProductLinkServiceClient(metaclass=ProductLinkServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v18.services.ProductLinkServiceClient`.",
                    extra=(
                        {
    ...
    def create_product_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.CreateProductLinkRequest, dict]):
    ...
    def remove_product_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.RemoveProductLinkRequest, dict]):
                The request object. Request message for
