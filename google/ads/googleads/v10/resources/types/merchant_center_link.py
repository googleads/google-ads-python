...
from google.ads.googleads.v10.enums.types import merchant_center_link_status
...
class MerchantCenterLink(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v10.enums.types.MerchantCenterLinkStatusEnum.MerchantCenterLinkStatus):
