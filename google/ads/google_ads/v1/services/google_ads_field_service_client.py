...
"""Accesses the google.ads.googleads.v1.services GoogleAdsFieldService API."""
...
from google.ads.google_ads.v1.services import google_ads_field_service_client_config
...
class GoogleAdsFieldServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.GoogleAdsFieldService'
    ...
    def get_google_ads_field(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.GoogleAdsField` instance.
    ...
    def search_google_ads_fields(
        ...
        Returns:
            ...
            is an iterable of :class:`~google.ads.googleads_v1.types.GoogleAdsField` instances.
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            ...
            method=functools.partial(
                self._inner_api_calls['search_google_ads_fields'],
                retry=retry,
                timeout=timeout,
                metadata=metadata),
            request=request,
