...
"""Accesses the google.ads.googleads.v1.services AssetService API."""
...
from google.ads.google_ads.v1.services import asset_service_client_config
...
class AssetServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.AssetService'
    ...
    def get_asset(self,
        ...
        if 'get_asset' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_asset'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['get_asset'](
    ...
    def mutate_assets(self,
        ...
        if 'mutate_assets' not in self._inner_api_calls:
            self._inner_api_calls[
                'mutate_assets'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.mutate_assets,
                    default_retry=self._method_configs['MutateAssets'].retry,
                    default_timeout=self._method_configs['MutateAssets'].
                    timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['mutate_assets'](
            request, retry=retry, timeout=timeout, metadata=metadata)
