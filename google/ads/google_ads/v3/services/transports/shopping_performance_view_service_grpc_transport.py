...
from google.ads.google_ads.v3.proto.services import shopping_performance_view_service_pb2_grpc


class ShoppingPerformanceViewServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v3.services ShoppingPerformanceViewService API.
