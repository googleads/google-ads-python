...
def main(client, customer_id, campaign_id):
    ...
    shared_set_service = client.get_service('SharedSetService', version='v4')
    ...
    shared_set_operation = client.get_type('SharedSetOperation', version='v4')
