...
class AdGroupAssetServiceClient(metaclass=AdGroupAssetServiceClientMeta):
    ...
    def get_ad_group_asset(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.AdGroupAsset:
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.AdGroupAssetOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateAdGroupAssetsResponse:
