...
class CustomerFeedServiceClient(metaclass=CustomerFeedServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, CustomerFeedServiceTransport]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, CustomerFeedServiceTransport]]): The
    ...
    def mutate_customer_feeds(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateCustomerFeedsRequest, dict, None]):
