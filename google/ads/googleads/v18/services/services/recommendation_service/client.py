...
class RecommendationServiceClient(metaclass=RecommendationServiceClientMeta):
    ...
    def apply_recommendation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.ApplyRecommendationRequest, dict, None]):
    ...
    def dismiss_recommendation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.DismissRecommendationRequest, dict, None]):
                The request object. Request message for
    ...
    def generate_recommendations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.GenerateRecommendationsRequest, dict, None]):
                The request object. Request message for
