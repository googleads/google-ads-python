...
# source: google/ads/googleads_v4/proto/services/shared_criterion_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v4/proto/services/shared_criterion_service.proto',
...
_SHAREDCRITERIONOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_shared__criterion__pb2._SHAREDCRITERION
...
GetSharedCriterionRequest = _reflection.GeneratedProtocolMessageType('GetSharedCriterionRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v4.proto.services.shared_criterion_service_pb2'
  ,
...
_SHAREDCRITERIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_shared__criterion__pb2._SHAREDCRITERION,
    serialized_options=_b('\202\323\344\223\0022\0220/v4/{resource_name=customers/*/sharedCriteria/*}\332A\rresource_name'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0028\"3/v4/customers/{customer_id=*}/sharedCriteria:mutate:\001*\332A\026customer_id,operations'),
  ),
])
