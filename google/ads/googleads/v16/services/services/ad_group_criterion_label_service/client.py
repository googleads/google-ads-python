...
class AdGroupCriterionLabelServiceClient(
    ...
    def mutate_ad_group_criterion_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateAdGroupCriterionLabelsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v16.services.types.AdGroupCriterionLabelOperation]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateAdGroupCriterionLabelsResponse:
