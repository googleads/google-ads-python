...
class ProductLinkInvitationServiceClient(
    ...
    def update_product_link_invitation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.UpdateProductLinkInvitationRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.UpdateProductLinkInvitationResponse:
