...
class ConversionValueRuleSetServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, ConversionValueRuleSetServiceTransport]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, ConversionValueRuleSetServiceTransport]]): The
    ...
    def mutate_conversion_value_rule_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateConversionValueRuleSetsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v18.services.types.MutateConversionValueRuleSetsResponse:
