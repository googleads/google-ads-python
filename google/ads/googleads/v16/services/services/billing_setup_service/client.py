...
class BillingSetupServiceClient(metaclass=BillingSetupServiceClientMeta):
    ...
    def mutate_billing_setup(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateBillingSetupRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v16.services.types.BillingSetupOperation):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateBillingSetupResponse:
