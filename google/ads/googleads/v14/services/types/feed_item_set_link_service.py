...
from google.ads.googleads.v14.resources.types import feed_item_set_link
...
class MutateFeedItemSetLinksResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v14.services.types.MutateFeedItemSetLinkResult]):
