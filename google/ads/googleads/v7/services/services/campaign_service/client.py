...
class CampaignServiceClient(metaclass=CampaignServiceClientMeta):
    ...
    def get_campaign(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.Campaign:
                A campaign.
        """
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.CampaignOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateCampaignsResponse:
