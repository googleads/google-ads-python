...
class MutateMediaFilesRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v14.services.types.MediaFileOperation]):
...
class MediaFileOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v14.resources.types.MediaFile):
    ...
    create: gagr_media_file.MediaFile = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
...
class MutateMediaFilesResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v14.services.types.MutateMediaFileResult]):
