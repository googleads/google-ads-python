...
class MutateCustomerCustomizersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v15.services.types.CustomerCustomizerOperation]):
...
class CustomerCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v15.resources.types.CustomerCustomizer):
...
class MutateCustomerCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v15.services.types.MutateCustomerCustomizerResult]):
