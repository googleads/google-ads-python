...
class ProductLink(proto.Message):
    ...
    Attributes:
        ...
        data_partner (google.ads.googleads.v15.resources.types.DataPartnerIdentifier):
            Immutable. Data partner link.

            This field is a member of `oneof`_ ``linked_product``.
        google_ads (google.ads.googleads.v15.resources.types.GoogleAdsIdentifier):
            Immutable. Google Ads link.

            This field is a member of `oneof`_ ``linked_product``.
        merchant_center (google.ads.googleads.v15.resources.types.MerchantCenterIdentifier):
