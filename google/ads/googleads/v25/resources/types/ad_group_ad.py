...
from google.ads.googleads.v25.enums.types import ad_group_ad_primary_status
from google.ads.googleads.v25.enums.types import (
    ad_group_ad_primary_status_reason,
)
from google.ads.googleads.v25.enums.types import ad_group_ad_status
...
class AdGroupAd(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v25.enums.types.AdGroupAdStatusEnum.AdGroupAdStatus):
        ...
        end_date_time (str):
            ...
            "yyyy-MM-dd HH:mm:ss" format. Only supported for
            some ad types.
        policy_summary (google.ads.googleads.v25.resources.types.AdGroupAdPolicySummary):
        ...
        primary_status (google.ads.googleads.v25.enums.types.AdGroupAdPrimaryStatusEnum.AdGroupAdPrimaryStatus):
            Output only. Provides aggregated view into
            why an ad group ad is not serving or not serving
            optimally.
        primary_status_reasons (MutableSequence[google.ads.googleads.v25.enums.types.AdGroupAdPrimaryStatusReasonEnum.AdGroupAdPrimaryStatusReason]):
            Output only. Provides reasons for why an ad
            group ad is not serving or not serving
            optimally.
        ad_group_ad_asset_automation_settings (MutableSequence[google.ads.googleads.v25.resources.types.AdGroupAdAssetAutomationSetting]):
