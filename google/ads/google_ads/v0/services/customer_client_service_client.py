...
"""Accesses the google.ads.googleads.v0.services CustomerClientService API."""
...
from google.ads.google_ads.v0.services import customer_client_service_client_config
...
class CustomerClientServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v0.services.CustomerClientService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=customer_client_service_grpc_transport.
    ...
    def get_customer_client(self,
        ...
        Args:
            resource_name (str): The resource name of the customer client to fetch.
        ...
        Returns:
            A :class:`~google.ads.google_ads.v0.types.CustomerClient` instance.
        ...
        if 'get_customer_client' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_customer_client'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_customer_client,
                    default_retry=self._method_configs[
                        'GetCustomerClient'].retry,
                    default_timeout=self._method_configs['GetCustomerClient']
                    .timeout,
        ...
        return self._inner_api_calls['get_customer_client'](
