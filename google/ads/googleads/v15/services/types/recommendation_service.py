...
from google.ads.googleads.v15.common.types import extensions
...
class ApplyRecommendationRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            recommendation.
        operations (MutableSequence[google.ads.googleads.v15.services.types.ApplyRecommendationOperation]):
...
class ApplyRecommendationOperation(proto.Message):
    ...
    Attributes:
        resource_name (str):
            ...
            apply.
        campaign_budget (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.CampaignBudgetParameters):
        ...
        text_ad (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.TextAdParameters):
            Optional parameters to use when applying a
            text ad recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        keyword (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.KeywordParameters):
            Optional parameters to use when applying
            keyword recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        target_cpa_opt_in (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.TargetCpaOptInParameters):
            Optional parameters to use when applying
            target CPA opt-in recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        target_roas_opt_in (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.TargetRoasOptInParameters):
            Optional parameters to use when applying
            target ROAS opt-in recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        callout_extension (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.CalloutExtensionParameters):
            Parameters to use when applying callout
            extension recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        call_extension (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.CallExtensionParameters):
            Parameters to use when applying call
            extension recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        sitelink_extension (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.SitelinkExtensionParameters):
            Parameters to use when applying sitelink
            recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        move_unused_budget (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.MoveUnusedBudgetParameters):
            Parameters to use when applying move unused
            budget recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        responsive_search_ad (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.ResponsiveSearchAdParameters):
            Parameters to use when applying a responsive
            search ad recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        use_broad_match_keyword (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.UseBroadMatchKeywordParameters):
            Parameters to use when applying a use broad
            match keyword recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        responsive_search_ad_asset (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.ResponsiveSearchAdAssetParameters):
            Parameters to use when applying a responsive
            search ad asset recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        responsive_search_ad_improve_ad_strength (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.ResponsiveSearchAdImproveAdStrengthParameters):
            Parameters to use when applying a responsive
            search ad improve ad strength recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        raise_target_cpa_bid_too_low (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.RaiseTargetCpaBidTooLowParameters):
            ...
            This field is a member of `oneof`_ ``apply_parameters``.
        forecasting_set_target_roas (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.ForecastingSetTargetRoasParameters):
            Parameters to use when applying a forecasting
            set target ROAS recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        callout_asset (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.CalloutAssetParameters):
            Parameters to use when applying callout asset
            recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        call_asset (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.CallAssetParameters):
            Parameters to use when applying call asset
            recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        sitelink_asset (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.SitelinkAssetParameters):
            Parameters to use when applying sitelink
            asset recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        raise_target_cpa (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.RaiseTargetCpaParameters):
            Parameters to use when applying raise Target
            CPA recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        lower_target_roas (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.LowerTargetRoasParameters):
            Parameters to use when applying lower Target
            ROAS recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        forecasting_set_target_cpa (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.ForecastingSetTargetCpaParameters):
            Parameters to use when applying forecasting
            set target CPA recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        set_target_cpa (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.ForecastingSetTargetCpaParameters):
            Parameters to use when applying set target
            CPA recommendation.

            This field is a member of `oneof`_ ``apply_parameters``.
        set_target_roas (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.ForecastingSetTargetRoasParameters):
            Parameters to use when applying set target
            ROAS recommendation.
    ...
    class CalloutExtensionParameters(proto.Message):
        ...
        Attributes:
            callout_extensions (MutableSequence[google.ads.googleads.v15.common.types.CalloutFeedItem]):
    ...
    class CallExtensionParameters(proto.Message):
        ...
        Attributes:
            call_extensions (MutableSequence[google.ads.googleads.v15.common.types.CallFeedItem]):
    ...
    class SitelinkExtensionParameters(proto.Message):
        ...
        Attributes:
            sitelink_extensions (MutableSequence[google.ads.googleads.v15.common.types.SitelinkFeedItem]):
    ...
    class CalloutAssetParameters(proto.Message):
        ...
        Attributes:
            ad_asset_apply_parameters (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.AdAssetApplyParameters):
    ...
    class AdAssetApplyParameters(proto.Message):
        ...
        Attributes:
            new_assets (MutableSequence[google.ads.googleads.v15.resources.types.Asset]):
            ...
            scope (google.ads.googleads.v15.services.types.ApplyRecommendationOperation.AdAssetApplyParameters.ApplyScope):
    ...
    class ResponsiveSearchAdAssetParameters(proto.Message):
        ...
        Attributes:
            updated_ad (google.ads.googleads.v15.resources.types.Ad):
...
class ApplyRecommendationResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v15.services.types.ApplyRecommendationResult]):
...
class DismissRecommendationRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer with the
            recommendation.
        operations (MutableSequence[google.ads.googleads.v15.services.types.DismissRecommendationRequest.DismissRecommendationOperation]):
...
class DismissRecommendationResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v15.services.types.DismissRecommendationResponse.DismissRecommendationResult]):
