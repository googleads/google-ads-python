...
class AdGroupAdServiceClient(metaclass=AdGroupAdServiceClientMeta):
    ...
    def mutate_ad_group_ads(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateAdGroupAdsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateAdGroupAdsResponse:
