...
from google.ads.googleads.v13.common.types import bidding
from google.ads.googleads.v13.common.types import custom_parameter
from google.ads.googleads.v13.common.types import frequency_cap
...
from google.ads.googleads.v13.enums.types import app_campaign_app_store
from google.ads.googleads.v13.enums.types import (
...
from google.ads.googleads.v13.enums.types import brand_safety_suitability
from google.ads.googleads.v13.enums.types import campaign_experiment_type
from google.ads.googleads.v13.enums.types import campaign_primary_status
...
from google.ads.googleads.v13.enums.types import optimization_goal_type
from google.ads.googleads.v13.enums.types import (
    payment_mode as gage_payment_mode,
)
from google.ads.googleads.v13.enums.types import performance_max_upgrade_status
from google.ads.googleads.v13.enums.types import (
...
class Campaign(proto.Message):
    ...
    Attributes:
        ...
        primary_status (google.ads.googleads.v13.enums.types.CampaignPrimaryStatusEnum.CampaignPrimaryStatus):
        ...
        primary_status_reasons (MutableSequence[google.ads.googleads.v13.enums.types.CampaignPrimaryStatusReasonEnum.CampaignPrimaryStatusReason]):
        ...
        status (google.ads.googleads.v13.enums.types.CampaignStatusEnum.CampaignStatus):
            The status of the campaign.
            When a new campaign is added, the status
            defaults to ENABLED.
        serving_status (google.ads.googleads.v13.enums.types.CampaignServingStatusEnum.CampaignServingStatus):
            Output only. The ad serving status of the
            campaign.
        bidding_strategy_system_status (google.ads.googleads.v13.enums.types.BiddingStrategySystemStatusEnum.BiddingStrategySystemStatus):
            Output only. The system status of the
            campaign's bidding strategy.
        ad_serving_optimization_status (google.ads.googleads.v13.enums.types.AdServingOptimizationStatusEnum.AdServingOptimizationStatus):
            The ad serving optimization status of the
            campaign.
        advertising_channel_type (google.ads.googleads.v13.enums.types.AdvertisingChannelTypeEnum.AdvertisingChannelType):
        ...
        advertising_channel_sub_type (google.ads.googleads.v13.enums.types.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType):
        ...
        url_custom_parameters (MutableSequence[google.ads.googleads.v13.common.types.CustomParameter]):
            ...
            ``mobile_final_urls``.
        local_services_campaign_settings (google.ads.googleads.v13.resources.types.Campaign.LocalServicesCampaignSettings):
            The Local Services Campaign related settings.
        travel_campaign_settings (google.ads.googleads.v13.resources.types.Campaign.TravelCampaignSettings):
            Settings for Travel campaign.
        real_time_bidding_setting (google.ads.googleads.v13.common.types.RealTimeBiddingSetting):
            Settings for Real-Time Bidding, a feature
            only available for campaigns targeting the Ad
            Exchange network.
        network_settings (google.ads.googleads.v13.resources.types.Campaign.NetworkSettings):
            The network settings for the campaign.
        hotel_setting (google.ads.googleads.v13.resources.types.Campaign.HotelSettingInfo):
            Immutable. The hotel setting for the
            campaign.
        dynamic_search_ads_setting (google.ads.googleads.v13.resources.types.Campaign.DynamicSearchAdsSetting):
            The setting for controlling Dynamic Search
            Ads (DSA).
        shopping_setting (google.ads.googleads.v13.resources.types.Campaign.ShoppingSetting):
            The setting for controlling Shopping
            campaigns.
        targeting_setting (google.ads.googleads.v13.common.types.TargetingSetting):
            Setting for targeting related features.
        audience_setting (google.ads.googleads.v13.resources.types.Campaign.AudienceSetting):
            Immutable. Setting for audience related
            features.

            This field is a member of `oneof`_ ``_audience_setting``.
        geo_target_type_setting (google.ads.googleads.v13.resources.types.Campaign.GeoTargetTypeSetting):
            The setting for ads geotargeting.
        local_campaign_setting (google.ads.googleads.v13.resources.types.Campaign.LocalCampaignSetting):
            The setting for local campaign.
        app_campaign_setting (google.ads.googleads.v13.resources.types.Campaign.AppCampaignSetting):
            The setting related to App Campaign.
        labels (MutableSequence[str]):
            Output only. The resource names of labels
            attached to this campaign.
        experiment_type (google.ads.googleads.v13.enums.types.CampaignExperimentTypeEnum.CampaignExperimentType):
        ...
        bidding_strategy_type (google.ads.googleads.v13.enums.types.BiddingStrategyTypeEnum.BiddingStrategyType):
        ...
        frequency_caps (MutableSequence[google.ads.googleads.v13.common.types.FrequencyCapEntry]):
            A list that limits how often each user will
            see this campaign's ads.
        video_brand_safety_suitability (google.ads.googleads.v13.enums.types.BrandSafetySuitabilityEnum.BrandSafetySuitability):
            Output only. 3-Tier Brand Safety setting for
            the campaign.
        vanity_pharma (google.ads.googleads.v13.resources.types.Campaign.VanityPharma):
            Describes how unbranded pharma ads will be
            displayed.
        selective_optimization (google.ads.googleads.v13.resources.types.Campaign.SelectiveOptimization):
        ...
        optimization_goal_setting (google.ads.googleads.v13.resources.types.Campaign.OptimizationGoalSetting):
            Optimization goal setting for this campaign,
            which includes a set of optimization goal types.
        tracking_setting (google.ads.googleads.v13.resources.types.Campaign.TrackingSetting):
            Output only. Campaign-level settings for
            tracking information.
        payment_mode (google.ads.googleads.v13.enums.types.PaymentModeEnum.PaymentMode):
        ...
        excluded_parent_asset_field_types (MutableSequence[google.ads.googleads.v13.enums.types.AssetFieldTypeEnum.AssetFieldType]):
        ...
        excluded_parent_asset_set_types (MutableSequence[google.ads.googleads.v13.enums.types.AssetSetTypeEnum.AssetSetType]):
        ...
        performance_max_upgrade (google.ads.googleads.v13.resources.types.Campaign.PerformanceMaxUpgrade):
        ...
        commission (google.ads.googleads.v13.common.types.Commission):
            Commission is an automatic bidding strategy
            in which the advertiser pays a certain portion
            of the conversion value.

            This field is a member of `oneof`_ ``campaign_bidding_strategy``.
        manual_cpa (google.ads.googleads.v13.common.types.ManualCpa):
            ...
            This field is a member of `oneof`_ ``campaign_bidding_strategy``.
        manual_cpc (google.ads.googleads.v13.common.types.ManualCpc):
            Standard Manual CPC bidding strategy.
            Manual click-based bidding where user pays per
            click.

            This field is a member of `oneof`_ ``campaign_bidding_strategy``.
        manual_cpm (google.ads.googleads.v13.common.types.ManualCpm):
            Standard Manual CPM bidding strategy.
            Manual impression-based bidding where user pays
            per thousand impressions.

            This field is a member of `oneof`_ ``campaign_bidding_strategy``.
        manual_cpv (google.ads.googleads.v13.common.types.ManualCpv):
            Output only. A bidding strategy that pays a
            configurable amount per video view.

            This field is a member of `oneof`_ ``campaign_bidding_strategy``.
        maximize_conversions (google.ads.googleads.v13.common.types.MaximizeConversions):
            ...
            This field is a member of `oneof`_ ``campaign_bidding_strategy``.
        maximize_conversion_value (google.ads.googleads.v13.common.types.MaximizeConversionValue):
            ...
            This field is a member of `oneof`_ ``campaign_bidding_strategy``.
        target_cpa (google.ads.googleads.v13.common.types.TargetCpa):
            ...
            This field is a member of `oneof`_ ``campaign_bidding_strategy``.
        target_impression_share (google.ads.googleads.v13.common.types.TargetImpressionShare):
            ...
            This field is a member of `oneof`_ ``campaign_bidding_strategy``.
        target_roas (google.ads.googleads.v13.common.types.TargetRoas):
            ...
            This field is a member of `oneof`_ ``campaign_bidding_strategy``.
        target_spend (google.ads.googleads.v13.common.types.TargetSpend):
            ...
            This field is a member of `oneof`_ ``campaign_bidding_strategy``.
        percent_cpc (google.ads.googleads.v13.common.types.PercentCpc):
            Standard Percent Cpc bidding strategy where
            bids are a fraction of the advertised price for
            some good or service.

            This field is a member of `oneof`_ ``campaign_bidding_strategy``.
        target_cpm (google.ads.googleads.v13.common.types.TargetCpm):
    ...
    class PerformanceMaxUpgrade(proto.Message):
        ...
        Attributes:
            ...
            status (google.ads.googleads.v13.enums.types.PerformanceMaxUpgradeStatusEnum.PerformanceMaxUpgradeStatus):
    ...
    class GeoTargetTypeSetting(proto.Message):
        ...
        Attributes:
            positive_geo_target_type (google.ads.googleads.v13.enums.types.PositiveGeoTargetTypeEnum.PositiveGeoTargetType):
                The setting used for positive geotargeting in
                this particular campaign.
            negative_geo_target_type (google.ads.googleads.v13.enums.types.NegativeGeoTargetTypeEnum.NegativeGeoTargetType):
    ...
    class LocalCampaignSetting(proto.Message):
        ...
        Attributes:
            location_source_type (google.ads.googleads.v13.enums.types.LocationSourceTypeEnum.LocationSourceType):
    ...
    class AppCampaignSetting(proto.Message):
        ...
        Attributes:
            bidding_strategy_goal_type (google.ads.googleads.v13.enums.types.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalType):
            ...
            app_store (google.ads.googleads.v13.enums.types.AppCampaignAppStoreEnum.AppCampaignAppStore):
    ...
    class VanityPharma(proto.Message):
        ...
        Attributes:
            vanity_pharma_display_url_mode (google.ads.googleads.v13.enums.types.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlMode):
                The display mode for vanity pharma URLs.
            vanity_pharma_text (google.ads.googleads.v13.enums.types.VanityPharmaTextEnum.VanityPharmaText):
    ...
    class OptimizationGoalSetting(proto.Message):
        ...
        Attributes:
            optimization_goal_types (MutableSequence[google.ads.googleads.v13.enums.types.OptimizationGoalTypeEnum.OptimizationGoalType]):
    ...
    class LocalServicesCampaignSettings(proto.Message):
        ...
        Attributes:
            category_bids (MutableSequence[google.ads.googleads.v13.resources.types.Campaign.CategoryBid]):
