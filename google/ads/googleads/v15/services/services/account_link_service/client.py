...
class AccountLinkServiceClient(metaclass=AccountLinkServiceClientMeta):
    ...
    def create_account_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.CreateAccountLinkRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.CreateAccountLinkResponse:
    ...
    def mutate_account_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateAccountLinkRequest, dict, None]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (google.ads.googleads.v15.services.types.AccountLinkOperation):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateAccountLinkResponse:
