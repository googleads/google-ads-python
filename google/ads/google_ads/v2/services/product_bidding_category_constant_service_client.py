...
"""Accesses the google.ads.googleads.v2.services ProductBiddingCategoryConstantService API."""
...
from google.ads.google_ads.v2.services import product_bidding_category_constant_service_client_config
...
class ProductBiddingCategoryConstantServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.ProductBiddingCategoryConstantService'
    ...
    def get_product_bidding_category_constant(
        ...
        Args:
            resource_name (str): Resource name of the Product Bidding Category to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.ProductBiddingCategoryConstant` instance.
