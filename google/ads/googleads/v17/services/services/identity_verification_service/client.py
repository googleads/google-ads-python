...
from google.ads.googleads.v17.enums.types import identity_verification_program
...
class IdentityVerificationServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, IdentityVerificationServiceTransport]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, IdentityVerificationServiceTransport]]): The
        ...
        if isinstance(transport, IdentityVerificationServiceTransport):
    ...
    def start_identity_verification(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.StartIdentityVerificationRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            verification_program (google.ads.googleads.v17.enums.types.IdentityVerificationProgramEnum.IdentityVerificationProgram):
        ...
        has_flattened_params = any([customer_id, verification_program])
        ...
        # in a identity_verification_service.StartIdentityVerificationRequest.
    ...
    def get_identity_verification(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.GetIdentityVerificationRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v17.services.types.GetIdentityVerificationResponse:
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a identity_verification_service.GetIdentityVerificationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(
            request,
