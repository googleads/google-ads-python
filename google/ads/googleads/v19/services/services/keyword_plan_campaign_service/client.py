...
class KeywordPlanCampaignServiceClient(
    ...
    def mutate_keyword_plan_campaigns(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.MutateKeywordPlanCampaignsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v19.services.types.KeywordPlanCampaignOperation]):
        ...
        Returns:
            google.ads.googleads.v19.services.types.MutateKeywordPlanCampaignsResponse:
