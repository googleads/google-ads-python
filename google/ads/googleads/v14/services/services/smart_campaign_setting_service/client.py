...
class SmartCampaignSettingServiceClient(
    ...
    def get_smart_campaign_status(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.GetSmartCampaignStatusRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.GetSmartCampaignStatusResponse:
    ...
    def mutate_smart_campaign_settings(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateSmartCampaignSettingsResponse:
