...
from google.ads.googleads.v10.enums.types import hotel_reconciliation_status
...
class HotelReconciliation(proto.Message):
    ...
    Attributes:
        ...
        billed (bool):
            ...
            modified.
        status (google.ads.googleads.v10.enums.types.HotelReconciliationStatusEnum.HotelReconciliationStatus):
