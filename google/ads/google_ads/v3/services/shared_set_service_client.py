...
"""Accesses the google.ads.googleads.v3.services SharedSetService API."""
...
from google.ads.google_ads.v3.services import shared_set_service_client_config
from google.ads.google_ads.v3.services.transports import shared_set_service_grpc_transport
from google.ads.google_ads.v3.proto.services import shared_set_service_pb2
...
class SharedSetServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v3.services.SharedSetService'
    ...
    def get_shared_set(
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.SharedSet` instance.
    ...
    def mutate_shared_sets(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v3.types.SharedSetOperation]]): Required. The list of operations to perform on individual shared sets.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.SharedSetOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.MutateSharedSetsResponse` instance.
