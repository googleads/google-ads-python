...
from google.ads.googleads.v19.resources.types import Asset, CampaignAsset
...
def create_lead_form_asset(client: GoogleAdsClient, customer_id: str) -> str:
    ...
    input_type_enum: LeadFormFieldUserInputTypeEnum = (
...
def create_lead_form_campaign_asset(
    ...
    campaign_asset_service: CampaignAssetService = client.get_service(
        "CampaignAssetService"
    )
