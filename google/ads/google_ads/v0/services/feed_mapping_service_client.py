...
class FeedMappingServiceClient(object):
    ...
    def get_feed_mapping(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.FeedMapping` instance.
    ...
    def mutate_feed_mappings(self,
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v0.types.FeedMappingOperation]]): The list of operations to perform on individual feed mappings.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v0.types.FeedMappingOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.MutateFeedMappingsResponse` instance.
