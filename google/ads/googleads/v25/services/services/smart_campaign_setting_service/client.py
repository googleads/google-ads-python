...
class SmartCampaignSettingServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v25.services.SmartCampaignSettingServiceClient`.",
                    extra=(
                        {
    ...
    def get_smart_campaign_status(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.GetSmartCampaignStatusRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v25.services.types.GetSmartCampaignStatusResponse:
    ...
    def mutate_smart_campaign_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.MutateSmartCampaignSettingsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v25.services.types.MutateSmartCampaignSettingsResponse:
    ...
    def generate_p_max_draft_campaign(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.GeneratePMaxDraftCampaignRequest, dict]):
                The request object. Request message for
        ...
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[
            self._transport.generate_p_max_draft_campaign
        ]
