...
class GoogleAdsFieldServiceClient(metaclass=GoogleAdsFieldServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v19.services.GoogleAdsFieldServiceClient`.",
                    extra=(
                        {
    ...
    def get_google_ads_field(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GetGoogleAdsFieldRequest, dict]):
    ...
    def search_google_ads_fields(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.SearchGoogleAdsFieldsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v19.services.services.google_ads_field_service.pagers.SearchGoogleAdsFieldsPager:
