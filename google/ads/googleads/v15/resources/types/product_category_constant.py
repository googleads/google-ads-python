...
from google.ads.googleads.v15.enums.types import product_category_state
...
class ProductCategoryConstant(proto.Message):
    ...
    Attributes:
        ...
        state (google.ads.googleads.v15.enums.types.ProductCategoryStateEnum.ProductCategoryState):
            Output only. State of the product category.
        localizations (MutableSequence[google.ads.googleads.v15.resources.types.ProductCategoryConstant.ProductCategoryLocalization]):
