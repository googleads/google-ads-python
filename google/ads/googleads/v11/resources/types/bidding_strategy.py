...
from google.ads.googleads.v11.common.types import bidding
from google.ads.googleads.v11.enums.types import bidding_strategy_status
...
class BiddingStrategy(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v11.enums.types.BiddingStrategyStatusEnum.BiddingStrategyStatus):
        ...
        enhanced_cpc (google.ads.googleads.v11.common.types.EnhancedCpc):
        ...
        maximize_conversion_value (google.ads.googleads.v11.common.types.MaximizeConversionValue):
            An automated bidding strategy to help get the
            most conversion value for your campaigns while
            spending your budget.

            This field is a member of `oneof`_ ``scheme``.
        maximize_conversions (google.ads.googleads.v11.common.types.MaximizeConversions):
            An automated bidding strategy to help get the
            most conversions for your campaigns while
            spending your budget.

            This field is a member of `oneof`_ ``scheme``.
        target_cpa (google.ads.googleads.v11.common.types.TargetCpa):
        ...
        target_roas (google.ads.googleads.v11.common.types.TargetRoas):
            ...
            This field is a member of `oneof`_ ``scheme``.
        target_spend (google.ads.googleads.v11.common.types.TargetSpend):
