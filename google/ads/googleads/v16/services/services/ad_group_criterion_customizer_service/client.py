...
class AdGroupCriterionCustomizerServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, AdGroupCriterionCustomizerServiceTransport]]): The
    ...
    def mutate_ad_group_criterion_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateAdGroupCriterionCustomizersRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateAdGroupCriterionCustomizersResponse:
