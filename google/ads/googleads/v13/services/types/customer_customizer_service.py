...
class CustomerCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v13.resources.types.CustomerCustomizer):
...
class MutateCustomerCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v13.services.types.MutateCustomerCustomizerResult]):
