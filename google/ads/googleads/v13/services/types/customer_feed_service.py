...
class MutateCustomerFeedsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v13.services.types.CustomerFeedOperation]):
...
class CustomerFeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v13.resources.types.CustomerFeed):
            Create operation: No resource name is
            expected for the new customer feed.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v13.resources.types.CustomerFeed):
...
class MutateCustomerFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v13.services.types.MutateCustomerFeedResult]):
