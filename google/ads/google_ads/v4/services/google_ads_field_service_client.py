...
"""Accesses the google.ads.googleads.v4.services GoogleAdsFieldService API."""
...
from google.ads.google_ads.v4.services import google_ads_field_service_client_config
from google.ads.google_ads.v4.services.transports import google_ads_field_service_grpc_transport
from google.ads.google_ads.v4.proto.services import google_ads_field_service_pb2
...
class GoogleAdsFieldServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v4.services.GoogleAdsFieldService'
    ...
    def get_google_ads_field(
        ...
        Returns:
            A :class:`~google.ads.googleads_v4.types.GoogleAdsField` instance.
    ...
    def search_google_ads_fields(
        ...
        Returns:
            ...
            is an iterable of :class:`~google.ads.googleads_v4.types.GoogleAdsField` instances.
