...
"""Accesses the google.ads.googleads.v2.services TopicViewService API."""
...
from google.ads.google_ads.v2.services import topic_view_service_client_config
...
class TopicViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.TopicViewService'
    ...
    def get_topic_view(
        ...
        Args:
            resource_name (str): The resource name of the topic view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.TopicView` instance.
