...
class BiddingSeasonalityAdjustmentServiceClient(
    ...
    def mutate_bidding_seasonality_adjustments(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateBiddingSeasonalityAdjustmentsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateBiddingSeasonalityAdjustmentsResponse:
