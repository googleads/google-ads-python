...
class FeedItemServiceClient(metaclass=FeedItemServiceClientMeta):
    ...
    def get_feed_item(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetFeedItemRequest`):
        ...
        Returns:
            google.ads.googleads.v8.resources.types.FeedItem:
                A feed item.
        """
    ...
    def mutate_feed_items(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateFeedItemsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.FeedItemOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateFeedItemsResponse:
