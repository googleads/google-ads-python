...
from google.ads.googleads.v19.common.types import asset_policy
...
from google.ads.googleads.v19.enums.types import asset_link_primary_status
from google.ads.googleads.v19.enums.types import (
    asset_link_primary_status_reason,
)
from google.ads.googleads.v19.enums.types import asset_link_status
from google.ads.googleads.v19.enums.types import asset_performance_label
from google.ads.googleads.v19.enums.types import asset_source
...
class AssetGroupAsset(proto.Message):
    ...
    Attributes:
        ...
        asset (str):
            ...
            asset is linking.
        field_type (google.ads.googleads.v19.enums.types.AssetFieldTypeEnum.AssetFieldType):
            The description of the placement of the asset within the
            asset group. For example: HEADLINE, YOUTUBE_VIDEO etc
        status (google.ads.googleads.v19.enums.types.AssetLinkStatusEnum.AssetLinkStatus):
            The status of the link between an asset and
            asset group.
        primary_status (google.ads.googleads.v19.enums.types.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus):
        ...
        primary_status_reasons (MutableSequence[google.ads.googleads.v19.enums.types.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason]):
            Output only. Provides a list of reasons for
            why an asset is not serving or not serving at
            full capacity.
        primary_status_details (MutableSequence[google.ads.googleads.v19.common.types.AssetLinkPrimaryStatusDetails]):
            Output only. Provides the details of the
            primary status and its associated reasons.
        performance_label (google.ads.googleads.v19.enums.types.AssetPerformanceLabelEnum.AssetPerformanceLabel):
            Output only. The performance of this asset
            group asset.
        policy_summary (google.ads.googleads.v19.common.types.PolicySummary):
