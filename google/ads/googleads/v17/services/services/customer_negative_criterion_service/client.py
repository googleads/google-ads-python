...
class CustomerNegativeCriterionServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, CustomerNegativeCriterionServiceTransport]]): The
    ...
    def mutate_customer_negative_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateCustomerNegativeCriteriaRequest, dict, None]):
