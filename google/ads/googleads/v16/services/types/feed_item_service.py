...
class MutateFeedItemsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v16.services.types.FeedItemOperation]):
    ...
    operations: MutableSequence["FeedItemOperation"] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
...
class FeedItemOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v16.resources.types.FeedItem):
            Create operation: No resource name is
            expected for the new feed item.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v16.resources.types.FeedItem):
    ...
    create: gagr_feed_item.FeedItem = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
        message=gagr_feed_item.FeedItem,
    )
    update: gagr_feed_item.FeedItem = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_feed_item.FeedItem,
...
class MutateFeedItemsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v16.services.types.MutateFeedItemResult]):
    ...
    results: MutableSequence["MutateFeedItemResult"] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
