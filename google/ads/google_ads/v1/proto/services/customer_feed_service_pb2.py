...
# source: google/ads/googleads_v1/proto/services/customer_feed_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v1/proto/services/customer_feed_service.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads__v1_dot_proto_dot_resources_dot_customer__feed__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_protobuf_dot_field__mask__pb2.DESCRIPTOR,google_dot_protobuf_dot_wrappers__pb2.DESCRIPTOR,google_dot_rpc_dot_status__pb2.DESCRIPTOR,])
...
_CUSTOMERFEEDOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v1_dot_proto_dot_resources_dot_customer__feed__pb2._CUSTOMERFEED
_CUSTOMERFEEDOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v1_dot_proto_dot_resources_dot_customer__feed__pb2._CUSTOMERFEED
...
GetCustomerFeedRequest = _reflection.GeneratedProtocolMessageType('GetCustomerFeedRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v1.proto.services.customer_feed_service_pb2'
  ,
...
_CUSTOMERFEEDSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v1_dot_proto_dot_resources_dot_customer__feed__pb2._CUSTOMERFEED,
    serialized_options=_b('\202\323\344\223\0021\022//v1/{resource_name=customers/*/customerFeeds/*}'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0027\"2/v1/customers/{customer_id=*}/customerFeeds:mutate:\001*'),
  ),
])
