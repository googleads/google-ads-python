...
class AdGroupExtensionSettingServiceGrpcAsyncIOTransport(
    AdGroupExtensionSettingServiceTransport
):
    """gRPC AsyncIO backend transport for AdGroupExtensionSettingService.
    ...
    def mutate_ad_group_extension_settings(
        ...
        Returns:
            Callable[[~.MutateAdGroupExtensionSettingsRequest],
                    Awaitable[~.MutateAdGroupExtensionSettingsResponse]]:
        ...
        if "mutate_ad_group_extension_settings" not in self._stubs:
            self._stubs["mutate_ad_group_extension_settings"] = (
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_ad_group_extension_settings: self._wrap_method(
...
__all__ = ("AdGroupExtensionSettingServiceGrpcAsyncIOTransport",)
