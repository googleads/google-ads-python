...
from google.ads.googleads.v18.enums.types import account_budget_proposal_type
from google.ads.googleads.v18.enums.types import account_budget_status
from google.ads.googleads.v18.enums.types import (
    spending_limit_type as gage_spending_limit_type,
)
from google.ads.googleads.v18.enums.types import time_type
...
class AccountBudget(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v18.enums.types.AccountBudgetStatusEnum.AccountBudgetStatus):
        ...
        pending_proposal (google.ads.googleads.v18.resources.types.AccountBudget.PendingAccountBudgetProposal):
        ...
        proposed_end_time_type (google.ads.googleads.v18.enums.types.TimeTypeEnum.TimeType):
        ...
        approved_end_time_type (google.ads.googleads.v18.enums.types.TimeTypeEnum.TimeType):
        ...
        proposed_spending_limit_type (google.ads.googleads.v18.enums.types.SpendingLimitTypeEnum.SpendingLimitType):
        ...
        approved_spending_limit_type (google.ads.googleads.v18.enums.types.SpendingLimitTypeEnum.SpendingLimitType):
        ...
        adjusted_spending_limit_type (google.ads.googleads.v18.enums.types.SpendingLimitTypeEnum.SpendingLimitType):
    ...
    class PendingAccountBudgetProposal(proto.Message):
        ...
        Attributes:
            ...
            proposal_type (google.ads.googleads.v18.enums.types.AccountBudgetProposalTypeEnum.AccountBudgetProposalType):
            ...
            end_time_type (google.ads.googleads.v18.enums.types.TimeTypeEnum.TimeType):
            ...
            spending_limit_type (google.ads.googleads.v18.enums.types.SpendingLimitTypeEnum.SpendingLimitType):
        ...
        end_date_time: str = proto.Field(
            proto.STRING, number=15, oneof="end_time",
        )
    ...
    id: int = proto.Field(
        proto.INT64, number=23, optional=True,
    )
    ...
    total_adjustments_micros: int = proto.Field(
        proto.INT64, number=33,
    )
    amount_served_micros: int = proto.Field(
        proto.INT64, number=34,
    )
    purchase_order_number: str = proto.Field(
