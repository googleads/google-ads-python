...
class AdGroupCriterionCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v13.resources.types.AdGroupCriterionCustomizer):
...
class MutateAdGroupCriterionCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v13.services.types.MutateAdGroupCriterionCustomizerResult]):
