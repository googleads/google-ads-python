...
from google.ads.google_ads.v6.proto.services import campaign_criterion_simulation_service_pb2_grpc


class CampaignCriterionSimulationServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v6.services CampaignCriterionSimulationService API.
