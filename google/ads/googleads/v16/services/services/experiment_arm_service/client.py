...
class ExperimentArmServiceClient(metaclass=ExperimentArmServiceClientMeta):
    ...
    def mutate_experiment_arms(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateExperimentArmsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v16.services.types.ExperimentArmOperation]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateExperimentArmsResponse:
