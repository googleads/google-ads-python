...
from google.ads.googleads.v25.common.types import audience_insights_attribute
from google.ads.googleads.v25.common.types import criteria
from google.ads.googleads.v25.enums.types import (
    content_creator_insights_supplemental_data,
)
from google.ads.googleads.v25.enums.types import insights_trend
from google.ads.googleads.v25.enums.types import partnership_opportunity
from google.ads.googleads.v25.enums.types import sentiment as gage_sentiment
...
class GenerateCreatorInsightsRequest(proto.Message):
    ...
    Attributes:
        ...
        insights_application_info (google.ads.googleads.v25.common.types.AdditionalApplicationInfo):
            Optional. Additional information on the
            application issuing the request.
        country_locations (MutableSequence[google.ads.googleads.v25.common.types.LocationInfo]):
            Required. The countries to search that apply
            to the criteria.
        sub_country_locations (MutableSequence[google.ads.googleads.v25.common.types.LocationInfo]):
            ...
            criteria.
        supplemental_data (MutableSequence[google.ads.googleads.v25.enums.types.ContentCreatorInsightsSupplementalDataEnum.ContentCreatorInsightsSupplementalData]):
            Optional. Optional features to include in the
            response. By default, only core insight data is
            returned. Including supplemental data here will
            populate additional fields in the response.
        search_attributes (google.ads.googleads.v25.services.types.GenerateCreatorInsightsRequest.SearchAttributes):
        ...
        search_channels (google.ads.googleads.v25.services.types.GenerateCreatorInsightsRequest.YouTubeChannels):
            ...
            This field is a member of `oneof`_ ``criteria``.
        search_topics (google.ads.googleads.v25.services.types.SearchTopics):
            Search for relevant creators who make content about the
            specified topics. Data fetched is based on the country
            specified in
            [country_locations][google.ads.googleads.v25.services.GenerateCreatorInsightsRequest.country_locations].
    ...
    class SearchAttributes(proto.Message):
        ...
        Attributes:
            audience_attributes (MutableSequence[google.ads.googleads.v25.common.types.AudienceInsightsAttribute]):
            ...
            audience_combinations (MutableSequence[google.ads.googleads.v25.common.types.InsightsAudienceAttributeGroup]):
            ...
            creator_attributes (MutableSequence[google.ads.googleads.v25.common.types.AudienceInsightsAttribute]):
    ...
    supplemental_data: MutableSequence[
        content_creator_insights_supplemental_data.ContentCreatorInsightsSupplementalDataEnum.ContentCreatorInsightsSupplementalData
    ] = proto.RepeatedField(
        proto.ENUM,
        number=10,
        enum=content_creator_insights_supplemental_data.ContentCreatorInsightsSupplementalDataEnum.ContentCreatorInsightsSupplementalData,
    )
...
class GenerateCreatorInsightsResponse(proto.Message):
    ...
    Attributes:
        creator_insights (MutableSequence[google.ads.googleads.v25.services.types.YouTubeCreatorInsights]):
            A collection of YouTube Creators, each
            containing a collection of YouTube Channels
            maintained by the YouTube Creator.
        local_creator_insights (MutableSequence[google.ads.googleads.v25.services.types.YouTubeCreatorInsights]):
            Local creators for this topic who have consented to share
            their location data. Local creators refers to creators that
            are based in or post from the chosen country and are viewed
            in the chosen country. Only populated when all of the
            following are true:
...
class GenerateTrendingInsightsRequest(proto.Message):
    ...
    Attributes:
        ...
        insights_application_info (google.ads.googleads.v25.common.types.AdditionalApplicationInfo):
            Optional. Additional information on the
            application issuing the request.
        country_location (google.ads.googleads.v25.common.types.LocationInfo):
            Required. The country to find trends in.
        sub_country_locations (MutableSequence[google.ads.googleads.v25.common.types.LocationInfo]):
            Optional. The sub-country geographic locations to search
            that apply to the criteria. Only supported for
            ``search_audience`` criteria.
        supplemental_data (MutableSequence[google.ads.googleads.v25.enums.types.ContentCreatorInsightsSupplementalDataEnum.ContentCreatorInsightsSupplementalData]):
            Optional. Optional features to include in the
            response. By default, only core insight data is
            returned. Including supplemental data here will
            populate additional fields in the response.
        search_audience (google.ads.googleads.v25.services.types.SearchAudience):
            An audience to search for trending content in. Data fetched
            is based on the country or sub-country locations specified
            in
...
class GenerateTrendingInsightsResponse(proto.Message):
    ...
    Attributes:
        trend_insights (MutableSequence[google.ads.googleads.v25.services.types.TrendInsight]):
...
class YouTubeCreatorInsights(proto.Message):
    ...
    Attributes:
        ...
        creator_channels (MutableSequence[google.ads.googleads.v25.services.types.YouTubeChannelInsights]):
...
class YouTubeMetrics(proto.Message):
    ...
    Attributes:
        ...
        partnership_opportunities (MutableSequence[google.ads.googleads.v25.enums.types.PartnershipOpportunityEnum.PartnershipOpportunity]):
...
class YouTubeChannelInsights(proto.Message):
    ...
    Attributes:
        ...
        youtube_channel (google.ads.googleads.v25.common.types.YouTubeChannelInfo):
        ...
        country_location (google.ads.googleads.v25.common.types.LocationInfo):
            ...
            associated.
        channel_metrics (google.ads.googleads.v25.services.types.YouTubeMetrics):
        ...
        data_sharing_consent_given (bool):
            ...
            Non-public data includes
            ``YouTubeMetrics.average_view_per_video``,
        ...
        channel_audience_attributes (MutableSequence[google.ads.googleads.v25.common.types.AudienceInsightsAttributeMetadata]):
        ...
        channel_attributes (MutableSequence[google.ads.googleads.v25.common.types.AudienceInsightsAttributeMetadata]):
            The attributes associated with the content
            made by a channel.
        top_videos (MutableSequence[google.ads.googleads.v25.common.types.AudienceInsightsAttributeMetadata]):
            The top 10 videos for the channel.
        language_distributions (MutableSequence[google.ads.googleads.v25.services.types.LanguageDistribution]):
    ...
    data_sharing_consent_given: bool = proto.Field(
        proto.BOOL,
        number=18,
    )
...
class SearchTopics(proto.Message):
    r"""A collection of content topics to return creator and trend
    information for.

    Attributes:
        entities (MutableSequence[google.ads.googleads.v25.common.types.AudienceInsightsEntity]):
            Required. A list of knowledge graph entities to retrieve
            creator and trend information for. Supported entities are
            tagged with
...
class TrendInsight(proto.Message):
    ...
    Attributes:
        trend_attribute (google.ads.googleads.v25.common.types.AudienceInsightsAttributeMetadata):
            The attribute this trend is for.
        trend_metrics (google.ads.googleads.v25.services.types.TrendInsightMetrics):
            Metrics associated with this trend. These
            metrics are for the latest available month and
            the comparison period is 3 months.
        trend (google.ads.googleads.v25.enums.types.InsightsTrendEnum.InsightsTrend):
            Indicate if a trend is sustained or emerging. Use
            trend_metrics.trend_change_percent to determine the
            direction of the trend.
        trend_data_points (MutableSequence[google.ads.googleads.v25.services.types.TrendInsightDataPoint]):
            ...
            search_topics.
        brand_sentiment_insights (MutableSequence[google.ads.googleads.v25.services.types.BrandSentimentInsight]):
            The brand sentiment for this topic. Only populated when all
            ...
            - Supplemental data
              ...
              is requested.
        related_videos (MutableSequence[google.ads.googleads.v25.common.types.AudienceInsightsAttributeMetadata]):
            Related videos for this topic. Only populated for trends
            using search_topics.
        related_creators (MutableSequence[google.ads.googleads.v25.services.types.YouTubeCreatorInsights]):
            Related creators for this topic. Only populated for trends
            using search_topics.
        related_local_creators (MutableSequence[google.ads.googleads.v25.services.types.YouTubeCreatorInsights]):
            Related local creators for this topic who have consented to
            share their location data. Related local creators refers to
            creators that are based in or post from the chosen country
            and are viewed in the chosen country. Only populated when
...
class BrandSentimentInsight(proto.Message):
    r"""Brand sentiment for a specific month. Measuring brand
    sentiment involves using AI models to analyze YouTube video
    content related to the brand, categorizing the sentiment as
    positive, negative, or neutral. Only the video content itself is
    analyzed; user comments are not included. The AI models are
    powered by Gemini and can make mistakes.

    Attributes:
        month (str):
            The month that the brand sentiment represents
            in the string format "YYYY-MM".
        has_insufficient_data (bool):
            When true, there is insufficient data to
            calculate the brand sentiment.
        sentiment_distributions (MutableSequence[google.ads.googleads.v25.services.types.SentimentInsightDistribution]):
            Distribution of sentiment between positive,
            negative, and neutral.
        sentiment_summaries (MutableSequence[google.ads.googleads.v25.services.types.SentimentInsightSummary]):
            A summary of what was positive and negative
            about content related to the brand. No summaries
            are generated for neutral sentiment. The summary
    ...
    has_insufficient_data: bool = proto.Field(
        proto.BOOL,
        number=2,
    )
    sentiment_distributions: MutableSequence["SentimentInsightDistribution"] = (
        proto.RepeatedField(
            proto.MESSAGE,
            number=3,
            message="SentimentInsightDistribution",
        )
    )
    sentiment_summaries: MutableSequence["SentimentInsightSummary"] = (
        proto.RepeatedField(
            proto.MESSAGE,
            number=4,
            message="SentimentInsightSummary",
        )
    )


class SentimentInsightDistribution(proto.Message):
    r"""The distribution of sentiment for a brand. The distribution
    is calculated as the proportion of views for videos that
    correspond to the brand with each sentiment. Example: positive
    sentiment share of 0.49 means that 49% of views about this brand
    were on content with positive sentiment.
    ...
    Attributes:
        ...
        sentiment_share (float):
            The proportion (between 0 and 1) of views for
            videos that correspond to the brand with this
            sentiment.
    """

    sentiment: gage_sentiment.SentimentEnum.Sentiment = proto.Field(
        proto.ENUM,
        number=1,
        enum=gage_sentiment.SentimentEnum.Sentiment,
    )
    sentiment_share: float = proto.Field(
        proto.DOUBLE,
        number=2,
    )
...
class SentimentInsightSummary(proto.Message):
    r"""A summary of the sentiment for content related to a brand.
    Summaries are only generated for positive and negative
    sentiment, not neutral. The summary is generated by AI models.

    Attributes:
        sentiment (google.ads.googleads.v25.enums.types.SentimentEnum.Sentiment):
            The sentiment for this summary.
        summary (str):
            A summary of what was positive or negative
            about content related to the brand.
        sample_videos (MutableSequence[google.ads.googleads.v25.common.types.AudienceInsightsAttributeMetadata]):
            Sample videos that correspond to the
            sentiment.
    """
