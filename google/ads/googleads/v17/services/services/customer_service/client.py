...
class CustomerServiceClient(metaclass=CustomerServiceClientMeta):
    ...
    def mutate_customer(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateCustomerRequest, dict, None]):
    ...
    def list_accessible_customers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.ListAccessibleCustomersRequest, dict, None]):
                The request object. Request message for
    ...
    def create_customer_client(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.CreateCustomerClientRequest, dict, None]):
                The request object. Request message for
