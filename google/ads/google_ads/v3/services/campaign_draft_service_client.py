...
"""Accesses the google.ads.googleads.v3.services CampaignDraftService API."""
...
from google.ads.google_ads.v3.services import campaign_draft_service_client_config
from google.ads.google_ads.v3.services.transports import campaign_draft_service_grpc_transport
from google.ads.google_ads.v3.proto.services import campaign_draft_service_pb2
...
class CampaignDraftServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v3.services.CampaignDraftService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=campaign_draft_service_grpc_transport.CampaignDraftServiceGrpcTransport,
                )
            else:
                if credentials:
                    raise ValueError(
    ...
    def get_campaign_draft(
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.CampaignDraft` instance.
        ...
        if 'get_campaign_draft' not in self._inner_api_calls:
            self._inner_api_calls['get_campaign_draft'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_campaign_draft,
                default_retry=self._method_configs['GetCampaignDraft'].retry,
                default_timeout=self._method_configs['GetCampaignDraft'].timeout,
        ...
        return self._inner_api_calls['get_campaign_draft'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def mutate_campaign_drafts(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v3.types.CampaignDraftOperation]]): Required. The list of operations to perform on individual campaign drafts.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.CampaignDraftOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.MutateCampaignDraftsResponse` instance.
        ...
        if 'mutate_campaign_drafts' not in self._inner_api_calls:
            self._inner_api_calls['mutate_campaign_drafts'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.mutate_campaign_drafts,
                default_retry=self._method_configs['MutateCampaignDrafts'].retry,
                default_timeout=self._method_configs['MutateCampaignDrafts'].timeout,
                client_info=self._client_info,
            )
        ...
        return self._inner_api_calls['mutate_campaign_drafts'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def promote_campaign_draft(
        ...
        if 'promote_campaign_draft' not in self._inner_api_calls:
            self._inner_api_calls['promote_campaign_draft'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.promote_campaign_draft,
                default_retry=self._method_configs['PromoteCampaignDraft'].retry,
                default_timeout=self._method_configs['PromoteCampaignDraft'].timeout,
                client_info=self._client_info,
            )
        ...
        metadata = list(metadata)
        try:
            routing_header = [('campaign_draft', campaign_draft)]
        except AttributeError:
            pass
        else:
            routing_metadata = google.api_core.gapic_v1.routing_header.to_grpc_metadata(routing_header)
        ...
        operation = self._inner_api_calls['promote_campaign_draft'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def list_campaign_draft_async_errors(
        ...
        Returns:
            ...
            is an iterable of :class:`~google.ads.googleads_v3.types.Status` instances.
        ...
        if 'list_campaign_draft_async_errors' not in self._inner_api_calls:
            self._inner_api_calls['list_campaign_draft_async_errors'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.list_campaign_draft_async_errors,
                default_retry=self._method_configs['ListCampaignDraftAsyncErrors'].retry,
                default_timeout=self._method_configs['ListCampaignDraftAsyncErrors'].timeout,
                client_info=self._client_info,
            )
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            client=None,
            method=functools.partial(self._inner_api_calls['list_campaign_draft_async_errors'], retry=retry, timeout=timeout, metadata=metadata),
            request=request,
            items_field='errors',
