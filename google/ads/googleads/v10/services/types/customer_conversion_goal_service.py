...
from google.ads.googleads.v10.resources.types import customer_conversion_goal
...
class MutateCustomerConversionGoalsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v10.services.types.CustomerConversionGoalOperation]):
...
class CustomerConversionGoalOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v10.resources.types.CustomerConversionGoal):
...
class MutateCustomerConversionGoalsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v10.services.types.MutateCustomerConversionGoalResult]):
