...
class AdGroupAdServiceClient(metaclass=AdGroupAdServiceClientMeta):
    ...
    def mutate_ad_group_ads(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateAdGroupAdsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateAdGroupAdsResponse:
