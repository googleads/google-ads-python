...
from google.ads.googleads.v11.common.types import audiences
from google.ads.googleads.v11.enums.types import audience_status
...
class Audience(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v11.enums.types.AudienceStatusEnum.AudienceStatus):
        ...
        dimensions (Sequence[google.ads.googleads.v11.common.types.AudienceDimension]):
            Positive dimensions specifying the audience
            composition.
        exclusion_dimension (google.ads.googleads.v11.common.types.AudienceExclusionDimension):
