...
"""Accesses the google.ads.googleads.v2.services UserInterestService API."""
...
from google.ads.google_ads.v2.services import user_interest_service_client_config
...
class UserInterestServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.UserInterestService'
    ...
    def get_user_interest(
        ...
        Args:
            resource_name (str): Resource name of the UserInterest to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.UserInterest` instance.
