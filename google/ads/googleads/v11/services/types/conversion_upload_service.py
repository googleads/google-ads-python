...
from google.ads.googleads.v11.common.types import offline_user_data
from google.ads.googleads.v11.enums.types import conversion_environment_enum
...
class UploadClickConversionsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            the upload.
        conversions (Sequence[google.ads.googleads.v11.services.types.ClickConversion]):
...
class UploadCallConversionsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer performing
            the upload.
        conversions (Sequence[google.ads.googleads.v11.services.types.CallConversion]):
            Required. The conversions that are being
            uploaded.
        partial_failure (bool):
            Required. If true, successful operations will
...
class ClickConversion(proto.Message):
    ...
    Attributes:
        ...
        external_attribution_data (google.ads.googleads.v11.services.types.ExternalAttributionData):
            ...
            otherwise.
        custom_variables (Sequence[google.ads.googleads.v11.services.types.CustomVariable]):
            The custom variables associated with this
            conversion.
        cart_data (google.ads.googleads.v11.services.types.CartData):
...
class CartData(proto.Message):
    ...
    Attributes:
        ...
        items (Sequence[google.ads.googleads.v11.services.types.CartData.Item]):
