...
from google.ads.googleads.v16.resources.types import billing_setup
...
class BillingSetupOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v16.resources.types.BillingSetup):
...
class MutateBillingSetupResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v16.services.types.MutateBillingSetupResult):
