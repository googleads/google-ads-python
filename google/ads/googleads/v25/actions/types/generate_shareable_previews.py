...
__protobuf__ = proto.module(
    package="google.ads.googleads.v25.actions",
...
class GenerateShareablePreviewsOperation(proto.Message):
    ...
    Attributes:
        shareable_previews (MutableSequence[google.ads.googleads.v25.actions.types.ShareablePreview]):
...
class ShareablePreview(proto.Message):
    ...
    Attributes:
        preview_type (google.ads.googleads.v25.enums.types.PreviewTypeEnum.PreviewType):
...
class GenerateShareablePreviewsResult(proto.Message):
    ...
    Attributes:
        previews (MutableSequence[google.ads.googleads.v25.actions.types.ShareablePreviewResult]):
            List of previews.
    """
...
class ShareablePreviewResult(proto.Message):
    ...
    Attributes:
        expiration_date_time (str):
            ...
            format.
        ui_preview_result (google.ads.googleads.v25.actions.types.UiPreviewResult):
            The result of a UI preview. Only populated for preview type
            UI_PREVIEW.

            This field is a member of `oneof`_ ``result``.
        youtube_live_preview_result (google.ads.googleads.v25.actions.types.YouTubeLivePreviewResult):
