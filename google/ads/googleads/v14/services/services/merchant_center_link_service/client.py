...
class MerchantCenterLinkServiceClient(
    ...
    def list_merchant_center_links(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.ListMerchantCenterLinksRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.ListMerchantCenterLinksResponse:
    ...
    def get_merchant_center_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.GetMerchantCenterLinkRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v14.resources.types.MerchantCenterLink:
    ...
    def mutate_merchant_center_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateMerchantCenterLinkRequest, dict, None]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (google.ads.googleads.v14.services.types.MerchantCenterLinkOperation):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateMerchantCenterLinkResponse:
