...
"""Accesses the google.ads.googleads.v1.services AdGroupAdLabelService API."""
...
from google.ads.google_ads.v1.services import ad_group_ad_label_service_client_config
...
class AdGroupAdLabelServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.AdGroupAdLabelService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=ad_group_ad_label_service_grpc_transport.
    ...
    def get_ad_group_ad_label(self,
        ...
        if 'get_ad_group_ad_label' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_ad_group_ad_label'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_ad_group_ad_label,
                    default_retry=self._method_configs['GetAdGroupAdLabel'].
                    retry,
                    default_timeout=self._method_configs['GetAdGroupAdLabel'].
                    timeout,
        ...
        return self._inner_api_calls['get_ad_group_ad_label'](
    ...
    def mutate_ad_group_ad_labels(
        ...
        if 'mutate_ad_group_ad_labels' not in self._inner_api_calls:
            self._inner_api_calls[
                'mutate_ad_group_ad_labels'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.mutate_ad_group_ad_labels,
                    default_retry=self.
                    _method_configs['MutateAdGroupAdLabels'].retry,
                    default_timeout=self.
                    _method_configs['MutateAdGroupAdLabels'].timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['mutate_ad_group_ad_labels'](
            request, retry=retry, timeout=timeout, metadata=metadata)
