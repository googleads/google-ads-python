...
class AdGroupCriterionServiceClient(
    ...
    def mutate_ad_group_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateAdGroupCriteriaRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v18.services.types.MutateAdGroupCriteriaResponse:
