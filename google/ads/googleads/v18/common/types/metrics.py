...
from google.ads.googleads.v18.enums.types import interaction_event_type
...
__protobuf__ = proto.module(
    ...
    manifest={"Metrics", "SearchVolumeRange",},
)
...
class Metrics(proto.Message):
    ...
    Attributes:
        ...
        historical_creative_quality_score (google.ads.googleads.v18.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
            The creative historical quality score.
        historical_landing_page_quality_score (google.ads.googleads.v18.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
        ...
        historical_search_predicted_ctr (google.ads.googleads.v18.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
        ...
        interaction_event_types (MutableSequence[google.ads.googleads.v18.enums.types.InteractionEventTypeEnum.InteractionEventType]):
        ...
        search_volume (google.ads.googleads.v18.common.types.SearchVolumeRange):
    ...
    all_conversions_value_by_conversion_date: float = proto.Field(
        proto.DOUBLE, number=240, optional=True,
    )
    all_new_customer_lifetime_value: float = proto.Field(
        proto.DOUBLE, number=294, optional=True,
    )
    ...
    all_conversions_by_conversion_date: float = proto.Field(
        proto.DOUBLE, number=241, optional=True,
    )
    ...
    conversions_value_by_conversion_date: float = proto.Field(
        proto.DOUBLE, number=242, optional=True,
    )
    new_customer_lifetime_value: float = proto.Field(
        proto.DOUBLE, number=293, optional=True,
    )
    ...
    conversions_by_conversion_date: float = proto.Field(
        proto.DOUBLE, number=243, optional=True,
    )
    ...
    cross_device_conversions_value_micros: int = proto.Field(
        proto.INT64, number=312, optional=True,
    )
    ...
    general_invalid_click_rate: float = proto.Field(
        proto.DOUBLE, number=370, optional=True,
    )
    general_invalid_clicks: int = proto.Field(
        proto.INT64, number=371, optional=True,
    )
    ...
    search_volume: "SearchVolumeRange" = proto.Field(
        proto.MESSAGE, number=295, optional=True, message="SearchVolumeRange",
    )
