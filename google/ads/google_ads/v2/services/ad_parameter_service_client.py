...
"""Accesses the google.ads.googleads.v2.services AdParameterService API."""
...
class AdParameterServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.AdParameterService'
    ...
    def get_ad_parameter(
        ...
        Args:
            resource_name (str): The resource name of the ad parameter to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.AdParameter` instance.
    ...
    def mutate_ad_parameters(
        ...
        Args:
            customer_id (str): The ID of the customer whose ad parameters are being modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.AdParameterOperation]]): The list of operations to perform on individual ad parameters.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.AdParameterOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateAdParametersResponse` instance.
