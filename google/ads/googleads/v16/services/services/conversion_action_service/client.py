...
class ConversionActionServiceClient(
    ...
    def mutate_conversion_actions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateConversionActionsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v16.services.types.ConversionActionOperation]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateConversionActionsResponse:
