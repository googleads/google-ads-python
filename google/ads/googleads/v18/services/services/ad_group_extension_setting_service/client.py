...
from .transports.grpc_asyncio import (
    AdGroupExtensionSettingServiceGrpcAsyncIOTransport,
)
...
class AdGroupExtensionSettingServiceClient(
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                AdGroupExtensionSettingServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = AdGroupExtensionSettingServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = AdGroupExtensionSettingServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = AdGroupExtensionSettingServiceClient._read_environment_variables()
        self._client_cert_source = (
            AdGroupExtensionSettingServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            AdGroupExtensionSettingServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, AdGroupExtensionSettingServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                AdGroupExtensionSettingServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or AdGroupExtensionSettingServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v18.services.AdGroupExtensionSettingServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_ad_group_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateAdGroupExtensionSettingsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v18.services.types.AdGroupExtensionSettingOperation]):
