...
class CampaignAssetServiceClient(metaclass=CampaignAssetServiceClientMeta):
    ...
    def mutate_campaign_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateCampaignAssetsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v15.services.types.CampaignAssetOperation]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateCampaignAssetsResponse:
