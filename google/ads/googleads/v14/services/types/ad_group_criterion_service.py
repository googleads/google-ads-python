...
class MutateAdGroupCriteriaRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            are being modified.
        operations (MutableSequence[google.ads.googleads.v14.services.types.AdGroupCriterionOperation]):
...
class AdGroupCriterionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v14.resources.types.AdGroupCriterion):
...
class MutateAdGroupCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v14.services.types.MutateAdGroupCriterionResult]):
