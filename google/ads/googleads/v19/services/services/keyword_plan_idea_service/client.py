...
class KeywordPlanIdeaServiceClient(metaclass=KeywordPlanIdeaServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v19.services.KeywordPlanIdeaServiceClient`.",
                    extra=(
                        {
    ...
    def generate_keyword_ideas(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GenerateKeywordIdeasRequest, dict]):
    ...
    def generate_keyword_historical_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GenerateKeywordHistoricalMetricsRequest, dict]):
                The request object. Request message for
    ...
    def generate_ad_group_themes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GenerateAdGroupThemesRequest, dict]):
                The request object. Request message for
    ...
    def generate_keyword_forecast_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GenerateKeywordForecastMetricsRequest, dict]):
                The request object. Request message for
