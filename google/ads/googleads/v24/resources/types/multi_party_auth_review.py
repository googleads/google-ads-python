...
from google.ads.googleads.v24.enums.types import multi_party_auth_operation_type
from google.ads.googleads.v24.enums.types import multi_party_auth_review_status
...
class MultiPartyAuthReview(proto.Message):
    ...
    Attributes:
        ...
        review_status (google.ads.googleads.v24.enums.types.MultiPartyAuthReviewStatusEnum.MultiPartyAuthReviewStatus):
        ...
        operation_type (google.ads.googleads.v24.enums.types.MultiPartyAuthOperationTypeEnum.MultiPartyAuthOperationType):
            Output only. The operation type of the
            Multi-Party Authorization review.
        target_resource (google.ads.googleads.v24.enums.types.MultiPartyAuthReviewTargetResourceEnum.MultiPartyAuthReviewTargetResource):
            Output only. The target resource for which
            Multi-Party Authorization is requested.
        customer_user_access_review (google.ads.googleads.v24.resources.types.CustomerUserAccessReview):
            Output only. The CustomerUserAccess details.

            This field is a member of `oneof`_ ``multi_party_review_detail``.
        customer_user_access_invitation_review (google.ads.googleads.v24.resources.types.CustomerUserAccessInvitationReview):
...
class CustomerUserAccessReview(proto.Message):
    ...
    Attributes:
        ...
        new_customer_user_access (google.ads.googleads.v24.resources.types.CustomerUserAccess):
...
class CustomerUserAccessInvitationReview(proto.Message):
    ...
    Attributes:
        new_customer_user_access_invitation (google.ads.googleads.v24.resources.types.CustomerUserAccessInvitation):
            Output only. The new
