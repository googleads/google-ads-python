...
from google.ads.googleads.v16.common.types import consent as gagc_consent
from google.ads.googleads.v16.common.types import offline_user_data
from google.ads.googleads.v16.enums.types import conversion_environment_enum
...
class UploadClickConversionsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            the upload.
        conversions (MutableSequence[google.ads.googleads.v16.services.types.ClickConversion]):
...
class UploadClickConversionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            https://developers.google.com/google-ads/api/docs/best-practices/partial-failures
            for more information about partial failure.
        results (MutableSequence[google.ads.googleads.v16.services.types.ClickConversionResult]):
...
class UploadCallConversionsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer performing
            the upload.
        conversions (MutableSequence[google.ads.googleads.v16.services.types.CallConversion]):
            Required. The conversions that are being
            uploaded.
        partial_failure (bool):
            Required. If true, successful operations will
...
class UploadCallConversionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            https://developers.google.com/google-ads/api/docs/best-practices/partial-failures
            for more information about partial failure.
        results (MutableSequence[google.ads.googleads.v16.services.types.CallConversionResult]):
            Returned for successfully processed conversions. Proto will
            be empty for rows that received an error. Results are not
            returned when validate_only is true.
    """
...
class ClickConversion(proto.Message):
    ...
    Attributes:
        ...
        external_attribution_data (google.ads.googleads.v16.services.types.ExternalAttributionData):
            ...
            otherwise.
        custom_variables (MutableSequence[google.ads.googleads.v16.services.types.CustomVariable]):
            The custom variables associated with this
            conversion.
        cart_data (google.ads.googleads.v16.services.types.CartData):
            The cart data associated with this
            conversion.
        user_identifiers (MutableSequence[google.ads.googleads.v16.common.types.UserIdentifier]):
        ...
        conversion_environment (google.ads.googleads.v16.enums.types.ConversionEnvironmentEnum.ConversionEnvironment):
            The environment this conversion was recorded
            on, for example, App or Web.
        consent (google.ads.googleads.v16.common.types.Consent):
...
class CartData(proto.Message):
    ...
    Attributes:
        ...
        items (MutableSequence[google.ads.googleads.v16.services.types.CartData.Item]):
