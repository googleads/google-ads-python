...
class CampaignAssetSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v15.resources.types.CampaignAssetSet):
...
class MutateCampaignAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v15.services.types.MutateCampaignAssetSetResult]):
