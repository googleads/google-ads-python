...
class AdGroupExtensionSettingServiceClient(
    ...
    def get_ad_group_extension_setting(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v4.resources.types.AdGroupExtensionSetting:
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.AdGroupExtensionSettingOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateAdGroupExtensionSettingsResponse:
