...
class AdGroupCriterionSimulationServiceClient(
    ...
    def get_ad_group_criterion_simulation(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetAdGroupCriterionSimulationRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.AdGroupCriterionSimulation:
