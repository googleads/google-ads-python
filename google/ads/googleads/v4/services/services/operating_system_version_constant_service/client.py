...
class OperatingSystemVersionConstantServiceClient(
    ...
    def get_operating_system_version_constant(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetOperatingSystemVersionConstantRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.OperatingSystemVersionConstant:
