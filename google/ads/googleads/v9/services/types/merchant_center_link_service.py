...
class ListMerchantCenterLinksResponse(proto.Message):
    ...
    Attributes:
        merchant_center_links (Sequence[google.ads.googleads.v9.resources.types.MerchantCenterLink]):
...
class MutateMerchantCenterLinkResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v9.services.types.MutateMerchantCenterLinkResult):
