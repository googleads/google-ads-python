...
class FeedItemSetLinkServiceClient(metaclass=FeedItemSetLinkServiceClientMeta):
    ...
    def get_feed_item_set_link(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.FeedItemSetLink:
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.FeedItemSetLinkOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateFeedItemSetLinksResponse:
