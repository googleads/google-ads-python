...
class RecommendationServiceClient(metaclass=RecommendationServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v19.services.RecommendationServiceClient`.",
                    extra=(
                        {
    ...
    def apply_recommendation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.ApplyRecommendationRequest, dict]):
    ...
    def dismiss_recommendation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.DismissRecommendationRequest, dict]):
                The request object. Request message for
    ...
    def generate_recommendations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GenerateRecommendationsRequest, dict]):
                The request object. Request message for
