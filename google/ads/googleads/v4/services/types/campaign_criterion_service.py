...
class MutateCampaignCriteriaRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v4.services.types.CampaignCriterionOperation]):
...
class CampaignCriterionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v4.resources.types.CampaignCriterion):
            Create operation: No resource name is
            expected for the new criterion.
        update (google.ads.googleads.v4.resources.types.CampaignCriterion):
    ...
    create = proto.Field(
        ...
        number=1,
        oneof="operation",
        message=campaign_criterion.CampaignCriterion,
    )
    update = proto.Field(
        proto.MESSAGE,
        number=2,
...
class MutateCampaignCriteriaResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v4.services.types.MutateCampaignCriterionResult]):
