...
"""Accesses the google.ads.googleads.v6.services AdGroupLabelService API."""
...
from google.ads.google_ads.v6.services import ad_group_label_service_client_config
from google.ads.google_ads.v6.services.transports import ad_group_label_service_grpc_transport
from google.ads.google_ads.v6.proto.services import ad_group_label_service_pb2
...
class AdGroupLabelServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v6.services.AdGroupLabelService'
    ...
    def get_ad_group_label(
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.AdGroupLabel` instance.
    ...
    def mutate_ad_group_labels(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v6.types.AdGroupLabelOperation]]): Required. The list of operations to perform on ad group labels.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v6.types.AdGroupLabelOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.MutateAdGroupLabelsResponse` instance.
