...
"""Accesses the google.ads.googleads.v2.services CampaignFeedService API."""
...
from google.ads.google_ads.v2.services import campaign_feed_service_client_config
...
class CampaignFeedServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.CampaignFeedService'
    ...
    def get_campaign_feed(
        ...
        Args:
            resource_name (str): The resource name of the campaign feed to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.CampaignFeed` instance.
    ...
    def mutate_campaign_feeds(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.CampaignFeedOperation]]): The list of operations to perform on individual campaign feeds.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.CampaignFeedOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateCampaignFeedsResponse` instance.
