...
class KeywordPlanAdGroupKeywordServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, KeywordPlanAdGroupKeywordServiceTransport]]): The
    ...
    def mutate_keyword_plan_ad_group_keywords(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateKeywordPlanAdGroupKeywordsRequest, dict, None]):
