...
class LiftMeasurementVideo(proto.Message):
    r"""A brand lift measurement by video.
    ...
    Attributes:
        resource_name (str):
            ...
            video. Lift measurement video resource names have the form:
        ...
        video (str):
            ...
            This field is a member of `oneof`_ ``_video``.
    """
