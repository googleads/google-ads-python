...
class ExtensionFeedItemServiceGrpcAsyncIOTransport(
    ExtensionFeedItemServiceTransport
):
    """gRPC AsyncIO backend transport for ExtensionFeedItemService.
    ...
    def mutate_extension_feed_items(
        ...
        Returns:
            Callable[[~.MutateExtensionFeedItemsRequest],
                    Awaitable[~.MutateExtensionFeedItemsResponse]]:
        ...
        if "mutate_extension_feed_items" not in self._stubs:
            self._stubs["mutate_extension_feed_items"] = (
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_extension_feed_items: self._wrap_method(
...
__all__ = ("ExtensionFeedItemServiceGrpcAsyncIOTransport",)
