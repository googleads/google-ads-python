...
class CampaignExtensionSettingServiceClient(
    ...
    def get_campaign_extension_setting(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetCampaignExtensionSettingRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.CampaignExtensionSetting:
    ...
    def mutate_campaign_extension_settings(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateCampaignExtensionSettingsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.CampaignExtensionSettingOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateCampaignExtensionSettingsResponse:
