...
from google.ads.googleads.v6.services.services.campaign_draft_service import (
    pagers,
)
...
class CampaignDraftServiceClient(metaclass=CampaignDraftServiceClientMeta):
    ...
    def get_campaign_draft(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v6.resources.types.CampaignDraft:
                A campaign draft.
        """
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.CampaignDraftOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateCampaignDraftsResponse:
    ...
    def list_campaign_draft_async_errors(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v6.services.services.campaign_draft_service.pagers.ListCampaignDraftAsyncErrorsPager:
