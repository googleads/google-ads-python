...
class SharedSet(proto.Message):
    ...
    Attributes:
        ...
        id (int):
            ...
            only.
        type_ (google.ads.googleads.v5.enums.types.SharedSetTypeEnum.SharedSetType):
        ...
        status (google.ads.googleads.v5.enums.types.SharedSetStatusEnum.SharedSetStatus):
