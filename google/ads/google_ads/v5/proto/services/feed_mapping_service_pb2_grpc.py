...
def add_FeedMappingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetFeedMapping': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=google_dot_ads_dot_googleads__v5_dot_proto_dot_services_dot_feed__mapping__service__pb2.GetFeedMappingRequest.FromString,
                    response_serializer=google_dot_ads_dot_googleads__v5_dot_proto_dot_resources_dot_feed__mapping__pb2.FeedMapping.SerializeToString,
            ),
            'MutateFeedMappings': grpc.unary_unary_rpc_method_handler(
                    servicer.MutateFeedMappings,
                    request_deserializer=google_dot_ads_dot_googleads__v5_dot_proto_dot_services_dot_feed__mapping__service__pb2.MutateFeedMappingsRequest.FromString,
                    response_serializer=google_dot_ads_dot_googleads__v5_dot_proto_dot_services_dot_feed__mapping__service__pb2.MutateFeedMappingsResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'google.ads.googleads.v5.services.FeedMappingService', rpc_method_handlers)
...
class FeedMappingService(object):
    ...
    def GetFeedMapping(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.ads.googleads.v5.services.FeedMappingService/GetFeedMapping',
            google_dot_ads_dot_googleads__v5_dot_proto_dot_services_dot_feed__mapping__service__pb2.GetFeedMappingRequest.SerializeToString,
            google_dot_ads_dot_googleads__v5_dot_proto_dot_resources_dot_feed__mapping__pb2.FeedMapping.FromString,
    ...
    def MutateFeedMappings(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/google.ads.googleads.v5.services.FeedMappingService/MutateFeedMappings',
            google_dot_ads_dot_googleads__v5_dot_proto_dot_services_dot_feed__mapping__service__pb2.MutateFeedMappingsRequest.SerializeToString,
            google_dot_ads_dot_googleads__v5_dot_proto_dot_services_dot_feed__mapping__service__pb2.MutateFeedMappingsResponse.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
