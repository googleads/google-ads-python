...
class GenerateKeywordIdeasPager:
    ...
    :class:`google.ads.googleads.v6.services.types.GenerateKeywordIdeaResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v6.services.types.GenerateKeywordIdeaResponse`
    ...
    def __init__(
        ...
        Args:
            ...
            response (:class:`google.ads.googleads.v6.services.types.GenerateKeywordIdeaResponse`):
