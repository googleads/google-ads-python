...
class RecommendationSubscriptionServiceClient(
    ...
    def mutate_recommendation_subscription(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateRecommendationSubscriptionRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v18.services.types.MutateRecommendationSubscriptionResponse:
