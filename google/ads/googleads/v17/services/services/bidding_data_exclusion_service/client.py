...
class BiddingDataExclusionServiceClient(
    ...
    def mutate_bidding_data_exclusions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateBiddingDataExclusionsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v17.services.types.MutateBiddingDataExclusionsResponse:
