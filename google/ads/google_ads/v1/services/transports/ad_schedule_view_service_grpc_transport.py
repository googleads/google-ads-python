...
from google.ads.google_ads.v1.proto.services import ad_schedule_view_service_pb2_grpc


class AdScheduleViewServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v1.services AdScheduleViewService API.
    ...
    def get_ad_schedule_view(self):
        """Return the gRPC stub for :meth:`AdScheduleViewServiceClient.get_ad_schedule_view`.
