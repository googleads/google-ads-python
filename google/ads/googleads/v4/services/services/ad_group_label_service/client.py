...
class AdGroupLabelServiceClient(metaclass=AdGroupLabelServiceClientMeta):
    ...
    def get_ad_group_label(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetAdGroupLabelRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.AdGroupLabel:
    ...
    def mutate_ad_group_labels(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateAdGroupLabelsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.AdGroupLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateAdGroupLabelsResponse:
