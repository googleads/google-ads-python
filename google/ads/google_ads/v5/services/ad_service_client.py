...
"""Accesses the google.ads.googleads.v5.services AdService API."""
...
from google.ads.google_ads.v5.services import ad_service_client_config
from google.ads.google_ads.v5.services.transports import ad_service_grpc_transport
from google.ads.google_ads.v5.proto.services import ad_service_pb2
...
class AdServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v5.services.AdService'
    ...
    def get_ad(
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.Ad` instance.
    ...
    def mutate_ads(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v5.types.AdOperation]]): Required. The list of operations to perform on individual ads.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v5.types.AdOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.MutateAdsResponse` instance.
