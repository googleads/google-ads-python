...
from google.ads.googleads.v10.resources.types import asset_group
...
class MutateAssetGroupsRequest(proto.Message):
    ...
    [AssetGroupService.MutateAssetGroups][google.ads.googleads.v10.services.AssetGroupService.MutateAssetGroups].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose asset
            groups are being modified.
        operations (Sequence[google.ads.googleads.v10.services.types.AssetGroupOperation]):
...
class AssetGroupOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v10.resources.types.AssetGroup):
            Create operation: No resource name is
            expected for the new asset group

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v10.resources.types.AssetGroup):
...
class MutateAssetGroupsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v10.services.types.MutateAssetGroupResult]):
