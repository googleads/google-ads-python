...
class CampaignExtensionSettingServiceClient(
    ...
    def mutate_campaign_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateCampaignExtensionSettingsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateCampaignExtensionSettingsResponse:
