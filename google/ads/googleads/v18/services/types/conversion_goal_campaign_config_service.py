...
class MutateConversionGoalCampaignConfigsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v18.services.types.ConversionGoalCampaignConfigOperation]):
...
class ConversionGoalCampaignConfigOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v18.resources.types.ConversionGoalCampaignConfig):
...
class MutateConversionGoalCampaignConfigsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v18.services.types.MutateConversionGoalCampaignConfigResult]):
