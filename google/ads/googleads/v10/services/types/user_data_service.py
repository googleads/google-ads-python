...
class UploadUserDataRequest(proto.Message):
    ...
    [UserDataService.UploadUserData][google.ads.googleads.v10.services.UserDataService.UploadUserData]
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v10.services.types.UserDataOperation]):
...
class UserDataOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v10.common.types.UserData):
            The list of user data to be appended to the
            user list.

            This field is a member of `oneof`_ ``operation``.
        remove (google.ads.googleads.v10.common.types.UserData):
