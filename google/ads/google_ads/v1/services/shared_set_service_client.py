...
"""Accesses the google.ads.googleads.v1.services SharedSetService API."""
...
from google.ads.google_ads.v1.services import shared_set_service_client_config
...
class SharedSetServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.SharedSetService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=shared_set_service_grpc_transport.
    ...
    def get_shared_set(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.SharedSet` instance.
        ...
        if 'get_shared_set' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_shared_set'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_shared_set,
                    default_retry=self._method_configs['GetSharedSet'].retry,
                    default_timeout=self._method_configs['GetSharedSet'].
                    timeout,
        ...
        return self._inner_api_calls['get_shared_set'](
    ...
    def mutate_shared_sets(self,
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v1.types.SharedSetOperation]]): The list of operations to perform on individual shared sets.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.SharedSetOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.MutateSharedSetsResponse` instance.
        ...
        if 'mutate_shared_sets' not in self._inner_api_calls:
            self._inner_api_calls[
                'mutate_shared_sets'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.mutate_shared_sets,
                    default_retry=self._method_configs['MutateSharedSets'].
                    retry,
                    default_timeout=self._method_configs['MutateSharedSets'].
                    timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['mutate_shared_sets'](
            request, retry=retry, timeout=timeout, metadata=metadata)
