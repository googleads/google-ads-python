...
"""Accesses the google.ads.googleads.v1.services LanguageConstantService API."""
...
from google.ads.google_ads.v1.services import language_constant_service_client_config
...
class LanguageConstantServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.LanguageConstantService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=language_constant_service_grpc_transport.
    ...
    def get_language_constant(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.LanguageConstant` instance.
        ...
        if 'get_language_constant' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_language_constant'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_language_constant,
                    default_retry=self._method_configs['GetLanguageConstant'].
                    retry,
                    default_timeout=self.
                    _method_configs['GetLanguageConstant'].timeout,
                    client_info=self._client_info,
                )

        request = language_constant_service_pb2.GetLanguageConstantRequest(
            resource_name=resource_name, )
        return self._inner_api_calls['get_language_constant'](
