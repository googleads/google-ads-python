...
"""Accesses the google.ads.googleads.v2.services SearchTermViewService API."""
...
from google.ads.google_ads.v2.services import search_term_view_service_client_config
...
class SearchTermViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.SearchTermViewService'
    ...
    def get_search_term_view(
        ...
        Args:
            resource_name (str): The resource name of the search term view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.SearchTermView` instance.
