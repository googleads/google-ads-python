...
"""Accesses the google.ads.googleads.v3.services CampaignExperimentService API."""
...
from google.ads.google_ads.v3.services import campaign_experiment_service_client_config
from google.ads.google_ads.v3.services.transports import campaign_experiment_service_grpc_transport
from google.ads.google_ads.v3.proto.services import campaign_experiment_service_pb2
...
class CampaignExperimentServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v3.services.CampaignExperimentService'
    ...
    def get_campaign_experiment(
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.CampaignExperiment` instance.
    ...
    def create_campaign_experiment(
        ...
        Args:
            ...
            campaign_experiment (Union[dict, ~google.ads.googleads_v3.types.CampaignExperiment]): Required. The campaign experiment to be created.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.CampaignExperiment`
    ...
    def mutate_campaign_experiments(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v3.types.CampaignExperimentOperation]]): Required. The list of operations to perform on individual campaign experiments.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.CampaignExperimentOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.MutateCampaignExperimentsResponse` instance.
    ...
    def graduate_campaign_experiment(
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.GraduateCampaignExperimentResponse` instance.
