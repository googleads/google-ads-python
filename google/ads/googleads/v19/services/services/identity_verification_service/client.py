...
class IdentityVerificationServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v19.services.IdentityVerificationServiceClient`.",
                    extra=(
                        {
    ...
    def start_identity_verification(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.StartIdentityVerificationRequest, dict]):
    ...
    def get_identity_verification(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GetIdentityVerificationRequest, dict]):
                The request object. Request message for
