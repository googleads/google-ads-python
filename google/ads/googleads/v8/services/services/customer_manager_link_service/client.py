...
class CustomerManagerLinkServiceClient(
    ...
    def get_customer_manager_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetCustomerManagerLinkRequest`):
        ...
        Returns:
            google.ads.googleads.v8.resources.types.CustomerManagerLink:
    ...
    def mutate_customer_manager_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateCustomerManagerLinkRequest`):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateCustomerManagerLinkResponse:
    ...
    def move_manager_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MoveManagerLinkRequest`):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v8.services.types.MoveManagerLinkResponse:
                Response message for a
