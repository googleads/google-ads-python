...
class ExtensionFeedItemServiceClient(
    ...
    def mutate_extension_feed_items(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.MutateExtensionFeedItemsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v10.services.types.MutateExtensionFeedItemsResponse:
