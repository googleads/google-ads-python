...
class GoogleAdsServiceClient(metaclass=GoogleAdsServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v17.services.GoogleAdsServiceClient`.",
                    extra=(
                        {
    ...
    def search(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.SearchGoogleAdsRequest, dict]):
    ...
    def search_stream(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.SearchGoogleAdsStreamRequest, dict]):
                The request object. Request message for
    ...
    def mutate(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateGoogleAdsRequest, dict]):
                The request object. Request message for
