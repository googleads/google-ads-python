...
class ExtensionFeedItemServiceClient(
    ...
    def mutate_extension_feed_items(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateExtensionFeedItemsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateExtensionFeedItemsResponse:
