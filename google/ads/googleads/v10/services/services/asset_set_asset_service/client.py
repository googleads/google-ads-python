...
class AssetSetAssetServiceClient(metaclass=AssetSetAssetServiceClientMeta):
    ...
    def mutate_asset_set_assets(
        self,
        request: Union[
            asset_set_asset_service.MutateAssetSetAssetsRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.MutateAssetSetAssetsRequest, dict]):
                The request object. Request message for
                [AssetSetAssetService.MutateAssetSetAssets][google.ads.googleads.v10.services.AssetSetAssetService.MutateAssetSetAssets].
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v10.services.types.AssetSetAssetOperation]):
        ...
        Returns:
            google.ads.googleads.v10.services.types.MutateAssetSetAssetsResponse:
