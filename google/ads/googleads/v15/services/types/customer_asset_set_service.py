...
class CustomerAssetSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v15.resources.types.CustomerAssetSet):
...
class MutateCustomerAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v15.services.types.MutateCustomerAssetSetResult]):
