...
class ProductBiddingCategoryConstantServiceClient(
    ...
    def get_product_bidding_category_constant(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetProductBiddingCategoryConstantRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.ProductBiddingCategoryConstant:
