...
"""Accesses the google.ads.googleads.v5.services AdGroupService API."""
...
from google.ads.google_ads.v5.services import ad_group_service_client_config
from google.ads.google_ads.v5.services.transports import ad_group_service_grpc_transport
from google.ads.google_ads.v5.proto.services import ad_group_service_pb2
...
class AdGroupServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v5.services.AdGroupService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=ad_group_service_grpc_transport.AdGroupServiceGrpcTransport,
    ...
    def get_ad_group(
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.AdGroup` instance.
        ...
        if 'get_ad_group' not in self._inner_api_calls:
            self._inner_api_calls['get_ad_group'] = google.api_core.gapic_v1.method.wrap_method(
        ...
        return self._inner_api_calls['get_ad_group'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def mutate_ad_groups(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v5.types.AdGroupOperation]]): Required. The list of operations to perform on individual ad groups.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v5.types.AdGroupOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.MutateAdGroupsResponse` instance.
        ...
        if 'mutate_ad_groups' not in self._inner_api_calls:
            self._inner_api_calls['mutate_ad_groups'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.mutate_ad_groups,
                default_retry=self._method_configs['MutateAdGroups'].retry,
                default_timeout=self._method_configs['MutateAdGroups'].timeout,
                client_info=self._client_info,
            )
        ...
        return self._inner_api_calls['mutate_ad_groups'](request, retry=retry, timeout=timeout, metadata=metadata)
