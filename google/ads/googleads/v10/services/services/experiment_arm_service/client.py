...
class ExperimentArmServiceClient(metaclass=ExperimentArmServiceClientMeta):
    ...
    def mutate_experiment_arms(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.MutateExperimentArmsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v10.services.types.MutateExperimentArmsResponse:
