...
from google.ads.google_ads.v4.proto.services import merchant_center_link_service_pb2_grpc


class MerchantCenterLinkServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v4.services MerchantCenterLinkService API.
