...
"""Accesses the google.ads.googleads.v3.services BillingSetupService API."""
...
from google.ads.google_ads.v3.services import billing_setup_service_client_config
from google.ads.google_ads.v3.services.transports import billing_setup_service_grpc_transport
from google.ads.google_ads.v3.proto.services import billing_setup_service_pb2
...
class BillingSetupServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v3.services.BillingSetupService'
    ...
    def get_billing_setup(
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.BillingSetup` instance.
    ...
    def mutate_billing_setup(
        ...
        Args:
            ...
            operation_ (Union[dict, ~google.ads.googleads_v3.types.BillingSetupOperation]): Required. The operation to perform.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.BillingSetupOperation`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.MutateBillingSetupResponse` instance.
