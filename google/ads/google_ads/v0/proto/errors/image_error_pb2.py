...
# source: google/ads/googleads_v0/proto/errors/image_error.proto
...
_IMAGEERRORENUM_IMAGEERROR = _descriptor.EnumDescriptor(
  name='ImageError',
  full_name='google.ads.googleads.v0.errors.ImageErrorEnum.ImageError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_IMAGEERRORENUM = _descriptor.Descriptor(
  name='ImageErrorEnum',
  full_name='google.ads.googleads.v0.errors.ImageErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
ImageErrorEnum = _reflection.GeneratedProtocolMessageType('ImageErrorEnum', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v0.proto.errors.image_error_pb2'
  ,
