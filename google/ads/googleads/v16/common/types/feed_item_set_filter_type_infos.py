...
class DynamicLocationSetFilter(proto.Message):
    ...
    Attributes:
        ...
        business_name_filter (google.ads.googleads.v16.common.types.BusinessNameFilter):
...
class BusinessNameFilter(proto.Message):
    ...
    Attributes:
        ...
        filter_type (google.ads.googleads.v16.enums.types.FeedItemSetStringFilterTypeEnum.FeedItemSetStringFilterType):
