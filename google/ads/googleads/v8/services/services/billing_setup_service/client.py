...
class BillingSetupServiceClient(metaclass=BillingSetupServiceClientMeta):
    ...
    def get_billing_setup(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.BillingSetup:
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v8.services.types.BillingSetupOperation`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateBillingSetupResponse:
