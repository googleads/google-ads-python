...
class SmartCampaignSettingServiceClient(
    ...
    def get_smart_campaign_status(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.GetSmartCampaignStatusRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.GetSmartCampaignStatusResponse:
    ...
    def mutate_smart_campaign_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateSmartCampaignSettingsRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateSmartCampaignSettingsResponse:
