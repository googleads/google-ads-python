...
class AdGroupCriterionServiceClient(object):
    ...
    def get_ad_group_criterion(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.AdGroupCriterion` instance.
    ...
    def mutate_ad_group_criteria(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v0.types.AdGroupCriterionOperation]]): The list of operations to perform on individual criteria.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v0.types.AdGroupCriterionOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.MutateAdGroupCriteriaResponse` instance.
