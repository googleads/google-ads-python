...
class BiddingDataExclusionServiceClient(
    ...
    def get_bidding_data_exclusion(
        self,
        request: Union[
            bidding_data_exclusion_service.GetBiddingDataExclusionRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetBiddingDataExclusionRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.BiddingDataExclusion:
    ...
    def mutate_bidding_data_exclusions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateBiddingDataExclusionsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.BiddingDataExclusionOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateBiddingDataExclusionsResponse:
