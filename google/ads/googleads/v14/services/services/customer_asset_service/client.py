...
class CustomerAssetServiceClient(metaclass=CustomerAssetServiceClientMeta):
    ...
    def mutate_customer_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateCustomerAssetsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v14.services.types.CustomerAssetOperation]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateCustomerAssetsResponse:
