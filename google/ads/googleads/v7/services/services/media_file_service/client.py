...
class MediaFileServiceClient(metaclass=MediaFileServiceClientMeta):
    ...
    def get_media_file(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetMediaFileRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v7.resources.types.MediaFile:
                A media file.
        """
    ...
    def mutate_media_files(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.MutateMediaFilesRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.MediaFileOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateMediaFilesResponse:
