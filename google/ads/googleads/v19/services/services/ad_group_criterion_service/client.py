...
class AdGroupCriterionServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v19.services.AdGroupCriterionServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_ad_group_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.MutateAdGroupCriteriaRequest, dict]):
