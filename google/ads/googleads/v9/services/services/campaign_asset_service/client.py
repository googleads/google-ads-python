...
class CampaignAssetServiceClient(metaclass=CampaignAssetServiceClientMeta):
    ...
    def get_campaign_asset(
        self,
        request: Union[
            campaign_asset_service.GetCampaignAssetRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCampaignAssetRequest, dict]):
                The request object. Request message for
                [CampaignAssetService.GetCampaignAsset][google.ads.googleads.v9.services.CampaignAssetService.GetCampaignAsset].
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CampaignAsset:
    ...
    def mutate_campaign_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCampaignAssetsRequest, dict]):
                The request object. Request message for
                [CampaignAssetService.MutateCampaignAssets][google.ads.googleads.v9.services.CampaignAssetService.MutateCampaignAssets].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CampaignAssetOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCampaignAssetsResponse:
