...
class MutateAssetGroupListingGroupFiltersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v18.services.types.AssetGroupListingGroupFilterOperation]):
...
class AssetGroupListingGroupFilterOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v18.resources.types.AssetGroupListingGroupFilter):
            Create operation: No resource name is
            expected for the new asset group listing group
            filter.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v18.resources.types.AssetGroupListingGroupFilter):
...
class MutateAssetGroupListingGroupFiltersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v18.services.types.MutateAssetGroupListingGroupFilterResult]):
