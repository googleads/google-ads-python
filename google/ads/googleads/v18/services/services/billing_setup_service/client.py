...
class BillingSetupServiceClient(metaclass=BillingSetupServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, BillingSetupServiceTransport]]): The
    ...
    def mutate_billing_setup(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateBillingSetupRequest, dict, None]):
