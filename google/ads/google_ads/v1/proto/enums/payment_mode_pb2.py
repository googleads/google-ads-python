...
# source: google/ads/googleads_v1/proto/enums/payment_mode.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v1/proto/enums/payment_mode.proto',
...
_PAYMENTMODEENUM_PAYMENTMODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PAYMENT_MODE_CPC', index=2, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PAYMENT_MODE_CPA', index=3, number=3,
      serialized_options=None,
      type=None),
  ],
...
PaymentModeEnum = _reflection.GeneratedProtocolMessageType('PaymentModeEnum', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v1.proto.enums.payment_mode_pb2'
  ,
