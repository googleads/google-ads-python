...
from google.ads.googleads.v10.resources.types import feed_item_set_link
...
class FeedItemSetLinkOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v10.resources.types.FeedItemSetLink):
...
class MutateFeedItemSetLinksResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v10.services.types.MutateFeedItemSetLinkResult]):
