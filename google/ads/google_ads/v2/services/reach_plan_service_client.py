...
"""Accesses the google.ads.googleads.v2.services ReachPlanService API."""
...
from google.ads.google_ads.v2.services import reach_plan_service_client_config
...
class ReachPlanServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.ReachPlanService'
    ...
    def list_plannable_locations(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.ListPlannableLocationsResponse` instance.
    ...
    def list_plannable_products(
        ...
        Args:
            plannable_location_id (Union[dict, ~google.ads.googleads_v2.types.StringValue]): The ID of the selected location for planning. To list the available
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.ListPlannableProductsResponse` instance.
    ...
    def generate_product_mix_ideas(
        ...
        Args:
            ...
            plannable_location_id (Union[dict, ~google.ads.googleads_v2.types.StringValue]): Required. The ID of the location, this is one of the ids returned by
                ListPlannableLocations.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.StringValue`
            currency_code (Union[dict, ~google.ads.googleads_v2.types.StringValue]): Required. Currency code.
                Three-character ISO 4217 currency code.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.StringValue`
            budget_micros (Union[dict, ~google.ads.googleads_v2.types.Int64Value]): Required. Total budget.
                Amount in micros. One million is equivalent to one unit.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.Int64Value`
            preferences (Union[dict, ~google.ads.googleads_v2.types.Preferences]): The preferences of the suggested product mix.
                An unset preference is interpreted as all possible values are allowed,
                unless explicitly specified.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.Preferences`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.GenerateProductMixIdeasResponse` instance.
    ...
    def generate_reach_forecast(
        ...
        Args:
            customer_id (str): The ID of the customer.
            currency_code (Union[dict, ~google.ads.googleads_v2.types.StringValue]): Required. The currency code.
                Three-character ISO 4217 currency code.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.StringValue`
            campaign_duration (Union[dict, ~google.ads.googleads_v2.types.CampaignDuration]): Campaign duration.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.CampaignDuration`
            cookie_frequency_cap (Union[dict, ~google.ads.googleads_v2.types.Int32Value]): Desired cookie frequency cap that will be applied to each planned product.
                ...
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.Int32Value`
            min_effective_frequency (Union[dict, ~google.ads.googleads_v2.types.Int32Value]): Desired minimum effective frequency (the number of times a person was
                ...
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.Int32Value`
            targeting (Union[dict, ~google.ads.googleads_v2.types.Targeting]): The targeting to be applied to all products selected in the product mix.
                ...
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.Targeting`
            planned_products (list[Union[dict, ~google.ads.googleads_v2.types.PlannedProduct]]): The product to be planned.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.PlannedProduct`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.GenerateReachForecastResponse` instance.
