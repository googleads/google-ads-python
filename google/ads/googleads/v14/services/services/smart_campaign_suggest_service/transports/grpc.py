    ...
    def suggest_smart_campaign_budget_options(
        ...
        if "suggest_smart_campaign_budget_options" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v14.services.SmartCampaignSuggestService/SuggestSmartCampaignBudgetOptions",
    ...
    def suggest_smart_campaign_ad(
        ...
        if "suggest_smart_campaign_ad" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v14.services.SmartCampaignSuggestService/SuggestSmartCampaignAd",
    ...
    def suggest_keyword_themes(
        ...
        if "suggest_keyword_themes" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v14.services.SmartCampaignSuggestService/SuggestKeywordThemes",
