...
class KeywordPlanCampaignServiceClient(
    ...
    def get_keyword_plan_campaign(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetKeywordPlanCampaignRequest`):
        ...
        Returns:
            google.ads.googleads.v5.resources.types.KeywordPlanCampaign:
    ...
    def mutate_keyword_plan_campaigns(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateKeywordPlanCampaignsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.KeywordPlanCampaignOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateKeywordPlanCampaignsResponse:
