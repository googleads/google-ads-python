...
class KeywordViewServiceClient(metaclass=KeywordViewServiceClientMeta):
    ...
    def get_keyword_view(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetKeywordViewRequest, dict]):
                The request object. Request message for
                [KeywordViewService.GetKeywordView][google.ads.googleads.v9.services.KeywordViewService.GetKeywordView].
        ...
        Returns:
            google.ads.googleads.v9.resources.types.KeywordView:
                A keyword view.
        """
