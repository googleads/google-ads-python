...
class AdGroupAdLabelServiceClient(metaclass=AdGroupAdLabelServiceClientMeta):
    ...
    def get_ad_group_ad_label(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetAdGroupAdLabelRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.AdGroupAdLabel:
    ...
    def mutate_ad_group_ad_labels(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateAdGroupAdLabelsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.AdGroupAdLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateAdGroupAdLabelsResponse:
