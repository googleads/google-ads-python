...
class BiddingStrategyServiceClient(metaclass=BiddingStrategyServiceClientMeta):
    ...
    def get_bidding_strategy(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.BiddingStrategy:
                A bidding strategy.
        """
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.BiddingStrategyOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateBiddingStrategiesResponse:
