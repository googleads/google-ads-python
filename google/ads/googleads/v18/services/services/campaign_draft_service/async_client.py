...
from google.ads.googleads.v18.services.services.campaign_draft_service import (
    pagers,
)
...
class CampaignDraftServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v18.services.CampaignDraftServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def mutate_campaign_drafts(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v18.services.types.MutateCampaignDraftsRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`MutableSequence[google.ads.googleads.v18.services.types.CampaignDraftOperation]`):
        ...
        Returns:
            google.ads.googleads.v18.services.types.MutateCampaignDraftsResponse:
    ...
    async def promote_campaign_draft(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v18.services.types.PromoteCampaignDraftRequest, dict]]):
                The request object. Request message for
    ...
    async def list_campaign_draft_async_errors(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v18.services.types.ListCampaignDraftAsyncErrorsRequest, dict]]):
                The request object. Request message for
                [CampaignDraftService.ListCampaignDraftAsyncErrors][google.ads.googleads.v18.services.CampaignDraftService.ListCampaignDraftAsyncErrors].
        ...
        Returns:
            google.ads.googleads.v18.services.services.campaign_draft_service.pagers.ListCampaignDraftAsyncErrorsAsyncPager:
