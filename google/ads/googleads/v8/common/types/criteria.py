...
class ListingGroupInfo(proto.Message):
    ...
    Attributes:
        ...
        case_value (google.ads.googleads.v8.common.types.ListingDimensionInfo):
...
class HotelDateSelectionTypeInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v8.enums.types.HotelDateSelectionTypeEnum.HotelDateSelectionType):
...
class AdScheduleInfo(proto.Message):
    ...
    Attributes:
        start_minute (google.ads.googleads.v8.enums.types.MinuteOfHourEnum.MinuteOfHour):
        ...
        end_minute (google.ads.googleads.v8.enums.types.MinuteOfHourEnum.MinuteOfHour):
...
class ProximityInfo(proto.Message):
    ...
    Attributes:
        geo_point (google.ads.googleads.v8.common.types.GeoPointInfo):
        ...
        address (google.ads.googleads.v8.common.types.AddressInfo):
            Full address.
    """
...
class WebpageInfo(proto.Message):
    ...
    Attributes:
        ...
        coverage_percentage (float):
            ...
            is read-only.
        sample (google.ads.googleads.v8.common.types.WebpageSampleInfo):
...
class WebpageConditionInfo(proto.Message):
    ...
    Attributes:
        operand (google.ads.googleads.v8.enums.types.WebpageConditionOperandEnum.WebpageConditionOperand):
            Operand of webpage targeting condition.
        operator (google.ads.googleads.v8.enums.types.WebpageConditionOperatorEnum.WebpageConditionOperator):
