...
class ReachPlanServiceClient(metaclass=ReachPlanServiceClientMeta):
    ...
    def list_plannable_locations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.ListPlannableLocationsRequest, dict, None]):
    ...
    def list_plannable_products(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.ListPlannableProductsRequest, dict, None]):
    ...
    def generate_reach_forecast(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.GenerateReachForecastRequest, dict, None]):
                The request object. Request message for
