...
from google.ads.googleads.v14.resources.types import custom_interest
...
class MutateCustomInterestsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v14.services.types.MutateCustomInterestResult]):
