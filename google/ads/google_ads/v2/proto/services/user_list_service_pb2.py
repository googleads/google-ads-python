...
# source: google/ads/googleads_v2/proto/services/user_list_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v2/proto/services/user_list_service.proto',
...
_USERLISTOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v2_dot_proto_dot_resources_dot_user__list__pb2._USERLIST
_USERLISTOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v2_dot_proto_dot_resources_dot_user__list__pb2._USERLIST
...
GetUserListRequest = _reflection.GeneratedProtocolMessageType('GetUserListRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v2.proto.services.user_list_service_pb2'
  ,
  __doc__ = """Request message for
  [UserListService.GetUserList][google.ads.googleads.v2.services.UserListService.GetUserList].
...
MutateUserListsRequest = _reflection.GeneratedProtocolMessageType('MutateUserListsRequest', (_message.Message,), dict(
  ...
  ,
  __doc__ = """Request message for
  [UserListService.MutateUserLists][google.ads.googleads.v2.services.UserListService.MutateUserLists].
...
_USERLISTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v2_dot_proto_dot_resources_dot_user__list__pb2._USERLIST,
    serialized_options=_b('\202\323\344\223\002-\022+/v2/{resource_name=customers/*/userLists/*}'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0023\"./v2/customers/{customer_id=*}/userLists:mutate:\001*'),
  ),
])
