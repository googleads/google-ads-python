...
"""Accesses the google.ads.googleads.v2.services AdGroupCriterionLabelService API."""
...
from google.ads.google_ads.v2.services import ad_group_criterion_label_service_client_config
...
class AdGroupCriterionLabelServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.AdGroupCriterionLabelService'
    ...
    def __init__(self, transport=None, channel=None, credentials=None,
        ...
        Args:
            transport (Union[~.AdGroupCriterionLabelServiceGrpcTransport,
                    Callable[[~.Credentials, type], ~.AdGroupCriterionLabelServiceGrpcTransport]): A transport
        ...
        if client_config is not None:
            ...
            client_config = ad_group_criterion_label_service_client_config.config
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=ad_group_criterion_label_service_grpc_transport.AdGroupCriterionLabelServiceGrpcTransport,
                )
            else:
                if credentials:
                    raise ValueError(
            ...
            self.transport = ad_group_criterion_label_service_grpc_transport.AdGroupCriterionLabelServiceGrpcTransport(
    ...
    def get_ad_group_criterion_label(
        ...
        Args:
            resource_name (str): The resource name of the ad group criterion label to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.AdGroupCriterionLabel` instance.
        ...
        if 'get_ad_group_criterion_label' not in self._inner_api_calls:
            self._inner_api_calls['get_ad_group_criterion_label'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_ad_group_criterion_label,
                default_retry=self._method_configs['GetAdGroupCriterionLabel'].retry,
                default_timeout=self._method_configs['GetAdGroupCriterionLabel'].timeout,
                client_info=self._client_info,
            )

        request = ad_group_criterion_label_service_pb2.GetAdGroupCriterionLabelRequest(
        ...
        return self._inner_api_calls['get_ad_group_criterion_label'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def mutate_ad_group_criterion_labels(
        ...
        Args:
            customer_id (str): ID of the customer whose ad group criterion labels are being modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.AdGroupCriterionLabelOperation]]): The list of operations to perform on ad group criterion labels.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.AdGroupCriterionLabelOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateAdGroupCriterionLabelsResponse` instance.
        ...
        """
        # Wrap the transport method to add retry and timeout logic.
        if 'mutate_ad_group_criterion_labels' not in self._inner_api_calls:
            self._inner_api_calls['mutate_ad_group_criterion_labels'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.mutate_ad_group_criterion_labels,
                default_retry=self._method_configs['MutateAdGroupCriterionLabels'].retry,
                default_timeout=self._method_configs['MutateAdGroupCriterionLabels'].timeout,
                client_info=self._client_info,
            )

        request = ad_group_criterion_label_service_pb2.MutateAdGroupCriterionLabelsRequest(
        ...
        return self._inner_api_calls['mutate_ad_group_criterion_labels'](request, retry=retry, timeout=timeout, metadata=metadata)
