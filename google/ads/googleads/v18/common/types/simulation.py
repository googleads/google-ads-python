...
class TargetCpaSimulationPointList(proto.Message):
    ...
    Attributes:
        points (MutableSequence[google.ads.googleads.v18.common.types.TargetCpaSimulationPoint]):
...
class TargetRoasSimulationPointList(proto.Message):
    ...
    Attributes:
        points (MutableSequence[google.ads.googleads.v18.common.types.TargetRoasSimulationPoint]):
...
class PercentCpcBidSimulationPointList(proto.Message):
    ...
    Attributes:
        points (MutableSequence[google.ads.googleads.v18.common.types.PercentCpcBidSimulationPoint]):
...
class BudgetSimulationPointList(proto.Message):
    ...
    Attributes:
        points (MutableSequence[google.ads.googleads.v18.common.types.BudgetSimulationPoint]):
...
class TargetImpressionShareSimulationPointList(proto.Message):
    ...
    Attributes:
        points (MutableSequence[google.ads.googleads.v18.common.types.TargetImpressionShareSimulationPoint]):
