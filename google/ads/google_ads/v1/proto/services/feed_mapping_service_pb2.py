...
# source: google/ads/googleads_v1/proto/services/feed_mapping_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v1/proto/services/feed_mapping_service.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads__v1_dot_proto_dot_resources_dot_feed__mapping__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_protobuf_dot_wrappers__pb2.DESCRIPTOR,google_dot_rpc_dot_status__pb2.DESCRIPTOR,])
...
_FEEDMAPPINGOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v1_dot_proto_dot_resources_dot_feed__mapping__pb2._FEEDMAPPING
...
GetFeedMappingRequest = _reflection.GeneratedProtocolMessageType('GetFeedMappingRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v1.proto.services.feed_mapping_service_pb2'
  ,
...
_FEEDMAPPINGSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v1_dot_proto_dot_resources_dot_feed__mapping__pb2._FEEDMAPPING,
    serialized_options=_b('\202\323\344\223\0020\022./v1/{resource_name=customers/*/feedMappings/*}'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0026\"1/v1/customers/{customer_id=*}/feedMappings:mutate:\001*'),
  ),
])
