...
class SmartCampaignSettingServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v17.services.SmartCampaignSettingServiceClient`.",
                    extra=(
                        {
    ...
    def get_smart_campaign_status(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.GetSmartCampaignStatusRequest, dict]):
    ...
    def mutate_smart_campaign_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateSmartCampaignSettingsRequest, dict]):
                The request object. Request message for
