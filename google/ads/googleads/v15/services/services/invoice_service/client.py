...
class InvoiceServiceClient(metaclass=InvoiceServiceClientMeta):
    ...
    def list_invoices(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.ListInvoicesRequest, dict, None]):
            ...
            issue_year (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            issue_month (google.ads.googleads.v15.enums.types.MonthOfYearEnum.MonthOfYear):
        ...
        Returns:
            google.ads.googleads.v15.services.types.ListInvoicesResponse:
