...
from google.ads.googleads.v18.enums.types import feed_item_validation_status
from google.ads.googleads.v18.enums.types import (
    geo_targeting_restriction as gage_geo_targeting_restriction,
)
from google.ads.googleads.v18.enums.types import placeholder_type
...
class FeedItem(proto.Message):
    ...
    Attributes:
        ...
        attribute_values (MutableSequence[google.ads.googleads.v18.resources.types.FeedItemAttributeValue]):
            The feed item's attribute values.
        geo_targeting_restriction (google.ads.googleads.v18.enums.types.GeoTargetingRestrictionEnum.GeoTargetingRestriction):
        ...
        policy_infos (MutableSequence[google.ads.googleads.v18.resources.types.FeedItemPlaceholderPolicyInfo]):
...
class FeedItemAttributeValue(proto.Message):
    ...
    Attributes:
        ...
        price_value (google.ads.googleads.v18.common.types.Money):
...
class FeedItemPlaceholderPolicyInfo(proto.Message):
    ...
    Attributes:
        placeholder_type_enum (google.ads.googleads.v18.enums.types.PlaceholderTypeEnum.PlaceholderType):
        ...
        policy_topic_entries (MutableSequence[google.ads.googleads.v18.common.types.PolicyTopicEntry]):
            ...
            the placeholder type.
        validation_status (google.ads.googleads.v18.enums.types.FeedItemValidationStatusEnum.FeedItemValidationStatus):
            Output only. The validation status of the
            placeholder type.
        validation_errors (MutableSequence[google.ads.googleads.v18.resources.types.FeedItemValidationError]):
            Output only. List of placeholder type
            validation errors.
        quality_approval_status (google.ads.googleads.v18.enums.types.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatus):
            Output only. Placeholder type quality
            evaluation approval status.
        quality_disapproval_reasons (MutableSequence[google.ads.googleads.v18.enums.types.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason]):
...
class FeedItemValidationError(proto.Message):
    ...
    Attributes:
        validation_error (google.ads.googleads.v18.errors.types.FeedItemValidationErrorEnum.FeedItemValidationError):
