...
class AdGroupAdAssetView(proto.Message):
    ...
    Attributes:
        ...
        asset (google.protobuf.wrappers_pb2.StringValue):
            ...
            ad group ad.
        field_type (google.ads.googleads.v5.enums.types.AssetFieldTypeEnum.AssetFieldType):
        ...
        policy_summary (google.ads.googleads.v5.resources.types.AdGroupAdAssetPolicySummary):
            Output only. Policy information for the ad
            group ad asset.
        performance_label (google.ads.googleads.v5.enums.types.AssetPerformanceLabelEnum.AssetPerformanceLabel):
