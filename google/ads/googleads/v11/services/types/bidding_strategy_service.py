...
class MutateBiddingStrategiesRequest(proto.Message):
    ...
    [BiddingStrategyService.MutateBiddingStrategies][google.ads.googleads.v11.services.BiddingStrategyService.MutateBiddingStrategies].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose
            bidding strategies are being modified.
        operations (Sequence[google.ads.googleads.v11.services.types.BiddingStrategyOperation]):
...
class BiddingStrategyOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v11.resources.types.BiddingStrategy):
            Create operation: No resource name is
            expected for the new bidding strategy.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v11.resources.types.BiddingStrategy):
...
class MutateBiddingStrategiesResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v11.services.types.MutateBiddingStrategyResult]):
