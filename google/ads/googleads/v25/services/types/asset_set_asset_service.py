...
class MutateAssetSetAssetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v25.services.types.AssetSetAssetOperation]):
...
class AssetSetAssetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v25.resources.types.AssetSetAsset):
...
class MutateAssetSetAssetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v25.services.types.MutateAssetSetAssetResult]):
