...
class FeedItemTargetServiceClient(metaclass=FeedItemTargetServiceClientMeta):
    ...
    def get_feed_item_target(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetFeedItemTargetRequest`):
        ...
        Returns:
            google.ads.googleads.v8.resources.types.FeedItemTarget:
                A feed item target.
        """
    ...
    def mutate_feed_item_targets(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateFeedItemTargetsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.FeedItemTargetOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateFeedItemTargetsResponse:
