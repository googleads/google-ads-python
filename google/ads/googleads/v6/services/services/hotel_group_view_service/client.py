...
class HotelGroupViewServiceClient(metaclass=HotelGroupViewServiceClientMeta):
    ...
    def get_hotel_group_view(
        ...
        *,
        ...
        r"""Returns the requested Hotel Group View in full
        detail.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetHotelGroupViewRequest`):
                The request object. Request message for
                [HotelGroupViewService.GetHotelGroupView][google.ads.googleads.v6.services.HotelGroupViewService.GetHotelGroupView].
        ...
        Returns:
            google.ads.googleads.v6.resources.types.HotelGroupView:
                A hotel group view.
        """
