...
from google.ads.googleads.v6.enums.types import billing_setup_status
...
class BillingSetup(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v6.enums.types.BillingSetupStatusEnum.BillingSetupStatus):
        ...
        payments_account_info (google.ads.googleads.v6.resources.types.BillingSetup.PaymentsAccountInfo):
    ...
    class PaymentsAccountInfo(proto.Message):
        ...
        payments_account_id = proto.Field(proto.STRING, number=6, optional=True)
        payments_account_name = proto.Field(
            proto.STRING, number=7, optional=True
        )
        payments_profile_id = proto.Field(proto.STRING, number=8, optional=True)
