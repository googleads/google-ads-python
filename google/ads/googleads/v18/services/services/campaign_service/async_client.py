...
class CampaignServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v18.services.CampaignServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def mutate_campaigns(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v18.services.types.MutateCampaignsRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`MutableSequence[google.ads.googleads.v18.services.types.CampaignOperation]`):
        ...
        Returns:
            google.ads.googleads.v18.services.types.MutateCampaignsResponse:
