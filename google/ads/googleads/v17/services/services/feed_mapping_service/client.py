...
from .transports.grpc_asyncio import FeedMappingServiceGrpcAsyncIOTransport
...
class FeedMappingServiceClientMeta(type):
    ...
    _transport_registry["grpc_asyncio"] = FeedMappingServiceGrpcAsyncIOTransport
...
class FeedMappingServiceClient(metaclass=FeedMappingServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = FeedMappingServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                FeedMappingServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = FeedMappingServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = FeedMappingServiceClient._read_environment_variables()
        self._client_cert_source = (
            FeedMappingServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = FeedMappingServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, FeedMappingServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(FeedMappingServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or FeedMappingServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                FeedMappingServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., FeedMappingServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v17.services.FeedMappingServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_feed_mappings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateFeedMappingsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v17.services.types.FeedMappingOperation]):
