...
class CustomerExtensionSettingServiceClient(
    ...
    def get_customer_extension_setting(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetCustomerExtensionSettingRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.CustomerExtensionSetting:
    ...
    def mutate_customer_extension_settings(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateCustomerExtensionSettingsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.CustomerExtensionSettingOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateCustomerExtensionSettingsResponse:
