...
from google.ads.google_ads.v4.proto.services import shopping_performance_view_service_pb2_grpc


class ShoppingPerformanceViewServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v4.services ShoppingPerformanceViewService API.
