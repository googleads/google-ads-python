...
from google.ads.google_ads.v6.proto.services import campaign_extension_setting_service_pb2_grpc


class CampaignExtensionSettingServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v6.services CampaignExtensionSettingService API.
