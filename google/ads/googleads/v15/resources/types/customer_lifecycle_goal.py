...
class CustomerLifecycleGoal(proto.Message):
    ...
    Attributes:
        ...
        lifecycle_goal_customer_definition_settings (google.ads.googleads.v15.resources.types.CustomerLifecycleGoal.LifecycleGoalCustomerDefinitionSettings):
            Output only. Common lifecycle goal settings
            shared among different types of lifecycle goals.
        customer_acquisition_goal_value_settings (google.ads.googleads.v15.common.types.LifecycleGoalValueSettings):
