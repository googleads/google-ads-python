...
class BiddingSeasonalityAdjustmentServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, BiddingSeasonalityAdjustmentServiceTransport]]): The
    ...
    def mutate_bidding_seasonality_adjustments(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateBiddingSeasonalityAdjustmentsRequest, dict, None]):
