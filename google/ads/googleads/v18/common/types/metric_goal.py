...
from google.ads.googleads.v18.enums.types import experiment_metric
from google.ads.googleads.v18.enums.types import experiment_metric_direction
...
class MetricGoal(proto.Message):
    ...
    Attributes:
        ...
        direction (google.ads.googleads.v18.enums.types.ExperimentMetricDirectionEnum.ExperimentMetricDirection):
