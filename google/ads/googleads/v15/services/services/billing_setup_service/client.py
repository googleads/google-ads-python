...
class BillingSetupServiceClient(metaclass=BillingSetupServiceClientMeta):
    ...
    def mutate_billing_setup(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateBillingSetupRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateBillingSetupResponse:
