...
"""Accesses the google.ads.googleads.v3.services KeywordPlanIdeaService API."""
...
from google.ads.google_ads.v3.services import keyword_plan_idea_service_client_config
from google.ads.google_ads.v3.services.transports import keyword_plan_idea_service_grpc_transport
from google.ads.google_ads.v3.proto.services import keyword_plan_idea_service_pb2
...
class KeywordPlanIdeaServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v3.services.KeywordPlanIdeaService'
    ...
    def generate_keyword_ideas(
        ...
        Args:
            ...
            geo_target_constants (list[Union[dict, ~google.ads.googleads_v3.types.StringValue]]): The resource names of the location to target.
                Max 10

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.StringValue`
            keyword_plan_network (~google.ads.googleads_v3.types.KeywordPlanNetwork): Targeting network.
            keyword_and_url_seed (Union[dict, ~google.ads.googleads_v3.types.KeywordAndUrlSeed]): A Keyword and a specific Url to generate ideas from
                e.g. cars, www.example.com/cars.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.KeywordAndUrlSeed`
            keyword_seed (Union[dict, ~google.ads.googleads_v3.types.KeywordSeed]): A Keyword or phrase to generate ideas from, e.g. cars.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.KeywordSeed`
            url_seed (Union[dict, ~google.ads.googleads_v3.types.UrlSeed]): A specific url to generate ideas from, e.g. www.example.com/cars.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.UrlSeed`
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.GenerateKeywordIdeaResponse` instance.
        ...
        return self._inner_api_calls['generate_keyword_ideas'](request, retry=retry, timeout=timeout, metadata=metadata)
