...
class SharedCriterionServiceClient(metaclass=SharedCriterionServiceClientMeta):
    ...
    def get_shared_criterion(
        self,
        request: Union[
            shared_criterion_service.GetSharedCriterionRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetSharedCriterionRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.SharedCriterion:
    ...
    def mutate_shared_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateSharedCriteriaRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.SharedCriterionOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateSharedCriteriaResponse:
