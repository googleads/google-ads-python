...
"""Accesses the google.ads.googleads.v2.services LandingPageViewService API."""
...
from google.ads.google_ads.v2.services import landing_page_view_service_client_config
...
class LandingPageViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.LandingPageViewService'
    ...
    def get_landing_page_view(
        ...
        Args:
            resource_name (str): The resource name of the landing page view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.LandingPageView` instance.
