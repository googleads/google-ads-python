...
from google.ads.googleads.v16.enums.types import listing_group_filter_type_enum
...
class AssetGroupListingGroupFilter(proto.Message):
    ...
    Attributes:
        ...
        id (int):
            ...
            ListingGroupFilter.
        type_ (google.ads.googleads.v16.enums.types.ListingGroupFilterTypeEnum.ListingGroupFilterType):
            Immutable. Type of a listing group filter
            node.
        listing_source (google.ads.googleads.v16.enums.types.ListingGroupFilterListingSourceEnum.ListingGroupFilterListingSource):
            Immutable. The source of listings filtered by
            this listing group filter.
        case_value (google.ads.googleads.v16.resources.types.ListingGroupFilterDimension):
        ...
        path (google.ads.googleads.v16.resources.types.ListingGroupFilterDimensionPath):
...
class ListingGroupFilterDimensionPath(proto.Message):
    ...
    Attributes:
        dimensions (MutableSequence[google.ads.googleads.v16.resources.types.ListingGroupFilterDimension]):
...
class ListingGroupFilterDimension(proto.Message):
    ...
    Attributes:
        product_category (google.ads.googleads.v16.resources.types.ListingGroupFilterDimension.ProductCategory):
            Category of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_brand (google.ads.googleads.v16.resources.types.ListingGroupFilterDimension.ProductBrand):
            Brand of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_channel (google.ads.googleads.v16.resources.types.ListingGroupFilterDimension.ProductChannel):
            Locality of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_condition (google.ads.googleads.v16.resources.types.ListingGroupFilterDimension.ProductCondition):
            Condition of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_custom_attribute (google.ads.googleads.v16.resources.types.ListingGroupFilterDimension.ProductCustomAttribute):
            Custom attribute of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_item_id (google.ads.googleads.v16.resources.types.ListingGroupFilterDimension.ProductItemId):
            Item id of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_type (google.ads.googleads.v16.resources.types.ListingGroupFilterDimension.ProductType):
            Type of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        webpage (google.ads.googleads.v16.resources.types.ListingGroupFilterDimension.Webpage):
    ...
    class ProductCategory(proto.Message):
        ...
        Attributes:
            ...
            level (google.ads.googleads.v16.enums.types.ListingGroupFilterProductCategoryLevelEnum.ListingGroupFilterProductCategoryLevel):
    ...
    class ProductChannel(proto.Message):
        ...
        Attributes:
            channel (google.ads.googleads.v16.enums.types.ListingGroupFilterProductChannelEnum.ListingGroupFilterProductChannel):
    ...
    class ProductCondition(proto.Message):
        ...
        Attributes:
            condition (google.ads.googleads.v16.enums.types.ListingGroupFilterProductConditionEnum.ListingGroupFilterProductCondition):
    ...
    class ProductCustomAttribute(proto.Message):
        ...
        Attributes:
            value (str):
                ...
                This field is a member of `oneof`_ ``_value``.
            index (google.ads.googleads.v16.enums.types.ListingGroupFilterCustomAttributeIndexEnum.ListingGroupFilterCustomAttributeIndex):
    ...
    class ProductType(proto.Message):
        ...
        Attributes:
            value (str):
                ...
                This field is a member of `oneof`_ ``_value``.
            level (google.ads.googleads.v16.enums.types.ListingGroupFilterProductTypeLevelEnum.ListingGroupFilterProductTypeLevel):
                Level of the type.
        """
    ...
    class Webpage(proto.Message):
        ...
        Attributes:
            conditions (MutableSequence[google.ads.googleads.v16.resources.types.ListingGroupFilterDimension.WebpageCondition]):
