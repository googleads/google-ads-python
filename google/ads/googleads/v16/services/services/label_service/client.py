...
class LabelServiceClient(metaclass=LabelServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, LabelServiceTransport]]): The
    ...
    def mutate_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateLabelsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateLabelsResponse:
