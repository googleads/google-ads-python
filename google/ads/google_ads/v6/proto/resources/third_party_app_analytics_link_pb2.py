...
# source: google/ads/googleads_v6/proto/resources/third_party_app_analytics_link.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v6/proto/resources/third_party_app_analytics_link.proto',
...
ThirdPartyAppAnalyticsLink = _reflection.GeneratedProtocolMessageType('ThirdPartyAppAnalyticsLink', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads_v6.proto.resources.third_party_app_analytics_link_pb2'
  ,
  '__doc__': """A data sharing connection, allowing the import of third party app
  analytics into a Google Ads Customer.
  
  Attributes:
      resource_name:
          Immutable. The resource name of the third party app analytics
          link. Third party app analytics link resource names have the
          form:  ``customers/{customer_id}/thirdPartyAppAnalyticsLinks/{
          account_link_id}``
      shareable_link_id:
          Output only. The shareable link ID that should be provided to
          the third party when setting up app analytics. This is able to
          be regenerated using regenerate method in the
