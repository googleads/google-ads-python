...
from google.ads.googleads.v25.enums.types import consent_status
...
class Consent(proto.Message):
    ...
    Attributes:
        ad_user_data (google.ads.googleads.v25.enums.types.ConsentStatusEnum.ConsentStatus):
            This represents consent for ad user data.
        ad_personalization (google.ads.googleads.v25.enums.types.ConsentStatusEnum.ConsentStatus):
