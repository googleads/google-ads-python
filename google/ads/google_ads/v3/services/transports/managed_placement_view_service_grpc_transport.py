...
from google.ads.google_ads.v3.proto.services import managed_placement_view_service_pb2_grpc


class ManagedPlacementViewServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v3.services ManagedPlacementViewService API.
