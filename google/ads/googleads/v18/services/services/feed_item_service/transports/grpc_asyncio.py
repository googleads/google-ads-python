...
class FeedItemServiceGrpcAsyncIOTransport(FeedItemServiceTransport):
    """gRPC AsyncIO backend transport for FeedItemService.
    ...
    def mutate_feed_items(
        ...
        Returns:
            Callable[[~.MutateFeedItemsRequest],
                    Awaitable[~.MutateFeedItemsResponse]]:
        ...
        if "mutate_feed_items" not in self._stubs:
            self._stubs["mutate_feed_items"] = self._logged_channel.unary_unary(
                "/google.ads.googleads.v18.services.FeedItemService/MutateFeedItems",
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_feed_items: self._wrap_method(
...
__all__ = ("FeedItemServiceGrpcAsyncIOTransport",)
