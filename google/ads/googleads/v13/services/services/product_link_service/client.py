...
class ProductLinkServiceClient(metaclass=ProductLinkServiceClientMeta):
    ...
    def create_product_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.CreateProductLinkRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.CreateProductLinkResponse:
    ...
    def remove_product_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.RemoveProductLinkRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v13.services.types.RemoveProductLinkResponse:
