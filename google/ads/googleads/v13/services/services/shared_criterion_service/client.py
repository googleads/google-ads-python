...
class SharedCriterionServiceClient(metaclass=SharedCriterionServiceClientMeta):
    ...
    def mutate_shared_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateSharedCriteriaRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v13.services.types.SharedCriterionOperation]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateSharedCriteriaResponse:
