...
"""Accesses the google.ads.googleads.v5.services GeoTargetConstantService API."""
...
from google.ads.google_ads.v5.services import geo_target_constant_service_client_config
from google.ads.google_ads.v5.services.transports import geo_target_constant_service_grpc_transport
from google.ads.google_ads.v5.proto.services import geo_target_constant_service_pb2
...
class GeoTargetConstantServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v5.services.GeoTargetConstantService'
    ...
    def get_geo_target_constant(
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.GeoTargetConstant` instance.
    ...
    def suggest_geo_target_constants(
        ...
        Args:
            locale (str): If possible, returned geo targets are translated using this locale. If not,
                ...
                targets.
            country_code (str): Returned geo targets are restricted to this country code.
            location_names (Union[dict, ~google.ads.googleads_v5.types.LocationNames]): The location names to search by. At most 25 names can be set.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v5.types.LocationNames`
            geo_targets (Union[dict, ~google.ads.googleads_v5.types.GeoTargets]): The geo target constant resource names to filter by.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v5.types.GeoTargets`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
                be retried using a default configuration.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.SuggestGeoTargetConstantsResponse` instance.
