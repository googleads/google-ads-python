...
from google.ads.googleads.v25.enums.types import interaction_event_type
from google.ads.googleads.v25.enums.types import quality_score_bucket
...
class Metrics(proto.Message):
    ...
    Attributes:
        ...
        cross_device_conversions_by_conversion_date (float):
            ...
            Details for the ``by_conversion_date`` columns are available
        ...
        historical_creative_quality_score (google.ads.googleads.v25.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
            The creative historical quality score.
        historical_landing_page_quality_score (google.ads.googleads.v25.enums.types.QualityScoreBucketEnum.QualityScoreBucket):
        ...
        interaction_event_types (MutableSequence[google.ads.googleads.v25.enums.types.InteractionEventTypeEnum.InteractionEventType]):
        ...
        search_volume (google.ads.googleads.v25.common.types.SearchVolumeRange):
        ...
        incremental_conversions (float):
            ...
            conversions directly attributable to the ad
            campaign.

            This field is a member of `oneof`_ ``_incremental_conversions``.
        incremental_conversions_winner_score (float):
            The probability that this experiment arm is
            the winner for incremental conversions. This
            value is between 0.0 and 1.0.

            This field is a member of `oneof`_ ``_incremental_conversions_winner_score``.
        incremental_conversion_value (float):
            The estimated additional conversion value the
            ads generated. Measures the incremental revenue
            or value from your campaigns.

            This field is a member of `oneof`_ ``_incremental_conversion_value``.
        incremental_conversion_value_winner_score (float):
            The probability that this experiment arm is
            the winner for incremental conversion value.
            This value is between 0.0 and 1.0.

            This field is a member of `oneof`_ ``_incremental_conversion_value_winner_score``.
        conversion_lift_baseline_conversions (float):
            Represents the number of conversions that
            would have occurred naturally without ad
            exposure, based on the behavior of the control
            group. Often referred to as "Control"
            conversions.

            This field is a member of `oneof`_ ``_conversion_lift_baseline_conversions``.
        conversion_lift_baseline_conversion_value (float):
            Represents the baseline conversion value from
            users not exposed to the ads.
        ...
        conversion_lift_exposed_conversion_value (float):
            Represents the total conversion value from
            users exposed to the ads.

            This field is a member of `oneof`_ ``_conversion_lift_exposed_conversion_value``.
        cost_per_incremental_conversion (float):
            The estimated cost incurred for each
            additional conversion generated by the campaign.
            This is the Incremental Cost Per Acquisition
            (iCPA).

            This field is a member of `oneof`_ ``_cost_per_incremental_conversion``.
        cost_per_incremental_conversion_winner_score (float):
            The probability that this experiment arm is
            the winner for cost per incremental conversion.
            This value is between 0.0 and 1.0.

            This field is a member of `oneof`_ ``_cost_per_incremental_conversion_winner_score``.
        cost_per_incremental_conversion_p90_lower_bound (float):
            The lower bound of the 90% confidence interval for
            cost_per_incremental_conversion. The lowest likely cost you
            paid per incremental conversion.

            This field is a member of `oneof`_ ``_cost_per_incremental_conversion_p90_lower_bound``.
        cost_per_incremental_conversion_p90_upper_bound (float):
            The upper bound of the 90% confidence interval for
            cost_per_incremental_conversion. The highest likely cost you
            paid per incremental conversion.

            This field is a member of `oneof`_ ``_cost_per_incremental_conversion_p90_upper_bound``.
        incremental_conversions_p90_lower_bound (float):
            The lower bound of the 90% confidence interval for
            incremental_conversions. The "conservative" estimate of your
            success. It is the minimum number of additional sales you
            can be 90% sure were caused by your ads.

            This field is a member of `oneof`_ ``_incremental_conversions_p90_lower_bound``.
        incremental_conversions_p90_upper_bound (float):
            The upper bound of the 90% confidence interval for
            incremental_conversions. The "optimistic" estimate of your
            success. It is the maximum number of additional sales likely
            driven by your ads.

            This field is a member of `oneof`_ ``_incremental_conversions_p90_upper_bound``.
        incremental_conversions_p_value (float):
            The conversions p-value provides a measure of
            the statistical significance for the detected
            lift in conversions. It calculates the
            likelihood that your incremental conversions
            were driven by ad performance rather than being
            a merely random occurrence.

            This field is a member of `oneof`_ ``_incremental_conversions_p_value``.
        incremental_conversion_value_p90_lower_bound (float):
            The lower bound of the 90% confidence interval for
            incremental_conversion_value. Shows the minimum amount of
            extra revenue ($) you can be 90% certain was generated by
            the campaign.

            This field is a member of `oneof`_ ``_incremental_conversion_value_p90_lower_bound``.
        incremental_conversion_value_p90_upper_bound (float):
            The upper bound of the 90% confidence interval for
            incremental_conversion_value. The highest amount of extra
            revenue ($) likely generated by the campaign.

            This field is a member of `oneof`_ ``_incremental_conversion_value_p90_upper_bound``.
        incremental_conversion_value_p_value (float):
            The conversions value p-value provides a
            measure of the statistical significance for the
            detected lift in conversions value. It
            calculates the likelihood that your incremental
            conversion value was driven by ad performance
            rather than being a merely random occurrence.

            This field is a member of `oneof`_ ``_incremental_conversion_value_p_value``.
        incremental_conversion_value_per_cost (float):
            The incremental return on ad spend (iROAS),
            calculated as the additional conversion value
            generated per unit of campaign cost. Measures
            the return on your ad spend in terms of
            incremental value.

            This field is a member of `oneof`_ ``_incremental_conversion_value_per_cost``.
        incremental_conversion_value_per_cost_winner_score (float):
            The probability that this experiment arm is
            the winner for incremental conversion value per
            cost. This value is between 0.0 and 1.0.

            This field is a member of `oneof`_ ``_incremental_conversion_value_per_cost_winner_score``.
        incremental_conversion_value_per_cost_p90_lower_bound (float):
            The lower bound of the 90% confidence
            interval for incremental conversion value per
            cost. The "Guaranteed" return. Even if the data
            is noisy, you can be 90% sure your return was at
            least this high.

            This field is a member of `oneof`_ ``_incremental_conversion_value_per_cost_p90_lower_bound``.
        incremental_conversion_value_per_cost_p90_upper_bound (float):
            The upper bound of the 90% confidence
            interval for incremental conversion value per
            cost. The "Potential" return. The maximum likely
            revenue generated for every dollar spent.

            This field is a member of `oneof`_ ``_incremental_conversion_value_per_cost_p90_upper_bound``.
        relative_conversion_lift (float):
            The percentage increase in conversions in the
            exposed group compared to the control group.

            This field is a member of `oneof`_ ``_relative_conversion_lift``.
        relative_conversion_lift_p90_lower_bound (float):
            The lower bound of the 90% confidence interval for
            relative_conversion_lift. The minimum percentage increase
            you can be 90% sure occurred.

            This field is a member of `oneof`_ ``_relative_conversion_lift_p90_lower_bound``.
        relative_conversion_lift_p90_upper_bound (float):
            The upper bound of the 90% confidence interval for
            relative_conversion_lift. The maximum percentage increase
            you can be 90% sure occurred.

            This field is a member of `oneof`_ ``_relative_conversion_lift_p90_upper_bound``.
        relative_conversion_value_lift (float):
            The percentage increase in conversion value
            in the exposed group compared to the control
            group.

            This field is a member of `oneof`_ ``_relative_conversion_value_lift``.
        relative_conversion_value_lift_p90_lower_bound (float):
            The lower bound of the 90% confidence interval for
            relative_conversion_value_lift. The lowest likely percentage
            of incremental revenue the ads generated.

            This field is a member of `oneof`_ ``_relative_conversion_value_lift_p90_lower_bound``.
        relative_conversion_value_lift_p90_upper_bound (float):
            The upper bound of the 90% confidence interval for
            relative_conversion_value_lift. The highest likely
            percentage of incremental revenue the ads generated.

            This field is a member of `oneof`_ ``_relative_conversion_value_lift_p90_upper_bound``.
        absolute_brand_lift (float):
            These metrics estimate the additional brand
            lift directly attributable to the ad campaign.

            This field is a member of `oneof`_ ``_absolute_brand_lift``.
        absolute_brand_lift_p90_lower_bound (float):
            Lower bound of the 90% confidence interval
            for absolute brand lift. The "conservative"
            estimate of your success. It is the minimum
            increase you can be 90% sure was caused by your
            ads.

            This field is a member of `oneof`_ ``_absolute_brand_lift_p90_lower_bound``.
        absolute_brand_lift_p90_upper_bound (float):
            Upper bound of the 90% confidence interval
            for absolute brand lift. The "optimistic"
            estimate of your success. It is the maximum
            increase likely driven by your ads.

            This field is a member of `oneof`_ ``_absolute_brand_lift_p90_upper_bound``.
        absolute_brand_lift_p_value (float):
            The p-value provides a measure of the
            statistical significance for the detected brand
            lift. It calculates the likelihood that your
            incremental lift was driven by ad performance
            rather than being a merely random occurrence.
            Achieving a low score of 0.10 indicates 90%
            confidence that your advertising efforts
            directly generated the additional lift.

            This field is a member of `oneof`_ ``_absolute_brand_lift_p_value``.
        brand_lift_baseline_positive_response_rate (float):
            ...
            This field is a member of `oneof`_ ``_brand_lift_baseline_positive_response_rate``.
        brand_lift_baseline_positive_response_rate_p90_lower_bound (float):
            Lower bound of the 90% confidence interval
            for the baseline positive response rate.
            Represents the conservative baseline rate of
            positive brand responses you could expect
            naturally without ad exposure.

            This field is a member of `oneof`_ ``_brand_lift_baseline_positive_response_rate_p90_lower_bound``.
        brand_lift_baseline_positive_response_rate_p90_upper_bound (float):
            Upper bound of the 90% confidence interval
            for the baseline positive response rate.
            Represents the optimistic baseline rate of
            positive brand responses expected naturally
            without ad exposure.

            This field is a member of `oneof`_ ``_brand_lift_baseline_positive_response_rate_p90_upper_bound``.
        brand_lift_exposed_positive_responder_fractional_cookies (float):
            Estimated unique users showing interest in
            the exposed group. This value is "fractional"
            because it represents a statistical estimate
            rather than a raw headcount.

            This field is a member of `oneof`_ ``_brand_lift_exposed_positive_responder_fractional_cookies``.
        brand_lift_exposed_positive_responder_fractional_cookies_p90_lower_bound (float):
            The lower bound of the 90% confidence
            interval for the estimated number of unique
            cookies within the ad-exposed group that are
            estimated to have a positive brand attitude, as
            measured by the Brand Lift survey.

            This field is a member of `oneof`_ ``_brand_lift_exposed_positive_responder_fractional_cookies_p90_lower_bound``.
        brand_lift_exposed_positive_responder_fractional_cookies_p90_upper_bound (float):
            The upper bound of the 90% confidence
            interval for the estimated number of unique
            cookies within the ad-exposed group that are
            estimated to have experienced a positive shift
            in brand attitude, as measured by the Brand Lift
            survey.
        ...
        brand_lift_exposed_positive_response_rate (float):
            ...
            This field is a member of `oneof`_ ``_brand_lift_exposed_positive_response_rate``.
        brand_lift_exposed_positive_response_rate_p90_lower_bound (float):
            Lower bound of the 90% confidence interval
            for the exposed positive response rate.
            Represents the conservative estimate of positive
            brand responses among users exposed to your ads.

            This field is a member of `oneof`_ ``_brand_lift_exposed_positive_response_rate_p90_lower_bound``.
        brand_lift_exposed_positive_response_rate_p90_upper_bound (float):
            Upper bound of the 90% confidence interval
            for the exposed positive response rate.
            Represents the maximum estimate of positive
            brand responses among users exposed to your ads.

            This field is a member of `oneof`_ ``_brand_lift_exposed_positive_response_rate_p90_upper_bound``.
        brand_lift_responses_exposed (float):
            The number of survey responses from users who
            were exposed to the ads.

            This field is a member of `oneof`_ ``_brand_lift_responses_exposed``.
        brand_lift_responses_suppressed (float):
            Brand lift responses suppressed.

            This field is a member of `oneof`_ ``_brand_lift_responses_suppressed``.
        brand_lift_suppressed_positive_responder_fractional_cookies (float):
            Estimated unique users showing interest in
            the control/suppressed group. This value is
            "fractional" because it represents a statistical
            estimate.

            This field is a member of `oneof`_ ``_brand_lift_suppressed_positive_responder_fractional_cookies``.
        brand_lift_suppressed_positive_responder_fractional_cookies_p90_lower_bound (float):
            Lower bound of the 90% confidence interval
            for the estimated number of fractional cookies
            within the control group that are categorized as
            positive responders. This lower bound provides a
            statistically supported minimum value for the
            total fractional cookies in the control group
            showing a positive brand attitude.

            This field is a member of `oneof`_ ``_brand_lift_suppressed_positive_responder_fractional_cookies_p90_lower_bound``.
        brand_lift_suppressed_positive_responder_fractional_cookies_p90_upper_bound (float):
            Represents the upper bound of the 90%
            confidence interval for the estimated number of
            fractional cookies within the control group that
            are categorized as positive responders. This
            upper bound provides a statistically supported
            maximum value for the total fractional cookies
            in the control group showing a positive brand
            attitude.

            This field is a member of `oneof`_ ``_brand_lift_suppressed_positive_responder_fractional_cookies_p90_upper_bound``.
        brand_lift_total_responses (float):
            The total number of survey responses
            collected across both the exposed and control
            groups.

            This field is a member of `oneof`_ ``_brand_lift_total_responses``.
        cost_per_lifted_cookie (float):
            The estimated cost incurred for each
            additional person moved to a positive brand
            state by the campaign. Helps assess the
            cost-effectiveness of your ad spend in driving
            brand growth.

            This field is a member of `oneof`_ ``_cost_per_lifted_cookie``.
        ...
        fractional_lifted_cookies (float):
            Estimated number of unique users who were
            moved to a positive brand state directly by the
            campaign (that is, lifted users).

            This field is a member of `oneof`_ ``_fractional_lifted_cookies``.
        fractional_lifted_cookies_p90_lower_bound (float):
            The lower bound of the 90% confidence interval for the
            fractional_lifted_cookies metric. This value represents a
            statistically conservative estimate of the minimum number of
            cookies for whom a positive Brand Lift is attributed to the
            ad exposure.

            This field is a member of `oneof`_ ``_fractional_lifted_cookies_p90_lower_bound``.
        fractional_lifted_cookies_p90_upper_bound (float):
            The upper bound of the 90% confidence interval for the
            fractional_lifted_cookies metric. This value represents a
            statistically optimistic estimate of the maximum number of
            cookies that may have experienced a positive Brand Lift.

            This field is a member of `oneof`_ ``_fractional_lifted_cookies_p90_upper_bound``.
        headroom_brand_lift (float):
            The increase in positive brand responses
            relative to the total potential growth
            remaining.

            This field is a member of `oneof`_ ``_headroom_brand_lift``.
        headroom_brand_lift_p90_lower_bound (float):
            Lower bound of the 90% confidence interval
            for headroom brand lift. The minimum growth rate
            relative to remaining brand potential you can be
            90% confident was driven by your ads.

            This field is a member of `oneof`_ ``_headroom_brand_lift_p90_lower_bound``.
        headroom_brand_lift_p90_upper_bound (float):
            Upper bound of the 90% confidence interval
            for headroom brand lift. The maximum growth rate
            relative to remaining brand potential likely
            driven by your ads.

            This field is a member of `oneof`_ ``_headroom_brand_lift_p90_upper_bound``.
        relative_brand_lift (float):
            The percentage increase in positive responses
            in the exposed group compared to the control
            group.

            This field is a member of `oneof`_ ``_relative_brand_lift``.
        relative_brand_lift_p90_lower_bound (float):
            The lower bound of the 90% confidence
            interval for Relative Brand Lift. Represents the
            minimum percentage increase in positive brand
            perception among users who were exposed to the
            ads, relative to the baseline positive response
            rate observed in the control group.

            This field is a member of `oneof`_ ``_relative_brand_lift_p90_lower_bound``.
        relative_brand_lift_p90_upper_bound (float):
            The upper bound of the 90% confidence
            interval for Relative Brand Lift. Represents the
            maximum percentage increase in positive brand
            perception in the ad-exposed group, relative to
            the control group's baseline positive response
            rate, at a 90% confidence level.

            This field is a member of `oneof`_ ``_relative_brand_lift_p90_upper_bound``.
        youtube_comments (int):
            The number of comments on YouTube Shorts
            videos attributed to ad impressions.

            This field is a member of `oneof`_ ``_youtube_comments``.
        youtube_likes (int):
            The number of likes on YouTube Shorts videos
            attributed to ad impressions.

            This field is a member of `oneof`_ ``_youtube_likes``.
        youtube_shares (int):
            The number of shares on YouTube Shorts videos
            attributed to ad impressions.

            This field is a member of `oneof`_ ``_youtube_shares``.
        original_conversion_value (float):
            The original conversion value from biddable
            conversions. This is the unadjusted value of
            conversions before any value rule adjustments,
            such as conversion value rules or lifecycle
    ...
    incremental_conversions: float = proto.Field(
        proto.DOUBLE,
        number=473,
        optional=True,
    )
    incremental_conversions_winner_score: float = proto.Field(
        proto.DOUBLE,
        number=601,
        optional=True,
    )
    incremental_conversion_value: float = proto.Field(
        proto.DOUBLE,
        number=474,
        optional=True,
    )
    incremental_conversion_value_winner_score: float = proto.Field(
        proto.DOUBLE,
        number=602,
        optional=True,
    )
    conversion_lift_baseline_conversions: float = proto.Field(
        proto.DOUBLE,
        number=475,
        optional=True,
    )
    conversion_lift_baseline_conversion_value: float = proto.Field(
        proto.DOUBLE,
        number=476,
        optional=True,
    )
    conversion_lift_exposed_conversions: float = proto.Field(
        proto.DOUBLE,
        number=477,
        optional=True,
    )
    conversion_lift_exposed_conversion_value: float = proto.Field(
        proto.DOUBLE,
        number=478,
        optional=True,
    )
    cost_per_incremental_conversion: float = proto.Field(
        proto.DOUBLE,
        number=479,
        optional=True,
    )
    cost_per_incremental_conversion_winner_score: float = proto.Field(
        proto.DOUBLE,
        number=603,
        optional=True,
    )
    cost_per_incremental_conversion_p90_lower_bound: float = proto.Field(
        proto.DOUBLE,
        number=480,
        optional=True,
    )
    cost_per_incremental_conversion_p90_upper_bound: float = proto.Field(
        proto.DOUBLE,
        number=481,
        optional=True,
    )
    incremental_conversions_p90_lower_bound: float = proto.Field(
        proto.DOUBLE,
        number=482,
        optional=True,
    )
    incremental_conversions_p90_upper_bound: float = proto.Field(
        proto.DOUBLE,
        number=483,
        optional=True,
    )
    incremental_conversions_p_value: float = proto.Field(
        proto.DOUBLE,
        number=484,
        optional=True,
    )
    incremental_conversion_value_p90_lower_bound: float = proto.Field(
        proto.DOUBLE,
        number=485,
        optional=True,
    )
    incremental_conversion_value_p90_upper_bound: float = proto.Field(
        proto.DOUBLE,
        number=486,
        optional=True,
    )
    incremental_conversion_value_p_value: float = proto.Field(
        proto.DOUBLE,
        number=487,
        optional=True,
    )
    incremental_conversion_value_per_cost: float = proto.Field(
        proto.DOUBLE,
        number=488,
        optional=True,
    )
    incremental_conversion_value_per_cost_winner_score: float = proto.Field(
        proto.DOUBLE,
        number=604,
        optional=True,
    )
    incremental_conversion_value_per_cost_p90_lower_bound: float = proto.Field(
        proto.DOUBLE,
        number=489,
        optional=True,
    )
    incremental_conversion_value_per_cost_p90_upper_bound: float = proto.Field(
        proto.DOUBLE,
        number=490,
        optional=True,
    )
    relative_conversion_lift: float = proto.Field(
        proto.DOUBLE,
        number=491,
        optional=True,
    )
    relative_conversion_lift_p90_lower_bound: float = proto.Field(
        proto.DOUBLE,
        number=492,
        optional=True,
    )
    relative_conversion_lift_p90_upper_bound: float = proto.Field(
        proto.DOUBLE,
        number=493,
        optional=True,
    )
    relative_conversion_value_lift: float = proto.Field(
        proto.DOUBLE,
        number=494,
        optional=True,
    )
    relative_conversion_value_lift_p90_lower_bound: float = proto.Field(
        proto.DOUBLE,
        number=495,
        optional=True,
    )
    relative_conversion_value_lift_p90_upper_bound: float = proto.Field(
        proto.DOUBLE,
        number=496,
        optional=True,
    )
    absolute_brand_lift: float = proto.Field(
        proto.DOUBLE,
        number=497,
        optional=True,
    )
    absolute_brand_lift_p90_lower_bound: float = proto.Field(
        proto.DOUBLE,
        number=498,
        optional=True,
    )
    absolute_brand_lift_p90_upper_bound: float = proto.Field(
        proto.DOUBLE,
        number=499,
        optional=True,
    )
    absolute_brand_lift_p_value: float = proto.Field(
        proto.DOUBLE,
        number=500,
        optional=True,
    )
    brand_lift_baseline_positive_response_rate: float = proto.Field(
        proto.DOUBLE,
        number=501,
        optional=True,
    )
    ...
    brand_lift_exposed_positive_response_rate: float = proto.Field(
        proto.DOUBLE,
        number=507,
        optional=True,
    )
    ...
    brand_lift_responses_exposed: float = proto.Field(
        proto.DOUBLE,
        number=510,
        optional=True,
    )
    brand_lift_responses_suppressed: float = proto.Field(
        proto.DOUBLE,
        number=511,
        optional=True,
    )
    ...
    brand_lift_total_responses: float = proto.Field(
        proto.DOUBLE,
        number=515,
        optional=True,
    )
    cost_per_lifted_cookie: float = proto.Field(
        proto.DOUBLE,
        number=516,
        optional=True,
    )
    cost_per_lifted_cookie_p90_lower_bound: float = proto.Field(
        proto.DOUBLE,
        number=517,
        optional=True,
    )
    cost_per_lifted_cookie_p90_upper_bound: float = proto.Field(
        proto.DOUBLE,
        number=518,
        optional=True,
    )
    fractional_lifted_cookies: float = proto.Field(
        proto.DOUBLE,
        number=519,
        optional=True,
    )
    fractional_lifted_cookies_p90_lower_bound: float = proto.Field(
        proto.DOUBLE,
        number=520,
        optional=True,
    )
    fractional_lifted_cookies_p90_upper_bound: float = proto.Field(
        proto.DOUBLE,
        number=521,
        optional=True,
    )
    headroom_brand_lift: float = proto.Field(
        proto.DOUBLE,
        number=522,
        optional=True,
    )
    headroom_brand_lift_p90_lower_bound: float = proto.Field(
        proto.DOUBLE,
        number=523,
        optional=True,
    )
    headroom_brand_lift_p90_upper_bound: float = proto.Field(
        proto.DOUBLE,
        number=524,
        optional=True,
    )
    relative_brand_lift: float = proto.Field(
        proto.DOUBLE,
        number=525,
        optional=True,
    )
    relative_brand_lift_p90_lower_bound: float = proto.Field(
        proto.DOUBLE,
        number=526,
        optional=True,
    )
    relative_brand_lift_p90_upper_bound: float = proto.Field(
        proto.DOUBLE,
        number=527,
        optional=True,
    )
    youtube_comments: int = proto.Field(
        proto.INT64,
        number=528,
        optional=True,
    )
    youtube_likes: int = proto.Field(
        proto.INT64,
        number=529,
        optional=True,
    )
    youtube_shares: int = proto.Field(
        proto.INT64,
        number=530,
        optional=True,
    )
