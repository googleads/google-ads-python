...
class Campaign(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v9.enums.types.CampaignStatusEnum.CampaignStatus):
            ...
            defaults to ENABLED.
        serving_status (google.ads.googleads.v9.enums.types.CampaignServingStatusEnum.CampaignServingStatus):
            Output only. The ad serving status of the
            campaign.
        ad_serving_optimization_status (google.ads.googleads.v9.enums.types.AdServingOptimizationStatusEnum.AdServingOptimizationStatus):
        ...
        advertising_channel_sub_type (google.ads.googleads.v9.enums.types.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType):
        ...
        url_custom_parameters (Sequence[google.ads.googleads.v9.common.types.CustomParameter]):
            ...
            ``mobile_final_urls``.
        real_time_bidding_setting (google.ads.googleads.v9.common.types.RealTimeBiddingSetting):
            Settings for Real-Time Bidding, a feature
            only available for campaigns targeting the Ad
            Exchange network.
        network_settings (google.ads.googleads.v9.resources.types.Campaign.NetworkSettings):
            The network settings for the campaign.
        hotel_setting (google.ads.googleads.v9.resources.types.Campaign.HotelSettingInfo):
            Immutable. The hotel setting for the
            campaign.
        dynamic_search_ads_setting (google.ads.googleads.v9.resources.types.Campaign.DynamicSearchAdsSetting):
            The setting for controlling Dynamic Search
            Ads (DSA).
        shopping_setting (google.ads.googleads.v9.resources.types.Campaign.ShoppingSetting):
            The setting for controlling Shopping
            campaigns.
        targeting_setting (google.ads.googleads.v9.common.types.TargetingSetting):
            Setting for targeting related features.
        geo_target_type_setting (google.ads.googleads.v9.resources.types.Campaign.GeoTargetTypeSetting):
            The setting for ads geotargeting.
        local_campaign_setting (google.ads.googleads.v9.resources.types.Campaign.LocalCampaignSetting):
            The setting for local campaign.
        app_campaign_setting (google.ads.googleads.v9.resources.types.Campaign.AppCampaignSetting):
            The setting related to App Campaign.
        labels (Sequence[str]):
            Output only. The resource names of labels
            attached to this campaign.
        experiment_type (google.ads.googleads.v9.enums.types.CampaignExperimentTypeEnum.CampaignExperimentType):
        ...
        video_brand_safety_suitability (google.ads.googleads.v9.enums.types.BrandSafetySuitabilityEnum.BrandSafetySuitability):
            Output only. 3-Tier Brand Safety setting for
            the campaign.
        vanity_pharma (google.ads.googleads.v9.resources.types.Campaign.VanityPharma):
            Describes how unbranded pharma ads will be
            displayed.
        selective_optimization (google.ads.googleads.v9.resources.types.Campaign.SelectiveOptimization):
        ...
        optimization_goal_setting (google.ads.googleads.v9.resources.types.Campaign.OptimizationGoalSetting):
            Optimization goal setting for this campaign,
            which includes a set of optimization goal types.
        tracking_setting (google.ads.googleads.v9.resources.types.Campaign.TrackingSetting):
            Output only. Campaign-level settings for
            tracking information.
        payment_mode (google.ads.googleads.v9.enums.types.PaymentModeEnum.PaymentMode):
    ...
    class AppCampaignSetting(proto.Message):
        ...
        Attributes:
            bidding_strategy_goal_type (google.ads.googleads.v9.enums.types.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalType):
    ...
    class VanityPharma(proto.Message):
        ...
        Attributes:
            vanity_pharma_display_url_mode (google.ads.googleads.v9.enums.types.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlMode):
                The display mode for vanity pharma URLs.
            vanity_pharma_text (google.ads.googleads.v9.enums.types.VanityPharmaTextEnum.VanityPharmaText):
    ...
    class GeoTargetTypeSetting(proto.Message):
        ...
        Attributes:
            positive_geo_target_type (google.ads.googleads.v9.enums.types.PositiveGeoTargetTypeEnum.PositiveGeoTargetType):
                The setting used for positive geotargeting in
                this particular campaign.
            negative_geo_target_type (google.ads.googleads.v9.enums.types.NegativeGeoTargetTypeEnum.NegativeGeoTargetType):
    ...
    class OptimizationGoalSetting(proto.Message):
        ...
        Attributes:
            optimization_goal_types (Sequence[google.ads.googleads.v9.enums.types.OptimizationGoalTypeEnum.OptimizationGoalType]):
    ...
    class LocalCampaignSetting(proto.Message):
        ...
        Attributes:
            location_source_type (google.ads.googleads.v9.enums.types.LocationSourceTypeEnum.LocationSourceType):
