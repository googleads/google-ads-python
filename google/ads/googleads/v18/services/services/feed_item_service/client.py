...
class FeedItemServiceClient(metaclass=FeedItemServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, FeedItemServiceTransport]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, FeedItemServiceTransport]]): The
    ...
    def mutate_feed_items(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateFeedItemsRequest, dict, None]):
