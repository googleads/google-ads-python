...
from google.ads.googleads.v13.resources.types import payments_account
...
class ListPaymentsAccountsResponse(proto.Message):
    ...
    Attributes:
        payments_accounts (MutableSequence[google.ads.googleads.v13.resources.types.PaymentsAccount]):
