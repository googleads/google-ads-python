...
class CustomerExtensionSettingServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, CustomerExtensionSettingServiceTransport]]): The
    ...
    def mutate_customer_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateCustomerExtensionSettingsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateCustomerExtensionSettingsResponse:
