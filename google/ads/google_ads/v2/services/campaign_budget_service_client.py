...
"""Accesses the google.ads.googleads.v2.services CampaignBudgetService API."""
...
from google.ads.google_ads.v2.services import campaign_budget_service_client_config
...
class CampaignBudgetServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.CampaignBudgetService'
    ...
    def get_campaign_budget(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.CampaignBudget` instance.
    ...
    def mutate_campaign_budgets(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.CampaignBudgetOperation]]): The list of operations to perform on individual campaign budgets.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.CampaignBudgetOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateCampaignBudgetsResponse` instance.
