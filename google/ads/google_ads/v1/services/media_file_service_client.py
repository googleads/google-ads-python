...
"""Accesses the google.ads.googleads.v1.services MediaFileService API."""
...
from google.ads.google_ads.v1.services import media_file_service_client_config
...
class MediaFileServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.MediaFileService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=media_file_service_grpc_transport.
    ...
    def get_media_file(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.MediaFile` instance.
        ...
        return self._inner_api_calls['get_media_file'](
    ...
    def mutate_media_files(self,
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v1.types.MediaFileOperation]]): The list of operations to perform on individual media file.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.MediaFileOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.MutateMediaFilesResponse` instance.
