...
from google.ads.googleads.v16.enums.types import campaign_draft_status
...
class CampaignDraft(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v16.enums.types.CampaignDraftStatusEnum.CampaignDraftStatus):
