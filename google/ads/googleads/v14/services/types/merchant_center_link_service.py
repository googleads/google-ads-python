...
class ListMerchantCenterLinksResponse(proto.Message):
    ...
    Attributes:
        merchant_center_links (MutableSequence[google.ads.googleads.v14.resources.types.MerchantCenterLink]):
...
class MutateMerchantCenterLinkResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v14.services.types.MutateMerchantCenterLinkResult):
