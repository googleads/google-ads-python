...
"""Accesses the google.ads.googleads.v1.services FeedItemService API."""
...
from google.ads.google_ads.v1.services import feed_item_service_client_config
...
class FeedItemServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.FeedItemService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=feed_item_service_grpc_transport.
    ...
    def get_feed_item(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.FeedItem` instance.
        ...
        return self._inner_api_calls['get_feed_item'](
    ...
    def mutate_feed_items(self,
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v1.types.FeedItemOperation]]): The list of operations to perform on individual feed items.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.FeedItemOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.MutateFeedItemsResponse` instance.
