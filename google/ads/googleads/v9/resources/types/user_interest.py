...
from google.ads.googleads.v9.enums.types import user_interest_taxonomy_type
...
class UserInterest(proto.Message):
    ...
    Attributes:
        ...
        taxonomy_type (google.ads.googleads.v9.enums.types.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType):
