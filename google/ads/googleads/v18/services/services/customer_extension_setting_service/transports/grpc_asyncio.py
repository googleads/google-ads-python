...
class CustomerExtensionSettingServiceGrpcAsyncIOTransport(
    CustomerExtensionSettingServiceTransport
):
    """gRPC AsyncIO backend transport for CustomerExtensionSettingService.
    ...
    def mutate_customer_extension_settings(
        ...
        Returns:
            Callable[[~.MutateCustomerExtensionSettingsRequest],
                    Awaitable[~.MutateCustomerExtensionSettingsResponse]]:
        ...
        if "mutate_customer_extension_settings" not in self._stubs:
            self._stubs["mutate_customer_extension_settings"] = (
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_customer_extension_settings: self._wrap_method(
...
__all__ = ("CustomerExtensionSettingServiceGrpcAsyncIOTransport",)
