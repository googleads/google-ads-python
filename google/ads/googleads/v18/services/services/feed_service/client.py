...
class FeedServiceClient(metaclass=FeedServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v18.services.FeedServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_feeds(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateFeedsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v18.services.types.FeedOperation]):
