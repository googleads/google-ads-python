...
# source: google/ads/googleads_v2/proto/services/feed_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v2/proto/services/feed_service.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads__v2_dot_proto_dot_resources_dot_feed__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_protobuf_dot_field__mask__pb2.DESCRIPTOR,google_dot_rpc_dot_status__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,])
...
_FEEDOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v2_dot_proto_dot_resources_dot_feed__pb2._FEED
_FEEDOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v2_dot_proto_dot_resources_dot_feed__pb2._FEED
...
GetFeedRequest = _reflection.GeneratedProtocolMessageType('GetFeedRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v2.proto.services.feed_service_pb2'
  ,
  __doc__ = """Request message for
  [FeedService.GetFeed][google.ads.googleads.v2.services.FeedService.GetFeed].
...
MutateFeedsRequest = _reflection.GeneratedProtocolMessageType('MutateFeedsRequest', (_message.Message,), dict(
  ...
  ,
  __doc__ = """Request message for
  [FeedService.MutateFeeds][google.ads.googleads.v2.services.FeedService.MutateFeeds].
...
_FEEDSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v2_dot_proto_dot_resources_dot_feed__pb2._FEED,
    serialized_options=_b('\202\323\344\223\002)\022\'/v2/{resource_name=customers/*/feeds/*}'),
  ),
  _descriptor.MethodDescriptor(
    name='MutateFeeds',
    ...
    serialized_options=_b('\202\323\344\223\002/\"*/v2/customers/{customer_id=*}/feeds:mutate:\001*'),
  ),
])
