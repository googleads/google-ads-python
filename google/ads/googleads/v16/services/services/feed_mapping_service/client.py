...
class FeedMappingServiceClient(metaclass=FeedMappingServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, FeedMappingServiceTransport]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, FeedMappingServiceTransport]]): The
    ...
    def mutate_feed_mappings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateFeedMappingsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v16.services.types.FeedMappingOperation]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateFeedMappingsResponse:
