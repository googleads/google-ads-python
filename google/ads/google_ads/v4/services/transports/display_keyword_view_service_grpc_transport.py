...
from google.ads.google_ads.v4.proto.services import display_keyword_view_service_pb2_grpc


class DisplayKeywordViewServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v4.services DisplayKeywordViewService API.
