...
"""Accesses the google.ads.googleads.v2.services CustomerManagerLinkService API."""
...
from google.ads.google_ads.v2.services import customer_manager_link_service_client_config
...
class CustomerManagerLinkServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.CustomerManagerLinkService'
    ...
    def get_customer_manager_link(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.CustomerManagerLink` instance.
    ...
    def mutate_customer_manager_link(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.CustomerManagerLinkOperation]]): The list of operations to perform on individual customer manager links.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.CustomerManagerLinkOperation`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateCustomerManagerLinkResponse` instance.
