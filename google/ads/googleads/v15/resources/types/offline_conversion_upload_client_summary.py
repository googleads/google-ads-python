...
class OfflineConversionUploadClientSummary(proto.Message):
    ...
    Attributes:
        ...
        client (google.ads.googleads.v15.enums.types.OfflineEventUploadClientEnum.OfflineEventUploadClient):
            Output only. Client type of the upload event.
        status (google.ads.googleads.v15.enums.types.OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus):
        ...
        daily_summaries (MutableSequence[google.ads.googleads.v15.resources.types.OfflineConversionSummary]):
            Output only. Summary of history stats by last
            N days.
        job_summaries (MutableSequence[google.ads.googleads.v15.resources.types.OfflineConversionSummary]):
            Output only. Summary of history stats by last
            N jobs.
        alerts (MutableSequence[google.ads.googleads.v15.resources.types.OfflineConversionAlert]):
...
class OfflineConversionAlert(proto.Message):
    ...
    Attributes:
        error (google.ads.googleads.v15.resources.types.OfflineConversionError):
