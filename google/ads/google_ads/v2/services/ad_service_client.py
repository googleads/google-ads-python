...
"""Accesses the google.ads.googleads.v2.services AdService API."""
...
from google.ads.google_ads.v2.services import ad_service_client_config
...
class AdServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.AdService'
    ...
    def get_ad(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.Ad` instance.
    ...
    def mutate_ads(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.AdOperation]]): The list of operations to perform on individual ads.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.AdOperation`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateAdsResponse` instance.
