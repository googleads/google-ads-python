...
class AdGroupCriterionServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, AdGroupCriterionServiceTransport]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, AdGroupCriterionServiceTransport]]): The
    ...
    def mutate_ad_group_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateAdGroupCriteriaRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateAdGroupCriteriaResponse:
