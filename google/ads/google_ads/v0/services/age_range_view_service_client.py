...
"""Accesses the google.ads.googleads.v0.services AgeRangeViewService API."""
...
from google.ads.google_ads.v0.services import age_range_view_service_client_config
...
class AgeRangeViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v0.services.AgeRangeViewService'
    ...
    def get_age_range_view(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.AgeRangeView` instance.
