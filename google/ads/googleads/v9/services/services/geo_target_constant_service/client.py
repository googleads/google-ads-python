...
class GeoTargetConstantServiceClient(
    ...
    def get_geo_target_constant(
        self,
        request: Union[
            geo_target_constant_service.GetGeoTargetConstantRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetGeoTargetConstantRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.GeoTargetConstant:
    ...
    def suggest_geo_target_constants(
        self,
        request: Union[
            geo_target_constant_service.SuggestGeoTargetConstantsRequest, dict
        ] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: float = None,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.SuggestGeoTargetConstantsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v9.services.types.SuggestGeoTargetConstantsResponse:
