...
class InvoiceServiceClient(metaclass=InvoiceServiceClientMeta):
    ...
    def list_invoices(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.ListInvoicesRequest`):
                The request object.
            ...
            issue_year (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            issue_month (:class:`google.ads.googleads.v7.enums.types.MonthOfYearEnum.MonthOfYear`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.ListInvoicesResponse:
