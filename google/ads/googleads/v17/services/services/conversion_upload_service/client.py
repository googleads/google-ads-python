...
class ConversionUploadServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, ConversionUploadServiceTransport]]): The
    ...
    def upload_click_conversions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.UploadClickConversionsRequest, dict, None]):
    ...
    def upload_call_conversions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.UploadCallConversionsRequest, dict, None]):
                The request object. Request message for
