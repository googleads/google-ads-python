...
"""Accesses the google.ads.googleads.v1.services ClickViewService API."""
...
from google.ads.google_ads.v1.services import click_view_service_client_config
...
class ClickViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.ClickViewService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=click_view_service_grpc_transport.
    ...
    def get_click_view(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.ClickView` instance.
        ...
        if 'get_click_view' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_click_view'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_click_view,
                    default_retry=self._method_configs['GetClickView'].retry,
                    default_timeout=self._method_configs['GetClickView'].
                    timeout,
        ...
        return self._inner_api_calls['get_click_view'](
