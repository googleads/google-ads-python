...
from google.ads.google_ads.v5.proto.services import merchant_center_link_service_pb2_grpc


class MerchantCenterLinkServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v5.services MerchantCenterLinkService API.
