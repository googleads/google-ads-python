...
class KeywordPlanAdGroupKeywordServiceClient(
    ...
    def get_keyword_plan_ad_group_keyword(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v5.resources.types.KeywordPlanAdGroupKeyword:
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.KeywordPlanAdGroupKeywordOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateKeywordPlanAdGroupKeywordsResponse:
