...
"""Accesses the google.ads.googleads.v3.services AdGroupCriterionService API."""
...
from google.ads.google_ads.v3.services import ad_group_criterion_service_client_config
from google.ads.google_ads.v3.services.transports import ad_group_criterion_service_grpc_transport
from google.ads.google_ads.v3.proto.services import ad_group_criterion_service_pb2
...
class AdGroupCriterionServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v3.services.AdGroupCriterionService'
    ...
    def get_ad_group_criterion(
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.AdGroupCriterion` instance.
    ...
    def mutate_ad_group_criteria(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v3.types.AdGroupCriterionOperation]]): Required. The list of operations to perform on individual criteria.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.AdGroupCriterionOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.MutateAdGroupCriteriaResponse` instance.
