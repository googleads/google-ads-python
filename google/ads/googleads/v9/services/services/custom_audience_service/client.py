...
class CustomAudienceServiceClient(metaclass=CustomAudienceServiceClientMeta):
    ...
    def get_custom_audience(
        self,
        request: Union[
            custom_audience_service.GetCustomAudienceRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCustomAudienceRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CustomAudience:
    ...
    def mutate_custom_audiences(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCustomAudiencesRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CustomAudienceOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCustomAudiencesResponse:
