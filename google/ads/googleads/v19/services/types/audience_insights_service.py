...
from google.ads.googleads.v19.enums.types import audience_insights_dimension
...
class GenerateInsightsFinderReportRequest(proto.Message):
    ...
    Attributes:
        ...
        baseline_audience (google.ads.googleads.v19.services.types.BasicInsightsAudience):
            Required. A baseline audience for this
            report, typically all people in a region.
        specific_audience (google.ads.googleads.v19.services.types.BasicInsightsAudience):
...
class GenerateAudienceCompositionInsightsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer.
        audience (google.ads.googleads.v19.services.types.InsightsAudience):
            Required. The audience of interest for which
            insights are being requested.
        baseline_audience (google.ads.googleads.v19.services.types.InsightsAudience):
        ...
        data_month (str):
            ...
            days of data.
        dimensions (MutableSequence[google.ads.googleads.v19.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension]):
            ...
            YOUTUBE_CHANNEL, YOUTUBE_DYNAMIC_LINEUP,
...
class GenerateAudienceCompositionInsightsResponse(proto.Message):
    ...
    Attributes:
        sections (MutableSequence[google.ads.googleads.v19.services.types.AudienceCompositionSection]):
...
class GenerateSuggestedTargetingInsightsRequest(proto.Message):
    ...
    Attributes:
        ...
        audience_definition (google.ads.googleads.v19.services.types.InsightsAudienceDefinition):
            Provide a seed audience to get suggestions
            for.

            This field is a member of `oneof`_ ``audience_input``.
        audience_description (google.ads.googleads.v19.services.types.InsightsAudienceDescription):
...
class GenerateSuggestedTargetingInsightsResponse(proto.Message):
    ...
    Attributes:
        suggestions (MutableSequence[google.ads.googleads.v19.services.types.TargetingSuggestionMetrics]):
...
class TargetingSuggestionMetrics(proto.Message):
    ...
    Attributes:
        locations (MutableSequence[google.ads.googleads.v19.common.types.AudienceInsightsAttributeMetadata]):
            Suggested location targeting. These attributes all have
            dimension GEO_TARGET_COUNTRY or SUB_COUNTRY_LOCATION
        age_ranges (MutableSequence[google.ads.googleads.v19.common.types.AgeRangeInfo]):
            Suggested age targeting; may be empty
            indicating no age targeting.
        gender (google.ads.googleads.v19.common.types.GenderInfo):
            Suggested gender targeting.  If present, this
            attribute has dimension GENDER.
        parental_status (google.ads.googleads.v19.common.types.ParentalStatusInfo):
            A Parental Status value (parent, or not a
            parent).
        user_interests (MutableSequence[google.ads.googleads.v19.common.types.AudienceInsightsAttributeMetadata]):
...
class ListAudienceInsightsAttributesRequest(proto.Message):
    ...
    Attributes:
        ...
        dimensions (MutableSequence[google.ads.googleads.v19.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension]):
            ...
            GEO_TARGET_COUNTRY, SUB_COUNTRY_LOCATION,
            YOUTUBE_DYNAMIC_LINEUP, AFFINITY_USER_INTEREST,
        ...
        customer_insights_group (str):
            The name of the customer being planned for.
            This is a user-defined value.
        location_country_filters (MutableSequence[google.ads.googleads.v19.common.types.LocationInfo]):
            ...
            return an error.
        youtube_reach_location (google.ads.googleads.v19.common.types.LocationInfo):
...
class ListAudienceInsightsAttributesResponse(proto.Message):
    ...
    Attributes:
        attributes (MutableSequence[google.ads.googleads.v19.common.types.AudienceInsightsAttributeMetadata]):
...
class ListInsightsEligibleDatesResponse(proto.Message):
    ...
    Attributes:
        ...
        last_thirty_days (google.ads.googleads.v19.common.types.DateRange):
...
class GenerateAudienceOverlapInsightsResponse(proto.Message):
    ...
    Attributes:
        primary_attribute_metadata (google.ads.googleads.v19.common.types.AudienceInsightsAttributeMetadata):
            Metadata for the primary attribute, including
            potential YouTube reach.
        dimension_results (MutableSequence[google.ads.googleads.v19.services.types.DimensionOverlapResult]):
...
class DimensionOverlapResult(proto.Message):
    ...
    Attributes:
        dimension (google.ads.googleads.v19.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension):
            The dimension of all the attributes in this
            section.
        items (MutableSequence[google.ads.googleads.v19.services.types.AudienceOverlapItem]):
...
class GenerateTargetingSuggestionMetricsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer.
        audiences (MutableSequence[google.ads.googleads.v19.services.types.BasicInsightsAudience]):
...
class BasicInsightsAudience(proto.Message):
    ...
    Attributes:
        ...
        sub_country_locations (MutableSequence[google.ads.googleads.v19.common.types.LocationInfo]):
        ...
        user_interests (MutableSequence[google.ads.googleads.v19.common.types.UserInterestInfo]):
            User interests defining this audience.
            Affinity and In-Market audiences are supported.
        topics (MutableSequence[google.ads.googleads.v19.common.types.AudienceInsightsTopic]):
...
class InsightsAudienceDescription(proto.Message):
    ...
    Attributes:
        ...
        audience_description (str):
            ...
            travel".
        marketing_objective (google.ads.googleads.v19.enums.types.AudienceInsightsMarketingObjectiveEnum.AudienceInsightsMarketingObjective):
...
class InsightsAudience(proto.Message):
    ...
    Attributes:
        ...
        parental_status (google.ads.googleads.v19.common.types.ParentalStatusInfo):
            ...
            status.
        income_ranges (MutableSequence[google.ads.googleads.v19.common.types.IncomeRangeInfo]):
            Household income percentile ranges for the
            audience.  If absent, the audience does not
            restrict by household income range.
        dynamic_lineups (MutableSequence[google.ads.googleads.v19.common.types.AudienceInsightsDynamicLineup]):
            Dynamic lineups representing the YouTube
            content viewed by the audience.
        topic_audience_combinations (MutableSequence[google.ads.googleads.v19.services.types.InsightsAudienceAttributeGroup]):
    ...
    dynamic_lineups: MutableSequence[
        audience_insights_attribute.AudienceInsightsDynamicLineup
    ] = proto.RepeatedField(
        proto.MESSAGE,
        number=9,
        message=audience_insights_attribute.AudienceInsightsDynamicLineup,
    )
...
class AudienceCompositionSection(proto.Message):
    ...
    Attributes:
        ...
        top_attributes (MutableSequence[google.ads.googleads.v19.services.types.AudienceCompositionAttribute]):
        ...
        clustered_attributes (MutableSequence[google.ads.googleads.v19.services.types.AudienceCompositionAttributeCluster]):
...
class AudienceCompositionAttributeCluster(proto.Message):
    ...
    Attributes:
        ...
        cluster_metrics (google.ads.googleads.v19.services.types.AudienceCompositionMetrics):
            ...
            field is unset.
        attributes (MutableSequence[google.ads.googleads.v19.services.types.AudienceCompositionAttribute]):
...
class AudienceCompositionAttribute(proto.Message):
    ...
    Attributes:
        ...
        metrics (google.ads.googleads.v19.services.types.AudienceCompositionMetrics):
