...
# source: google/ads/googleads_v0/proto/enums/callout_placeholder_field.proto
...
_CALLOUTPLACEHOLDERFIELDENUM_CALLOUTPLACEHOLDERFIELD = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v0.enums.CalloutPlaceholderFieldEnum.CalloutPlaceholderField',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_CALLOUTPLACEHOLDERFIELDENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.enums.CalloutPlaceholderFieldEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
