...
class PaymentsAccountServiceClient(metaclass=PaymentsAccountServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, PaymentsAccountServiceTransport]]): The
    ...
    def list_payments_accounts(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.ListPaymentsAccountsRequest, dict, None]):
