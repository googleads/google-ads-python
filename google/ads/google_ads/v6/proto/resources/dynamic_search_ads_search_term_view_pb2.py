...
# source: google/ads/googleads_v6/proto/resources/dynamic_search_ads_search_term_view.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v6/proto/resources/dynamic_search_ads_search_term_view.proto',
...
DynamicSearchAdsSearchTermView = _reflection.GeneratedProtocolMessageType('DynamicSearchAdsSearchTermView', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads_v6.proto.resources.dynamic_search_ads_search_term_view_pb2'
  ,
  ...
  Attributes:
      resource_name:
          ...
          dsSearchTermViews/{ad_group_id}~{search_term_fingerprint}~{hea
          dline_fingerprint}~{landing_page_fingerprint}~{page_url_finger
          print}``
      search_term:
