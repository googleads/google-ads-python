...
# source: google/ads/googleads_v2/proto/resources/ad_group_criterion_simulation.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v2/proto/resources/ad_group_criterion_simulation.proto',
...
_ADGROUPCRITERIONSIMULATION.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads__v2_dot_proto_dot_enums_dot_simulation__type__pb2._SIMULATIONTYPEENUM_SIMULATIONTYPE
_ADGROUPCRITERIONSIMULATION.fields_by_name['modification_method'].enum_type = google_dot_ads_dot_googleads__v2_dot_proto_dot_enums_dot_simulation__modification__method__pb2._SIMULATIONMODIFICATIONMETHODENUM_SIMULATIONMODIFICATIONMETHOD
...
_ADGROUPCRITERIONSIMULATION.fields_by_name['cpc_bid_point_list'].message_type = google_dot_ads_dot_googleads__v2_dot_proto_dot_common_dot_simulation__pb2._CPCBIDSIMULATIONPOINTLIST
...
AdGroupCriterionSimulation = _reflection.GeneratedProtocolMessageType('AdGroupCriterionSimulation', (_message.Message,), dict(
  DESCRIPTOR = _ADGROUPCRITERIONSIMULATION,
  __module__ = 'google.ads.googleads_v2.proto.resources.ad_group_criterion_simulation_pb2'
  ,
  ...
  DISPLAY KEYWORD CPC\_BID UNIFORM SEARCH KEYWORD CPC\_BID UNIFORM
  SHOPPING LISTING\_GROUP CPC\_BID UNIFORM
  
  
  Attributes:
      resource_name:
          The resource name of the ad group criterion simulation. Ad
          group criterion simulation resource names have the form:  ``cu
          stomers/{customer_id}/adGroupCriterionSimulations/{ad_group_id
          }~{criterion_id}~{type}~{modification_method}~{start_date}~{en
          d_date}``
      ad_group_id:
