...
class MutateCustomerFeedsRequest(proto.Message):
    ...
    operations: MutableSequence["CustomerFeedOperation"] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
...
class CustomerFeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v17.resources.types.CustomerFeed):
            Create operation: No resource name is
            expected for the new customer feed.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v17.resources.types.CustomerFeed):
    ...
    create: gagr_customer_feed.CustomerFeed = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
        message=gagr_customer_feed.CustomerFeed,
    )
    update: gagr_customer_feed.CustomerFeed = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_customer_feed.CustomerFeed,
...
class MutateCustomerFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v17.services.types.MutateCustomerFeedResult]):
    ...
    results: MutableSequence["MutateCustomerFeedResult"] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
