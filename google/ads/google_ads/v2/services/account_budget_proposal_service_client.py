...
"""Accesses the google.ads.googleads.v2.services AccountBudgetProposalService API."""
...
from google.ads.google_ads.v2.services import account_budget_proposal_service_client_config
...
class AccountBudgetProposalServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.AccountBudgetProposalService'
    ...
    def get_account_budget_proposal(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.AccountBudgetProposal` instance.
    ...
    def mutate_account_budget_proposal(
        ...
        Args:
            ...
            operation_ (Union[dict, ~google.ads.googleads_v2.types.AccountBudgetProposalOperation]): The operation to perform on an individual account-level budget proposal.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.AccountBudgetProposalOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateAccountBudgetProposalResponse` instance.
