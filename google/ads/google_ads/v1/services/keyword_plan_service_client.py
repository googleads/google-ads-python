...
"""Accesses the google.ads.googleads.v1.services KeywordPlanService API."""
...
from google.ads.google_ads.v1.services import keyword_plan_service_client_config
...
class KeywordPlanServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.KeywordPlanService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=keyword_plan_service_grpc_transport.
    ...
    def get_keyword_plan(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.KeywordPlan` instance.
        ...
        if 'get_keyword_plan' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_keyword_plan'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_keyword_plan,
                    default_retry=self._method_configs['GetKeywordPlan'].retry,
                    default_timeout=self._method_configs['GetKeywordPlan'].
                    timeout,
        ...
        return self._inner_api_calls['get_keyword_plan'](
    ...
    def mutate_keyword_plans(self,
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v1.types.KeywordPlanOperation]]): The list of operations to perform on individual keyword plans.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.KeywordPlanOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.MutateKeywordPlansResponse` instance.
        ...
        if 'mutate_keyword_plans' not in self._inner_api_calls:
            self._inner_api_calls[
                'mutate_keyword_plans'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.mutate_keyword_plans,
                    default_retry=self._method_configs['MutateKeywordPlans'].
                    retry,
                    default_timeout=self._method_configs['MutateKeywordPlans'].
                    timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['mutate_keyword_plans'](
            request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def generate_forecast_metrics(
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.GenerateForecastMetricsResponse` instance.
        ...
        if 'generate_forecast_metrics' not in self._inner_api_calls:
            self._inner_api_calls[
                'generate_forecast_metrics'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.generate_forecast_metrics,
                    default_retry=self.
                    _method_configs['GenerateForecastMetrics'].retry,
                    default_timeout=self.
                    _method_configs['GenerateForecastMetrics'].timeout,
                    client_info=self._client_info,
                )

        request = keyword_plan_service_pb2.GenerateForecastMetricsRequest(
            keyword_plan=keyword_plan, )
        return self._inner_api_calls['generate_forecast_metrics'](
            request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def generate_historical_metrics(
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.GenerateHistoricalMetricsResponse` instance.
        ...
        if 'generate_historical_metrics' not in self._inner_api_calls:
            self._inner_api_calls[
                'generate_historical_metrics'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.generate_historical_metrics,
                    default_retry=self.
                    _method_configs['GenerateHistoricalMetrics'].retry,
                    default_timeout=self.
                    _method_configs['GenerateHistoricalMetrics'].timeout,
                    client_info=self._client_info,
                )

        request = keyword_plan_service_pb2.GenerateHistoricalMetricsRequest(
            keyword_plan=keyword_plan, )
        return self._inner_api_calls['generate_historical_metrics'](
            request, retry=retry, timeout=timeout, metadata=metadata)
