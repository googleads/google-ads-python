...
# source: google/ads/googleads_v0/proto/services/campaign_audience_view_service.proto
...
_GETCAMPAIGNAUDIENCEVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.GetCampaignAudienceViewRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v0.services.GetCampaignAudienceViewRequest.resource_name', index=0,
...
GetCampaignAudienceViewRequest = _reflection.GeneratedProtocolMessageType('GetCampaignAudienceViewRequest', (_message.Message,), dict(
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v0.services.GetCampaignAudienceViewRequest)
  ))
...
_CAMPAIGNAUDIENCEVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v0.services.CampaignAudienceViewService.GetCampaignAudienceView',
    index=0,
