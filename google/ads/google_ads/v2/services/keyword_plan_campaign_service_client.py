...
"""Accesses the google.ads.googleads.v2.services KeywordPlanCampaignService API."""
...
from google.ads.google_ads.v2.services import keyword_plan_campaign_service_client_config
...
class KeywordPlanCampaignServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.KeywordPlanCampaignService'
    ...
    def get_keyword_plan_campaign(
        ...
        Args:
            resource_name (str): The resource name of the Keyword Plan campaign to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.KeywordPlanCampaign` instance.
    ...
    def mutate_keyword_plan_campaigns(
        ...
        Args:
            customer_id (str): The ID of the customer whose Keyword Plan campaigns are being modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.KeywordPlanCampaignOperation]]): The list of operations to perform on individual Keyword Plan campaigns.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.KeywordPlanCampaignOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateKeywordPlanCampaignsResponse` instance.
