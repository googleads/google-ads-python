...
class FeedMappingServiceGrpcAsyncIOTransport(FeedMappingServiceTransport):
    """gRPC AsyncIO backend transport for FeedMappingService.
    ...
    def mutate_feed_mappings(
        ...
        Returns:
            Callable[[~.MutateFeedMappingsRequest],
                    Awaitable[~.MutateFeedMappingsResponse]]:
        ...
        if "mutate_feed_mappings" not in self._stubs:
            self._stubs["mutate_feed_mappings"] = (
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_feed_mappings: self._wrap_method(
...
__all__ = ("FeedMappingServiceGrpcAsyncIOTransport",)
