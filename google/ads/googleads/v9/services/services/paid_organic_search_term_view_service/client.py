...
class PaidOrganicSearchTermViewServiceClient(
    ...
    def get_paid_organic_search_term_view(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetPaidOrganicSearchTermViewRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.PaidOrganicSearchTermView:
