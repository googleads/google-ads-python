...
from google.ads.google_ads.v0.proto.enums import budget_period_pb2 as google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_budget__period__pb2
...
_CAMPAIGNBUDGET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='has_recommended_budget', full_name='google.ads.googleads.v0.resources.CampaignBudget.has_recommended_budget', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='recommended_budget_amount_micros', full_name='google.ads.googleads.v0.resources.CampaignBudget.recommended_budget_amount_micros', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='period', full_name='google.ads.googleads.v0.resources.CampaignBudget.period', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='recommended_budget_estimated_change_weekly_clicks', full_name='google.ads.googleads.v0.resources.CampaignBudget.recommended_budget_estimated_change_weekly_clicks', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='recommended_budget_estimated_change_weekly_cost_micros', full_name='google.ads.googleads.v0.resources.CampaignBudget.recommended_budget_estimated_change_weekly_cost_micros', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='recommended_budget_estimated_change_weekly_interactions', full_name='google.ads.googleads.v0.resources.CampaignBudget.recommended_budget_estimated_change_weekly_interactions', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='recommended_budget_estimated_change_weekly_views', full_name='google.ads.googleads.v0.resources.CampaignBudget.recommended_budget_estimated_change_weekly_views', index=15,
...
_CAMPAIGNBUDGET.fields_by_name['period'].enum_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_budget__period__pb2._BUDGETPERIODENUM_BUDGETPERIOD
