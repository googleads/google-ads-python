...
class CustomerFeedServiceGrpcAsyncIOTransport(CustomerFeedServiceTransport):
    """gRPC AsyncIO backend transport for CustomerFeedService.
    ...
    def mutate_customer_feeds(
        ...
        Returns:
            Callable[[~.MutateCustomerFeedsRequest],
                    Awaitable[~.MutateCustomerFeedsResponse]]:
        ...
        if "mutate_customer_feeds" not in self._stubs:
            self._stubs["mutate_customer_feeds"] = (
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_customer_feeds: self._wrap_method(
...
__all__ = ("CustomerFeedServiceGrpcAsyncIOTransport",)
