...
class ConversionValueRuleServiceClient(
    ...
    def mutate_conversion_value_rules(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.MutateConversionValueRulesRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v10.services.types.MutateConversionValueRulesResponse:
