...
class CustomerConversionGoalServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the customer conversion goal service client.
        ...
        if isinstance(transport, CustomerConversionGoalServiceTransport):
            ...
            self._transport = CustomerConversionGoalServiceGrpcTransport(
    ...
    def mutate_customer_conversion_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCustomerConversionGoalsRequest, dict]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CustomerConversionGoalOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCustomerConversionGoalsResponse:
