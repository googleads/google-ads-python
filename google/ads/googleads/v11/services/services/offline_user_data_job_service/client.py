...
class OfflineUserDataJobServiceClient(
    ...
    def create_offline_user_data_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.CreateOfflineUserDataJobRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            job (google.ads.googleads.v11.resources.types.OfflineUserDataJob):
        ...
        Returns:
            google.ads.googleads.v11.services.types.CreateOfflineUserDataJobResponse:
    ...
    def add_offline_user_data_job_operations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.AddOfflineUserDataJobOperationsRequest, dict]):
                The request object. Request message for
            ...
            resource_name (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (Sequence[google.ads.googleads.v11.services.types.OfflineUserDataJobOperation]):
        ...
        Returns:
            google.ads.googleads.v11.services.types.AddOfflineUserDataJobOperationsResponse:
                Response message for
                   [OfflineUserDataJobService.AddOfflineUserDataJobOperations][google.ads.googleads.v11.services.OfflineUserDataJobService.AddOfflineUserDataJobOperations].
    ...
    def run_offline_user_data_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v11.services.types.RunOfflineUserDataJobRequest, dict]):
                The request object. Request message for
