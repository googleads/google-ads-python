...
# source: google/ads/googleads_v0/proto/services/mobile_app_category_constant_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v0/proto/services/mobile_app_category_constant_service.proto',
  package='google.ads.googleads.v0.services',
  syntax='proto3',
  serialized_options=_b('\n$com.google.ads.googleads.v0.servicesB%MobileAppCategoryConstantServiceProtoP\001ZHgoogle.golang.org/genproto/googleapis/ads/googleads/v0/services;services\242\002\003GAA\252\002 Google.Ads.GoogleAds.V0.Services\312\002 Google\\Ads\\GoogleAds\\V0\\Services\352\002$Google::Ads::GoogleAds::V0::Services'),
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads__v0_dot_proto_dot_resources_dot_mobile__app__category__constant__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,])
...
_GETMOBILEAPPCATEGORYCONSTANTREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.GetMobileAppCategoryConstantRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v0.services.GetMobileAppCategoryConstantRequest.resource_name', index=0,
...
GetMobileAppCategoryConstantRequest = _reflection.GeneratedProtocolMessageType('GetMobileAppCategoryConstantRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v0.proto.services.mobile_app_category_constant_service_pb2'
  ,
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v0.services.GetMobileAppCategoryConstantRequest)
  ))
...
_MOBILEAPPCATEGORYCONSTANTSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v0.services.MobileAppCategoryConstantService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v0.services.MobileAppCategoryConstantService.GetMobileAppCategoryConstant',
    index=0,
    containing_service=None,
    input_type=_GETMOBILEAPPCATEGORYCONSTANTREQUEST,
    output_type=google_dot_ads_dot_googleads__v0_dot_proto_dot_resources_dot_mobile__app__category__constant__pb2._MOBILEAPPCATEGORYCONSTANT,
    serialized_options=_b('\202\323\344\223\0022\0220/v0/{resource_name=mobileAppCategoryConstants/*}'),
  ),
])
