...
from google.ads.google_ads.v6.proto.services import managed_placement_view_service_pb2_grpc


class ManagedPlacementViewServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v6.services ManagedPlacementViewService API.
