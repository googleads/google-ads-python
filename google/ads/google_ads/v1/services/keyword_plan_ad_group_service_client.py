...
"""Accesses the google.ads.googleads.v1.services KeywordPlanAdGroupService API."""
...
from google.ads.google_ads.v1.services import keyword_plan_ad_group_service_client_config
...
class KeywordPlanAdGroupServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.KeywordPlanAdGroupService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=keyword_plan_ad_group_service_grpc_transport.
    ...
    def get_keyword_plan_ad_group(
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.KeywordPlanAdGroup` instance.
        ...
        return self._inner_api_calls['get_keyword_plan_ad_group'](
    ...
    def mutate_keyword_plan_ad_groups(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v1.types.KeywordPlanAdGroupOperation]]): The list of operations to perform on individual Keyword Plan ad groups.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.KeywordPlanAdGroupOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.MutateKeywordPlanAdGroupsResponse` instance.
