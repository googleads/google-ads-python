...
class DetailPlacementViewServiceClient(
    ...
    def get_detail_placement_view(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetDetailPlacementViewRequest`):
                The request object. Request message for
                [DetailPlacementViewService.GetDetailPlacementView][google.ads.googleads.v5.services.DetailPlacementViewService.GetDetailPlacementView].
        ...
        Returns:
            google.ads.googleads.v5.resources.types.DetailPlacementView:
