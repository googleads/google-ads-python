...
class CustomerClientLinkServiceClient(
    ...
    def get_customer_client_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetCustomerClientLinkRequest`):
                The request object. Request message for
                [CustomerClientLinkService.GetCustomerClientLink][google.ads.googleads.v4.services.CustomerClientLinkService.GetCustomerClientLink].
        ...
        Returns:
            google.ads.googleads.v4.resources.types.CustomerClientLink:
    ...
    def mutate_customer_client_link(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateCustomerClientLinkRequest`):
                The request object. Request message for
                [CustomerClientLinkService.MutateCustomerClientLink][google.ads.googleads.v4.services.CustomerClientLinkService.MutateCustomerClientLink].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v4.services.types.CustomerClientLinkOperation`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateCustomerClientLinkResponse:
