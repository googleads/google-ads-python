...
class ConversionGoalCampaignConfigServiceClient(
    ...
    def mutate_conversion_goal_campaign_configs(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateConversionGoalCampaignConfigsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateConversionGoalCampaignConfigsResponse:
