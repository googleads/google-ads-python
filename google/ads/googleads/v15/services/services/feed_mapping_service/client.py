...
class FeedMappingServiceClient(metaclass=FeedMappingServiceClientMeta):
    ...
    def mutate_feed_mappings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateFeedMappingsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v15.services.types.FeedMappingOperation]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateFeedMappingsResponse:
