...
class LanguageConstantServiceClient(
    ...
    def get_language_constant(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetLanguageConstantRequest`):
                The request object.
                Request message for
                [LanguageConstantService.GetLanguageConstant][google.ads.googleads.v7.services.LanguageConstantService.GetLanguageConstant].
        ...
        Returns:
            google.ads.googleads.v7.resources.types.LanguageConstant:
                A language.
        """
