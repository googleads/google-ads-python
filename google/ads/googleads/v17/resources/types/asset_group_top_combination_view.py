...
from google.ads.googleads.v17.common.types import asset_usage
...
class AssetGroupTopCombinationView(proto.Message):
    ...
    Attributes:
        ...
        asset_group_top_combinations (MutableSequence[google.ads.googleads.v17.resources.types.AssetGroupAssetCombinationData]):
...
class AssetGroupAssetCombinationData(proto.Message):
    ...
    Attributes:
        asset_combination_served_assets (MutableSequence[google.ads.googleads.v17.common.types.AssetUsage]):
