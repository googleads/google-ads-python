...
"""Accesses the google.ads.googleads.v2.services AdGroupAdLabelService API."""
...
from google.ads.google_ads.v2.services import ad_group_ad_label_service_client_config
...
class AdGroupAdLabelServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.AdGroupAdLabelService'
    ...
    def get_ad_group_ad_label(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.AdGroupAdLabel` instance.
    ...
    def mutate_ad_group_ad_labels(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.AdGroupAdLabelOperation]]): The list of operations to perform on ad group ad labels.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.AdGroupAdLabelOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateAdGroupAdLabelsResponse` instance.
