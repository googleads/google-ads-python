...
from google.ads.google_ads.v3.proto.services import display_keyword_view_service_pb2_grpc


class DisplayKeywordViewServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v3.services DisplayKeywordViewService API.
