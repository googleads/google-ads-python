...
"""Accesses the google.ads.googleads.v2.services KeywordPlanNegativeKeywordService API."""
...
from google.ads.google_ads.v2.services import keyword_plan_negative_keyword_service_client_config
...
class KeywordPlanNegativeKeywordServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.KeywordPlanNegativeKeywordService'
    ...
    def get_keyword_plan_negative_keyword(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.KeywordPlanNegativeKeyword` instance.
    ...
    def mutate_keyword_plan_negative_keywords(
        ...
        Args:
            customer_id (str): The ID of the customer whose negative keywords are being modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.KeywordPlanNegativeKeywordOperation]]): The list of operations to perform on individual Keyword Plan negative
                keywords.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.KeywordPlanNegativeKeywordOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateKeywordPlanNegativeKeywordsResponse` instance.
