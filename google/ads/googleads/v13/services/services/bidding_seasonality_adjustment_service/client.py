...
class BiddingSeasonalityAdjustmentServiceClient(
    ...
    def mutate_bidding_seasonality_adjustments(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateBiddingSeasonalityAdjustmentsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v13.services.types.BiddingSeasonalityAdjustmentOperation]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateBiddingSeasonalityAdjustmentsResponse:
