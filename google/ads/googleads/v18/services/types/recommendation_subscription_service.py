...
class MutateRecommendationSubscriptionRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v18.services.types.RecommendationSubscriptionOperation]):
    ...
    operations: MutableSequence[
        ...
        proto.MESSAGE, number=2, message="RecommendationSubscriptionOperation",
    )
...
class RecommendationSubscriptionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v18.resources.types.RecommendationSubscription):
            Create operation: No resource name is
            expected for the new subscription.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v18.resources.types.RecommendationSubscription):
    ...
    create: gagr_recommendation_subscription.RecommendationSubscription = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
        message=gagr_recommendation_subscription.RecommendationSubscription,
    )
    update: gagr_recommendation_subscription.RecommendationSubscription = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_recommendation_subscription.RecommendationSubscription,
...
class MutateRecommendationSubscriptionResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v18.services.types.MutateRecommendationSubscriptionResult]):
