...
class ExtensionFeedItemServiceClient(
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ExtensionFeedItemServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = ExtensionFeedItemServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ExtensionFeedItemServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = ExtensionFeedItemServiceClient._read_environment_variables()
        self._client_cert_source = (
            ExtensionFeedItemServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            ExtensionFeedItemServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, ExtensionFeedItemServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(ExtensionFeedItemServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ExtensionFeedItemServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                ExtensionFeedItemServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., ExtensionFeedItemServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v17.services.ExtensionFeedItemServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_extension_feed_items(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateExtensionFeedItemsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v17.services.types.ExtensionFeedItemOperation]):
