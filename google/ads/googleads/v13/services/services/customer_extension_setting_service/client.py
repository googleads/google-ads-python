...
class CustomerExtensionSettingServiceClient(
    ...
    def mutate_customer_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCustomerExtensionSettingsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateCustomerExtensionSettingsResponse:
