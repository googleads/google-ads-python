...
"""Accesses the google.ads.googleads.v2.services MerchantCenterLinkService API."""
...
from google.ads.google_ads.v2.services import merchant_center_link_service_client_config
...
class MerchantCenterLinkServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.MerchantCenterLinkService'
    ...
    def list_merchant_center_links(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.ListMerchantCenterLinksResponse` instance.
    ...
    def get_merchant_center_link(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MerchantCenterLink` instance.
    ...
    def mutate_merchant_center_link(
        ...
        Args:
            ...
            operation_ (Union[dict, ~google.ads.googleads_v2.types.MerchantCenterLinkOperation]): The operation to perform on the link

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.MerchantCenterLinkOperation`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateMerchantCenterLinkResponse` instance.
