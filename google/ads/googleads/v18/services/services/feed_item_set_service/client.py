...
from .transports.grpc_asyncio import FeedItemSetServiceGrpcAsyncIOTransport
...
class FeedItemSetServiceClientMeta(type):
    ...
    _transport_registry["grpc_asyncio"] = FeedItemSetServiceGrpcAsyncIOTransport
...
class FeedItemSetServiceClient(metaclass=FeedItemSetServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = FeedItemSetServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                FeedItemSetServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = FeedItemSetServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = FeedItemSetServiceClient._read_environment_variables()
        self._client_cert_source = (
            FeedItemSetServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = FeedItemSetServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, FeedItemSetServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(FeedItemSetServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or FeedItemSetServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                FeedItemSetServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(Callable[..., FeedItemSetServiceTransport], transport)
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v18.services.FeedItemSetServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_feed_item_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateFeedItemSetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v18.services.types.FeedItemSetOperation]):
