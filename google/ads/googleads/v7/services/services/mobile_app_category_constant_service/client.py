...
class MobileAppCategoryConstantServiceClient(
    ...
    def get_mobile_app_category_constant(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetMobileAppCategoryConstantRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v7.resources.types.MobileAppCategoryConstant:
