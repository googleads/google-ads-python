...
class MutateAdGroupFeedsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v16.services.types.AdGroupFeedOperation]):
    ...
    operations: MutableSequence["AdGroupFeedOperation"] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
...
class AdGroupFeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v16.resources.types.AdGroupFeed):
            Create operation: No resource name is
            expected for the new ad group feed.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v16.resources.types.AdGroupFeed):
    ...
    create: gagr_ad_group_feed.AdGroupFeed = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
        message=gagr_ad_group_feed.AdGroupFeed,
    )
    update: gagr_ad_group_feed.AdGroupFeed = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_ad_group_feed.AdGroupFeed,
...
class MutateAdGroupFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v16.services.types.MutateAdGroupFeedResult]):
    ...
    results: MutableSequence["MutateAdGroupFeedResult"] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
