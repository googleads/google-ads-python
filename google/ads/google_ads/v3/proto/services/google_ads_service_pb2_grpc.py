...
class GoogleAdsServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Search = channel.unary_unary(
        ...
        request_serializer=google_dot_ads_dot_googleads__v3_dot_proto_dot_services_dot_google__ads__service__pb2.SearchGoogleAdsRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads__v3_dot_proto_dot_services_dot_google__ads__service__pb2.SearchGoogleAdsResponse.FromString,
        )
    self.SearchStream = channel.unary_stream(
        '/google.ads.googleads.v3.services.GoogleAdsService/SearchStream',
        request_serializer=google_dot_ads_dot_googleads__v3_dot_proto_dot_services_dot_google__ads__service__pb2.SearchGoogleAdsStreamRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads__v3_dot_proto_dot_services_dot_google__ads__service__pb2.SearchGoogleAdsStreamResponse.FromString,
        )
    self.Mutate = channel.unary_unary(
        '/google.ads.googleads.v3.services.GoogleAdsService/Mutate',
        request_serializer=google_dot_ads_dot_googleads__v3_dot_proto_dot_services_dot_google__ads__service__pb2.MutateGoogleAdsRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads__v3_dot_proto_dot_services_dot_google__ads__service__pb2.MutateGoogleAdsResponse.FromString,
        )
