...
class AccountLinkServiceClient(metaclass=AccountLinkServiceClientMeta):
    ...
    def get_account_link(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v9.resources.types.AccountLink:
    ...
    def create_account_link(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v9.services.types.CreateAccountLinkResponse:
    ...
    def mutate_account_link(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateAccountLinkResponse:
