...
class AccountLinkStatusEnum(_CreateEnumTypeUponFirstAccess):
    ...
    class AccountLinkStatus(enum.IntEnum):
        ...
        Attributes:
          ...
          REJECTED (int): The link is rejected by the approver.
          REVOKED (int): The link is revoked by the user who requested the link.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        ENABLED = 2
...
class AdDestinationTypeEnum(_CreateEnumTypeUponFirstAccess):
    AdDestinationType = '''\
    class AdDestinationType(enum.IntEnum):
        """
        ...
        Attributes:
          ...
          NOT_APPLICABLE (int): Ads that don't intend to drive users off from ads to other destinations
          WEBSITE (int): Website
          APP_DEEP_LINK (int): App Deep Link
          APP_STORE (int): iOS App Store or Play Store
          PHONE_CALL (int): Call Dialer
          MAP_DIRECTIONS (int): Map App
          LOCATION_LISTING (int): Location Dedicated Page
          MESSAGE (int): Text Message
          LEAD_FORM (int): Lead Generation Form
          YOUTUBE (int): YouTube
          UNMODELED_FOR_CONVERSIONS (int): Ad Destination for Conversions with keys unknown
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        NOT_APPLICABLE = 2
...
'''
AdDestinationTypeEnum = AdDestinationTypeEnum() # For __getattribute__
...
class AssetErrorEnum(_CreateEnumTypeUponFirstAccess):
    ...
    class AssetError(enum.IntEnum):
        ...
        Attributes:
          ...
          INVALID_CALL_TO_ACTION_TEXT (int): Call to action must come from the list of supported values.
          LEAD_FORM_INVALID_FIELDS_COMBINATION (int): A lead form asset is created with an invalid combination of input fields.
          LEAD_FORM_MISSING_AGREEMENT (int): Lead forms require that the Terms of Service have been agreed to before
          mutates can be executed.
          INVALID_ASSET_STATUS (int): Asset status is invalid in this operation.
          FIELD_CANNOT_BE_MODIFIED_FOR_ASSET_TYPE (int): The field cannot be modified by this asset type.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
...
class AssetFieldTypeEnum(_CreateEnumTypeUponFirstAccess):
    ...
    class AssetFieldType(enum.IntEnum):
        ...
        Attributes:
          ...
          Google" enabled.
          LEAD_FORM (int): The asset is linked for use as a Lead Form extension.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        HEADLINE = 2
...
class AuthorizationErrorEnum(_CreateEnumTypeUponFirstAccess):
    ...
    class AuthorizationError(enum.IntEnum):
        ...
        Attributes:
          ...
          DEVELOPER_TOKEN_NOT_ON_ALLOWLIST (int): The developer token is not on the allow-list.
...
class BiddingErrorEnum(_CreateEnumTypeUponFirstAccess):
    ...
    class BiddingError(enum.IntEnum):
        ...
        Attributes:
          ...
          CONVERSION_TRACKING_NOT_ENABLED (int): Conversion tracking is not enabled in the campaign that has value-based
          bidding transitions.
          NOT_ENOUGH_CONVERSIONS (int): Not enough conversions tracked for value-based bidding transitions.
...
class ChangeClientTypeEnum(_CreateEnumTypeUponFirstAccess):
    ChangeClientType = '''\
    class ChangeClientType(enum.IntEnum):
        ...
        Attributes:
          UNSPECIFIED (int): No value has been specified.
          UNKNOWN (int): Used for return value only. Represents an unclassified client type
          unknown in this version.
          GOOGLE_ADS_WEB_CLIENT (int): Changes made through the "ads.google.com".
          For example, changes made through campaign management.
          GOOGLE_ADS_AUTOMATED_RULE (int): Changes made through Google Ads automated rules.
          GOOGLE_ADS_SCRIPTS (int): Changes made through Google Ads scripts.
          GOOGLE_ADS_BULK_UPLOAD (int): Changes made by Google Ads bulk upload.
          GOOGLE_ADS_API (int): Changes made by Google Ads API.
          GOOGLE_ADS_EDITOR (int): Changes made by Google Ads Editor.
          ...
          OTHER (int): Types of changes that are not categorized, for example,
        ...
        OTHER = 13
'''
ChangeClientTypeEnum = ChangeClientTypeEnum() # For __getattribute__

class ChangeEventErrorEnum(_CreateEnumTypeUponFirstAccess):
    ChangeEventError = '''\
    class ChangeEventError(enum.IntEnum):
        """
...
'''
ChangeEventErrorEnum = ChangeEventErrorEnum() # For __getattribute__

class ChangeEventResourceTypeEnum(_CreateEnumTypeUponFirstAccess):
...
class CombinedAudienceStatusEnum(_CreateEnumTypeUponFirstAccess):
    CombinedAudienceStatus = '''\
    class CombinedAudienceStatus(enum.IntEnum):
        """
        ...
        Attributes:
          UNSPECIFIED (int): Not specified.
          UNKNOWN (int): Used for return value only. Represents value unknown in this version.
          ENABLED (int): Enabled status - combined audience is enabled and can be targeted.
          REMOVED (int): Removed status - combined audience is removed and cannot be used for
          targeting.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        ...
        REMOVED = 3
'''
CombinedAudienceStatusEnum = CombinedAudienceStatusEnum() # For __getattribute__
...
class CriterionErrorEnum(_CreateEnumTypeUponFirstAccess):
    ...
    class CriterionError(enum.IntEnum):
        ...
        Attributes:
          ...
          INVALID_COMBINED_AUDIENCE (int): Invalid combined audience criterion.
          INVALID_CUSTOM_AFFINITY (int): Invalid custom affinity criterion.
          INVALID_CUSTOM_INTENT (int): Invalid custom intent criterion.
          INVALID_CUSTOM_AUDIENCE (int): Invalid custom audience criterion.
          ...
          CANNOT_SET_GEO_TARGET_CONSTANTS_WITH_FEED_ITEM_SETS (int): Cannot set geo target constants and feed item sets at the same time.
          INVALID_LOCATION_GROUP_RADIUS (int): The location group radius is in the range but not at the valid increment.
          INVALID_LOCATION_GROUP_RADIUS_UNIT (int): The location group radius unit is invalid.
          ...
          CANNOT_TARGET_PLACEMENTS_FOR_SEARCH_CAMPAIGNS (int): Cannot add positive placement criterion types in search campaigns.
          ...
          CANNOT_TARGET_REMOVED_CUSTOM_AUDIENCE (int): Can not target removed combined audience.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        CONCRETE_TYPE_REQUIRED = 2
...
class CustomAudienceErrorEnum(_CreateEnumTypeUponFirstAccess):
    CustomAudienceError = '''\
    class CustomAudienceError(enum.IntEnum):
        """
        ...
        Attributes:
          UNSPECIFIED (int): Enum unspecified.
          UNKNOWN (int): The received error code is not known in this version.
          NAME_ALREADY_USED (int): New name in the custom audience is duplicated ignoring cases.
          CANNOT_REMOVE_WHILE_IN_USE (int): Cannot remove a custom audience while it's still being used as targeting.
          RESOURCE_ALREADY_REMOVED (int): Cannot update or remove a custom audience that is already removed.
          MEMBER_TYPE_AND_PARAMETER_ALREADY_EXISTED (int): The pair of [type, value] already exists in members.
          INVALID_MEMBER_TYPE (int): Member type is invalid.
          MEMBER_TYPE_AND_VALUE_DOES_NOT_MATCH (int): Member type does not have associated value.
          POLICY_VIOLATION (int): Custom audience contains a member that violates policy.
          INVALID_TYPE_CHANGE (int): Change in custom audience type is not allowed.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        NAME_ALREADY_USED = 2
...
'''
CustomAudienceErrorEnum = CustomAudienceErrorEnum() # For __getattribute__

class CustomAudienceMemberTypeEnum(_CreateEnumTypeUponFirstAccess):
    CustomAudienceMemberType = '''\
    class CustomAudienceMemberType(enum.IntEnum):
        """
        ...
        Attributes:
          UNSPECIFIED (int): Not specified.
          UNKNOWN (int): Used for return value only. Represents value unknown in this version.
          KEYWORD (int): Users whose interests or actions are described by a keyword.
          URL (int): Users who have interests related to the website's content.
          PLACE_CATEGORY (int): Users who visit place types described by a place category.
          APP (int): Users who have installed a mobile app.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        KEYWORD = 2
        ...
        APP = 5
'''
CustomAudienceMemberTypeEnum = CustomAudienceMemberTypeEnum() # For __getattribute__

class CustomAudienceStatusEnum(_CreateEnumTypeUponFirstAccess):
    CustomAudienceStatus = '''\
    class CustomAudienceStatus(enum.IntEnum):
        """
        ...
        Attributes:
          UNSPECIFIED (int): Not specified.
          UNKNOWN (int): Used for return value only. Represents value unknown in this version.
          ENABLED (int): Enabled status - custom audience is enabled and can be targeted.
          REMOVED (int): Removed status - custom audience is removed and cannot be used for
          targeting.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        ...
        REMOVED = 3
'''
CustomAudienceStatusEnum = CustomAudienceStatusEnum() # For __getattribute__

class CustomAudienceTypeEnum(_CreateEnumTypeUponFirstAccess):
    CustomAudienceType = '''\
    class CustomAudienceType(enum.IntEnum):
        """
        ...
        Attributes:
          UNSPECIFIED (int): Not specified.
          UNKNOWN (int): Used for return value only. Represents value unknown in this version.
          AUTO (int): Google Ads will auto-select the best interpretation at serving
          time.
          INTEREST (int): Matches users by their interests.
          PURCHASE_INTENT (int): Matches users by topics they are researching or products they are
          considering for purchase.
          SEARCH (int): Matches users by what they searched on Google Search.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        AUTO = 2
        ...
        SEARCH = 5
'''
CustomAudienceTypeEnum = CustomAudienceTypeEnum() # For __getattribute__
...
class CustomerUserAccessErrorEnum(_CreateEnumTypeUponFirstAccess):
    CustomerUserAccessError = '''\
    class CustomerUserAccessError(enum.IntEnum):
        """
        ...
        Attributes:
          UNSPECIFIED (int): Enum unspecified.
          UNKNOWN (int): The received error code is not known in this version.
          INVALID_USER_ID (int): There is no user associated with the user id specified.
          REMOVAL_DISALLOWED (int): Unable to remove the access between the user and customer.
          DISALLOWED_ACCESS_ROLE (int): Unable to add or update the access role as specified.
          LAST_ADMIN_USER_OF_SERVING_CUSTOMER (int): The user can't remove itself from an active serving customer if it's the
          last admin user and the customer doesn't have any owner manager
          LAST_ADMIN_USER_OF_MANAGER (int): Last admin user cannot be removed from a manager.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        INVALID_USER_ID = 2
...
'''
CustomerUserAccessErrorEnum = CustomerUserAccessErrorEnum() # For __getattribute__
...
class ExternalConversionSourceEnum(_CreateEnumTypeUponFirstAccess):
    ...
    class ExternalConversionSource(enum.IntEnum):
        ...
        Attributes:
          ...
          SEARCH_ADS_360 (int): Conversions imported from Search Ads 360 Floodlight data.
          GOOGLE_HOSTED (int): Conversions that track local actions from Google's products and services
          after interacting with an ad.
          FLOODLIGHT (int): Conversions reported by Floodlight tags.
          ANALYTICS_SEARCH_ADS_360 (int): Conversions that come from Google Analytics specifically for Search Ads
...
class FeedItemSetErrorEnum(_CreateEnumTypeUponFirstAccess):
    FeedItemSetError = '''\
    class FeedItemSetError(enum.IntEnum):
        """
        ...
        Attributes:
          UNSPECIFIED (int): Enum unspecified.
          UNKNOWN (int): The received error code is not known in this version.
          FEED_ITEM_SET_REMOVED (int): The given ID refers to a removed FeedItemSet.
          CANNOT_CLEAR_DYNAMIC_FILTER (int): The dynamic filter of a feed item set cannot be cleared on UPDATE if it
          exists. A set is either static or dynamic once added, and that cannot
          change.
          CANNOT_CREATE_DYNAMIC_FILTER (int): The dynamic filter of a feed item set cannot be created on UPDATE if it
          does not exist. A set is either static or dynamic once added, and that
          cannot change.
          INVALID_FEED_TYPE (int): FeedItemSets can only be made for location or affiliate location feeds.
...
'''
FeedItemSetErrorEnum = FeedItemSetErrorEnum() # For __getattribute__

class FeedItemSetLinkErrorEnum(_CreateEnumTypeUponFirstAccess):
    FeedItemSetLinkError = '''\
    class FeedItemSetLinkError(enum.IntEnum):
        """
        ...
        Attributes:
          UNSPECIFIED (int): Enum unspecified.
          UNKNOWN (int): The received error code is not known in this version.
          FEED_ID_MISMATCH (int): The feed IDs of the FeedItemSet and FeedItem do not match. Only FeedItems
          in a given Feed can be linked to a FeedItemSet in that Feed.
          NO_MUTATE_ALLOWED_FOR_DYNAMIC_SET (int): Cannot add or remove links to a dynamic set.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        FEED_ID_MISMATCH = 2
...
'''
FeedItemSetLinkErrorEnum = FeedItemSetLinkErrorEnum() # For __getattribute__

class FeedItemSetStatusEnum(_CreateEnumTypeUponFirstAccess):
    FeedItemSetStatus = '''\
    class FeedItemSetStatus(enum.IntEnum):
        """
        ...
        Attributes:
          UNSPECIFIED (int): Not specified.
          UNKNOWN (int): Used for return value only. Represents value unknown in this version.
          ENABLED (int): Feed item set is enabled.
          REMOVED (int): Feed item set has been removed.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        ENABLED = 2
        REMOVED = 3
'''
FeedItemSetStatusEnum = FeedItemSetStatusEnum() # For __getattribute__

class FeedItemSetStringFilterTypeEnum(_CreateEnumTypeUponFirstAccess):
    FeedItemSetStringFilterType = '''\
    class FeedItemSetStringFilterType(enum.IntEnum):
        """
        ...
        Attributes:
          UNSPECIFIED (int): Not specified.
          UNKNOWN (int): The received error code is not known in this version.
          EXACT (int): The dynamic set filter will use exact string matching.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        EXACT = 2
'''
FeedItemSetStringFilterTypeEnum = FeedItemSetStringFilterTypeEnum() # For __getattribute__
...
class LeadFormCallToActionTypeEnum(_CreateEnumTypeUponFirstAccess):
    LeadFormCallToActionType = '''\
    class LeadFormCallToActionType(enum.IntEnum):
        """
        ...
        Attributes:
          UNSPECIFIED (int): Not specified.
          UNKNOWN (int): Used for return value only. Represents value unknown in this version.
          LEARN_MORE (int): Learn more.
          GET_QUOTE (int): Get quote.
          APPLY_NOW (int): Apply now.
          SIGN_UP (int): Sign Up.
          CONTACT_US (int): Contact us.
          SUBSCRIBE (int): Subscribe.
          DOWNLOAD (int): Download.
          BOOK_NOW (int): Book now.
          GET_OFFER (int): Get offer.
          REGISTER (int): Register.
          GET_INFO (int): Get info.
          REQUEST_DEMO (int): Request a demo.
          JOIN_NOW (int): Join now.
        ...
        GET_STARTED = 15
'''
LeadFormCallToActionTypeEnum = LeadFormCallToActionTypeEnum() # For __getattribute__

class LeadFormDesiredIntentEnum(_CreateEnumTypeUponFirstAccess):
    LeadFormDesiredIntent = '''\
    class LeadFormDesiredIntent(enum.IntEnum):
        """
        ...
        Attributes:
          UNSPECIFIED (int): Not specified.
          UNKNOWN (int): Used for return value only. Represents value unknown in this version.
          LOW_INTENT (int): Deliver more leads at a potentially lower quality.
          HIGH_INTENT (int): Only leads with a high level of intent are desired.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        LOW_INTENT = 2
        HIGH_INTENT = 3
'''
LeadFormDesiredIntentEnum = LeadFormDesiredIntentEnum() # For __getattribute__

class LeadFormFieldUserInputTypeEnum(_CreateEnumTypeUponFirstAccess):
    LeadFormFieldUserInputType = '''\
    class LeadFormFieldUserInputType(enum.IntEnum):
        """
        ...
        Attributes:
          ...
          CITY (int): The user will be asked to fill in their city.
          REGION (int): The user will be asked to fill in their region part of the address (e.g.
          state for US, province for Canada).
          COUNTRY (int): The user will be asked to fill in their country.
          WORK_EMAIL (int): The user will be asked to fill in their work email address.
          COMPANY_NAME (int): The user will be asked to fill in their company name.
          WORK_PHONE (int): The user will be asked to fill in their work phone.
          JOB_TITLE (int): The user will be asked to fill in their job title.
          VEHICLE_MODEL (int): Question: "Which model are you interested in?"
          Category: "Auto"
          VEHICLE_TYPE (int): Question: "Which type of vehicle are you interested in?"
          Category: "Auto"
          PREFERRED_DEALERSHIP (int): Question: "What is your preferred dealership?"
          Category: "Auto"
          VEHICLE_PURCHASE_TIMELINE (int): Question: "When do you plan on purchasing a vehicle?"
          Category: "Auto"
          VEHICLE_OWNERSHIP (int): Question: "Do you own a vehicle?"
          Category: "Auto"
          VEHICLE_PAYMENT_TYPE (int): Question: "What vehicle ownership option are you interested in?"
          Category: "Auto"
          VEHICLE_CONDITION (int): Question: "What type of vehicle condition are you interested in?"
          Category: "Auto"
          COMPANY_SIZE (int): Question: "What size is your company?"
          Category: "Business"
          ANNUAL_SALES (int): Question: "What is your annual sales volume?"
          Category: "Business"
          YEARS_IN_BUSINESS (int): Question: "How many years have you been in business?"
          Category: "Business"
          JOB_DEPARTMENT (int): Question: "What is your job department?"
          Category: "Business"
          JOB_ROLE (int): Question: "What is your job role?"
          Category: "Business"
          EDUCATION_PROGRAM (int): Question: "Which program are you interested in?"
          Category: "Education"
          EDUCATION_COURSE (int): Question: "Which course are you interested in?"
          Category: "Education"
          PRODUCT (int): Question: "Which product are you interested in?"
          Category: "General"
          SERVICE (int): Question: "Which service are you interested in?"
          Category: "General"
          OFFER (int): Question: "Which offer are you interested in?"
          Category: "General"
          CATEGORY (int): Question: "Which category are you interested in?"
          Category: "General"
          PREFERRED_CONTACT_METHOD (int): Question: "What is your preferred method of contact?"
          Category: "General"
          PREFERRED_LOCATION (int): Question: "What is your preferred location?"
          Category: "General"
          PREFERRED_CONTACT_TIME (int): Question: "What is the best time to contact you?"
          Category: "General"
          PURCHASE_TIMELINE (int): Question: "When are you looking to make a purchase?"
          Category: "General"
          YEARS_OF_EXPERIENCE (int): Question: "How many years of work experience do you have?"
          Category: "Jobs"
          JOB_INDUSTRY (int): Question: "What industry do you work in?"
          Category: "Jobs"
          LEVEL_OF_EDUCATION (int): Question: "What is your highest level of education?"
          Category: "Jobs"
          PROPERTY_TYPE (int): Question: "What type of property are you looking for?"
          Category: "Real Estate"
          REALTOR_HELP_GOAL (int): Question: "What do you need a realtor's help with?"
          Category: "Real Estate"
          PROPERTY_COMMUNITY (int): Question: "What neighborhood are you interested in?"
          Category: "Real Estate"
          PRICE_RANGE (int): Question: "What price range are you looking for?"
          Category: "Real Estate"
          NUMBER_OF_BEDROOMS (int): Question: "How many bedrooms are you looking for?"
          Category: "Real Estate"
          FURNISHED_PROPERTY (int): Question: "Are you looking for a fully furnished property?"
          Category: "Real Estate"
          PETS_ALLOWED_PROPERTY (int): Question: "Are you looking for properties that allow pets?"
          Category: "Real Estate"
          NEXT_PLANNED_PURCHASE (int): Question: "What is the next product you plan to purchase?"
          Category: "Retail"
          EVENT_SIGNUP_INTEREST (int): Question: "Would you like to sign up for an event?"
          Category: "Retail"
          PREFERRED_SHOPPING_PLACES (int): Question: "Where are you interested in shopping?"
          Category: "Retail"
          FAVORITE_BRAND (int): Question: "What is your favorite brand?"
          Category: "Retail"
          TRANSPORTATION_COMMERCIAL_LICENSE_TYPE (int): Question: "Which type of valid commercial license do you have?"
          Category: "Transportation"
          EVENT_BOOKING_INTEREST (int): Question: "Interested in booking an event?"
          Category: "Travel"
          DESTINATION_COUNTRY (int): Question: "What is your destination country?"
          Category: "Travel"
          DESTINATION_CITY (int): Question: "What is your destination city?"
          Category: "Travel"
          DEPARTURE_COUNTRY (int): Question: "What is your departure country?"
          Category: "Travel"
          DEPARTURE_CITY (int): Question: "What is your departure city?"
          Category: "Travel"
          DEPARTURE_DATE (int): Question: "What is your departure date?"
          Category: "Travel"
          RETURN_DATE (int): Question: "What is your return date?"
          Category: "Travel"
          NUMBER_OF_TRAVELERS (int): Question: "How many people are you traveling with?"
          Category: "Travel"
          TRAVEL_BUDGET (int): Question: "What is your travel budget?"
          Category: "Travel"
          TRAVEL_ACCOMMODATION (int): Question: "Where do you want to stay during your travel?"
          Category: "Travel"
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
...
'''
LeadFormFieldUserInputTypeEnum = LeadFormFieldUserInputTypeEnum() # For __getattribute__

class LeadFormPostSubmitCallToActionTypeEnum(_CreateEnumTypeUponFirstAccess):
    LeadFormPostSubmitCallToActionType = '''\
    class LeadFormPostSubmitCallToActionType(enum.IntEnum):
        """
        ...
        Attributes:
          UNSPECIFIED (int): Not specified.
          UNKNOWN (int): Used for return value only. Represents value unknown in this version.
          VISIT_SITE (int): Visit site.
          DOWNLOAD (int): Download.
          LEARN_MORE (int): Learn more.
          SHOP_NOW (int): Shop now.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        VISIT_SITE = 2
        ...
        SHOP_NOW = 5
'''
LeadFormPostSubmitCallToActionTypeEnum = LeadFormPostSubmitCallToActionTypeEnum() # For __getattribute__
...
class MediaUploadErrorEnum(_CreateEnumTypeUponFirstAccess):
    ...
    class MediaUploadError(enum.IntEnum):
        ...
        Attributes:
          ...
          CANNOT_UPLOAD_MEDIA_TYPE_THROUGH_API (int): This type of media cannot be uploaded through the Google Ads API.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        FILE_TOO_BIG = 2
...
class OfflineUserDataJobErrorEnum(_CreateEnumTypeUponFirstAccess):
    ...
    class OfflineUserDataJobError(enum.IntEnum):
        ...
        Attributes:
          ...
          REMOVE_ALL_NOT_SUPPORTED (int): Remove-all is not supported for certain offline user data job types.
          ...
          CUSTOMER_NOT_ACCEPTED_CUSTOMER_DATA_TERMS (int): The customer has not accepted the customer data terms in the conversion
          settings page.
          ATTRIBUTES_NOT_APPLICABLE_FOR_CUSTOMER_MATCH_USER_LIST (int): User attributes cannot be uploaded into a user list.
          LIFETIME_VALUE_BUCKET_NOT_IN_RANGE (int): Lifetime value bucket must be a number from 1-10, except for remove
          operation where 0 will be accepted.
          INCOMPATIBLE_USER_IDENTIFIER_FOR_ATTRIBUTES (int): Identifiers not supported for Customer Match attributes. User attributes
...
class OfflineUserDataJobTypeEnum(_CreateEnumTypeUponFirstAccess):
    ...
    class OfflineUserDataJobType(enum.IntEnum):
        ...
        Attributes:
          ...
          CUSTOMER_MATCH_WITH_ATTRIBUTES (int): Customer Match with attribute data.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
...
class PlaceholderTypeEnum(_CreateEnumTypeUponFirstAccess):
    ...
    class PlaceholderType(enum.IntEnum):
        ...
        Attributes:
          ...
          IMAGE (int): Lets you attach an image to an ad.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        SITELINK = 2
...
class ReachPlanErrorEnum(_CreateEnumTypeUponFirstAccess):
    ...
    class ReachPlanError(enum.IntEnum):
        ...
        Attributes:
          UNSPECIFIED (int): Enum unspecified.
          UNKNOWN (int): The received error code is not known in this version.
          NOT_FORECASTABLE_MISSING_RATE (int): Not forecastable due to missing rate card data.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
...
class ResourceChangeOperationEnum(_CreateEnumTypeUponFirstAccess):
    ...
    class ResourceChangeOperation(enum.IntEnum):
        ...
        Attributes:
          UNSPECIFIED (int): No value has been specified.
          UNKNOWN (int): Used for return value only. Represents an unclassified operation unknown
          in this version.
          CREATE (int): The resource was created.
          UPDATE (int): The resource was modified.
          REMOVE (int): The resource was removed.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        CREATE = 2
        ...
        REMOVE = 4
'''
ResourceChangeOperationEnum = ResourceChangeOperationEnum() # For __getattribute__
...
class UserIdentifierSourceEnum(_CreateEnumTypeUponFirstAccess):
    UserIdentifierSource = '''\
    class UserIdentifierSource(enum.IntEnum):
        """
        ...
        Attributes:
          UNSPECIFIED (int): Not specified.
          UNKNOWN (int): Used for return value only. Represents value unknown in this version
          FIRST_PARTY (int): Indicates that the user identifier was provided by the first party
          (advertiser).
          THIRD_PARTY (int): Indicates that the user identifier was provided by the third party
          (partner).
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
        ...
        THIRD_PARTY = 3
'''
UserIdentifierSourceEnum = UserIdentifierSourceEnum() # For __getattribute__
