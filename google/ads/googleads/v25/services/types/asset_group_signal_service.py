...
class MutateAssetGroupSignalsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v25.services.types.AssetGroupSignalOperation]):
...
class AssetGroupSignalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v25.resources.types.AssetGroupSignal):
...
class MutateAssetGroupSignalsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v25.services.types.MutateAssetGroupSignalResult]):
