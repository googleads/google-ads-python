...
from google.ads.googleads.v14.resources.types import campaign_conversion_goal
...
class MutateCampaignConversionGoalsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v14.services.types.MutateCampaignConversionGoalResult]):
