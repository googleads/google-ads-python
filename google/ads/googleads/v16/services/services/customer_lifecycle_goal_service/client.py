...
class CustomerLifecycleGoalServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, CustomerLifecycleGoalServiceTransport]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, CustomerLifecycleGoalServiceTransport]]): The
        ...
        if isinstance(transport, CustomerLifecycleGoalServiceTransport):
    ...
    def configure_customer_lifecycle_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.ConfigureCustomerLifecycleGoalsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v16.services.types.CustomerLifecycleGoalOperation):
        ...
        Returns:
            google.ads.googleads.v16.services.types.ConfigureCustomerLifecycleGoalsResponse:
        ...
        # in a customer_lifecycle_goal_service.ConfigureCustomerLifecycleGoalsRequest.
