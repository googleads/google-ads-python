...
from google.ads.googleads.v10.resources.types import customer
...
class CustomerServiceClient(metaclass=CustomerServiceClientMeta):
    ...
    def mutate_customer(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.MutateCustomerRequest, dict]):
                The request object. Request message for
                [CustomerService.MutateCustomer][google.ads.googleads.v10.services.CustomerService.MutateCustomer].
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v10.services.types.CustomerOperation):
        ...
        Returns:
            google.ads.googleads.v10.services.types.MutateCustomerResponse:
    ...
    def list_accessible_customers(
        self,
        request: Union[
            customer_service.ListAccessibleCustomersRequest, dict
        ] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: float = None,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.ListAccessibleCustomersRequest, dict]):
                The request object. Request message for
                [CustomerService.ListAccessibleCustomers][google.ads.googleads.v10.services.CustomerService.ListAccessibleCustomers].
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
            metadata (Sequence[Tuple[str, str]]): Strings which should be
        ...
        Returns:
            google.ads.googleads.v10.services.types.ListAccessibleCustomersResponse:
    ...
    def create_customer_client(
        self,
        request: Union[
            customer_service.CreateCustomerClientRequest, dict
        ] = None,
        *,
        customer_id: str = None,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.CreateCustomerClientRequest, dict]):
                The request object. Request message for
                [CustomerService.CreateCustomerClient][google.ads.googleads.v10.services.CustomerService.CreateCustomerClient].
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            customer_client (google.ads.googleads.v10.resources.types.Customer):
        ...
        Returns:
            google.ads.googleads.v10.services.types.CreateCustomerClientResponse:
                Response message for
