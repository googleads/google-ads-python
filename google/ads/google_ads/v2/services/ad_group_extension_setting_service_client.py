...
"""Accesses the google.ads.googleads.v2.services AdGroupExtensionSettingService API."""
...
from google.ads.google_ads.v2.services import ad_group_extension_setting_service_client_config
...
class AdGroupExtensionSettingServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.AdGroupExtensionSettingService'
    ...
    def __init__(self, transport=None, channel=None, credentials=None,
        ...
        Args:
            transport (Union[~.AdGroupExtensionSettingServiceGrpcTransport,
                    Callable[[~.Credentials, type], ~.AdGroupExtensionSettingServiceGrpcTransport]): A transport
        ...
        if client_config is not None:
            ...
            client_config = ad_group_extension_setting_service_client_config.config
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=ad_group_extension_setting_service_grpc_transport.AdGroupExtensionSettingServiceGrpcTransport,
                )
            else:
                if credentials:
                    raise ValueError(
            ...
            self.transport = ad_group_extension_setting_service_grpc_transport.AdGroupExtensionSettingServiceGrpcTransport(
    ...
    def get_ad_group_extension_setting(
        ...
        Args:
            resource_name (str): The resource name of the ad group extension setting to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.AdGroupExtensionSetting` instance.
        ...
        if 'get_ad_group_extension_setting' not in self._inner_api_calls:
            self._inner_api_calls['get_ad_group_extension_setting'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_ad_group_extension_setting,
                default_retry=self._method_configs['GetAdGroupExtensionSetting'].retry,
                default_timeout=self._method_configs['GetAdGroupExtensionSetting'].timeout,
                client_info=self._client_info,
            )

        request = ad_group_extension_setting_service_pb2.GetAdGroupExtensionSettingRequest(
        ...
        return self._inner_api_calls['get_ad_group_extension_setting'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def mutate_ad_group_extension_settings(
        ...
        Args:
            customer_id (str): The ID of the customer whose ad group extension settings are being
                modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.AdGroupExtensionSettingOperation]]): The list of operations to perform on individual ad group extension
                settings.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.AdGroupExtensionSettingOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateAdGroupExtensionSettingsResponse` instance.
        ...
        """
        # Wrap the transport method to add retry and timeout logic.
        if 'mutate_ad_group_extension_settings' not in self._inner_api_calls:
            self._inner_api_calls['mutate_ad_group_extension_settings'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.mutate_ad_group_extension_settings,
                default_retry=self._method_configs['MutateAdGroupExtensionSettings'].retry,
                default_timeout=self._method_configs['MutateAdGroupExtensionSettings'].timeout,
                client_info=self._client_info,
            )

        request = ad_group_extension_setting_service_pb2.MutateAdGroupExtensionSettingsRequest(
        ...
        return self._inner_api_calls['mutate_ad_group_extension_settings'](request, retry=retry, timeout=timeout, metadata=metadata)
