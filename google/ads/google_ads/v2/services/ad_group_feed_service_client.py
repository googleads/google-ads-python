...
"""Accesses the google.ads.googleads.v2.services AdGroupFeedService API."""
...
from google.ads.google_ads.v2.services import ad_group_feed_service_client_config
...
class AdGroupFeedServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.AdGroupFeedService'
    ...
    def __init__(self, transport=None, channel=None, credentials=None,
        ...
        Args:
            transport (Union[~.AdGroupFeedServiceGrpcTransport,
                    Callable[[~.Credentials, type], ~.AdGroupFeedServiceGrpcTransport]): A transport
        ...
        if client_config is not None:
            ...
            client_config = ad_group_feed_service_client_config.config
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=ad_group_feed_service_grpc_transport.AdGroupFeedServiceGrpcTransport,
                )
            else:
                if credentials:
                    raise ValueError(
            ...
            self.transport = ad_group_feed_service_grpc_transport.AdGroupFeedServiceGrpcTransport(
    ...
    def get_ad_group_feed(
        ...
        Args:
            resource_name (str): The resource name of the ad group feed to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.AdGroupFeed` instance.
        ...
        if 'get_ad_group_feed' not in self._inner_api_calls:
            self._inner_api_calls['get_ad_group_feed'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_ad_group_feed,
                default_retry=self._method_configs['GetAdGroupFeed'].retry,
                default_timeout=self._method_configs['GetAdGroupFeed'].timeout,
                client_info=self._client_info,
            )

        request = ad_group_feed_service_pb2.GetAdGroupFeedRequest(
        ...
        return self._inner_api_calls['get_ad_group_feed'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def mutate_ad_group_feeds(
        ...
        Args:
            customer_id (str): The ID of the customer whose ad group feeds are being modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.AdGroupFeedOperation]]): The list of operations to perform on individual ad group feeds.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.AdGroupFeedOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateAdGroupFeedsResponse` instance.
        ...
        """
        # Wrap the transport method to add retry and timeout logic.
        if 'mutate_ad_group_feeds' not in self._inner_api_calls:
            self._inner_api_calls['mutate_ad_group_feeds'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.mutate_ad_group_feeds,
                default_retry=self._method_configs['MutateAdGroupFeeds'].retry,
                default_timeout=self._method_configs['MutateAdGroupFeeds'].timeout,
                client_info=self._client_info,
            )

        request = ad_group_feed_service_pb2.MutateAdGroupFeedsRequest(
        ...
        return self._inner_api_calls['mutate_ad_group_feeds'](request, retry=retry, timeout=timeout, metadata=metadata)
