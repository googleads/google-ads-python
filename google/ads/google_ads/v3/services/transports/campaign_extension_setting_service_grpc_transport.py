...
from google.ads.google_ads.v3.proto.services import campaign_extension_setting_service_pb2_grpc


class CampaignExtensionSettingServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v3.services CampaignExtensionSettingService API.
