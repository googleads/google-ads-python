...
from google.ads.google_ads.v1.proto.services import ad_group_simulation_service_pb2_grpc


class AdGroupSimulationServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v1.services AdGroupSimulationService API.
    ...
    def get_ad_group_simulation(self):
        """Return the gRPC stub for :meth:`AdGroupSimulationServiceClient.get_ad_group_simulation`.
