...
from google.ads.googleads.v19.enums.types import advertising_channel_type
from google.ads.googleads.v19.enums.types import device
from google.ads.googleads.v19.enums.types import seasonality_event_scope
from google.ads.googleads.v19.enums.types import seasonality_event_status
...
class BiddingDataExclusion(proto.Message):
    r"""Represents a bidding data exclusion. Cannot be used in
    manager accounts.
    ...
    Attributes:
        ...
        scope (google.ads.googleads.v19.enums.types.SeasonalityEventScopeEnum.SeasonalityEventScope):
            The scope of the data exclusion.
        status (google.ads.googleads.v19.enums.types.SeasonalityEventStatusEnum.SeasonalityEventStatus):
        ...
        devices (MutableSequence[google.ads.googleads.v19.enums.types.DeviceEnum.Device]):
        ...
        campaigns (MutableSequence[str]):
            ...
            supported.
        advertising_channel_types (MutableSequence[google.ads.googleads.v19.enums.types.AdvertisingChannelTypeEnum.AdvertisingChannelType]):
