...
class MutateBiddingDataExclusionsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v15.services.types.BiddingDataExclusionOperation]):
...
class BiddingDataExclusionOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v15.resources.types.BiddingDataExclusion):
            Create operation: No resource name is
            expected for the new data exclusion.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v15.resources.types.BiddingDataExclusion):
...
class MutateBiddingDataExclusionsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v15.services.types.MutateBiddingDataExclusionsResult]):
