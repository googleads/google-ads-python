...
"""Accesses the google.ads.googleads.v2.services ParentalStatusViewService API."""
...
from google.ads.google_ads.v2.services import parental_status_view_service_client_config
...
class ParentalStatusViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.ParentalStatusViewService'
    ...
    def get_parental_status_view(
        ...
        Args:
            resource_name (str): The resource name of the parental status view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.ParentalStatusView` instance.
