...
class CampaignServiceClient(metaclass=CampaignServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, CampaignServiceTransport]]): The
    ...
    def mutate_campaigns(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.MutateCampaignsRequest, dict, None]):
    ...
    def enable_p_max_brand_guidelines(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.EnablePMaxBrandGuidelinesRequest, dict, None]):
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a campaign_service.EnablePMaxBrandGuidelinesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(
