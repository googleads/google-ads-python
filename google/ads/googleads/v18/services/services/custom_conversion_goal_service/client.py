...
class CustomConversionGoalServiceClient(
    ...
    def mutate_custom_conversion_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateCustomConversionGoalsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v18.services.types.CustomConversionGoalOperation]):
        ...
        Returns:
            google.ads.googleads.v18.services.types.MutateCustomConversionGoalsResponse:
