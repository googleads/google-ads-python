...
from google.ads.google_ads.v6.proto.services import paid_organic_search_term_view_service_pb2_grpc


class PaidOrganicSearchTermViewServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v6.services PaidOrganicSearchTermViewService API.
