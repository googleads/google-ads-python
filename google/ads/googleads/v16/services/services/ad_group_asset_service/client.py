...
class AdGroupAssetServiceClient(metaclass=AdGroupAssetServiceClientMeta):
    ...
    def mutate_ad_group_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateAdGroupAssetsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v16.services.types.AdGroupAssetOperation]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateAdGroupAssetsResponse:
