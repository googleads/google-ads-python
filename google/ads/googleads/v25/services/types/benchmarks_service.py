...
class ListBenchmarksLocationsResponse(proto.Message):
    ...
    Attributes:
        benchmarks_locations (MutableSequence[google.ads.googleads.v25.services.types.BenchmarksLocation]):
...
class BenchmarksLocation(proto.Message):
    ...
    Attributes:
        ...
        location_info (google.ads.googleads.v25.common.types.LocationInfo):
...
class ListBenchmarksProductsResponse(proto.Message):
    ...
    Attributes:
        benchmarks_products (MutableSequence[google.ads.googleads.v25.services.types.BenchmarksProductMetadata]):
...
class BenchmarksProductMetadata(proto.Message):
    ...
    Attributes:
        ...
        marketing_objective (google.ads.googleads.v25.enums.types.BenchmarksMarketingObjectiveEnum.BenchmarksMarketingObjective):
...
class ListBenchmarksSourcesResponse(proto.Message):
    ...
    Attributes:
        benchmarks_sources (MutableSequence[google.ads.googleads.v25.services.types.BenchmarksSourceMetadata]):
...
class BenchmarksSourceMetadata(proto.Message):
    ...
    Attributes:
        benchmarks_source_type (google.ads.googleads.v25.enums.types.BenchmarksSourceTypeEnum.BenchmarksSourceType):
...
class GenerateBenchmarksMetricsRequest(proto.Message):
    ...
    Attributes:
        ...
        breakdown_definition (google.ads.googleads.v25.services.types.BreakdownDefinition):
...
class ProductFilter(proto.Message):
    ...
    Attributes:
        product_list (google.ads.googleads.v25.services.types.ProductFilter.ProductList):
            The list of products.

            This field is a member of `oneof`_ ``filter_settings``.
        marketing_objective_list (google.ads.googleads.v25.services.types.ProductFilter.MarketingObjectiveList):
    ...
    class MarketingObjectiveList(proto.Message):
        ...
        Attributes:
            marketing_objectives (MutableSequence[google.ads.googleads.v25.enums.types.BenchmarksMarketingObjectiveEnum.BenchmarksMarketingObjective]):
...
class BreakdownDefinition(proto.Message):
    ...
    Attributes:
        date_breakdown (google.ads.googleads.v25.enums.types.BenchmarksTimeGranularityEnum.BenchmarksTimeGranularity):
...
class GenerateBenchmarksMetricsResponse(proto.Message):
    ...
    Attributes:
        customer_metrics (google.ads.googleads.v25.services.types.CustomerMetrics):
    ...
    customer_metrics: "CustomerMetrics" = proto.Field(
        proto.MESSAGE,
        number=4,
...
class BreakdownMetrics(proto.Message):
    ...
    Attributes:
        breakdown_key (google.ads.googleads.v25.services.types.BreakdownKey):
...
class BreakdownKey(proto.Message):
    ...
    Attributes:
        dates (google.ads.googleads.v25.common.types.DateRange):
...
class CustomerMetrics(proto.Message):
    r"""Metrics representing the customer’s Ad performance.
