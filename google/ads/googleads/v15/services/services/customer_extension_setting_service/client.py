...
class CustomerExtensionSettingServiceClient(
    ...
    def mutate_customer_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateCustomerExtensionSettingsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateCustomerExtensionSettingsResponse:
