...
# source: google/ads/googleads_v4/proto/services/keyword_plan_service.proto
...
from google.ads.google_ads.v4.proto.common import keyword_plan_common_pb2 as google_dot_ads_dot_googleads__v4_dot_proto_dot_common_dot_keyword__plan__common__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v4/proto/services/keyword_plan_service.proto',
...
_KEYWORDPLANOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_keyword__plan__pb2._KEYWORDPLAN
_KEYWORDPLANOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_keyword__plan__pb2._KEYWORDPLAN
...
_KEYWORDPLANKEYWORDHISTORICALMETRICS.fields_by_name['keyword_metrics'].message_type = google_dot_ads_dot_googleads__v4_dot_proto_dot_common_dot_keyword__plan__common__pb2._KEYWORDPLANHISTORICALMETRICS
...
GenerateForecastCurveRequest = _reflection.GeneratedProtocolMessageType('GenerateForecastCurveRequest', (_message.Message,), dict(
...
GenerateForecastCurveResponse = _reflection.GeneratedProtocolMessageType('GenerateForecastCurveResponse', (_message.Message,), dict(
...
KeywordPlanCampaignForecastCurve = _reflection.GeneratedProtocolMessageType('KeywordPlanCampaignForecastCurve', (_message.Message,), dict(
...
KeywordPlanMaxCpcBidForecastCurve = _reflection.GeneratedProtocolMessageType('KeywordPlanMaxCpcBidForecastCurve', (_message.Message,), dict(
...
KeywordPlanMaxCpcBidForecast = _reflection.GeneratedProtocolMessageType('KeywordPlanMaxCpcBidForecast', (_message.Message,), dict(
...
_KEYWORDPLANSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_keyword__plan__pb2._KEYWORDPLAN,
    serialized_options=_b('\202\323\344\223\0020\022./v4/{resource_name=customers/*/keywordPlans/*}\332A\rresource_name'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0026\"1/v4/customers/{customer_id=*}/keywordPlans:mutate:\001*\332A\026customer_id,operations'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002H\"C/v4/{keyword_plan=customers/*/keywordPlans/*}:generateForecastCurve:\001*\332A\014keyword_plan'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002J\"E/v4/{keyword_plan=customers/*/keywordPlans/*}:generateForecastMetrics:\001*\332A\014keyword_plan'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002L\"G/v4/{keyword_plan=customers/*/keywordPlans/*}:generateHistoricalMetrics:\001*\332A\014keyword_plan'),
  ),
])
