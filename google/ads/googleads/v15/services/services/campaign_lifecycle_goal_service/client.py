...
class CampaignLifecycleGoalServiceClient(
    ...
    def configure_campaign_lifecycle_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.ConfigureCampaignLifecycleGoalsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.ConfigureCampaignLifecycleGoalsResponse:
