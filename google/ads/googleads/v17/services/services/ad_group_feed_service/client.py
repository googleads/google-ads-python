...
class AdGroupFeedServiceClient(metaclass=AdGroupFeedServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v17.services.AdGroupFeedServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_ad_group_feeds(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateAdGroupFeedsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v17.services.types.AdGroupFeedOperation]):
