...
class ConversionGoalCampaignConfigServiceClient(
    ...
    def mutate_conversion_goal_campaign_configs(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.MutateConversionGoalCampaignConfigsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v10.services.types.MutateConversionGoalCampaignConfigsResponse:
