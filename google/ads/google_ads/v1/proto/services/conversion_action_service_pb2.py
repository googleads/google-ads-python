...
# source: google/ads/googleads_v1/proto/services/conversion_action_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v1/proto/services/conversion_action_service.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads__v1_dot_proto_dot_resources_dot_conversion__action__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_protobuf_dot_field__mask__pb2.DESCRIPTOR,google_dot_protobuf_dot_wrappers__pb2.DESCRIPTOR,google_dot_rpc_dot_status__pb2.DESCRIPTOR,])
...
_CONVERSIONACTIONOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v1_dot_proto_dot_resources_dot_conversion__action__pb2._CONVERSIONACTION
_CONVERSIONACTIONOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v1_dot_proto_dot_resources_dot_conversion__action__pb2._CONVERSIONACTION
...
GetConversionActionRequest = _reflection.GeneratedProtocolMessageType('GetConversionActionRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v1.proto.services.conversion_action_service_pb2'
  ,
...
_CONVERSIONACTIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v1_dot_proto_dot_resources_dot_conversion__action__pb2._CONVERSIONACTION,
    serialized_options=_b('\202\323\344\223\0025\0223/v1/{resource_name=customers/*/conversionActions/*}'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002;\"6/v1/customers/{customer_id=*}/conversionActions:mutate:\001*'),
  ),
])
