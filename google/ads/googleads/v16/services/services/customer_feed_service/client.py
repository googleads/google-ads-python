...
class CustomerFeedServiceClient(metaclass=CustomerFeedServiceClientMeta):
    ...
    def mutate_customer_feeds(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateCustomerFeedsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateCustomerFeedsResponse:
