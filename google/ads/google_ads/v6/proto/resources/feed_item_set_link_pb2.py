...
# source: google/ads/googleads_v6/proto/resources/feed_item_set_link.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v6/proto/resources/feed_item_set_link.proto',
...
FeedItemSetLink = _reflection.GeneratedProtocolMessageType('FeedItemSetLink', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads_v6.proto.resources.feed_item_set_link_pb2'
  ,
  '__doc__': """Represents a link between a FeedItem and a FeedItemSet.
  
  Attributes:
      resource_name:
          Immutable. The resource name of the feed item set link. Feed
          item set link resource names have the form: ``customers/{custo
          mer_id}/feedItemSetLinks/{feed_id}~{feed_item_set_id}~{feed_it
          em_id}``
      feed_item:
