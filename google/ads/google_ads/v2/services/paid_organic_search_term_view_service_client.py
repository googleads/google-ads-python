...
"""Accesses the google.ads.googleads.v2.services PaidOrganicSearchTermViewService API."""
...
from google.ads.google_ads.v2.services import paid_organic_search_term_view_service_client_config
...
class PaidOrganicSearchTermViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.PaidOrganicSearchTermViewService'
    ...
    def get_paid_organic_search_term_view(
        ...
        Args:
            resource_name (str): The resource name of the paid organic search term view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.PaidOrganicSearchTermView` instance.
