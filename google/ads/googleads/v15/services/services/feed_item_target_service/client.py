...
class FeedItemTargetServiceClient(metaclass=FeedItemTargetServiceClientMeta):
    ...
    def mutate_feed_item_targets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateFeedItemTargetsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateFeedItemTargetsResponse:
