...
class KeywordPlanCampaignKeywordServiceClient(
    ...
    def mutate_keyword_plan_campaign_keywords(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateKeywordPlanCampaignKeywordsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateKeywordPlanCampaignKeywordsResponse:
