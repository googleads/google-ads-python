...
"""Accesses the google.ads.googleads.v2.services ConversionActionService API."""
...
from google.ads.google_ads.v2.services import conversion_action_service_client_config
...
class ConversionActionServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.ConversionActionService'
    ...
    def __init__(self, transport=None, channel=None, credentials=None,
        ...
        Args:
            transport (Union[~.ConversionActionServiceGrpcTransport,
                    Callable[[~.Credentials, type], ~.ConversionActionServiceGrpcTransport]): A transport
        ...
        if client_config is not None:
            ...
            client_config = conversion_action_service_client_config.config
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=conversion_action_service_grpc_transport.ConversionActionServiceGrpcTransport,
                )
            else:
                if credentials:
                    raise ValueError(
            ...
            self.transport = conversion_action_service_grpc_transport.ConversionActionServiceGrpcTransport(
    ...
    def get_conversion_action(
        ...
        Args:
            resource_name (str): The resource name of the conversion action to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.ConversionAction` instance.
        ...
        if 'get_conversion_action' not in self._inner_api_calls:
            self._inner_api_calls['get_conversion_action'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_conversion_action,
                default_retry=self._method_configs['GetConversionAction'].retry,
                default_timeout=self._method_configs['GetConversionAction'].timeout,
                client_info=self._client_info,
            )

        request = conversion_action_service_pb2.GetConversionActionRequest(
        ...
        return self._inner_api_calls['get_conversion_action'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def mutate_conversion_actions(
        ...
        Args:
            customer_id (str): The ID of the customer whose conversion actions are being modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.ConversionActionOperation]]): The list of operations to perform on individual conversion actions.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.ConversionActionOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateConversionActionsResponse` instance.
        ...
        """
        # Wrap the transport method to add retry and timeout logic.
        if 'mutate_conversion_actions' not in self._inner_api_calls:
            self._inner_api_calls['mutate_conversion_actions'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.mutate_conversion_actions,
                default_retry=self._method_configs['MutateConversionActions'].retry,
                default_timeout=self._method_configs['MutateConversionActions'].timeout,
                client_info=self._client_info,
            )

        request = conversion_action_service_pb2.MutateConversionActionsRequest(
        ...
        return self._inner_api_calls['mutate_conversion_actions'](request, retry=retry, timeout=timeout, metadata=metadata)
