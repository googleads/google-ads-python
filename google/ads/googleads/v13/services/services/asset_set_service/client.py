...
class AssetSetServiceClient(metaclass=AssetSetServiceClientMeta):
    ...
    def mutate_asset_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAssetSetsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v13.services.types.AssetSetOperation]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateAssetSetsResponse:
