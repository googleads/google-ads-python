...
class AssetGroupSignalServiceClient(
    ...
    def mutate_asset_group_signals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateAssetGroupSignalsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateAssetGroupSignalsResponse:
