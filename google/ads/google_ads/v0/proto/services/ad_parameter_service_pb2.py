...
# source: google/ads/googleads_v0/proto/services/ad_parameter_service.proto
...
from google.ads.google_ads.v0.proto.resources import ad_parameter_pb2 as google_dot_ads_dot_googleads__v0_dot_proto_dot_resources_dot_ad__parameter__pb2
...
_GETADPARAMETERREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.GetAdParameterRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v0.services.GetAdParameterRequest.resource_name', index=0,
...
_MUTATEADPARAMETERSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.MutateAdParametersRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v0.services.MutateAdParametersRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v0.services.MutateAdParametersRequest.operations', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v0.services.MutateAdParametersRequest.partial_failure', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v0.services.MutateAdParametersRequest.validate_only', index=3,
...
_ADPARAMETEROPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.AdParameterOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v0.services.AdParameterOperation.update_mask', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v0.services.AdParameterOperation.create', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v0.services.AdParameterOperation.update', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v0.services.AdParameterOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v0.services.AdParameterOperation.operation',
...
_MUTATEADPARAMETERSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.MutateAdParametersResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v0.services.MutateAdParametersResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v0.services.MutateAdParametersResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEADPARAMETERRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.MutateAdParameterResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v0.services.MutateAdParameterResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADPARAMETEROPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_resources_dot_ad__parameter__pb2._ADPARAMETER
_ADPARAMETEROPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_resources_dot_ad__parameter__pb2._ADPARAMETER
...
GetAdParameterRequest = _reflection.GeneratedProtocolMessageType('GetAdParameterRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v0.proto.services.ad_parameter_service_pb2'
  ,
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v0.services.GetAdParameterRequest)
  ))
...
AdParameterOperation = _reflection.GeneratedProtocolMessageType('AdParameterOperation', (_message.Message,), dict(
  ...
  Attributes:
      ...
      remove:
          ...
          adParameters/{ad_group_id}_{criterion_id}_{parameter_index}``
  """,
...
_ADPARAMETERSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v0.services.AdParameterService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='GetAdParameter',
    full_name='google.ads.googleads.v0.services.AdParameterService.GetAdParameter',
    index=0,
    containing_service=None,
    input_type=_GETADPARAMETERREQUEST,
    output_type=google_dot_ads_dot_googleads__v0_dot_proto_dot_resources_dot_ad__parameter__pb2._ADPARAMETER,
    serialized_options=_b('\202\323\344\223\0020\022./v0/{resource_name=customers/*/adParameters/*}'),
  ),
  _descriptor.MethodDescriptor(
    name='MutateAdParameters',
    full_name='google.ads.googleads.v0.services.AdParameterService.MutateAdParameters',
    index=1,
    containing_service=None,
    input_type=_MUTATEADPARAMETERSREQUEST,
    output_type=_MUTATEADPARAMETERSRESPONSE,
    serialized_options=_b('\202\323\344\223\0026\"1/v0/customers/{customer_id=*}/adParameters:mutate:\001*'),
  ),
])
