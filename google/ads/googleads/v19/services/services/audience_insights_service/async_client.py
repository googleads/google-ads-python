...
class AudienceInsightsServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v19.services.AudienceInsightsServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def generate_insights_finder_report(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.GenerateInsightsFinderReportRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            baseline_audience (:class:`google.ads.googleads.v19.services.types.BasicInsightsAudience`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            specific_audience (:class:`google.ads.googleads.v19.services.types.BasicInsightsAudience`):
    ...
    async def list_audience_insights_attributes(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.ListAudienceInsightsAttributesRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            dimensions (:class:`MutableSequence[google.ads.googleads.v19.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension]`):
    ...
    async def list_insights_eligible_dates(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.ListInsightsEligibleDatesRequest, dict]]):
                The request object. Request message for
    ...
    async def generate_audience_composition_insights(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.GenerateAudienceCompositionInsightsRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            audience (:class:`google.ads.googleads.v19.services.types.InsightsAudience`):
    ...
    async def generate_suggested_targeting_insights(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.GenerateSuggestedTargetingInsightsRequest, dict]]):
                The request object. Request message for
    ...
    async def generate_audience_overlap_insights(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.GenerateAudienceOverlapInsightsRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            country_location (:class:`google.ads.googleads.v19.common.types.LocationInfo`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            primary_attribute (:class:`google.ads.googleads.v19.common.types.AudienceInsightsAttribute`):
    ...
    async def generate_targeting_suggestion_metrics(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.GenerateTargetingSuggestionMetricsRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            audiences (:class:`MutableSequence[google.ads.googleads.v19.services.types.BasicInsightsAudience]`):
