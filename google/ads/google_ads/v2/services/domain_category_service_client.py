...
"""Accesses the google.ads.googleads.v2.services DomainCategoryService API."""
...
from google.ads.google_ads.v2.services import domain_category_service_client_config
...
class DomainCategoryServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.DomainCategoryService'
    ...
    def get_domain_category(
        ...
        Args:
            resource_name (str): Resource name of the domain category to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.DomainCategory` instance.
