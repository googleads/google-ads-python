...
from google.ads.googleads.v15.common.types import lifecycle_goals
...
class CampaignLifecycleGoal(proto.Message):
    ...
    Attributes:
        ...
        campaign (str):
            ...
            attached.
        customer_acquisition_goal_settings (google.ads.googleads.v15.resources.types.CustomerAcquisitionGoalSettings):
...
class CustomerAcquisitionGoalSettings(proto.Message):
    ...
    Attributes:
        optimization_mode (google.ads.googleads.v15.enums.types.CustomerAcquisitionOptimizationModeEnum.CustomerAcquisitionOptimizationMode):
            Output only. Customer acquisition
            optimization mode of this campaign.
        value_settings (google.ads.googleads.v15.common.types.LifecycleGoalValueSettings):
