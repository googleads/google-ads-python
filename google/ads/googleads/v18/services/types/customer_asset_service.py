...
class CustomerAssetOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v18.resources.types.CustomerAsset):
            Create operation: No resource name is
            expected for the new customer asset.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v18.resources.types.CustomerAsset):
...
class MutateCustomerAssetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v18.services.types.MutateCustomerAssetResult]):
