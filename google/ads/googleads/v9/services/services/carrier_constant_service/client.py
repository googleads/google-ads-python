...
class CarrierConstantServiceClient(metaclass=CarrierConstantServiceClientMeta):
    ...
    def get_carrier_constant(
        self,
        request: Union[
            carrier_constant_service.GetCarrierConstantRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCarrierConstantRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CarrierConstant:
