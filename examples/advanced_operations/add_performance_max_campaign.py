...
from google.ads.googleads.v19.services.services.asset_group_service.client import (
    AssetGroupServiceClient,
)
from google.ads.googleads.v19.services.services.asset_service.client import (
    AssetServiceClient,
)
...
next_temp_id: int = int(_ASSET_GROUP_TEMPORARY_ID) - 1
...
def create_asset_group_operation(
    ...
    mutate_operation: MutateOperation = client.get_type("MutateOperation")
    asset_group_op: AssetGroupOperation = (
        mutate_operation.asset_group_operation
    )
    asset_group: AssetGroup = asset_group_op.create
    ...
    for resource_name in headline_asset_resource_names:
        mutate_operation = client.get_type("MutateOperation")
        asset_group_asset_op: AssetGroupAssetOperation = (
            mutate_operation.asset_group_asset_operation
        )
        asset_group_asset: AssetGroupAsset = asset_group_asset_op.create
...
def create_and_link_brand_assets(
    ...
    # Create the Text Asset.
    text_asset_temp_id: int = next_temp_id
    next_temp_id -= 1

    text_mutate_operation: MutateOperation = client.get_type("MutateOperation")
    text_asset_op: AssetOperation = text_mutate_operation.asset_operation
    text_asset: Asset = text_asset_op.create
    ...
    # Create the Image Asset.
    image_asset_temp_id: int = next_temp_id
    next_temp_id -= 1

    image_mutate_operation: MutateOperation = client.get_type("MutateOperation")
    image_asset_op: AssetOperation = image_mutate_operation.asset_operation
    image_asset: Asset = image_asset_op.create
    ...
    if brand_guidelines_enabled:
        ...
        business_name_campaign_asset_op: CampaignAssetOperation = (
            business_name_mutate_operation.campaign_asset_operation
        )
        business_name_campaign_asset: CampaignAsset = (
            business_name_campaign_asset_op.create
        )
        ...
        logo_campaign_asset_op: CampaignAssetOperation = (
            logo_mutate_operation.campaign_asset_operation
        )
        logo_campaign_asset: CampaignAsset = logo_campaign_asset_op.create
        ...
        business_name_asset_group_asset_op: AssetGroupAssetOperation = (
            business_name_mutate_operation.asset_group_asset_operation
        )
        business_name_asset_group_asset: AssetGroupAsset = (
            business_name_asset_group_asset_op.create
        )
        ...
        logo_asset_group_asset_op: AssetGroupAssetOperation = (
            logo_mutate_operation.asset_group_asset_operation
        )
        logo_asset_group_asset: AssetGroupAsset = (
            logo_asset_group_asset_op.create
        )
...
def create_asset_group_signal_operations(
    ...
    if audience_id:
        ...
        mutate_operation: MutateOperation = client.get_type("MutateOperation")
        asset_group_signal_op: AssetGroupSignalOperation = (
            mutate_operation.asset_group_signal_operation
        )
        operation: AssetGroupSignal = asset_group_signal_op.create
