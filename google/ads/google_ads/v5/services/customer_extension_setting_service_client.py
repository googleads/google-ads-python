...
"""Accesses the google.ads.googleads.v5.services CustomerExtensionSettingService API."""
...
from google.ads.google_ads.v5.services import customer_extension_setting_service_client_config
from google.ads.google_ads.v5.services.transports import customer_extension_setting_service_grpc_transport
from google.ads.google_ads.v5.proto.services import customer_extension_setting_service_pb2
...
class CustomerExtensionSettingServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v5.services.CustomerExtensionSettingService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=customer_extension_setting_service_grpc_transport.CustomerExtensionSettingServiceGrpcTransport,
    ...
    def get_customer_extension_setting(
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.CustomerExtensionSetting` instance.
        ...
        if 'get_customer_extension_setting' not in self._inner_api_calls:
            self._inner_api_calls['get_customer_extension_setting'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_customer_extension_setting,
                default_retry=self._method_configs['GetCustomerExtensionSetting'].retry,
                default_timeout=self._method_configs['GetCustomerExtensionSetting'].timeout,
        ...
        return self._inner_api_calls['get_customer_extension_setting'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def mutate_customer_extension_settings(
        ...
        Args:
            customer_id (str): Required. The ID of the customer whose customer extension settings are being
                modified.
            operations (list[Union[dict, ~google.ads.googleads_v5.types.CustomerExtensionSettingOperation]]): Required. The list of operations to perform on individual customer extension
                settings.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v5.types.CustomerExtensionSettingOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.MutateCustomerExtensionSettingsResponse` instance.
        ...
        if 'mutate_customer_extension_settings' not in self._inner_api_calls:
            self._inner_api_calls['mutate_customer_extension_settings'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.mutate_customer_extension_settings,
                default_retry=self._method_configs['MutateCustomerExtensionSettings'].retry,
                default_timeout=self._method_configs['MutateCustomerExtensionSettings'].timeout,
                client_info=self._client_info,
            )
        ...
        return self._inner_api_calls['mutate_customer_extension_settings'](request, retry=retry, timeout=timeout, metadata=metadata)
