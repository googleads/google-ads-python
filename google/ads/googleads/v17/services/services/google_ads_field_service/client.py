...
class GoogleAdsFieldServiceClient(metaclass=GoogleAdsFieldServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, GoogleAdsFieldServiceTransport]]): The
    ...
    def get_google_ads_field(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.GetGoogleAdsFieldRequest, dict, None]):
    ...
    def search_google_ads_fields(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.SearchGoogleAdsFieldsRequest, dict, None]):
                The request object. Request message for
