...
class BiddingDataExclusionServiceClient(
    ...
    def mutate_bidding_data_exclusions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateBiddingDataExclusionsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateBiddingDataExclusionsResponse:
