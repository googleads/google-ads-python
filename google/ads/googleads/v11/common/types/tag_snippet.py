...
from google.ads.googleads.v11.enums.types import tracking_code_page_format
from google.ads.googleads.v11.enums.types import tracking_code_type
...
class TagSnippet(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v11.enums.types.TrackingCodeTypeEnum.TrackingCodeType):
