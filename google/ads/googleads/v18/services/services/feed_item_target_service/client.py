...
class FeedItemTargetServiceClient(metaclass=FeedItemTargetServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v18.services.FeedItemTargetServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_feed_item_targets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateFeedItemTargetsRequest, dict]):
