...
class CustomerSkAdNetworkConversionValueSchemaServiceClient(
    ...
    def mutate_customer_sk_ad_network_conversion_value_schema(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.MutateCustomerSkAdNetworkConversionValueSchemaRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v19.services.types.MutateCustomerSkAdNetworkConversionValueSchemaResponse:
