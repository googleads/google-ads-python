...
class PaidOrganicSearchTermViewServiceClient(
    ...
    def get_paid_organic_search_term_view(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetPaidOrganicSearchTermViewRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v7.resources.types.PaidOrganicSearchTermView:
