...
class AdGroupFeedServiceGrpcAsyncIOTransport(AdGroupFeedServiceTransport):
    """gRPC AsyncIO backend transport for AdGroupFeedService.
    ...
    def mutate_ad_group_feeds(
        ...
        Returns:
            Callable[[~.MutateAdGroupFeedsRequest],
                    Awaitable[~.MutateAdGroupFeedsResponse]]:
        ...
        if "mutate_ad_group_feeds" not in self._stubs:
            self._stubs["mutate_ad_group_feeds"] = (
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_ad_group_feeds: self._wrap_method(
...
__all__ = ("AdGroupFeedServiceGrpcAsyncIOTransport",)
