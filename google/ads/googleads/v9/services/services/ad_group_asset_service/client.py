...
class AdGroupAssetServiceClient(metaclass=AdGroupAssetServiceClientMeta):
    ...
    def get_ad_group_asset(
        self,
        request: Union[
            ad_group_asset_service.GetAdGroupAssetRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetAdGroupAssetRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.AdGroupAsset:
    ...
    def mutate_ad_group_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateAdGroupAssetsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.AdGroupAssetOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateAdGroupAssetsResponse:
