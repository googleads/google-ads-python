...
from google.ads.googleads.v25.enums.types import asset_group_primary_status
from google.ads.googleads.v25.enums.types import (
    asset_group_primary_status_reason,
)
from google.ads.googleads.v25.enums.types import asset_group_status
...
class AssetGroup(proto.Message):
    ...
    Attributes:
        ...
        final_mobile_urls (MutableSequence[str]):
            ...
            unless opted out.
        status (google.ads.googleads.v25.enums.types.AssetGroupStatusEnum.AssetGroupStatus):
            The status of the asset group.
        primary_status (google.ads.googleads.v25.enums.types.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus):
        ...
        primary_status_reasons (MutableSequence[google.ads.googleads.v25.enums.types.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason]):
        ...
        ad_strength (google.ads.googleads.v25.enums.types.AdStrengthEnum.AdStrength):
            ...
            asset group.
        asset_coverage (google.ads.googleads.v25.resources.types.AssetCoverage):
    ...
    google_local_services_info: "GoogleLocalServicesInfo" = proto.Field(
        proto.MESSAGE,
        number=14,
...
class AssetCoverage(proto.Message):
    ...
    Attributes:
        ad_strength_action_items (MutableSequence[google.ads.googleads.v25.resources.types.AdStrengthActionItem]):
...
class AdStrengthActionItem(proto.Message):
    ...
    Attributes:
        action_item_type (google.ads.googleads.v25.enums.types.AdStrengthActionItemTypeEnum.AdStrengthActionItemType):
            Output only. The action item type.
        add_asset_details (google.ads.googleads.v25.resources.types.AdStrengthActionItem.AddAssetDetails):
    ...
    class AddAssetDetails(proto.Message):
        ...
        Attributes:
            ...
            video_aspect_ratio_requirement (google.ads.googleads.v25.enums.types.AssetCoverageVideoAspectRatioRequirementEnum.AssetCoverageVideoAspectRatioRequirement):
...
class GoogleLocalServicesInfo(proto.Message):
    r"""Local services info for the asset group.

    .. _oneof: https://proto-plus-python.readthedocs.io/en/stable/fields.html#oneofs-mutually-exclusive-fields

    Attributes:
        category_id (str):
            Immutable. The local services category associated with this
            asset group. That is, XCAT format -
            xcat:service_area_business_plumber. See
            https://developers.google.com/google-ads/api/data/codes-formats#local-services-category-ids
            This field cannot be modified after the AssetGroup has been
            created.

            This field is a member of `oneof`_ ``_category_id``.
        callouts (MutableSequence[google.ads.googleads.v25.resources.types.LocalServicesCallout]):
    ...
    callouts: MutableSequence["LocalServicesCallout"] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
...
class LocalServicesCallout(proto.Message):
    r"""Local services callout of the asset group.
    ...
    Attributes:
        callout_id (str):
            ...
            This field is a member of `oneof`_ ``_callout_id``.
    """

    callout_id: str = proto.Field(
        proto.STRING,
        number=1,
        optional=True,
    )
