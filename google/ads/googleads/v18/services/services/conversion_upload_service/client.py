...
class ConversionUploadServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v18.services.ConversionUploadServiceClient`.",
                    extra=(
                        {
    ...
    def upload_click_conversions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.UploadClickConversionsRequest, dict]):
    ...
    def upload_call_conversions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.UploadCallConversionsRequest, dict]):
                The request object. Request message for
