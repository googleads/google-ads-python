...
class CampaignExperiment(proto.Message):
    ...
    Attributes:
        ...
        traffic_split_type (google.ads.googleads.v6.enums.types.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType):
        ...
        status (google.ads.googleads.v6.enums.types.CampaignExperimentStatusEnum.CampaignExperimentStatus):
