...
class IdentityVerificationServiceClient(
    ...
    def start_identity_verification(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.StartIdentityVerificationRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            verification_program (google.ads.googleads.v16.enums.types.IdentityVerificationProgramEnum.IdentityVerificationProgram):
    ...
    def get_identity_verification(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.GetIdentityVerificationRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v16.services.types.GetIdentityVerificationResponse:
