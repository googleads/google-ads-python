...
class CampaignExtensionSettingServiceClient(
    ...
    def mutate_campaign_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCampaignExtensionSettingsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v13.services.types.CampaignExtensionSettingOperation]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateCampaignExtensionSettingsResponse:
