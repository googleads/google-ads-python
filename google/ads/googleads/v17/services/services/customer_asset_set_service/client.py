...
class CustomerAssetSetServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, CustomerAssetSetServiceTransport]]): The
    ...
    def mutate_customer_asset_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateCustomerAssetSetsRequest, dict, None]):
