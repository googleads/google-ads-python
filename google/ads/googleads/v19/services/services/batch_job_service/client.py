...
class BatchJobServiceClient(metaclass=BatchJobServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v19.services.BatchJobServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_batch_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.MutateBatchJobRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v19.services.types.BatchJobOperation):
    ...
    def list_batch_job_results(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.ListBatchJobResultsRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v19.services.services.batch_job_service.pagers.ListBatchJobResultsPager:
                Response message for
                   [BatchJobService.ListBatchJobResults][google.ads.googleads.v19.services.BatchJobService.ListBatchJobResults].
    ...
    def run_batch_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.RunBatchJobRequest, dict]):
                The request object. Request message for
    ...
    def add_batch_job_operations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.AddBatchJobOperationsRequest, dict]):
                The request object. Request message for
