...
class CreateOfflineUserDataJobRequest(proto.Message):
    ...
    Attributes:
        ...
        job (google.ads.googleads.v4.resources.types.OfflineUserDataJob):
...
class AddOfflineUserDataJobOperationsRequest(proto.Message):
    ...
    Attributes:
        resource_name (str):
            Required. The resource name of the
            OfflineUserDataJob.
        enable_partial_failure (google.protobuf.wrappers_pb2.BoolValue):
            True to enable partial failure for the
            offline user data job.
        operations (Sequence[google.ads.googleads.v4.services.types.OfflineUserDataJobOperation]):
