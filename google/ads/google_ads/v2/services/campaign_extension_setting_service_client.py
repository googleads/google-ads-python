...
"""Accesses the google.ads.googleads.v2.services CampaignExtensionSettingService API."""
...
from google.ads.google_ads.v2.services import campaign_extension_setting_service_client_config
...
class CampaignExtensionSettingServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.CampaignExtensionSettingService'
    ...
    def get_campaign_extension_setting(
        ...
        Args:
            resource_name (str): The resource name of the campaign extension setting to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.CampaignExtensionSetting` instance.
    ...
    def mutate_campaign_extension_settings(
        ...
        Args:
            customer_id (str): The ID of the customer whose campaign extension settings are being
                modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.CampaignExtensionSettingOperation]]): The list of operations to perform on individual campaign extension
                settings.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.CampaignExtensionSettingOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateCampaignExtensionSettingsResponse` instance.
