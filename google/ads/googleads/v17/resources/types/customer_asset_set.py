...
from google.ads.googleads.v17.enums.types import asset_set_link_status
...
class CustomerAssetSet(proto.Message):
    ...
    Attributes:
        ...
        customer (str):
            ...
            set is linked.
        status (google.ads.googleads.v17.enums.types.AssetSetLinkStatusEnum.AssetSetLinkStatus):
