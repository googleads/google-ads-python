...
class CustomerUserAccessInvitationServiceClient(
    ...
    def get_customer_user_access_invitation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCustomerUserAccessInvitationRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CustomerUserAccessInvitation:
    ...
    def mutate_customer_user_access_invitation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCustomerUserAccessInvitationRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v9.services.types.CustomerUserAccessInvitationOperation`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCustomerUserAccessInvitationResponse:
