...
# source: google/ads/googleads_v0/proto/services/display_keyword_view_service.proto
...
_GETDISPLAYKEYWORDVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.GetDisplayKeywordViewRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v0.services.GetDisplayKeywordViewRequest.resource_name', index=0,
...
GetDisplayKeywordViewRequest = _reflection.GeneratedProtocolMessageType('GetDisplayKeywordViewRequest', (_message.Message,), dict(
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v0.services.GetDisplayKeywordViewRequest)
  ))
_sym_db.RegisterMessage(GetDisplayKeywordViewRequest)


DESCRIPTOR.has_options = True
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n$com.google.ads.googleads.v0.servicesB\036DisplayKeywordViewServiceProtoP\001ZHgoogle.golang.org/genproto/googleapis/ads/googleads/v0/services;services\242\002\003GAA\252\002 Google.Ads.GoogleAds.V0.Services\312\002 Google\\Ads\\GoogleAds\\V0\\Services'))

_DISPLAYKEYWORDVIEWSERVICE = _descriptor.ServiceDescriptor(
  name='DisplayKeywordViewService',
  full_name='google.ads.googleads.v0.services.DisplayKeywordViewService',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v0.services.DisplayKeywordViewService.GetDisplayKeywordView',
    index=0,
    containing_service=None,
    input_type=_GETDISPLAYKEYWORDVIEWREQUEST,
    output_type=google_dot_ads_dot_googleads__v0_dot_proto_dot_resources_dot_display__keyword__view__pb2._DISPLAYKEYWORDVIEW,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\0027\0225/v0/{resource_name=customers/*/displayKeywordViews/*}')),
  ),
])
