...
class RecommendationServiceClient(metaclass=RecommendationServiceClientMeta):
    ...
    def get_recommendation(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetRecommendationRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.Recommendation:
                A recommendation.
        """
    ...
    def dismiss_recommendation(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.DismissRecommendationRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.DismissRecommendationRequest.DismissRecommendationOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.DismissRecommendationResponse:
                Response message for
                [RecommendationService.DismissRecommendation][google.ads.googleads.v6.services.RecommendationService.DismissRecommendation].
