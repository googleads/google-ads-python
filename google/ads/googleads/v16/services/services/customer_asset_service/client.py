...
class CustomerAssetServiceClient(metaclass=CustomerAssetServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, CustomerAssetServiceTransport]]): The
    ...
    def mutate_customer_assets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateCustomerAssetsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v16.services.types.CustomerAssetOperation]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateCustomerAssetsResponse:
