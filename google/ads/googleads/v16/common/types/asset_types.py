...
from google.ads.googleads.v16.common.types import feed_common
...
from google.ads.googleads.v16.enums.types import lead_form_call_to_action_type
from google.ads.googleads.v16.enums.types import lead_form_desired_intent
from google.ads.googleads.v16.enums.types import lead_form_field_user_input_type
from google.ads.googleads.v16.enums.types import (
...
from google.ads.googleads.v16.enums.types import mobile_app_vendor
from google.ads.googleads.v16.enums.types import price_extension_price_qualifier
from google.ads.googleads.v16.enums.types import price_extension_price_unit
from google.ads.googleads.v16.enums.types import price_extension_type
from google.ads.googleads.v16.enums.types import (
    promotion_extension_discount_modifier,
)
from google.ads.googleads.v16.enums.types import promotion_extension_occasion
...
class ImageAsset(proto.Message):
    ...
    Attributes:
        ...
        full_size (google.ads.googleads.v16.common.types.ImageDimension):
...
class LeadFormAsset(proto.Message):
    ...
    Attributes:
        business_name (str):
            ...
            advertised.
        call_to_action_type (google.ads.googleads.v16.enums.types.LeadFormCallToActionTypeEnum.LeadFormCallToActionType):
        ...
        fields (MutableSequence[google.ads.googleads.v16.common.types.LeadFormField]):
            Ordered list of input fields. This field can
            be updated by reordering questions, but not by
            adding or removing questions.
        custom_question_fields (MutableSequence[google.ads.googleads.v16.common.types.LeadFormCustomQuestionField]):
            Ordered list of custom question fields. This
            field is subject to a limit of 5 qualifying
            questions per form.
        delivery_methods (MutableSequence[google.ads.googleads.v16.common.types.LeadFormDeliveryMethod]):
        ...
        post_submit_call_to_action_type (google.ads.googleads.v16.enums.types.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType):
        ...
        desired_intent (google.ads.googleads.v16.enums.types.LeadFormDesiredIntentEnum.LeadFormDesiredIntent):
...
class LeadFormField(proto.Message):
    ...
    Attributes:
        input_type (google.ads.googleads.v16.enums.types.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType):
            ...
            do you have?".
        single_choice_answers (google.ads.googleads.v16.common.types.LeadFormSingleChoiceAnswers):
...
class LeadFormDeliveryMethod(proto.Message):
    ...
    Attributes:
        webhook (google.ads.googleads.v16.common.types.WebhookDelivery):
...
class PromotionAsset(proto.Message):
    ...
    Attributes:
        ...
        discount_modifier (google.ads.googleads.v16.enums.types.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier):
        ...
        redemption_end_date (str):
            ...
            to be redeemed, in yyyy-MM-dd format.
        occasion (google.ads.googleads.v16.enums.types.PromotionExtensionOccasionEnum.PromotionExtensionOccasion):
        ...
        ad_schedule_targets (MutableSequence[google.ads.googleads.v16.common.types.AdScheduleInfo]):
        ...
        money_amount_off (google.ads.googleads.v16.common.types.Money):
        ...
        orders_over_amount (google.ads.googleads.v16.common.types.Money):
...
class MobileAppAsset(proto.Message):
    ...
    Attributes:
        ...
        app_store (google.ads.googleads.v16.enums.types.MobileAppVendorEnum.MobileAppVendor):
...
class CallAsset(proto.Message):
    ...
    Attributes:
        ...
        call_conversion_reporting_state (google.ads.googleads.v16.enums.types.CallConversionReportingStateEnum.CallConversionReportingState):
...
class PriceAsset(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v16.enums.types.PriceExtensionTypeEnum.PriceExtensionType):
            Required. The type of the price asset.
        price_qualifier (google.ads.googleads.v16.enums.types.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier):
            The price qualifier of the price asset.
        language_code (str):
            Required. The language of the price asset.
            Represented as BCP 47 language tag.
        price_offerings (MutableSequence[google.ads.googleads.v16.common.types.PriceOffering]):
...
class PriceOffering(proto.Message):
    ...
    Attributes:
        ...
        description (str):
            ...
            between 1 and 25, inclusive.
        price (google.ads.googleads.v16.common.types.Money):
            Required. The price value of the price
            offering.
        unit (google.ads.googleads.v16.enums.types.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit):
...
class CallToActionAsset(proto.Message):
    ...
    Attributes:
        call_to_action (google.ads.googleads.v16.enums.types.CallToActionTypeEnum.CallToActionType):
            Call to action.
    """
...
class LocationAsset(proto.Message):
    ...
    Attributes:
        ...
        business_profile_locations (MutableSequence[google.ads.googleads.v16.common.types.BusinessProfileLocation]):
        ...
        location_ownership_type (google.ads.googleads.v16.enums.types.LocationOwnershipTypeEnum.LocationOwnershipType):
