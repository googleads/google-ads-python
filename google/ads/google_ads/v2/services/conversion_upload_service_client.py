...
"""Accesses the google.ads.googleads.v2.services ConversionUploadService API."""
...
from google.ads.google_ads.v2.services import conversion_upload_service_client_config
...
class ConversionUploadServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.ConversionUploadService'
    ...
    def upload_click_conversions(
        ...
        Args:
            ...
            conversions (list[Union[dict, ~google.ads.googleads_v2.types.ClickConversion]]): The conversions that are being uploaded.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.ClickConversion`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.UploadClickConversionsResponse` instance.
    ...
    def upload_call_conversions(
        ...
        Args:
            customer_id (str): The ID of the customer performing the upload.
            conversions (list[Union[dict, ~google.ads.googleads_v2.types.CallConversion]]): The conversions that are being uploaded.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.CallConversion`
            partial_failure (bool): If true, successful operations will be carried out and invalid
                operations will return errors. If false, all operations will be carried
                out in one transaction if and only if they are all valid.
                This should always be set to true.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.UploadCallConversionsResponse` instance.
