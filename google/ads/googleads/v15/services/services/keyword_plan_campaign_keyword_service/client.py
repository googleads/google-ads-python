...
class KeywordPlanCampaignKeywordServiceClient(
    ...
    def mutate_keyword_plan_campaign_keywords(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateKeywordPlanCampaignKeywordsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v15.services.types.KeywordPlanCampaignKeywordOperation]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateKeywordPlanCampaignKeywordsResponse:
