...
"""Accesses the google.ads.googleads.v0.services MobileAppCategoryConstantService API."""
...
from google.ads.google_ads.v0.services import mobile_app_category_constant_service_client_config
...
class MobileAppCategoryConstantServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v0.services.MobileAppCategoryConstantService'
    ...
    def get_mobile_app_category_constant(
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.MobileAppCategoryConstant` instance.
        ...
        if 'get_mobile_app_category_constant' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_mobile_app_category_constant'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_mobile_app_category_constant,
                    default_retry=self.
                    _method_configs['GetMobileAppCategoryConstant'].retry,
                    default_timeout=self.
                    _method_configs['GetMobileAppCategoryConstant'].timeout,
                    client_info=self._client_info,
                )

        request = mobile_app_category_constant_service_pb2.GetMobileAppCategoryConstantRequest(
            resource_name=resource_name, )
        return self._inner_api_calls['get_mobile_app_category_constant'](
