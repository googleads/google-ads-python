...
class FeedItemSetLinkServiceClient(metaclass=FeedItemSetLinkServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v17.services.FeedItemSetLinkServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_feed_item_set_links(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateFeedItemSetLinksRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v17.services.types.FeedItemSetLinkOperation]):
