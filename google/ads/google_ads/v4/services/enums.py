...
class AdGroupErrorEnum(_CreateEnumTypeUponFirstAccess):
    ...
    class AdGroupError(enum.IntEnum):
        ...
        Attributes:
          ...
          PROMOTED_HOTEL_AD_GROUPS_NOT_AVAILABLE_FOR_CUSTOMER (int): Promoted hotels ad groups are only available to whitelisted customers.
        """
        UNSPECIFIED = 0
        UNKNOWN = 1
...
class OfflineUserDataJobErrorEnum(_CreateEnumTypeUponFirstAccess):
    ...
    class OfflineUserDataJobError(enum.IntEnum):
        ...
        Attributes:
          ...
          NOT_WHITELISTED_FOR_UNIFIED_STORE_SALES (int): Customer is not whitelisted for unified store sales data.
