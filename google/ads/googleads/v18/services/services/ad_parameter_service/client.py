...
class AdParameterServiceClient(metaclass=AdParameterServiceClientMeta):
    ...
    def mutate_ad_parameters(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateAdParametersRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v18.services.types.AdParameterOperation]):
        ...
        Returns:
            google.ads.googleads.v18.services.types.MutateAdParametersResponse:
