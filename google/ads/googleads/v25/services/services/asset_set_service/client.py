...
class AssetSetServiceClient(metaclass=AssetSetServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v25.services.AssetSetServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_asset_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.MutateAssetSetsRequest, dict]):
