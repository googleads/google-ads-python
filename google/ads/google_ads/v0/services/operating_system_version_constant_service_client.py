...
"""Accesses the google.ads.googleads.v0.services OperatingSystemVersionConstantService API."""
...
from google.ads.google_ads.v0.services import operating_system_version_constant_service_client_config
...
class OperatingSystemVersionConstantServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v0.services.OperatingSystemVersionConstantService'
    ...
    def get_operating_system_version_constant(
        ...
        Args:
            resource_name (str): Resource name of the OS version to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.OperatingSystemVersionConstant` instance.
        ...
        if 'get_operating_system_version_constant' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_operating_system_version_constant'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_operating_system_version_constant,
                    default_retry=self.
                    _method_configs['GetOperatingSystemVersionConstant'].retry,
                    default_timeout=self._method_configs[
                        'GetOperatingSystemVersionConstant'].timeout,
                    client_info=self._client_info,
                )

        request = operating_system_version_constant_service_pb2.GetOperatingSystemVersionConstantRequest(
            resource_name=resource_name, )
        return self._inner_api_calls['get_operating_system_version_constant'](
