...
class BiddingStrategyServiceClient(metaclass=BiddingStrategyServiceClientMeta):
    ...
    def mutate_bidding_strategies(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateBiddingStrategiesRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v14.services.types.BiddingStrategyOperation]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateBiddingStrategiesResponse:
