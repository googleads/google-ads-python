...
from google.ads.google_ads.v4.proto.services import campaign_experiment_service_pb2_grpc


class CampaignExperimentServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v4.services CampaignExperimentService API.
