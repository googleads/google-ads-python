...
class MutateCampaignCustomizersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v25.services.types.CampaignCustomizerOperation]):
...
class CampaignCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v25.resources.types.CampaignCustomizer):
...
class MutateCampaignCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v25.services.types.MutateCampaignCustomizerResult]):
