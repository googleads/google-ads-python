...
class CustomizerAttributeServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiate the customizer attribute service client.
        ...
        if isinstance(transport, CustomizerAttributeServiceTransport):
            ...
            self._transport = CustomizerAttributeServiceGrpcTransport(
    ...
    def mutate_customizer_attributes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCustomizerAttributesRequest, dict]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CustomizerAttributeOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCustomizerAttributesResponse:
