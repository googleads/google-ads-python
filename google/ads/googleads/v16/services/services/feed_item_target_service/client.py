...
class FeedItemTargetServiceClient(metaclass=FeedItemTargetServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, FeedItemTargetServiceTransport]]): The
    ...
    def mutate_feed_item_targets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateFeedItemTargetsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v16.services.types.FeedItemTargetOperation]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateFeedItemTargetsResponse:
