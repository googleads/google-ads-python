...
class GenerateKeywordIdeasPager:
    ...
    :class:`google.ads.googleads.v25.services.types.GenerateKeywordIdeaResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v25.services.types.GenerateKeywordIdeaResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.ads.googleads.v25.services.types.GenerateKeywordIdeasRequest):
                The initial request object.
            response (google.ads.googleads.v25.services.types.GenerateKeywordIdeaResponse):
