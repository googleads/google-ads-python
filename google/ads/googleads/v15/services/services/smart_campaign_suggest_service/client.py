...
class SmartCampaignSuggestServiceClient(
    ...
    def suggest_smart_campaign_budget_options(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.SuggestSmartCampaignBudgetOptionsRequest, dict, None]):
    ...
    def suggest_smart_campaign_ad(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.SuggestSmartCampaignAdRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v15.services.types.SuggestSmartCampaignAdResponse:
                Response message for
                   [SmartCampaignSuggestService.SuggestSmartCampaignAd][google.ads.googleads.v15.services.SmartCampaignSuggestService.SuggestSmartCampaignAd].
    ...
    def suggest_keyword_themes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.SuggestKeywordThemesRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v15.services.types.SuggestKeywordThemesResponse:
                Response message for
                   [SmartCampaignSuggestService.SuggestKeywordThemes][google.ads.googleads.v15.services.SmartCampaignSuggestService.SuggestKeywordThemes].
