...
"""Accesses the google.ads.googleads.v1.services CustomerClientService API."""
...
from google.ads.google_ads.v1.services import customer_client_service_client_config
...
class CustomerClientServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.CustomerClientService'
    ...
    def get_customer_client(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.CustomerClient` instance.
        ...
        if 'get_customer_client' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_customer_client'] = google.api_core.gapic_v1.method.wrap_method(
                    ...
                    default_retry=self._method_configs['GetCustomerClient'].
                    retry,
