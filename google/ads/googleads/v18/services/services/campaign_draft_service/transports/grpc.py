    ...
    def mutate_campaign_drafts(
        ...
        if "mutate_campaign_drafts" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v18.services.CampaignDraftService/MutateCampaignDrafts",
    ...
    def promote_campaign_draft(
        ...
        if "promote_campaign_draft" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v18.services.CampaignDraftService/PromoteCampaignDraft",
    ...
    def list_campaign_draft_async_errors(
        ...
        if "list_campaign_draft_async_errors" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v18.services.CampaignDraftService/ListCampaignDraftAsyncErrors",
