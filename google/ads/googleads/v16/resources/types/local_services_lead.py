...
class LocalServicesLead(proto.Message):
    ...
    Attributes:
        ...
        contact_details (google.ads.googleads.v16.resources.types.ContactDetails):
            Output only. Lead's contact details.
        lead_type (google.ads.googleads.v16.enums.types.LocalServicesLeadTypeEnum.LeadType):
            Output only. Type of Local Services lead:
            phone, message, booking, etc.
        lead_status (google.ads.googleads.v16.enums.types.LocalServicesLeadStatusEnum.LeadStatus):
        ...
        note (google.ads.googleads.v16.resources.types.Note):
