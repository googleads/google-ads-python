...
"""Accesses the google.ads.googleads.v2.services LocationViewService API."""
...
from google.ads.google_ads.v2.services import location_view_service_client_config
...
class LocationViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.LocationViewService'
    ...
    def get_location_view(
        ...
        Args:
            resource_name (str): The resource name of the location view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.LocationView` instance.
