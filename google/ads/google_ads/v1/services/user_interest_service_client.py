...
"""Accesses the google.ads.googleads.v1.services UserInterestService API."""
...
from google.ads.google_ads.v1.services import user_interest_service_client_config
...
class UserInterestServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.UserInterestService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=user_interest_service_grpc_transport.
    ...
    def get_user_interest(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.UserInterest` instance.
        ...
        return self._inner_api_calls['get_user_interest'](
