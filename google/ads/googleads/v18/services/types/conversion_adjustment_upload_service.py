...
class UploadConversionAdjustmentsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            the upload.
        conversion_adjustments (MutableSequence[google.ads.googleads.v18.services.types.ConversionAdjustment]):
...
class UploadConversionAdjustmentsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            https://developers.google.com/google-ads/api/docs/best-practices/partial-failures
            for more information about partial failure.
        results (MutableSequence[google.ads.googleads.v18.services.types.ConversionAdjustmentResult]):
...
class ConversionAdjustment(proto.Message):
    ...
    Attributes:
        gclid_date_time_pair (google.ads.googleads.v18.services.types.GclidDateTimePair):
        ...
        adjustment_type (google.ads.googleads.v18.enums.types.ConversionAdjustmentTypeEnum.ConversionAdjustmentType):
            The adjustment type.
        restatement_value (google.ads.googleads.v18.services.types.RestatementValue):
