...
class CustomerCustomizerServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v25.services.CustomerCustomizerServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customer_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.MutateCustomerCustomizersRequest, dict]):
