...
class ListCampaignDraftAsyncErrorsPager:
    ...
    :class:`google.ads.googleads.v25.services.types.ListCampaignDraftAsyncErrorsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v25.services.types.ListCampaignDraftAsyncErrorsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.ads.googleads.v25.services.types.ListCampaignDraftAsyncErrorsRequest):
                The initial request object.
            response (google.ads.googleads.v25.services.types.ListCampaignDraftAsyncErrorsResponse):
