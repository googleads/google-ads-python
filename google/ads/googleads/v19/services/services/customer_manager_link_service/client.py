...
class CustomerManagerLinkServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v19.services.CustomerManagerLinkServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customer_manager_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.MutateCustomerManagerLinkRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v19.services.types.CustomerManagerLinkOperation]):
    ...
    def move_manager_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.MoveManagerLinkRequest, dict]):
                The request object. Request message for
