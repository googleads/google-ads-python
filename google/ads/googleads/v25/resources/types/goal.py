...
from google.ads.googleads.v25.common.types import goal_setting
from google.ads.googleads.v25.enums.types import goal_optimization_eligibility
...
class Goal(proto.Message):
    ...
    Attributes:
        ...
        optimization_eligibility (google.ads.googleads.v25.enums.types.GoalOptimizationEligibilityEnum.GoalOptimizationEligibility):
            Output only. Indicates if this goal is
            eligible for campaign optimization.
        retention_goal_settings (google.ads.googleads.v25.common.types.GoalSetting.RetentionGoal):
            Retention goal settings.

            This field is a member of `oneof`_ ``goal_settings``.
        new_customer_acquisition_goal_settings (google.ads.googleads.v25.common.types.GoalSetting.NewCustomerAcquisitionGoal):
            New customer acquisition goal settings.

            This field is a member of `oneof`_ ``goal_settings``.
        loyalty_retention_goal_settings (google.ads.googleads.v25.common.types.GoalSetting.LoyaltyRetentionGoal):
    ...
    new_customer_acquisition_goal_settings: (
        goal_setting.GoalSetting.NewCustomerAcquisitionGoal
    ) = proto.Field(
        proto.MESSAGE,
        number=8,
        oneof="goal_settings",
        message=goal_setting.GoalSetting.NewCustomerAcquisitionGoal,
    )
    loyalty_retention_goal_settings: (
        goal_setting.GoalSetting.LoyaltyRetentionGoal
    ) = proto.Field(
        proto.MESSAGE,
        number=9,
        oneof="goal_settings",
        message=goal_setting.GoalSetting.LoyaltyRetentionGoal,
    )
