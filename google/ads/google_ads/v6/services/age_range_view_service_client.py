...
"""Accesses the google.ads.googleads.v6.services AgeRangeViewService API."""
...
from google.ads.google_ads.v6.services import age_range_view_service_client_config
from google.ads.google_ads.v6.services.transports import age_range_view_service_grpc_transport
from google.ads.google_ads.v6.proto.services import age_range_view_service_pb2
...
class AgeRangeViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v6.services.AgeRangeViewService'
    ...
    @classmethod
    def age_range_view_path(cls, customer_id, ad_group_id, criterion_id):
    ...
    def get_age_range_view(
        ...
        Example:
            ...
            >>>
            >>> client = googleads_v6.AgeRangeViewServiceClient()
            >>>
            >>> resource_name = client.age_range_view_path('[CUSTOMER_ID]', '[AD_GROUP_ID]', '[CRITERION_ID]')
            >>>
            >>> response = client.get_age_range_view(resource_name)

        Args:
            resource_name (str): Required. The resource name of the age range view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.AgeRangeView` instance.
