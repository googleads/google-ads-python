...
class BiddingDataExclusionServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, BiddingDataExclusionServiceTransport]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, BiddingDataExclusionServiceTransport]]): The
    ...
    def mutate_bidding_data_exclusions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateBiddingDataExclusionsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v18.services.types.MutateBiddingDataExclusionsResponse:
