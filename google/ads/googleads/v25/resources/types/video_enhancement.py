...
from google.ads.googleads.v25.enums.types import video_enhancement_source
...
class VideoEnhancement(proto.Message):
    ...
    Attributes:
        ...
        duration_millis (int):
            ...
            milliseconds.
        source (google.ads.googleads.v25.enums.types.VideoEnhancementSourceEnum.VideoEnhancementSource):
