...
class GenerateShareablePreviewsResponse(proto.Message):
    ...
    Attributes:
        responses (MutableSequence[google.ads.googleads.v19.services.types.ShareablePreviewOrError]):
...
class ShareablePreviewOrError(proto.Message):
    ...
    Attributes:
        ...
        shareable_preview_result (google.ads.googleads.v19.services.types.ShareablePreviewResult):
