...
"""Accesses the google.ads.googleads.v2.services FeedItemService API."""
...
from google.ads.google_ads.v2.services import feed_item_service_client_config
...
class FeedItemServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.FeedItemService'
    ...
    def get_feed_item(
        ...
        Args:
            resource_name (str): The resource name of the feed item to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.FeedItem` instance.
    ...
    def mutate_feed_items(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.FeedItemOperation]]): The list of operations to perform on individual feed items.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.FeedItemOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateFeedItemsResponse` instance.
