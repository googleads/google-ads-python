...
class MutateCustomerCustomizersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v10.services.types.CustomerCustomizerOperation]):
...
class CustomerCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v10.resources.types.CustomerCustomizer):
...
class MutateCustomerCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v10.services.types.MutateCustomerCustomizerResult]):
