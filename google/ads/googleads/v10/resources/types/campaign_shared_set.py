...
from google.ads.googleads.v10.enums.types import campaign_shared_set_status
...
class CampaignSharedSet(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v10.enums.types.CampaignSharedSetStatusEnum.CampaignSharedSetStatus):
