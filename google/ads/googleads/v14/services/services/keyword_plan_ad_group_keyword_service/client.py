...
class KeywordPlanAdGroupKeywordServiceClient(
    ...
    def mutate_keyword_plan_ad_group_keywords(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateKeywordPlanAdGroupKeywordsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v14.services.types.KeywordPlanAdGroupKeywordOperation]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateKeywordPlanAdGroupKeywordsResponse:
