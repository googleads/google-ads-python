...
from .transports.grpc_asyncio import FeedItemTargetServiceGrpcAsyncIOTransport
...
class FeedItemTargetServiceClient(metaclass=FeedItemTargetServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = FeedItemTargetServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                FeedItemTargetServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = FeedItemTargetServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = FeedItemTargetServiceClient._read_environment_variables()
        self._client_cert_source = (
            FeedItemTargetServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            FeedItemTargetServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, FeedItemTargetServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(FeedItemTargetServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or FeedItemTargetServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                FeedItemTargetServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., FeedItemTargetServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v17.services.FeedItemTargetServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_feed_item_targets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateFeedItemTargetsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v17.services.types.FeedItemTargetOperation]):
