...
class BillingSetup(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v5.enums.types.BillingSetupStatusEnum.BillingSetupStatus):
        ...
        payments_account_info (google.ads.googleads.v5.resources.types.BillingSetup.PaymentsAccountInfo):
        ...
        start_date_time (google.protobuf.wrappers_pb2.StringValue):
            ...
            time is allowed.
        start_time_type (google.ads.googleads.v5.enums.types.TimeTypeEnum.TimeType):
