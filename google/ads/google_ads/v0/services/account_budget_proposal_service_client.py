...
class AccountBudgetProposalServiceClient(object):
    ...
    def get_account_budget_proposal(
        ...
        Returns:
            A :class:`~google.ads.google_ads.v0.types.AccountBudgetProposal` instance.
            ...
            self._inner_api_calls[
                'get_account_budget_proposal'] = google.api_core.gapic_v1.method.wrap_method(
                    ...
                    default_retry=self._method_configs[
                        'GetAccountBudgetProposal'].retry,
                    default_timeout=self._method_configs[
                        'GetAccountBudgetProposal'].timeout,
    ...
    def mutate_account_budget_proposal(
        ...
        Args:
            ...
            operation (Union[dict, ~google.ads.google_ads.v0.types.AccountBudgetProposalOperation]): The operation to perform on an individual account-level budget proposal.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.google_ads.v0.types.AccountBudgetProposalOperation`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.google_ads.v0.types.MutateAccountBudgetProposalResponse` instance.
        ...
        if 'mutate_account_budget_proposal' not in self._inner_api_calls:
            self._inner_api_calls[
                'mutate_account_budget_proposal'] = google.api_core.gapic_v1.method.wrap_method(
                    ...
                    default_retry=self._method_configs[
                        'MutateAccountBudgetProposal'].retry,
                    default_timeout=self._method_configs[
                        'MutateAccountBudgetProposal'].timeout,
                    client_info=self._client_info,
                )
