...
from google.ads.googleads.v17.enums.types import consent_status
...
class Consent(proto.Message):
    ...
    Attributes:
        ...
        ad_personalization (google.ads.googleads.v17.enums.types.ConsentStatusEnum.ConsentStatus):
