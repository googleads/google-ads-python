...
class CustomerLifecycleGoalServiceClient(
    ...
    def configure_customer_lifecycle_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.ConfigureCustomerLifecycleGoalsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v19.services.types.CustomerLifecycleGoalOperation):
        ...
        Returns:
            google.ads.googleads.v19.services.types.ConfigureCustomerLifecycleGoalsResponse:
