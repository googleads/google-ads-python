...
# source: google/ads/googleads_v0/proto/resources/customer_manager_link.proto
...
_CUSTOMERMANAGERLINK = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.resources.CustomerManagerLink',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v0.resources.CustomerManagerLink.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='manager_customer', full_name='google.ads.googleads.v0.resources.CustomerManagerLink.manager_customer', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='manager_link_id', full_name='google.ads.googleads.v0.resources.CustomerManagerLink.manager_link_id', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='status', full_name='google.ads.googleads.v0.resources.CustomerManagerLink.status', index=3,
...
_CUSTOMERMANAGERLINK.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_manager__link__status__pb2._MANAGERLINKSTATUSENUM_MANAGERLINKSTATUS
...
CustomerManagerLink = _reflection.GeneratedProtocolMessageType('CustomerManagerLink', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.google_ads.v0.proto.resources.customer_manager_link_pb2'
  ,
  ...
  Attributes:
      resource_name:
          ...
          ager_customer_id}_{manager_link_id}``
      manager_customer:
          The manager customer linked to the customer. This field is
          read only.
      manager_link_id:
...
DESCRIPTOR._options = _descriptor._ParseOptions(descriptor_pb2.FileOptions(), _b('\n%com.google.ads.googleads.v0.resourcesB\030CustomerManagerLinkProtoP\001ZJgoogle.golang.org/genproto/googleapis/ads/googleads/v0/resources;resources\242\002\003GAA\252\002!Google.Ads.GoogleAds.V0.Resources\312\002!Google\\Ads\\GoogleAds\\V0\\Resources'))
