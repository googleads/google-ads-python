...
class InvoiceServiceClient(metaclass=InvoiceServiceClientMeta):
    ...
    @staticmethod
    def invoice_path(customer: str, invoice: str,) -> str:
        """Return a fully-qualified invoice string."""
        return "customers/{customer}/invoices/{invoice}".format(
    ...
    def parse_invoice_path(path: str) -> Dict[str, str]:
        ...
        m = re.match(
            r"^customers/(?P<customer>.+?)/invoices/(?P<invoice>.+?)$", path
        )
    ...
    def list_invoices(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.ListInvoicesRequest`):
            ...
            issue_year (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            issue_month (:class:`google.ads.googleads.v4.enums.types.MonthOfYearEnum.MonthOfYear`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.ListInvoicesResponse:
                Response message for
                [InvoiceService.ListInvoices][google.ads.googleads.v4.services.InvoiceService.ListInvoices].
