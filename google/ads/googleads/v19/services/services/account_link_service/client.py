...
class AccountLinkServiceClient(metaclass=AccountLinkServiceClientMeta):
    ...
    def create_account_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.CreateAccountLinkRequest, dict, None]):
    ...
    def mutate_account_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.MutateAccountLinkRequest, dict, None]):
                The request object. Request message for
