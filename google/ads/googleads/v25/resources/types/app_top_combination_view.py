...
from google.ads.googleads.v25.common.types import asset_usage
...
class AppTopCombinationView(proto.Message):
    ...
    Attributes:
        ...
        ad_group_top_combinations (MutableSequence[google.ads.googleads.v25.resources.types.AdGroupCreativeAssetCombinationData]):
...
class AdGroupCreativeAssetCombinationData(proto.Message):
    ...
    Attributes:
        asset_combination_served_assets (MutableSequence[google.ads.googleads.v25.common.types.AssetUsage]):
