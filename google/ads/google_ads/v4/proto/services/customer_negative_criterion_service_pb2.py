...
# source: google/ads/googleads_v4/proto/services/customer_negative_criterion_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v4/proto/services/customer_negative_criterion_service.proto',
...
_CUSTOMERNEGATIVECRITERIONOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_customer__negative__criterion__pb2._CUSTOMERNEGATIVECRITERION
...
GetCustomerNegativeCriterionRequest = _reflection.GeneratedProtocolMessageType('GetCustomerNegativeCriterionRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v4.proto.services.customer_negative_criterion_service_pb2'
  ,
...
_CUSTOMERNEGATIVECRITERIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_customer__negative__criterion__pb2._CUSTOMERNEGATIVECRITERION,
    serialized_options=_b('\202\323\344\223\002<\022:/v4/{resource_name=customers/*/customerNegativeCriteria/*}\332A\rresource_name'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002B\"=/v4/customers/{customer_id=*}/customerNegativeCriteria:mutate:\001*\332A\026customer_id,operations'),
  ),
])
