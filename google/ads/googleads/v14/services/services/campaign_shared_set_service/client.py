...
class CampaignSharedSetServiceClient(
    ...
    def mutate_campaign_shared_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateCampaignSharedSetsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateCampaignSharedSetsResponse:
