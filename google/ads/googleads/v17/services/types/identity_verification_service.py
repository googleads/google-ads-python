...
class GetIdentityVerificationResponse(proto.Message):
    ...
    Attributes:
        identity_verification (MutableSequence[google.ads.googleads.v17.services.types.IdentityVerification]):
...
class IdentityVerification(proto.Message):
    ...
    Attributes:
        ...
        identity_verification_requirement (google.ads.googleads.v17.services.types.IdentityVerificationRequirement):
        ...
        verification_progress (google.ads.googleads.v17.services.types.IdentityVerificationProgress):
...
class IdentityVerificationProgress(proto.Message):
    ...
    Attributes:
        program_status (google.ads.googleads.v17.enums.types.IdentityVerificationProgramStatusEnum.IdentityVerificationProgramStatus):
