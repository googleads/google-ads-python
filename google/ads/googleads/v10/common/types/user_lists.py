...
from google.ads.googleads.v10.enums.types import user_list_crm_data_source_type
from google.ads.googleads.v10.enums.types import (
    user_list_date_rule_item_operator,
)
from google.ads.googleads.v10.enums.types import user_list_logical_rule_operator
from google.ads.googleads.v10.enums.types import (
    user_list_number_rule_item_operator,
)
from google.ads.googleads.v10.enums.types import user_list_prepopulation_status
from google.ads.googleads.v10.enums.types import user_list_rule_type
from google.ads.googleads.v10.enums.types import (
...
class CrmBasedUserListInfo(proto.Message):
    ...
    Attributes:
        app_id (str):
            ...
            package name (e.g., "com.labpixies.colordrips"
            for "Color Drips" given Google Play link
        ...
        upload_key_type (google.ads.googleads.v10.enums.types.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyType):
            Matching key type of the list.
            Mixed data types are not allowed on the same
            list. This field is required for an ADD
            operation.
        data_source_type (google.ads.googleads.v10.enums.types.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceType):
...
class UserListRuleInfo(proto.Message):
    ...
    Attributes:
        rule_type (google.ads.googleads.v10.enums.types.UserListRuleTypeEnum.UserListRuleType):
        ...
        rule_item_groups (Sequence[google.ads.googleads.v10.common.types.UserListRuleItemGroupInfo]):
...
class UserListRuleItemGroupInfo(proto.Message):
    ...
    Attributes:
        rule_items (Sequence[google.ads.googleads.v10.common.types.UserListRuleItemInfo]):
...
class UserListRuleItemInfo(proto.Message):
    ...
    Attributes:
        ...
        number_rule_item (google.ads.googleads.v10.common.types.UserListNumberRuleItemInfo):
            An atomic rule item composed of a number
            operation.

            This field is a member of `oneof`_ ``rule_item``.
        string_rule_item (google.ads.googleads.v10.common.types.UserListStringRuleItemInfo):
            An atomic rule item composed of a string
            operation.

            This field is a member of `oneof`_ ``rule_item``.
        date_rule_item (google.ads.googleads.v10.common.types.UserListDateRuleItemInfo):
...
class UserListDateRuleItemInfo(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v10.enums.types.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperator):
...
class UserListNumberRuleItemInfo(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v10.enums.types.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperator):
...
class UserListStringRuleItemInfo(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v10.enums.types.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperator):
...
class CombinedRuleUserListInfo(proto.Message):
    ...
    Attributes:
        left_operand (google.ads.googleads.v10.common.types.UserListRuleInfo):
            Left operand of the combined rule.
            This field is required and must be populated
            when creating new combined rule based user list.
        right_operand (google.ads.googleads.v10.common.types.UserListRuleInfo):
            Right operand of the combined rule.
            This field is required and must be populated
            when creating new combined rule based user list.
        rule_operator (google.ads.googleads.v10.enums.types.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperator):
...
class DateSpecificRuleUserListInfo(proto.Message):
    ...
    Attributes:
        rule (google.ads.googleads.v10.common.types.UserListRuleInfo):
...
class RuleBasedUserListInfo(proto.Message):
    ...
    Attributes:
        prepopulation_status (google.ads.googleads.v10.enums.types.UserListPrepopulationStatusEnum.UserListPrepopulationStatus):
            ...
            request fails.
        combined_rule_user_list (google.ads.googleads.v10.common.types.CombinedRuleUserListInfo):
        ...
        date_specific_rule_user_list (google.ads.googleads.v10.common.types.DateSpecificRuleUserListInfo):
            ...
            This field is a member of `oneof`_ ``rule_based_user_list``.
        expression_rule_user_list (google.ads.googleads.v10.common.types.ExpressionRuleUserListInfo):
...
class LogicalUserListInfo(proto.Message):
    ...
    Attributes:
        rules (Sequence[google.ads.googleads.v10.common.types.UserListLogicalRuleInfo]):
...
class UserListLogicalRuleInfo(proto.Message):
    ...
    Attributes:
        operator (google.ads.googleads.v10.enums.types.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperator):
            The logical operator of the rule.
        rule_operands (Sequence[google.ads.googleads.v10.common.types.LogicalUserListOperandInfo]):
...
class BasicUserListInfo(proto.Message):
    ...
    Attributes:
        actions (Sequence[google.ads.googleads.v10.common.types.UserListActionInfo]):
