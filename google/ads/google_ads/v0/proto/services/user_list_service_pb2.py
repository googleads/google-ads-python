...
# source: google/ads/googleads_v0/proto/services/user_list_service.proto
...
_GETUSERLISTREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.GetUserListRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v0.services.GetUserListRequest.resource_name', index=0,
...
_MUTATEUSERLISTSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.MutateUserListsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v0.services.MutateUserListsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_USERLISTOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.UserListOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v0.services.UserListOperation.update_mask', index=0,
...
_MUTATEUSERLISTSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.MutateUserListsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_MUTATEUSERLISTRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.MutateUserListResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v0.services.MutateUserListResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_USERLISTOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_resources_dot_user__list__pb2._USERLIST
_USERLISTOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_resources_dot_user__list__pb2._USERLIST
...
GetUserListRequest = _reflection.GeneratedProtocolMessageType('GetUserListRequest', (_message.Message,), dict(
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v0.services.GetUserListRequest)
  ))
...
UserListOperation = _reflection.GeneratedProtocolMessageType('UserListOperation', (_message.Message,), dict(
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v0.services.UserListOperation)
  ))
...
MutateUserListResult = _reflection.GeneratedProtocolMessageType('MutateUserListResult', (_message.Message,), dict(
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v0.services.MutateUserListResult)
  ))
...
_USERLISTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetUserList',
    full_name='google.ads.googleads.v0.services.UserListService.GetUserList',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v0.services.UserListService.MutateUserLists',
    index=1,
    containing_service=None,
