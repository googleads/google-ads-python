...
class CustomerExtensionSettingServiceClient(
    ...
    def mutate_customer_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.MutateCustomerExtensionSettingsRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v10.services.types.MutateCustomerExtensionSettingsResponse:
