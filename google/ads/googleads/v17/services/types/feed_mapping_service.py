...
class FeedMappingOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v17.resources.types.FeedMapping):
    ...
    create: gagr_feed_mapping.FeedMapping = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
...
class MutateFeedMappingsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v17.services.types.MutateFeedMappingResult]):
