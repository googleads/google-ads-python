...
class CustomizerAttributeServiceClient(
    ...
    def mutate_customizer_attributes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateCustomizerAttributesRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v17.services.types.CustomizerAttributeOperation]):
        ...
        Returns:
            google.ads.googleads.v17.services.types.MutateCustomizerAttributesResponse:
