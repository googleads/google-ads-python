...
from google.ads.googleads.v25.enums.types import local_services_lead_status
from google.ads.googleads.v25.enums.types import local_services_lead_type
...
class LocalServicesLead(proto.Message):
    ...
    Attributes:
        resource_name (str):
            ...
            data. Local Services Lead resource names have the form
        ...
        contact_details (google.ads.googleads.v25.resources.types.ContactDetails):
            Output only. Lead's contact details.
        lead_type (google.ads.googleads.v25.enums.types.LocalServicesLeadTypeEnum.LeadType):
            Output only. Type of Local Services lead:
            phone, message, booking, etc.
        lead_status (google.ads.googleads.v25.enums.types.LocalServicesLeadStatusEnum.LeadStatus):
        ...
        note (google.ads.googleads.v25.resources.types.Note):
        ...
        credit_details (google.ads.googleads.v25.resources.types.CreditDetails):
...
class ContactDetails(proto.Message):
    ...
    Attributes:
        ...
        phone_number_extension (str):
            Output only. The extension number to be used with the phone
            number. This field is populated only when the 'phone_number'
            is a tracking number. It is typically 3 or 4 digits.
            Example: 013, 0129. When populated, this extension number is
            required to reach out to the right consumer.
    """
    ...
    phone_number_extension: str = proto.Field(
        proto.STRING,
        number=4,
    )
...
class CreditDetails(proto.Message):
    ...
    Attributes:
        credit_state (google.ads.googleads.v25.enums.types.LocalServicesCreditStateEnum.CreditState):
