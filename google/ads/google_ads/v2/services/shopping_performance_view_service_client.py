...
"""Accesses the google.ads.googleads.v2.services ShoppingPerformanceViewService API."""
...
from google.ads.google_ads.v2.services import shopping_performance_view_service_client_config
...
class ShoppingPerformanceViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.ShoppingPerformanceViewService'
    ...
    def get_shopping_performance_view(
        ...
        Args:
            resource_name (str): The resource name of the Shopping performance view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.ShoppingPerformanceView` instance.
