...
keyword_text_phrase_1 = "example of phrase match"
keyword_text_broad_1 = "example of broad match"
...
def main(
  ...
  # [START Step 2 -- Create an ad group]
  ...
  # [END Step 2 -- Create an ad group]

  # [START Step 3 -- Create an ad group ad]
  ...
  for result in ad_group_ad_response.results:
      ...
      rsa_resource_name = result.resource_name

  # [END Step 3 -- Create an ad group ad]

  # [START Step 4 -- Add Keywords]
  ...
  ad_group_criterion.keyword.text = keyword_text_exact_1

  # 3 keyword match types: EXACT, PHRASE, and BROAD.
  ...
  ad_group_criterion.status = client.enums.AdGroupCriterionStatusEnum.ENABLED
  ad_group_criterion.keyword.text = keyword_text_phrase_1
  ...
  ad_group_criterion.status = client.enums.AdGroupCriterionStatusEnum.ENABLED
  ad_group_criterion.keyword.text = keyword_text_broad_1
  ...
  for results in ad_group_criterion_response.results:
    print(
      "Created keyword "
      f"{results.resource_name}."
    )

  # [END Step 4 -- Add Keywords]

  # [START Step 5 -- Add Geo Targeting]
  ...
  for suggestion in results.geo_target_constant_suggestions:
      ...
      campaign_criterion.location.geo_target_constant = geo_target_constant.resource_name
  ...
  # [END Step 5 -- Add Geo Targeting]

  # [START Step 6 -- Add Image Extensions]
  # This is optional but recommended for RSA.
  if add_image_extension:
    ...
    # [END Step 6 -- Add Image Extensions]
  return 
...
if __name__ == "__main__":
  ...
  parser = argparse.ArgumentParser(description=("Creates a Responsive Search Ad for specified customer."))
