...
from google.ads.googleads.v16.enums.types import campaign_group_status
...
class CampaignGroup(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v16.enums.types.CampaignGroupStatusEnum.CampaignGroupStatus):
