...
class MutateCampaignAssetSetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v25.services.types.CampaignAssetSetOperation]):
...
class CampaignAssetSetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v25.resources.types.CampaignAssetSet):
...
class MutateCampaignAssetSetsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v25.services.types.MutateCampaignAssetSetResult]):
