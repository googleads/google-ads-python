...
from google.ads.googleads.v14.resources.types import customer_conversion_goal
...
class MutateCustomerConversionGoalsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v14.services.types.MutateCustomerConversionGoalResult]):
