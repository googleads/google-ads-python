...
class AdGroupFeedServiceClient(metaclass=AdGroupFeedServiceClientMeta):
    ...
    def mutate_ad_group_feeds(
        self,
        request: Union[
            ad_group_feed_service.MutateAdGroupFeedsRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.MutateAdGroupFeedsRequest, dict]):
                The request object. Request message for
                [AdGroupFeedService.MutateAdGroupFeeds][google.ads.googleads.v10.services.AdGroupFeedService.MutateAdGroupFeeds].
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v10.services.types.AdGroupFeedOperation]):
        ...
        Returns:
            google.ads.googleads.v10.services.types.MutateAdGroupFeedsResponse:
