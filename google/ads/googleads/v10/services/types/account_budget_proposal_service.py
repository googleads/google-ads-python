...
from google.ads.googleads.v10.resources.types import account_budget_proposal
...
class MutateAccountBudgetProposalRequest(proto.Message):
    ...
    Attributes:
        ...
        operation (google.ads.googleads.v10.services.types.AccountBudgetProposalOperation):
...
class AccountBudgetProposalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v10.resources.types.AccountBudgetProposal):
...
class MutateAccountBudgetProposalResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v10.services.types.MutateAccountBudgetProposalResult):
