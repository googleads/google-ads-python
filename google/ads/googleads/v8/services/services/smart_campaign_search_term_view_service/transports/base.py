...
class SmartCampaignSearchTermViewServiceTransport(metaclass=abc.ABCMeta):
    """Abstract transport class for SmartCampaignSearchTermViewService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_smart_campaign_search_term_view: gapic_v1.method.wrap_method(
                self.get_smart_campaign_search_term_view,
...
__all__ = ("SmartCampaignSearchTermViewServiceTransport",)
