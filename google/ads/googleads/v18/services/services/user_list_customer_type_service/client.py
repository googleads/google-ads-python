...
class UserListCustomerTypeServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, UserListCustomerTypeServiceTransport]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, UserListCustomerTypeServiceTransport]]): The
        ...
        if isinstance(transport, UserListCustomerTypeServiceTransport):
    ...
    def mutate_user_list_customer_types(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateUserListCustomerTypesRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v18.services.types.UserListCustomerTypeOperation]):
        ...
        Returns:
            google.ads.googleads.v18.services.types.MutateUserListCustomerTypesResponse:
        ...
        # in a user_list_customer_type_service.MutateUserListCustomerTypesRequest.
