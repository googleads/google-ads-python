...
from google.ads.googleads.v25.enums.types import benchmarks_source_type
...
class BenchmarksServiceAsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        sa_info_func = (
            BenchmarksServiceClient.from_service_account_info.__func__  # type: ignore
        )
        return sa_info_func(BenchmarksServiceAsyncClient, info, *args, **kwargs)
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        """
        sa_file_func = (
            BenchmarksServiceClient.from_service_account_file.__func__  # type: ignore
        )
        return sa_file_func(
            BenchmarksServiceAsyncClient, filename, *args, **kwargs
        )
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v25.services.BenchmarksServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def list_benchmarks_available_dates(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v25.services.types.ListBenchmarksAvailableDatesRequest, dict]]):
        ...
        Returns:
            google.ads.googleads.v25.services.types.ListBenchmarksAvailableDatesResponse:
    ...
    async def list_benchmarks_locations(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v25.services.types.ListBenchmarksLocationsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v25.services.types.ListBenchmarksLocationsResponse:
                Response message for
                   [BenchmarksService.ListBenchmarksLocations][google.ads.googleads.v25.services.BenchmarksService.ListBenchmarksLocations].
    ...
    async def list_benchmarks_products(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v25.services.types.ListBenchmarksProductsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v25.services.types.ListBenchmarksProductsResponse:
                Response message for
                   [BenchmarksService.ListBenchmarksProducts][google.ads.googleads.v25.services.BenchmarksService.ListBenchmarksProducts].
    ...
    async def list_benchmarks_sources(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v25.services.types.ListBenchmarksSourcesRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v25.services.types.ListBenchmarksSourcesResponse:
                Response message for
                   [BenchmarksService.ListBenchmarksSources][google.ads.googleads.v25.services.BenchmarksService.ListBenchmarksSources].
    ...
    async def generate_benchmarks_metrics(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v25.services.types.GenerateBenchmarksMetricsRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            location (:class:`google.ads.googleads.v25.common.types.LocationInfo`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            benchmarks_source (:class:`google.ads.googleads.v25.services.types.BenchmarksSource`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            product_filter (:class:`google.ads.googleads.v25.services.types.ProductFilter`):
        ...
        Returns:
            google.ads.googleads.v25.services.types.GenerateBenchmarksMetricsResponse:
                Response message for
                   [BenchmarksService.GenerateBenchmarksMetrics][google.ads.googleads.v25.services.BenchmarksService.GenerateBenchmarksMetrics].
