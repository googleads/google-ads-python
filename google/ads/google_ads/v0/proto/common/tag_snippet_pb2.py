...
# source: google/ads/googleads_v0/proto/common/tag_snippet.proto
...
_TAGSNIPPET = _descriptor.Descriptor(
  name='TagSnippet',
  full_name='google.ads.googleads.v0.common.TagSnippet',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='google.ads.googleads.v0.common.TagSnippet.type', index=0,
...
_TAGSNIPPET.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_tracking__code__type__pb2._TRACKINGCODETYPEENUM_TRACKINGCODETYPE
_TAGSNIPPET.fields_by_name['page_format'].enum_type = google_dot_ads_dot_googleads__v0_dot_proto_dot_enums_dot_tracking__code__page__format__pb2._TRACKINGCODEPAGEFORMATENUM_TRACKINGCODEPAGEFORMAT
