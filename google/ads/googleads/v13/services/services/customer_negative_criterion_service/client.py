...
class CustomerNegativeCriterionServiceClient(
    ...
    def mutate_customer_negative_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateCustomerNegativeCriteriaRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v13.services.types.CustomerNegativeCriterionOperation]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateCustomerNegativeCriteriaResponse:
