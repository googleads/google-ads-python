...
class MutateAdGroupAdsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            are being modified.
        operations (MutableSequence[google.ads.googleads.v25.services.types.AdGroupAdOperation]):
...
class AdGroupAdOperation(proto.Message):
    ...
    Attributes:
        ...
        policy_validation_parameter (google.ads.googleads.v25.common.types.PolicyValidationParameter):
            Configuration for how policies are validated.
        create (google.ads.googleads.v25.resources.types.AdGroupAd):
            Create operation: No resource name is
            expected for the new ad.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v25.resources.types.AdGroupAd):
...
class MutateAdGroupAdsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v25.services.types.MutateAdGroupAdResult]):
...
class RemoveAutomaticallyCreatedAssetsRequest(proto.Message):
    ...
    Attributes:
        ad_group_ad (str):
            ...
            assets.
        assets_with_field_type (MutableSequence[google.ads.googleads.v25.services.types.AssetsWithFieldType]):
