...
class Commission(proto.Message):
    ...
    Attributes:
        commission_rate_micros (google.protobuf.wrappers_pb2.Int64Value):
...
class ManualCpc(proto.Message):
    ...
    Attributes:
        enhanced_cpc_enabled (google.protobuf.wrappers_pb2.BoolValue):
...
class TargetCpa(proto.Message):
    ...
    Attributes:
        ...
        cpc_bid_floor_micros (google.protobuf.wrappers_pb2.Int64Value):
...
class TargetImpressionShare(proto.Message):
    ...
    Attributes:
        location (google.ads.googleads.v4.enums.types.TargetImpressionShareLocationEnum.TargetImpressionShareLocation):
            The targeted location on the search results
            page.
        location_fraction_micros (google.protobuf.wrappers_pb2.Int64Value):
...
class TargetSpend(proto.Message):
    ...
    Attributes:
        target_spend_micros (google.protobuf.wrappers_pb2.Int64Value):
