...
"""Accesses the google.ads.googleads.v5.services CustomerManagerLinkService API."""
...
from google.ads.google_ads.v5.services import customer_manager_link_service_client_config
from google.ads.google_ads.v5.services.transports import customer_manager_link_service_grpc_transport
from google.ads.google_ads.v5.proto.services import customer_manager_link_service_pb2
...
class CustomerManagerLinkServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v5.services.CustomerManagerLinkService'
    ...
    def get_customer_manager_link(
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.CustomerManagerLink` instance.
    ...
    def mutate_customer_manager_link(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v5.types.CustomerManagerLinkOperation]]): Required. The list of operations to perform on individual customer manager links.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v5.types.CustomerManagerLinkOperation`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
                be retried using a default configuration.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.MutateCustomerManagerLinkResponse` instance.
    ...
    def move_manager_link(
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.MoveManagerLinkResponse` instance.
