...
class AdServiceClient(metaclass=AdServiceClientMeta):
    ...
    def get_ad(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.GetAdRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v13.resources.types.Ad:
                An ad.
        """
    ...
    def mutate_ads(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateAdsRequest, dict, None]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (MutableSequence[google.ads.googleads.v13.services.types.AdOperation]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateAdsResponse:
