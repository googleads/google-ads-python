...
class CustomerServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.MutateCustomer = channel.unary_unary(
        '/google.ads.googleads.v0.services.CustomerService/MutateCustomer',
        request_serializer=google_dot_ads_dot_googleads__v0_dot_proto_dot_services_dot_customer__service__pb2.MutateCustomerRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads__v0_dot_proto_dot_services_dot_customer__service__pb2.MutateCustomerResponse.FromString,
        )
    ...
    self.CreateCustomerClient = channel.unary_unary(
        ...
        request_serializer=google_dot_ads_dot_googleads__v0_dot_proto_dot_services_dot_customer__service__pb2.CreateCustomerClientRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads__v0_dot_proto_dot_services_dot_customer__service__pb2.CreateCustomerClientResponse.FromString,
        )
...
def add_CustomerServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'MutateCustomer': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=google_dot_ads_dot_googleads__v0_dot_proto_dot_services_dot_customer__service__pb2.MutateCustomerRequest.FromString,
          response_serializer=google_dot_ads_dot_googleads__v0_dot_proto_dot_services_dot_customer__service__pb2.MutateCustomerResponse.SerializeToString,
      ),
      ...
      'CreateCustomerClient': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=google_dot_ads_dot_googleads__v0_dot_proto_dot_services_dot_customer__service__pb2.CreateCustomerClientRequest.FromString,
          response_serializer=google_dot_ads_dot_googleads__v0_dot_proto_dot_services_dot_customer__service__pb2.CreateCustomerClientResponse.SerializeToString,
      ),
  }
