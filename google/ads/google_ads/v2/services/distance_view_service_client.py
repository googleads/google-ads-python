...
"""Accesses the google.ads.googleads.v2.services DistanceViewService API."""
...
from google.ads.google_ads.v2.services import distance_view_service_client_config
...
class DistanceViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.DistanceViewService'
    ...
    def get_distance_view(
        ...
        Args:
            resource_name (str): The resource name of the distance view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.DistanceView` instance.
