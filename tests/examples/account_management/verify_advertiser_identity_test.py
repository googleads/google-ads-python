...
from google.ads.googleads.v19.services.services.identity_verification_service import (
...
from google.ads.googleads.v19.enums.types.identity_verification_program_status import (
    IdentityVerificationProgramStatusEnum as ActualIdentityVerificationProgramStatusEnumType,
)
from google.ads.googleads.v19.enums.types.identity_verification_program import (
    IdentityVerificationProgramEnum as ActualIdentityVerificationProgramEnumType,
)
...
class TestVerifyAdvertiserIdentity(unittest.TestCase):
    ...
    @patch(
        "examples.account_management.verify_advertiser_identity.GoogleAdsClient"
    )
    def test_main_unspecified_starts_verification(
        ...
        mock_id_verification_service = MagicMock(
            spec=IdentityVerificationServiceClient
        )
        mock_client_instance.get_service.return_value = (
            mock_id_verification_service
        )
        ...
        mock_client_instance.enums.IdentityVerificationProgramStatusEnum = (
            ActualIdentityVerificationProgramStatusEnumType.IdentityVerificationProgramStatus
        )
        # The script uses client.enums.IdentityVerificationProgramEnum.ADVERTISER_IDENTITY_VERIFICATION
        mock_client_instance.enums.IdentityVerificationProgramEnum = (
            ActualIdentityVerificationProgramEnumType.IdentityVerificationProgram
        )
        ...
        mock_id_verification_1.identity_verification_requirement = (
            MagicMock()
        )  # Explicit mock
        mock_id_verification_1.identity_verification_requirement.verification_completion_deadline_time = (
            deadline_time
        )
        mock_id_verification_1.verification_progress = (
            MagicMock()
        )  # Explicit mock
        mock_id_verification_1.verification_progress.program_status = (
            ActualIdentityVerificationProgramStatusEnumType.IdentityVerificationProgramStatus.UNSPECIFIED
        )
        mock_verification_response_1.identity_verification = [
            mock_id_verification_1
        ]
        ...
        mock_id_verification_2.identity_verification_requirement = (
            MagicMock()
        )  # Explicit mock
        mock_id_verification_2.identity_verification_requirement.verification_completion_deadline_time = (
            deadline_time  # Assume same deadline
        )
        mock_id_verification_2.verification_progress = (
            MagicMock()
        )  # Explicit mock
        mock_id_verification_2.verification_progress.program_status = (
            ActualIdentityVerificationProgramStatusEnumType.IdentityVerificationProgramStatus.PENDING_USER_ACTION
        )
        mock_id_verification_2.verification_progress.action_url = (
            "http://example.com/verify"
        )
        mock_id_verification_2.verification_progress.invitation_link_expiration_time = (
            "2025-01-15 23:59:59"
        )
        mock_verification_response_2.identity_verification = [
            mock_id_verification_2
        ]
        ...
        mock_id_verification_service.start_identity_verification.return_value = (
            None
        )
        ...
        # 5. Assertions
        # Assert get_service was called for IdentityVerificationService
        ...
        mock_id_verification_service.get_identity_verification.assert_called_once_with(
        ...
        # expected_status_val_1 = ActualIdentityVerificationProgramStatusEnumType.IdentityVerificationProgramStatus.UNSPECIFIED.name
        ...
        # # Script prints the integer value of the enum for status
        # expected_status_val_2 = ActualIdentityVerificationProgramStatusEnumType.IdentityVerificationProgramStatus.PENDING_USER_ACTION.name
    ...
    def test_main_pending_user_action_prints_details(
        self, mock_google_ads_client_class
    ):
        ...
        mock_verification.identity_verification_requirement = (
            MagicMock()
        )  # Explicit mock
        mock_verification.identity_verification_requirement.verification_completion_deadline_time = (
            deadline_time
        )
        mock_verification.verification_progress = MagicMock()  # Explicit mock
        mock_verification.verification_progress.program_status = (
            ActualIdentityVerificationProgramStatusEnumType.IdentityVerificationProgramStatus.PENDING_USER_ACTION
        )
        mock_verification.verification_progress.action_url = action_url
        mock_verification.verification_progress.invitation_link_expiration_time = (
            invitation_expiration
        )
        mock_response.identity_verification = [mock_verification]
        mock_id_verification_service.get_identity_verification.return_value = (
            mock_response
        )
        ...
        # Script prints the integer value of the enum for status
        expected_status_val_pending = (
            ActualIdentityVerificationProgramStatusEnumType.IdentityVerificationProgramStatus.PENDING_USER_ACTION.name
        )
        expected_output_get = (
            f"Account {customer_id} has a verification completion deadline "
