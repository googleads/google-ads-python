...
"""Accesses the google.ads.googleads.v1.services DisplayKeywordViewService API."""
...
from google.ads.google_ads.v1.services import display_keyword_view_service_client_config
...
class DisplayKeywordViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.DisplayKeywordViewService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=display_keyword_view_service_grpc_transport.
    ...
    def get_display_keyword_view(
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.DisplayKeywordView` instance.
        ...
        return self._inner_api_calls['get_display_keyword_view'](
