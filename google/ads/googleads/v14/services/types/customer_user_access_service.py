...
from google.ads.googleads.v14.resources.types import customer_user_access
...
class MutateCustomerUserAccessResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v14.services.types.MutateCustomerUserAccessResult):
