...
# source: google/ads/googleads_v3/proto/services/ad_parameter_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v3/proto/services/ad_parameter_service.proto',
...
_ADPARAMETEROPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v3_dot_proto_dot_resources_dot_ad__parameter__pb2._ADPARAMETER
_ADPARAMETEROPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v3_dot_proto_dot_resources_dot_ad__parameter__pb2._ADPARAMETER
...
GetAdParameterRequest = _reflection.GeneratedProtocolMessageType('GetAdParameterRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v3.proto.services.ad_parameter_service_pb2'
  ,
  __doc__ = """Request message for
  [AdParameterService.GetAdParameter][google.ads.googleads.v3.services.AdParameterService.GetAdParameter]
...
MutateAdParametersRequest = _reflection.GeneratedProtocolMessageType('MutateAdParametersRequest', (_message.Message,), dict(
  ...
  ,
  __doc__ = """Request message for
  [AdParameterService.MutateAdParameters][google.ads.googleads.v3.services.AdParameterService.MutateAdParameters]
...
_ADPARAMETERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v3_dot_proto_dot_resources_dot_ad__parameter__pb2._ADPARAMETER,
    serialized_options=_b('\202\323\344\223\0020\022./v3/{resource_name=customers/*/adParameters/*}\332A\rresource_name'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0026\"1/v3/customers/{customer_id=*}/adParameters:mutate:\001*\332A\026customer_id,operations'),
  ),
])
