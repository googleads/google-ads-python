...
from google.ads.google_ads.v0.proto.services import recommendation_service_pb2 as google_dot_ads_dot_googleads__v0_dot_proto_dot_services_dot_recommendation__service__pb2
...
class RecommendationServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetRecommendation = channel.unary_unary(
        ...
        request_serializer=google_dot_ads_dot_googleads__v0_dot_proto_dot_services_dot_recommendation__service__pb2.GetRecommendationRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads__v0_dot_proto_dot_resources_dot_recommendation__pb2.Recommendation.FromString,
        )
...
def add_RecommendationServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetRecommendation': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=google_dot_ads_dot_googleads__v0_dot_proto_dot_services_dot_recommendation__service__pb2.GetRecommendationRequest.FromString,
          response_serializer=google_dot_ads_dot_googleads__v0_dot_proto_dot_resources_dot_recommendation__pb2.Recommendation.SerializeToString,
      ),
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'google.ads.googleads.v0.services.RecommendationService', rpc_method_handlers)
