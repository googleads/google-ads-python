...
# source: google/ads/googleads_v3/proto/services/customer_client_link_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v3/proto/services/customer_client_link_service.proto',
...
_CUSTOMERCLIENTLINKOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v3_dot_proto_dot_resources_dot_customer__client__link__pb2._CUSTOMERCLIENTLINK
_CUSTOMERCLIENTLINKOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v3_dot_proto_dot_resources_dot_customer__client__link__pb2._CUSTOMERCLIENTLINK
...
GetCustomerClientLinkRequest = _reflection.GeneratedProtocolMessageType('GetCustomerClientLinkRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v3.proto.services.customer_client_link_service_pb2'
  ,
  __doc__ = """Request message for
  [CustomerClientLinkService.GetCustomerClientLink][google.ads.googleads.v3.services.CustomerClientLinkService.GetCustomerClientLink].
  
  
  Attributes:
      resource_name:
          Required. The resource name of the customer client link to
          fetch.
  """,
...
MutateCustomerClientLinkRequest = _reflection.GeneratedProtocolMessageType('MutateCustomerClientLinkRequest', (_message.Message,), dict(
  ...
  ,
  __doc__ = """Request message for
  [CustomerClientLinkService.MutateCustomerClientLink][google.ads.googleads.v3.services.CustomerClientLinkService.MutateCustomerClientLink].
  
  
  Attributes:
      customer_id:
          Required. The ID of the customer whose customer link are being
          modified.
      operation:
          Required. The operation to perform on the individual
          CustomerClientLink.
  """,
...
_CUSTOMERCLIENTLINKSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v3_dot_proto_dot_resources_dot_customer__client__link__pb2._CUSTOMERCLIENTLINK,
    serialized_options=_b('\202\323\344\223\0027\0225/v3/{resource_name=customers/*/customerClientLinks/*}\332A\rresource_name'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002=\"8/v3/customers/{customer_id=*}/customerClientLinks:mutate:\001*\332A\025customer_id,operation'),
  ),
])
