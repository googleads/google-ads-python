...
# source: google/ads/googleads_v0/proto/enums/feed_item_quality_disapproval_reason.proto
...
_FEEDITEMQUALITYDISAPPROVALREASONENUM_FEEDITEMQUALITYDISAPPROVALREASON = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v0.enums.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_FEEDITEMQUALITYDISAPPROVALREASONENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.enums.FeedItemQualityDisapprovalReasonEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
FeedItemQualityDisapprovalReasonEnum = _reflection.GeneratedProtocolMessageType('FeedItemQualityDisapprovalReasonEnum', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v0.proto.enums.feed_item_quality_disapproval_reason_pb2'
  ,
  __doc__ = """Container for enum describing possible quality evaluation disapproval
  reasons of a feed item.
  """,
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v0.enums.FeedItemQualityDisapprovalReasonEnum)
  ))
