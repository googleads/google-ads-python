...
class CampaignServiceClient(metaclass=CampaignServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v18.services.CampaignServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaigns(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateCampaignsRequest, dict]):
