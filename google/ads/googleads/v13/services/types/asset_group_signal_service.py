...
class AssetGroupSignalOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v13.resources.types.AssetGroupSignal):
...
class MutateAssetGroupSignalsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v13.services.types.MutateAssetGroupSignalResult]):
