...
from google.ads.googleads.v17.enums.types import search_term_targeting_status
...
class SearchTermView(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v17.enums.types.SearchTermTargetingStatusEnum.SearchTermTargetingStatus):
