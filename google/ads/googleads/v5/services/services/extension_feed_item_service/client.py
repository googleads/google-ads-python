...
class ExtensionFeedItemServiceClient(
    ...
    def get_extension_feed_item(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetExtensionFeedItemRequest`):
        ...
        Returns:
            google.ads.googleads.v5.resources.types.ExtensionFeedItem:
    ...
    def mutate_extension_feed_items(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateExtensionFeedItemsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.ExtensionFeedItemOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateExtensionFeedItemsResponse:
