...
from google.ads.googleads.v10.enums.types import age_range_type
from google.ads.googleads.v10.enums.types import app_payment_model_type
from google.ads.googleads.v10.enums.types import content_label_type
from google.ads.googleads.v10.enums.types import day_of_week as gage_day_of_week
from google.ads.googleads.v10.enums.types import device
from google.ads.googleads.v10.enums.types import gender_type
from google.ads.googleads.v10.enums.types import hotel_date_selection_type
from google.ads.googleads.v10.enums.types import income_range_type
from google.ads.googleads.v10.enums.types import interaction_type
from google.ads.googleads.v10.enums.types import keyword_match_type
from google.ads.googleads.v10.enums.types import listing_group_type
from google.ads.googleads.v10.enums.types import location_group_radius_units
from google.ads.googleads.v10.enums.types import minute_of_hour
from google.ads.googleads.v10.enums.types import parental_status_type
from google.ads.googleads.v10.enums.types import preferred_content_type
from google.ads.googleads.v10.enums.types import product_bidding_category_level
...
from google.ads.googleads.v10.enums.types import product_custom_attribute_index
from google.ads.googleads.v10.enums.types import product_type_level
from google.ads.googleads.v10.enums.types import proximity_radius_units
from google.ads.googleads.v10.enums.types import webpage_condition_operand
from google.ads.googleads.v10.enums.types import webpage_condition_operator
...
class KeywordInfo(proto.Message):
    ...
    Attributes:
        ...
        match_type (google.ads.googleads.v10.enums.types.KeywordMatchTypeEnum.KeywordMatchType):
...
class DeviceInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v10.enums.types.DeviceEnum.Device):
            Type of the device.
    """
...
class PreferredContentInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v10.enums.types.PreferredContentTypeEnum.PreferredContentType):
...
class ListingGroupInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v10.enums.types.ListingGroupTypeEnum.ListingGroupType):
            Type of the listing group.
        case_value (google.ads.googleads.v10.common.types.ListingDimensionInfo):
...
class ListingScopeInfo(proto.Message):
    ...
    Attributes:
        dimensions (Sequence[google.ads.googleads.v10.common.types.ListingDimensionInfo]):
...
class ListingDimensionInfo(proto.Message):
    ...
    Attributes:
        hotel_id (google.ads.googleads.v10.common.types.HotelIdInfo):
            Advertiser-specific hotel ID.

            This field is a member of `oneof`_ ``dimension``.
        hotel_class (google.ads.googleads.v10.common.types.HotelClassInfo):
            Class of the hotel as a number of stars 1 to
            5.

            This field is a member of `oneof`_ ``dimension``.
        hotel_country_region (google.ads.googleads.v10.common.types.HotelCountryRegionInfo):
            Country or Region the hotel is located in.

            This field is a member of `oneof`_ ``dimension``.
        hotel_state (google.ads.googleads.v10.common.types.HotelStateInfo):
            State the hotel is located in.

            This field is a member of `oneof`_ ``dimension``.
        hotel_city (google.ads.googleads.v10.common.types.HotelCityInfo):
            City the hotel is located in.

            This field is a member of `oneof`_ ``dimension``.
        product_bidding_category (google.ads.googleads.v10.common.types.ProductBiddingCategoryInfo):
            Bidding category of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_brand (google.ads.googleads.v10.common.types.ProductBrandInfo):
            Brand of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_channel (google.ads.googleads.v10.common.types.ProductChannelInfo):
            Locality of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_channel_exclusivity (google.ads.googleads.v10.common.types.ProductChannelExclusivityInfo):
            Availability of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_condition (google.ads.googleads.v10.common.types.ProductConditionInfo):
            Condition of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_custom_attribute (google.ads.googleads.v10.common.types.ProductCustomAttributeInfo):
            Custom attribute of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_item_id (google.ads.googleads.v10.common.types.ProductItemIdInfo):
            Item id of a product offer.

            This field is a member of `oneof`_ ``dimension``.
        product_type (google.ads.googleads.v10.common.types.ProductTypeInfo):
...
class ProductBiddingCategoryInfo(proto.Message):
    ...
    Attributes:
        ...
        level (google.ads.googleads.v10.enums.types.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevel):
...
class ProductChannelInfo(proto.Message):
    ...
    Attributes:
        channel (google.ads.googleads.v10.enums.types.ProductChannelEnum.ProductChannel):
...
class ProductChannelExclusivityInfo(proto.Message):
    ...
    Attributes:
        channel_exclusivity (google.ads.googleads.v10.enums.types.ProductChannelExclusivityEnum.ProductChannelExclusivity):
...
class ProductConditionInfo(proto.Message):
    ...
    Attributes:
        condition (google.ads.googleads.v10.enums.types.ProductConditionEnum.ProductCondition):
...
class ProductCustomAttributeInfo(proto.Message):
    ...
    Attributes:
        value (str):
            ...
            This field is a member of `oneof`_ ``_value``.
        index (google.ads.googleads.v10.enums.types.ProductCustomAttributeIndexEnum.ProductCustomAttributeIndex):
...
class ProductTypeInfo(proto.Message):
    ...
    Attributes:
        value (str):
            ...
            This field is a member of `oneof`_ ``_value``.
        level (google.ads.googleads.v10.enums.types.ProductTypeLevelEnum.ProductTypeLevel):
            Level of the type.
    """
...
class HotelDateSelectionTypeInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v10.enums.types.HotelDateSelectionTypeEnum.HotelDateSelectionType):
...
class HotelCheckInDayInfo(proto.Message):
    ...
    Attributes:
        day_of_week (google.ads.googleads.v10.enums.types.DayOfWeekEnum.DayOfWeek):
            The day of the week.
    """
...
class InteractionTypeInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v10.enums.types.InteractionTypeEnum.InteractionType):
...
class AdScheduleInfo(proto.Message):
    ...
    Attributes:
        start_minute (google.ads.googleads.v10.enums.types.MinuteOfHourEnum.MinuteOfHour):
        ...
        end_minute (google.ads.googleads.v10.enums.types.MinuteOfHourEnum.MinuteOfHour):
...
class AgeRangeInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v10.enums.types.AgeRangeTypeEnum.AgeRangeType):
...
class GenderInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v10.enums.types.GenderTypeEnum.GenderType):
            Type of the gender.
    """
...
class IncomeRangeInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v10.enums.types.IncomeRangeTypeEnum.IncomeRangeType):
...
class ParentalStatusInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v10.enums.types.ParentalStatusTypeEnum.ParentalStatusType):
...
class ProximityInfo(proto.Message):
    ...
    Attributes:
        geo_point (google.ads.googleads.v10.common.types.GeoPointInfo):
            Latitude and longitude.
        radius (float):
            The radius of the proximity.

            This field is a member of `oneof`_ ``_radius``.
        radius_units (google.ads.googleads.v10.enums.types.ProximityRadiusUnitsEnum.ProximityRadiusUnits):
            The unit of measurement of the radius.
            Default is KILOMETERS.
        address (google.ads.googleads.v10.common.types.AddressInfo):
            Full address.
    """
...
class ContentLabelInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v10.enums.types.ContentLabelTypeEnum.ContentLabelType):
...
class WebpageInfo(proto.Message):
    ...
    Attributes:
        ...
        conditions (Sequence[google.ads.googleads.v10.common.types.WebpageConditionInfo]):
        ...
        coverage_percentage (float):
            ...
            is read-only.
        sample (google.ads.googleads.v10.common.types.WebpageSampleInfo):
...
class WebpageConditionInfo(proto.Message):
    ...
    Attributes:
        operand (google.ads.googleads.v10.enums.types.WebpageConditionOperandEnum.WebpageConditionOperand):
            Operand of webpage targeting condition.
        operator (google.ads.googleads.v10.enums.types.WebpageConditionOperatorEnum.WebpageConditionOperator):
...
class AppPaymentModelInfo(proto.Message):
    ...
    Attributes:
        type_ (google.ads.googleads.v10.enums.types.AppPaymentModelTypeEnum.AppPaymentModelType):
...
class LocationGroupInfo(proto.Message):
    ...
    Attributes:
        ...
        radius (int):
            ...
            This field is a member of `oneof`_ ``_radius``.
        radius_units (google.ads.googleads.v10.enums.types.LocationGroupRadiusUnitsEnum.LocationGroupRadiusUnits):
