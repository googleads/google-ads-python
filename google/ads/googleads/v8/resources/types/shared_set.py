...
class SharedSet(proto.Message):
    ...
    Attributes:
        ...
        id (int):
            ...
            only.
        type_ (google.ads.googleads.v8.enums.types.SharedSetTypeEnum.SharedSetType):
        ...
        status (google.ads.googleads.v8.enums.types.SharedSetStatusEnum.SharedSetStatus):
