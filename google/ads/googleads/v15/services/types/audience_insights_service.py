...
from google.ads.googleads.v15.common.types import dates
from google.ads.googleads.v15.enums.types import audience_insights_dimension
...
class GenerateInsightsFinderReportRequest(proto.Message):
    ...
    Attributes:
        ...
        baseline_audience (google.ads.googleads.v15.services.types.BasicInsightsAudience):
            Required. A baseline audience for this
            report, typically all people in a region.
        specific_audience (google.ads.googleads.v15.services.types.BasicInsightsAudience):
...
class GenerateAudienceCompositionInsightsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer.
        audience (google.ads.googleads.v15.services.types.InsightsAudience):
            Required. The audience of interest for which
            insights are being requested.
        baseline_audience (google.ads.googleads.v15.services.types.InsightsAudience):
        ...
        data_month (str):
            ...
            days of data.
        dimensions (MutableSequence[google.ads.googleads.v15.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension]):
...
class GenerateAudienceCompositionInsightsResponse(proto.Message):
    ...
    Attributes:
        sections (MutableSequence[google.ads.googleads.v15.services.types.AudienceCompositionSection]):
...
class GenerateSuggestedTargetingInsightsResponse(proto.Message):
    ...
    Attributes:
        suggestions (MutableSequence[google.ads.googleads.v15.services.types.TargetingSuggestionMetrics]):
...
class TargetingSuggestionMetrics(proto.Message):
    ...
    Attributes:
        locations (MutableSequence[google.ads.googleads.v15.services.types.AudienceInsightsAttributeMetadata]):
            Suggested location targeting. These attributes all have
            dimension GEO_TARGET_COUNTRY or SUB_COUNTRY_LOCATION
        age_ranges (MutableSequence[google.ads.googleads.v15.common.types.AgeRangeInfo]):
            Suggested age targeting; may be empty
            indicating no age targeting.
        gender (google.ads.googleads.v15.common.types.GenderInfo):
            Suggested gender targeting.  If present, this
            attribute has dimension GENDER.
        user_interests (MutableSequence[google.ads.googleads.v15.services.types.AudienceInsightsAttributeMetadata]):
...
class ListAudienceInsightsAttributesRequest(proto.Message):
    ...
    Attributes:
        ...
        customer_insights_group (str):
            The name of the customer being planned for.
            This is a user-defined value.
        location_country_filters (MutableSequence[google.ads.googleads.v15.common.types.LocationInfo]):
...
class ListAudienceInsightsAttributesResponse(proto.Message):
    ...
    Attributes:
        attributes (MutableSequence[google.ads.googleads.v15.services.types.AudienceInsightsAttributeMetadata]):
...
class ListInsightsEligibleDatesResponse(proto.Message):
    ...
    Attributes:
        ...
        last_thirty_days (google.ads.googleads.v15.common.types.DateRange):
...
class AudienceInsightsAttribute(proto.Message):
    ...
    Attributes:
        age_range (google.ads.googleads.v15.common.types.AgeRangeInfo):
        ...
        gender (google.ads.googleads.v15.common.types.GenderInfo):
            ...
            This field is a member of `oneof`_ ``attribute``.
        location (google.ads.googleads.v15.common.types.LocationInfo):
            An audience attribute defined by a geographic
            location.

            This field is a member of `oneof`_ ``attribute``.
        user_interest (google.ads.googleads.v15.common.types.UserInterestInfo):
            An Affinity or In-Market audience.

            This field is a member of `oneof`_ ``attribute``.
        entity (google.ads.googleads.v15.services.types.AudienceInsightsEntity):
            An audience attribute defined by interest in
            a topic represented by a Knowledge Graph entity.

            This field is a member of `oneof`_ ``attribute``.
        category (google.ads.googleads.v15.services.types.AudienceInsightsCategory):
            An audience attribute defined by interest in
            a Product & Service category.

            This field is a member of `oneof`_ ``attribute``.
        dynamic_lineup (google.ads.googleads.v15.services.types.AudienceInsightsDynamicLineup):
            A YouTube Dynamic Lineup

            This field is a member of `oneof`_ ``attribute``.
        parental_status (google.ads.googleads.v15.common.types.ParentalStatusInfo):
            A Parental Status value (parent, or not a
            parent).

            This field is a member of `oneof`_ ``attribute``.
        income_range (google.ads.googleads.v15.common.types.IncomeRangeInfo):
...
class BasicInsightsAudience(proto.Message):
    ...
    Attributes:
        country_location (MutableSequence[google.ads.googleads.v15.common.types.LocationInfo]):
            Required. The countries for this audience.
        sub_country_locations (MutableSequence[google.ads.googleads.v15.common.types.LocationInfo]):
        ...
        user_interests (MutableSequence[google.ads.googleads.v15.common.types.UserInterestInfo]):
            User interests defining this audience.
            Affinity and In-Market audiences are supported.
        topics (MutableSequence[google.ads.googleads.v15.services.types.AudienceInsightsTopic]):
...
class AudienceInsightsAttributeMetadata(proto.Message):
    ...
    Attributes:
        dimension (google.ads.googleads.v15.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension):
            The type of the attribute.
        attribute (google.ads.googleads.v15.services.types.AudienceInsightsAttribute):
        ...
        youtube_channel_metadata (google.ads.googleads.v15.services.types.YouTubeChannelAttributeMetadata):
            Special metadata for a YouTube channel.

            This field is a member of `oneof`_ ``dimension_metadata``.
        dynamic_attribute_metadata (google.ads.googleads.v15.services.types.DynamicLineupAttributeMetadata):
            Special metadata for a YouTube Dynamic
            Lineup.

            This field is a member of `oneof`_ ``dimension_metadata``.
        location_attribute_metadata (google.ads.googleads.v15.services.types.LocationAttributeMetadata):
...
class DynamicLineupAttributeMetadata(proto.Message):
    ...
    Attributes:
        inventory_country (google.ads.googleads.v15.common.types.LocationInfo):
        ...
        sample_channels (MutableSequence[google.ads.googleads.v15.services.types.DynamicLineupAttributeMetadata.SampleChannel]):
...
class LocationAttributeMetadata(proto.Message):
    ...
    Attributes:
        country_location (google.ads.googleads.v15.common.types.LocationInfo):
...
class InsightsAudience(proto.Message):
    ...
    Attributes:
        country_locations (MutableSequence[google.ads.googleads.v15.common.types.LocationInfo]):
        ...
        parental_status (google.ads.googleads.v15.common.types.ParentalStatusInfo):
            ...
            status.
        income_ranges (MutableSequence[google.ads.googleads.v15.common.types.IncomeRangeInfo]):
            Household income percentile ranges for the
            audience.  If absent, the audience does not
            restrict by household income range.
        dynamic_lineups (MutableSequence[google.ads.googleads.v15.services.types.AudienceInsightsDynamicLineup]):
            Dynamic lineups representing the YouTube
            content viewed by the audience.
        topic_audience_combinations (MutableSequence[google.ads.googleads.v15.services.types.InsightsAudienceAttributeGroup]):
...
class InsightsAudienceAttributeGroup(proto.Message):
    ...
    Attributes:
        attributes (MutableSequence[google.ads.googleads.v15.services.types.AudienceInsightsAttribute]):
...
class AudienceCompositionSection(proto.Message):
    ...
    Attributes:
        ...
        top_attributes (MutableSequence[google.ads.googleads.v15.services.types.AudienceCompositionAttribute]):
        ...
        clustered_attributes (MutableSequence[google.ads.googleads.v15.services.types.AudienceCompositionAttributeCluster]):
...
class AudienceCompositionAttributeCluster(proto.Message):
    ...
    Attributes:
        ...
        cluster_metrics (google.ads.googleads.v15.services.types.AudienceCompositionMetrics):
            ...
            field is unset.
        attributes (MutableSequence[google.ads.googleads.v15.services.types.AudienceCompositionAttribute]):
...
class AudienceCompositionAttribute(proto.Message):
    ...
    Attributes:
        attribute_metadata (google.ads.googleads.v15.services.types.AudienceInsightsAttributeMetadata):
            The attribute with its metadata.
        metrics (google.ads.googleads.v15.services.types.AudienceCompositionMetrics):
