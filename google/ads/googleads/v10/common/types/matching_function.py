...
from google.ads.googleads.v10.enums.types import matching_function_context_type
from google.ads.googleads.v10.enums.types import matching_function_operator
...
class MatchingFunction(proto.Message):
    ...
    Attributes:
        ...
        operator (google.ads.googleads.v10.enums.types.MatchingFunctionOperatorEnum.MatchingFunctionOperator):
            Operator for a function.
        left_operands (Sequence[google.ads.googleads.v10.common.types.Operand]):
        ...
        right_operands (Sequence[google.ads.googleads.v10.common.types.Operand]):
...
class Operand(proto.Message):
    ...
    Attributes:
        constant_operand (google.ads.googleads.v10.common.types.Operand.ConstantOperand):
            A constant operand in a matching function.

            This field is a member of `oneof`_ ``function_argument_operand``.
        feed_attribute_operand (google.ads.googleads.v10.common.types.Operand.FeedAttributeOperand):
            This operand specifies a feed attribute in
            feed.

            This field is a member of `oneof`_ ``function_argument_operand``.
        function_operand (google.ads.googleads.v10.common.types.Operand.FunctionOperand):
            A function operand in a matching function.
            Used to represent nested functions.

            This field is a member of `oneof`_ ``function_argument_operand``.
        request_context_operand (google.ads.googleads.v10.common.types.Operand.RequestContextOperand):
    ...
    class FunctionOperand(proto.Message):
        ...
        Attributes:
            matching_function (google.ads.googleads.v10.common.types.MatchingFunction):
    ...
    class RequestContextOperand(proto.Message):
        ...
        Attributes:
            context_type (google.ads.googleads.v10.enums.types.MatchingFunctionContextTypeEnum.MatchingFunctionContextType):
