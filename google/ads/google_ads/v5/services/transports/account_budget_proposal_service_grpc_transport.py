...
from google.ads.google_ads.v5.proto.services import account_budget_proposal_service_pb2_grpc


class AccountBudgetProposalServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v5.services AccountBudgetProposalService API.
