...
class PaymentsAccountServiceClient(metaclass=PaymentsAccountServiceClientMeta):
    ...
    def list_payments_accounts(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.ListPaymentsAccountsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.ListPaymentsAccountsResponse:
