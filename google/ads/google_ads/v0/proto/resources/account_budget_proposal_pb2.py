...
_ACCOUNTBUDGETPROPOSAL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='proposed_purchase_order_number', full_name='google.ads.googleads.v0.resources.AccountBudgetProposal.proposed_purchase_order_number', index=7,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='proposed_notes', full_name='google.ads.googleads.v0.resources.AccountBudgetProposal.proposed_notes', index=8,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='creation_date_time', full_name='google.ads.googleads.v0.resources.AccountBudgetProposal.creation_date_time', index=9,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='approval_date_time', full_name='google.ads.googleads.v0.resources.AccountBudgetProposal.approval_date_time', index=10,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='proposed_start_date_time', full_name='google.ads.googleads.v0.resources.AccountBudgetProposal.proposed_start_date_time', index=11,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='proposed_start_time_type', full_name='google.ads.googleads.v0.resources.AccountBudgetProposal.proposed_start_time_type', index=12,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='proposed_end_date_time', full_name='google.ads.googleads.v0.resources.AccountBudgetProposal.proposed_end_date_time', index=13,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='proposed_end_time_type', full_name='google.ads.googleads.v0.resources.AccountBudgetProposal.proposed_end_time_type', index=14,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='proposed_spending_limit_micros', full_name='google.ads.googleads.v0.resources.AccountBudgetProposal.proposed_spending_limit_micros', index=15,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='proposed_spending_limit_type', full_name='google.ads.googleads.v0.resources.AccountBudgetProposal.proposed_spending_limit_type', index=16,
...
AccountBudgetProposal = _reflection.GeneratedProtocolMessageType('AccountBudgetProposal', (_message.Message,), dict(
  ...
  'approved' counterpart, to be introduced in a future version.
