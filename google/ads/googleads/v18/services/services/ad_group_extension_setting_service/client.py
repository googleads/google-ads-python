...
class AdGroupExtensionSettingServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, AdGroupExtensionSettingServiceTransport]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, AdGroupExtensionSettingServiceTransport]]): The
    ...
    def mutate_ad_group_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateAdGroupExtensionSettingsRequest, dict, None]):
