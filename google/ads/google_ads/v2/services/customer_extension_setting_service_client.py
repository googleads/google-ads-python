...
"""Accesses the google.ads.googleads.v2.services CustomerExtensionSettingService API."""
...
from google.ads.google_ads.v2.services import customer_extension_setting_service_client_config
...
class CustomerExtensionSettingServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.CustomerExtensionSettingService'
    ...
    def get_customer_extension_setting(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.CustomerExtensionSetting` instance.
    ...
    def mutate_customer_extension_settings(
        ...
        Args:
            customer_id (str): The ID of the customer whose customer extension settings are being
                modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.CustomerExtensionSettingOperation]]): The list of operations to perform on individual customer extension
                settings.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.CustomerExtensionSettingOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateCustomerExtensionSettingsResponse` instance.
