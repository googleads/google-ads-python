...
"""Accesses the google.ads.googleads.v2.services CustomerFeedService API."""
...
from google.ads.google_ads.v2.services import customer_feed_service_client_config
...
class CustomerFeedServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.CustomerFeedService'
    ...
    def __init__(self, transport=None, channel=None, credentials=None,
        ...
        Args:
            transport (Union[~.CustomerFeedServiceGrpcTransport,
                    Callable[[~.Credentials, type], ~.CustomerFeedServiceGrpcTransport]): A transport
        ...
        if client_config is not None:
            ...
            client_config = customer_feed_service_client_config.config
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=customer_feed_service_grpc_transport.CustomerFeedServiceGrpcTransport,
                )
            else:
                if credentials:
                    raise ValueError(
            ...
            self.transport = customer_feed_service_grpc_transport.CustomerFeedServiceGrpcTransport(
    ...
    def get_customer_feed(
        ...
        Args:
            resource_name (str): The resource name of the customer feed to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.CustomerFeed` instance.
        ...
        if 'get_customer_feed' not in self._inner_api_calls:
            self._inner_api_calls['get_customer_feed'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_customer_feed,
                default_retry=self._method_configs['GetCustomerFeed'].retry,
                default_timeout=self._method_configs['GetCustomerFeed'].timeout,
                client_info=self._client_info,
            )

        request = customer_feed_service_pb2.GetCustomerFeedRequest(
        ...
        return self._inner_api_calls['get_customer_feed'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def mutate_customer_feeds(
        ...
        Args:
            customer_id (str): The ID of the customer whose customer feeds are being modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.CustomerFeedOperation]]): The list of operations to perform on individual customer feeds.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.CustomerFeedOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateCustomerFeedsResponse` instance.
        ...
        """
        # Wrap the transport method to add retry and timeout logic.
        if 'mutate_customer_feeds' not in self._inner_api_calls:
            self._inner_api_calls['mutate_customer_feeds'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.mutate_customer_feeds,
                default_retry=self._method_configs['MutateCustomerFeeds'].retry,
                default_timeout=self._method_configs['MutateCustomerFeeds'].timeout,
                client_info=self._client_info,
            )

        request = customer_feed_service_pb2.MutateCustomerFeedsRequest(
        ...
        return self._inner_api_calls['mutate_customer_feeds'](request, retry=retry, timeout=timeout, metadata=metadata)
