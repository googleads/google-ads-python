...
# source: google/ads/googleads_v6/proto/services/ad_group_criterion_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v6/proto/services/ad_group_criterion_service.proto',
...
_MUTATEADGROUPCRITERIAREQUEST.fields_by_name['response_content_type'].enum_type = google_dot_ads_dot_googleads__v6_dot_proto_dot_enums_dot_response__content__type__pb2._RESPONSECONTENTTYPEENUM_RESPONSECONTENTTYPE
_ADGROUPCRITERIONOPERATION.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_ADGROUPCRITERIONOPERATION.fields_by_name['exempt_policy_violation_keys'].message_type = google_dot_ads_dot_googleads__v6_dot_proto_dot_common_dot_policy__pb2._POLICYVIOLATIONKEY
_ADGROUPCRITERIONOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v6_dot_proto_dot_resources_dot_ad__group__criterion__pb2._ADGROUPCRITERION
_ADGROUPCRITERIONOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v6_dot_proto_dot_resources_dot_ad__group__criterion__pb2._ADGROUPCRITERION
...
_MUTATEADGROUPCRITERIONRESULT.fields_by_name['ad_group_criterion'].message_type = google_dot_ads_dot_googleads__v6_dot_proto_dot_resources_dot_ad__group__criterion__pb2._ADGROUPCRITERION
...
GetAdGroupCriterionRequest = _reflection.GeneratedProtocolMessageType('GetAdGroupCriterionRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads_v6.proto.services.ad_group_criterion_service_pb2'
  ,
  '__doc__': """Request message for [AdGroupCriterionService.GetAdGroupCriterion][goog
  le.ads.googleads.v6.services.AdGroupCriterionService.GetAdGroupCriteri
  on].
...
MutateAdGroupCriteriaRequest = _reflection.GeneratedProtocolMessageType('MutateAdGroupCriteriaRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads_v6.proto.services.ad_group_criterion_service_pb2'
  ,
  '__doc__': """Request message for [AdGroupCriterionService.MutateAdGroupCriteria][go
  ogle.ads.googleads.v6.services.AdGroupCriterionService.MutateAdGroupCr
  iteria].
...
MutateAdGroupCriterionResult = _reflection.GeneratedProtocolMessageType('MutateAdGroupCriterionResult', (_message.Message,), {
  ...
  Attributes:
      ...
      ad_group_criterion:
          The mutated ad group criterion with only mutable fields after
...
_ADGROUPCRITERIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v6_dot_proto_dot_resources_dot_ad__group__criterion__pb2._ADGROUPCRITERION,
