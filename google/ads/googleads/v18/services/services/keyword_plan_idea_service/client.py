...
from google.ads.googleads.v18.services.services.keyword_plan_idea_service import (
    pagers,
)
from google.ads.googleads.v18.services.types import keyword_plan_idea_service
...
class KeywordPlanIdeaServiceClient(metaclass=KeywordPlanIdeaServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, KeywordPlanIdeaServiceTransport]]): The
    ...
    def generate_keyword_ideas(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.GenerateKeywordIdeasRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v18.services.services.keyword_plan_idea_service.pagers.GenerateKeywordIdeasPager:
    ...
    def generate_keyword_historical_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.GenerateKeywordHistoricalMetricsRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v18.services.types.GenerateKeywordHistoricalMetricsResponse:
                Response message for
                   [KeywordPlanIdeaService.GenerateKeywordHistoricalMetrics][google.ads.googleads.v18.services.KeywordPlanIdeaService.GenerateKeywordHistoricalMetrics].
    ...
    def generate_ad_group_themes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.GenerateAdGroupThemesRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v18.services.types.GenerateAdGroupThemesResponse:
                Response message for
                   [KeywordPlanIdeaService.GenerateAdGroupThemes][google.ads.googleads.v18.services.KeywordPlanIdeaService.GenerateAdGroupThemes].
        ...
        has_flattened_params = any([customer_id, keywords, ad_groups])
    ...
    def generate_keyword_forecast_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.GenerateKeywordForecastMetricsRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v18.services.types.GenerateKeywordForecastMetricsResponse:
                Response message for
                [KeywordPlanIdeaService.GenerateKeywordForecastMetrics].
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([campaign])
        if request is not None and has_flattened_params:
            raise ValueError(
                "If the `request` argument is set, then none of "
                "the individual field arguments should be set."
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a keyword_plan_idea_service.GenerateKeywordForecastMetricsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(
            request,
