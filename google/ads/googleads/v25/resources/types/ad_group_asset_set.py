...
from google.ads.googleads.v25.enums.types import asset_set_link_status
...
class AdGroupAssetSet(proto.Message):
    ...
    Attributes:
        ...
        asset_set (str):
            ...
            the ad group.
        status (google.ads.googleads.v25.enums.types.AssetSetLinkStatusEnum.AssetSetLinkStatus):
