...
class GenerateShareablePreviewsResponse(proto.Message):
    ...
    Attributes:
        responses (MutableSequence[google.ads.googleads.v18.services.types.ShareablePreviewOrError]):
...
class ShareablePreviewOrError(proto.Message):
    ...
    Attributes:
        ...
        shareable_preview_result (google.ads.googleads.v18.services.types.ShareablePreviewResult):
