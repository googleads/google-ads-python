...
"""Accesses the google.ads.googleads.v0.services FeedMappingService API."""
...
from google.ads.google_ads.v0.services import feed_mapping_service_client_config
...
class FeedMappingServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v0.services.FeedMappingService'
    ...
    def get_feed_mapping(self,
        ...
        Returns:
            A :class:`~google.ads.google_ads.v0.types.FeedMapping` instance.
    ...
    def mutate_feed_mappings(self,
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.google_ads.v0.types.FeedMappingOperation]]): The list of operations to perform on individual feed mappings.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.google_ads.v0.types.FeedMappingOperation`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.google_ads.v0.types.MutateFeedMappingsResponse` instance.
