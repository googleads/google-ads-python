...
from google.ads.googleads.v19.enums.types import frequency_cap_event_type
from google.ads.googleads.v19.enums.types import frequency_cap_level
...
class FrequencyCapEntry(proto.Message):
    ...
    Attributes:
        key (google.ads.googleads.v19.common.types.FrequencyCapKey):
...
class FrequencyCapKey(proto.Message):
    ...
    Attributes:
        level (google.ads.googleads.v19.enums.types.FrequencyCapLevelEnum.FrequencyCapLevel):
        ...
        event_type (google.ads.googleads.v19.enums.types.FrequencyCapEventTypeEnum.FrequencyCapEventType):
