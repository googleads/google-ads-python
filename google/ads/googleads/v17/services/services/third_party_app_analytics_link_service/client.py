...
class ThirdPartyAppAnalyticsLinkServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, ThirdPartyAppAnalyticsLinkServiceTransport]]): The
    ...
    def regenerate_shareable_link_id(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.RegenerateShareableLinkIdRequest, dict, None]):
