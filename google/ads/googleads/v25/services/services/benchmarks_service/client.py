...
class BenchmarksServiceClient(metaclass=BenchmarksServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v25.services.BenchmarksServiceClient`.",
                    extra=(
                        {
    ...
    def list_benchmarks_available_dates(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.ListBenchmarksAvailableDatesRequest, dict]):
    ...
    def list_benchmarks_locations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.ListBenchmarksLocationsRequest, dict]):
                The request object. Request message for
    ...
    def list_benchmarks_products(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.ListBenchmarksProductsRequest, dict]):
                The request object. Request message for
    ...
    def list_benchmarks_sources(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.ListBenchmarksSourcesRequest, dict]):
                The request object. Request message for
    ...
    def generate_benchmarks_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.GenerateBenchmarksMetricsRequest, dict]):
                The request object. Request message for
