...
class ThirdPartyAppAnalyticsLinkServiceClient(
    ...
    def regenerate_shareable_link_id(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.RegenerateShareableLinkIdRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.RegenerateShareableLinkIdResponse:
