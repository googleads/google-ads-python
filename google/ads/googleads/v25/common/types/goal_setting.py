...
class GoalSetting(proto.Message):
    ...
    class RetentionGoal(proto.Message):
        ...
        Attributes:
            value_settings (google.ads.googleads.v25.common.types.CustomerLifecycleOptimizationValueSettings):
    ...
    class NewCustomerAcquisitionGoal(proto.Message):
        r"""New Customer Acquisition goal settings.
    ...
    class LoyaltyRetentionGoal(proto.Message):
        r"""Loyalty retention goal settings.
