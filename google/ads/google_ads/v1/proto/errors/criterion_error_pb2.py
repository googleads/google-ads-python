...
# source: google/ads/googleads_v1/proto/errors/criterion_error.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v1/proto/errors/criterion_error.proto',
...
_CRITERIONERRORENUM_CRITERIONERROR = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LOCATION_FILTER_INVALID', index=82, number=80,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CANNOT_ATTACH_CRITERIA_AT_CAMPAIGN_AND_ADGROUP', index=83, number=81,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='HOTEL_LENGTH_OF_STAY_OVERLAPS_WITH_EXISTING_CRITERION', index=84, number=82,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='HOTEL_ADVANCE_BOOKING_WINDOW_OVERLAPS_WITH_EXISTING_CRITERION', index=85, number=83,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FIELD_INCOMPATIBLE_WITH_NEGATIVE_TARGETING', index=86, number=84,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INVALID_WEBPAGE_CONDITION', index=87, number=85,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INVALID_WEBPAGE_CONDITION_URL', index=88, number=86,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WEBPAGE_CONDITION_URL_CANNOT_BE_EMPTY', index=89, number=87,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WEBPAGE_CONDITION_URL_UNSUPPORTED_PROTOCOL', index=90, number=88,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WEBPAGE_CONDITION_URL_CANNOT_BE_IP_ADDRESS', index=91, number=89,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WEBPAGE_CONDITION_URL_DOMAIN_NOT_CONSISTENT_WITH_CAMPAIGN_SETTING', index=92, number=90,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WEBPAGE_CONDITION_URL_CANNOT_BE_PUBLIC_SUFFIX', index=93, number=91,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WEBPAGE_CONDITION_URL_INVALID_PUBLIC_SUFFIX', index=94, number=92,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WEBPAGE_CONDITION_URL_VALUE_TRACK_VALUE_NOT_SUPPORTED', index=95, number=93,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WEBPAGE_CRITERION_URL_EQUALS_CAN_HAVE_ONLY_ONE_CONDITION', index=96, number=94,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='WEBPAGE_CRITERION_NOT_SUPPORTED_ON_NON_DSA_AD_GROUP', index=97, number=95,
      serialized_options=None,
      type=None),
  ],
...
CriterionErrorEnum = _reflection.GeneratedProtocolMessageType('CriterionErrorEnum', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v1.proto.errors.criterion_error_pb2'
  ,
