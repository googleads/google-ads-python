...
class KeywordPlanCampaignServiceClient(
    ...
    def mutate_keyword_plan_campaigns(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateKeywordPlanCampaignsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateKeywordPlanCampaignsResponse:
