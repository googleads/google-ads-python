...
class AssetGroupSignal(proto.Message):
    ...
    Attributes:
        ...
        approval_status (google.ads.googleads.v18.enums.types.AssetGroupSignalApprovalStatusEnum.AssetGroupSignalApprovalStatus):
        ...
        search_theme (google.ads.googleads.v18.common.types.SearchThemeInfo):
    ...
    audience: criteria.AudienceInfo = proto.Field(
        proto.MESSAGE, number=4, oneof="signal", message=criteria.AudienceInfo,
    )
