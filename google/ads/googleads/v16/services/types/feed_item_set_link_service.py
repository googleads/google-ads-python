...
from google.ads.googleads.v16.resources.types import feed_item_set_link
...
class FeedItemSetLinkOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v16.resources.types.FeedItemSetLink):
    ...
    create: feed_item_set_link.FeedItemSetLink = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
...
class MutateFeedItemSetLinksResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v16.services.types.MutateFeedItemSetLinkResult]):
