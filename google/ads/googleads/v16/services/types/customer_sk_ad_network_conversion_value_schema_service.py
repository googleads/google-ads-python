...
class CustomerSkAdNetworkConversionValueSchemaOperation(proto.Message):
    ...
    Attributes:
        update (google.ads.googleads.v16.resources.types.CustomerSkAdNetworkConversionValueSchema):
...
class MutateCustomerSkAdNetworkConversionValueSchemaRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            ...
            being modified.
        operation (google.ads.googleads.v16.services.types.CustomerSkAdNetworkConversionValueSchemaOperation):
