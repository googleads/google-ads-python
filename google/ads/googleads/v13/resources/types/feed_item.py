...
from google.ads.googleads.v13.enums.types import feed_item_status
from google.ads.googleads.v13.enums.types import feed_item_validation_status
from google.ads.googleads.v13.enums.types import (
...
from google.ads.googleads.v13.errors.types import feed_item_validation_error
...
class FeedItem(proto.Message):
    ...
    Attributes:
        ...
        attribute_values (MutableSequence[google.ads.googleads.v13.resources.types.FeedItemAttributeValue]):
            The feed item's attribute values.
        geo_targeting_restriction (google.ads.googleads.v13.enums.types.GeoTargetingRestrictionEnum.GeoTargetingRestriction):
        ...
        url_custom_parameters (MutableSequence[google.ads.googleads.v13.common.types.CustomParameter]):
            ...
            ``mobile_final_urls``.
        status (google.ads.googleads.v13.enums.types.FeedItemStatusEnum.FeedItemStatus):
            Output only. Status of the feed item.
            This field is read-only.
        policy_infos (MutableSequence[google.ads.googleads.v13.resources.types.FeedItemPlaceholderPolicyInfo]):
...
class FeedItemAttributeValue(proto.Message):
    ...
    Attributes:
        ...
        price_value (google.ads.googleads.v13.common.types.Money):
...
class FeedItemPlaceholderPolicyInfo(proto.Message):
    ...
    Attributes:
        placeholder_type_enum (google.ads.googleads.v13.enums.types.PlaceholderTypeEnum.PlaceholderType):
        ...
        validation_errors (MutableSequence[google.ads.googleads.v13.resources.types.FeedItemValidationError]):
            ...
            validation errors.
        quality_approval_status (google.ads.googleads.v13.enums.types.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatus):
            Output only. Placeholder type quality
            evaluation approval status.
        quality_disapproval_reasons (MutableSequence[google.ads.googleads.v13.enums.types.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason]):
...
class FeedItemValidationError(proto.Message):
    ...
    Attributes:
        validation_error (google.ads.googleads.v13.errors.types.FeedItemValidationErrorEnum.FeedItemValidationError):
