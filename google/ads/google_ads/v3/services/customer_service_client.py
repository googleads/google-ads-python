...
"""Accesses the google.ads.googleads.v3.services CustomerService API."""
...
from google.ads.google_ads.v3.services import customer_service_client_config
from google.ads.google_ads.v3.services.transports import customer_service_grpc_transport
...
class CustomerServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v3.services.CustomerService'
    ...
    def mutate_customer(
        ...
        Args:
            ...
            operation_ (Union[dict, ~google.ads.googleads_v3.types.CustomerOperation]): Required. The operation to perform on the customer

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.CustomerOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.MutateCustomerResponse` instance.
    ...
    def list_accessible_customers(
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.ListAccessibleCustomersResponse` instance.
    ...
    def create_customer_client(
        ...
        Args:
            ...
            customer_client (Union[dict, ~google.ads.googleads_v3.types.Customer]): Required. The new client customer to create. The resource name on this customer
                will be ignored.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.Customer`
            email_address (Union[dict, ~google.ads.googleads_v3.types.StringValue]): Email address of the user who should be invited on the created client
                customer. Accessible to whitelisted customers only.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.StringValue`
            access_role (~google.ads.googleads_v3.types.AccessRole): The proposed role of user on the created client customer.
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.CreateCustomerClientResponse` instance.
