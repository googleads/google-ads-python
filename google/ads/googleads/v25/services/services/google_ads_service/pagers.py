...
class SearchPager:
    ...
    :class:`google.ads.googleads.v25.services.types.SearchGoogleAdsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v25.services.types.SearchGoogleAdsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.ads.googleads.v25.services.types.SearchGoogleAdsRequest):
                The initial request object.
            response (google.ads.googleads.v25.services.types.SearchGoogleAdsResponse):
