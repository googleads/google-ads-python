...
class BatchJobServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v18.services.BatchJobServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def mutate_batch_job(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v18.services.types.MutateBatchJobRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            operation (:class:`google.ads.googleads.v18.services.types.BatchJobOperation`):
    ...
    async def list_batch_job_results(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v18.services.types.ListBatchJobResultsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v18.services.services.batch_job_service.pagers.ListBatchJobResultsAsyncPager:
                Response message for
                   [BatchJobService.ListBatchJobResults][google.ads.googleads.v18.services.BatchJobService.ListBatchJobResults].
    ...
    async def run_batch_job(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v18.services.types.RunBatchJobRequest, dict]]):
                The request object. Request message for
    ...
    async def add_batch_job_operations(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v18.services.types.AddBatchJobOperationsRequest, dict]]):
                The request object. Request message for
