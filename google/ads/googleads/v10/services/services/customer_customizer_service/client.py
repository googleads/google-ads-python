...
class CustomerCustomizerServiceClient(
    ...
    def mutate_customer_customizers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.MutateCustomerCustomizersRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v10.services.types.MutateCustomerCustomizersResponse:
