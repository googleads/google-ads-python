...
class CustomAudience(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v6.enums.types.CustomAudienceStatusEnum.CustomAudienceStatus):
        ...
        name (str):
            ...
            operations.
        type_ (google.ads.googleads.v6.enums.types.CustomAudienceTypeEnum.CustomAudienceType):
        ...
        members (Sequence[google.ads.googleads.v6.resources.types.CustomAudienceMember]):
...
class CustomAudienceMember(proto.Message):
    ...
    Attributes:
        member_type (google.ads.googleads.v6.enums.types.CustomAudienceMemberTypeEnum.CustomAudienceMemberType):
