...
class ProductLinkInvitationServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, ProductLinkInvitationServiceTransport]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, ProductLinkInvitationServiceTransport]]): The
        ...
        if isinstance(transport, ProductLinkInvitationServiceTransport):
    ...
    def create_product_link_invitation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.CreateProductLinkInvitationRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v16.services.types.CreateProductLinkInvitationResponse:
        ...
        has_flattened_params = any([customer_id, product_link_invitation])
        ...
        # in a product_link_invitation_service.CreateProductLinkInvitationRequest.
    ...
    def update_product_link_invitation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.UpdateProductLinkInvitationRequest, dict, None]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            product_link_invitation_status (google.ads.googleads.v16.enums.types.ProductLinkInvitationStatusEnum.ProductLinkInvitationStatus):
                Required. The product link invitation
                to be created.
        ...
        Returns:
            google.ads.googleads.v16.services.types.UpdateProductLinkInvitationResponse:
                Response message for product link
                invitation update.
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a product_link_invitation_service.UpdateProductLinkInvitationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(
            request,
    ...
    def remove_product_link_invitation(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.RemoveProductLinkInvitationRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v16.services.types.RemoveProductLinkInvitationResponse:
                Response message for product link
                invitation removeal.
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a product_link_invitation_service.RemoveProductLinkInvitationRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(
            request,
