...
class MutateCampaignFeedsRequest(proto.Message):
    ...
    operations: MutableSequence["CampaignFeedOperation"] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
...
class CampaignFeedOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v17.resources.types.CampaignFeed):
            Create operation: No resource name is
            expected for the new campaign feed.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v17.resources.types.CampaignFeed):
    ...
    create: gagr_campaign_feed.CampaignFeed = proto.Field(
        proto.MESSAGE,
        number=1,
        oneof="operation",
        message=gagr_campaign_feed.CampaignFeed,
    )
    update: gagr_campaign_feed.CampaignFeed = proto.Field(
        proto.MESSAGE,
        number=2,
        oneof="operation",
        message=gagr_campaign_feed.CampaignFeed,
...
class MutateCampaignFeedsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v17.services.types.MutateCampaignFeedResult]):
    ...
    results: MutableSequence["MutateCampaignFeedResult"] = proto.RepeatedField(
        proto.MESSAGE,
        number=2,
