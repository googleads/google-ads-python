...
"""Accesses the google.ads.googleads.v2.services FeedPlaceholderViewService API."""
...
from google.ads.google_ads.v2.services import feed_placeholder_view_service_client_config
...
class FeedPlaceholderViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.FeedPlaceholderViewService'
    ...
    def get_feed_placeholder_view(
        ...
        Args:
            resource_name (str): The resource name of the feed placeholder view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.FeedPlaceholderView` instance.
