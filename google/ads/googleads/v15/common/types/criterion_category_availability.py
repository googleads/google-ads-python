...
class CriterionCategoryAvailability(proto.Message):
    ...
    Attributes:
        channel (google.ads.googleads.v15.common.types.CriterionCategoryChannelAvailability):
...
class CriterionCategoryChannelAvailability(proto.Message):
    ...
    Attributes:
        availability_mode (google.ads.googleads.v15.enums.types.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode):
        ...
        advertising_channel_sub_type (MutableSequence[google.ads.googleads.v15.enums.types.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType]):
...
class CriterionCategoryLocaleAvailability(proto.Message):
    ...
    Attributes:
        availability_mode (google.ads.googleads.v15.enums.types.CriterionCategoryLocaleAvailabilityModeEnum.CriterionCategoryLocaleAvailabilityMode):
