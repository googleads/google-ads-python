...
from google.ads.googleads.v11.resources.types import user_list
...
class MutateUserListsRequest(proto.Message):
    ...
    [UserListService.MutateUserLists][google.ads.googleads.v11.services.UserListService.MutateUserLists].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose user
            lists are being modified.
        operations (Sequence[google.ads.googleads.v11.services.types.UserListOperation]):
...
class UserListOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v11.resources.types.UserList):
            Create operation: No resource name is
            expected for the new user list.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v11.resources.types.UserList):
