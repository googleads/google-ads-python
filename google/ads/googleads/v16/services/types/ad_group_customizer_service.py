...
class AdGroupCustomizerOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v16.resources.types.AdGroupCustomizer):
...
class MutateAdGroupCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v16.services.types.MutateAdGroupCustomizerResult]):
