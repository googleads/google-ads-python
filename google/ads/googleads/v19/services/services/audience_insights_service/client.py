...
class AudienceInsightsServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, AudienceInsightsServiceTransport]]): The
    ...
    def generate_insights_finder_report(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GenerateInsightsFinderReportRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v19.services.types.GenerateInsightsFinderReportResponse:
    ...
    def list_audience_insights_attributes(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.ListAudienceInsightsAttributesRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v19.services.types.ListAudienceInsightsAttributesResponse:
    ...
    def list_insights_eligible_dates(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.ListInsightsEligibleDatesRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v19.services.types.ListInsightsEligibleDatesResponse:
                Response message for
                   [AudienceInsightsService.ListInsightsEligibleDates][google.ads.googleads.v19.services.AudienceInsightsService.ListInsightsEligibleDates].
    ...
    def generate_audience_composition_insights(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GenerateAudienceCompositionInsightsRequest, dict, None]):
                The request object. Request message for
            ...
            dimensions (MutableSequence[google.ads.googleads.v19.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension]):
                ...
                SUB_COUNTRY_LOCATION, YOUTUBE_CHANNEL,
                YOUTUBE_DYNAMIC_LINEUP, AFFINITY_USER_INTEREST,
                IN_MARKET_USER_INTEREST, PARENTAL_STATUS, INCOME_RANGE,
                AGE_RANGE, and GENDER.
        ...
        Returns:
            google.ads.googleads.v19.services.types.GenerateAudienceCompositionInsightsResponse:
                Response message for
                   [AudienceInsightsService.GenerateAudienceCompositionInsights][google.ads.googleads.v19.services.AudienceInsightsService.GenerateAudienceCompositionInsights].
    ...
    def generate_suggested_targeting_insights(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GenerateSuggestedTargetingInsightsRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v19.services.types.GenerateSuggestedTargetingInsightsResponse:
                Response message for
                   [AudienceInsightsService.GenerateSuggestedTargetingInsights][google.ads.googleads.v19.services.AudienceInsightsService.GenerateSuggestedTargetingInsights].
        ...
        # Create or coerce a protobuf request object.
        # Minor optimization to avoid making a copy if the user passes
        # in a audience_insights_service.GenerateSuggestedTargetingInsightsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(
            request,
    ...
    def generate_audience_overlap_insights(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GenerateAudienceOverlapInsightsRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v19.services.types.GenerateAudienceOverlapInsightsResponse:
                Response message for
                   [AudienceInsightsService.GenerateAudienceOverlapInsights][google.ads.googleads.v19.services.AudienceInsightsService.GenerateAudienceOverlapInsights].
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a audience_insights_service.GenerateAudienceOverlapInsightsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(
            request,
    ...
    def generate_targeting_suggestion_metrics(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.GenerateTargetingSuggestionMetricsRequest, dict, None]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v19.services.types.GenerateTargetingSuggestionMetricsResponse:
                Response message for
                   [AudienceInsightsService.GenerateTargetingSuggestionMetrics][google.ads.googleads.v19.services.AudienceInsightsService.GenerateTargetingSuggestionMetrics].
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([customer_id, audiences])
        if request is not None and has_flattened_params:
            raise ValueError(
                "If the `request` argument is set, then none of "
                "the individual field arguments should be set."
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a audience_insights_service.GenerateTargetingSuggestionMetricsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(
            request,
