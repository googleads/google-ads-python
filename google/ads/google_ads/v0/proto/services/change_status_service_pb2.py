...
# source: google/ads/googleads_v0/proto/services/change_status_service.proto
...
_GETCHANGESTATUSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.services.GetChangeStatusRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v0.services.GetChangeStatusRequest.resource_name', index=0,
...
GetChangeStatusRequest = _reflection.GeneratedProtocolMessageType('GetChangeStatusRequest', (_message.Message,), dict(
  ...
  """,
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v0.services.GetChangeStatusRequest)
  ))
...
_CHANGESTATUSSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v0.services.ChangeStatusService.GetChangeStatus',
    index=0,
