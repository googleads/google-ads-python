...
"""Accesses the google.ads.googleads.v1.services SharedCriterionService API."""
...
from google.ads.google_ads.v1.services import shared_criterion_service_client_config
...
class SharedCriterionServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.SharedCriterionService'
    ...
    def get_shared_criterion(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.SharedCriterion` instance.
        ...
        if 'get_shared_criterion' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_shared_criterion'] = google.api_core.gapic_v1.method.wrap_method(
                    ...
                    default_retry=self._method_configs['GetSharedCriterion'].
                    retry,
    ...
    def mutate_shared_criteria(self,
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v1.types.SharedCriterionOperation]]): The list of operations to perform on individual shared criteria.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.SharedCriterionOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.MutateSharedCriteriaResponse` instance.
        ...
        if 'mutate_shared_criteria' not in self._inner_api_calls:
            self._inner_api_calls[
                'mutate_shared_criteria'] = google.api_core.gapic_v1.method.wrap_method(
                    ...
                    _method_configs['MutateSharedCriteria'].timeout,
                    client_info=self._client_info,
                )
