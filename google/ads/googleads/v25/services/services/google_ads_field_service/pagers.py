...
class SearchGoogleAdsFieldsPager:
    ...
    :class:`google.ads.googleads.v25.services.types.SearchGoogleAdsFieldsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v25.services.types.SearchGoogleAdsFieldsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            request (google.ads.googleads.v25.services.types.SearchGoogleAdsFieldsRequest):
                The initial request object.
            response (google.ads.googleads.v25.services.types.SearchGoogleAdsFieldsResponse):
