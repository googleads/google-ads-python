...
"""Accesses the google.ads.googleads.v1.services GeoTargetConstantService API."""
...
from google.ads.google_ads.v1.services import geo_target_constant_service_client_config
...
class GeoTargetConstantServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.GeoTargetConstantService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=geo_target_constant_service_grpc_transport.
    ...
    def get_geo_target_constant(
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.GeoTargetConstant` instance.
    ...
    def suggest_geo_target_constants(
        ...
        Args:
            locale (Union[dict, ~google.ads.googleads_v1.types.StringValue]): If possible, returned geo targets are translated using this locale. If not,
                en is used by default. This is also used as a hint for returned geo
                targets.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.StringValue`
            country_code (Union[dict, ~google.ads.googleads_v1.types.StringValue]): Returned geo targets are restricted to this country code.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.StringValue`
            location_names (Union[dict, ~google.ads.googleads_v1.types.LocationNames]): The location names to search by. At most 25 names can be set.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.LocationNames`
            geo_targets (Union[dict, ~google.ads.googleads_v1.types.GeoTargets]): The geo target constant resource names to filter by.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.GeoTargets`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.SuggestGeoTargetConstantsResponse` instance.
