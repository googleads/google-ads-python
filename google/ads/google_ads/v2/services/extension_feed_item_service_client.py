...
"""Accesses the google.ads.googleads.v2.services ExtensionFeedItemService API."""
...
from google.ads.google_ads.v2.services import extension_feed_item_service_client_config
...
class ExtensionFeedItemServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.ExtensionFeedItemService'
    ...
    def __init__(self, transport=None, channel=None, credentials=None,
        ...
        Args:
            transport (Union[~.ExtensionFeedItemServiceGrpcTransport,
                    Callable[[~.Credentials, type], ~.ExtensionFeedItemServiceGrpcTransport]): A transport
        ...
        if client_config is not None:
            ...
            client_config = extension_feed_item_service_client_config.config
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=extension_feed_item_service_grpc_transport.ExtensionFeedItemServiceGrpcTransport,
                )
            else:
                if credentials:
                    raise ValueError(
            ...
            self.transport = extension_feed_item_service_grpc_transport.ExtensionFeedItemServiceGrpcTransport(
    ...
    def get_extension_feed_item(
        ...
        Args:
            resource_name (str): The resource name of the extension feed item to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.ExtensionFeedItem` instance.
        ...
        if 'get_extension_feed_item' not in self._inner_api_calls:
            self._inner_api_calls['get_extension_feed_item'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_extension_feed_item,
                default_retry=self._method_configs['GetExtensionFeedItem'].retry,
                default_timeout=self._method_configs['GetExtensionFeedItem'].timeout,
                client_info=self._client_info,
            )

        request = extension_feed_item_service_pb2.GetExtensionFeedItemRequest(
        ...
        return self._inner_api_calls['get_extension_feed_item'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def mutate_extension_feed_items(
        ...
        Args:
            customer_id (str): The ID of the customer whose extension feed items are being
                modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.ExtensionFeedItemOperation]]): The list of operations to perform on individual extension feed items.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.ExtensionFeedItemOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateExtensionFeedItemsResponse` instance.
        ...
        """
        # Wrap the transport method to add retry and timeout logic.
        if 'mutate_extension_feed_items' not in self._inner_api_calls:
            self._inner_api_calls['mutate_extension_feed_items'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.mutate_extension_feed_items,
                default_retry=self._method_configs['MutateExtensionFeedItems'].retry,
                default_timeout=self._method_configs['MutateExtensionFeedItems'].timeout,
                client_info=self._client_info,
            )

        request = extension_feed_item_service_pb2.MutateExtensionFeedItemsRequest(
        ...
        return self._inner_api_calls['mutate_extension_feed_items'](request, retry=retry, timeout=timeout, metadata=metadata)
