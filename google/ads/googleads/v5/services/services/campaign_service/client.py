...
class CampaignServiceClient(metaclass=CampaignServiceClientMeta):
    ...
    def mutate_campaigns(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateCampaignsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.CampaignOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateCampaignsResponse:
