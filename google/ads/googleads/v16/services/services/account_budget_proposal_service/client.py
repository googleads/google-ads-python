...
class AccountBudgetProposalServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, AccountBudgetProposalServiceTransport]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, AccountBudgetProposalServiceTransport]]): The
    ...
    def mutate_account_budget_proposal(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v16.services.types.MutateAccountBudgetProposalRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v16.services.types.AccountBudgetProposalOperation):
        ...
        Returns:
            google.ads.googleads.v16.services.types.MutateAccountBudgetProposalResponse:
