...
class CustomerNegativeCriterionServiceClient(
    ...
    def mutate_customer_negative_criteria(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.MutateCustomerNegativeCriteriaRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.MutateCustomerNegativeCriteriaResponse:
