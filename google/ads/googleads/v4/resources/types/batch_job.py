...
class BatchJob(proto.Message):
    ...
    Attributes:
        ...
        metadata (google.ads.googleads.v4.resources.types.BatchJob.BatchJobMetadata):
            Output only. Contains additional information
            about this batch job.
        status (google.ads.googleads.v4.enums.types.BatchJobStatusEnum.BatchJobStatus):
