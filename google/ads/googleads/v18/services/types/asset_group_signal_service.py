...
class AssetGroupSignalOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v18.resources.types.AssetGroupSignal):
    ...
    exempt_policy_violation_keys: MutableSequence[
        ...
        proto.MESSAGE, number=3, message=policy.PolicyViolationKey,
    )
...
class MutateAssetGroupSignalsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v18.services.types.MutateAssetGroupSignalResult]):
