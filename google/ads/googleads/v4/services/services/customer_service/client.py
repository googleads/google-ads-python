...
class CustomerServiceClient(metaclass=CustomerServiceClientMeta):
    ...
    def get_customer(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetCustomerRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.Customer:
                A customer.
        """
    ...
    def mutate_customer(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateCustomerRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v4.services.types.CustomerOperation`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateCustomerResponse:
    ...
    def list_accessible_customers(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.ListAccessibleCustomersRequest`):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v4.services.types.ListAccessibleCustomersResponse:
    ...
    def create_customer_client(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.CreateCustomerClientRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            customer_client (:class:`google.ads.googleads.v4.resources.types.Customer`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.CreateCustomerClientResponse:
                Response message for
