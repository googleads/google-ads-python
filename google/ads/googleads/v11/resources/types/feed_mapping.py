...
from google.ads.googleads.v11.enums.types import ad_customizer_placeholder_field
from google.ads.googleads.v11.enums.types import (
    affiliate_location_placeholder_field,
)
from google.ads.googleads.v11.enums.types import app_placeholder_field
from google.ads.googleads.v11.enums.types import call_placeholder_field
from google.ads.googleads.v11.enums.types import callout_placeholder_field
from google.ads.googleads.v11.enums.types import custom_placeholder_field
from google.ads.googleads.v11.enums.types import dsa_page_feed_criterion_field
from google.ads.googleads.v11.enums.types import education_placeholder_field
from google.ads.googleads.v11.enums.types import feed_mapping_criterion_type
from google.ads.googleads.v11.enums.types import feed_mapping_status
from google.ads.googleads.v11.enums.types import flight_placeholder_field
from google.ads.googleads.v11.enums.types import hotel_placeholder_field
from google.ads.googleads.v11.enums.types import image_placeholder_field
from google.ads.googleads.v11.enums.types import job_placeholder_field
from google.ads.googleads.v11.enums.types import local_placeholder_field
from google.ads.googleads.v11.enums.types import (
    location_extension_targeting_criterion_field,
)
from google.ads.googleads.v11.enums.types import location_placeholder_field
from google.ads.googleads.v11.enums.types import message_placeholder_field
from google.ads.googleads.v11.enums.types import (
    placeholder_type as gage_placeholder_type,
)
from google.ads.googleads.v11.enums.types import price_placeholder_field
from google.ads.googleads.v11.enums.types import promotion_placeholder_field
from google.ads.googleads.v11.enums.types import real_estate_placeholder_field
from google.ads.googleads.v11.enums.types import sitelink_placeholder_field
from google.ads.googleads.v11.enums.types import (
    structured_snippet_placeholder_field,
)
from google.ads.googleads.v11.enums.types import travel_placeholder_field
...
class FeedMapping(proto.Message):
    ...
    Attributes:
        ...
        attribute_field_mappings (Sequence[google.ads.googleads.v11.resources.types.AttributeFieldMapping]):
            ...
            attributes. Required.
        status (google.ads.googleads.v11.enums.types.FeedMappingStatusEnum.FeedMappingStatus):
...
class AttributeFieldMapping(proto.Message):
    ...
    Attributes:
        ...
        sitelink_field (google.ads.googleads.v11.enums.types.SitelinkPlaceholderFieldEnum.SitelinkPlaceholderField):
            Immutable. Sitelink Placeholder Fields.

            This field is a member of `oneof`_ ``field``.
        call_field (google.ads.googleads.v11.enums.types.CallPlaceholderFieldEnum.CallPlaceholderField):
            Immutable. Call Placeholder Fields.

            This field is a member of `oneof`_ ``field``.
        app_field (google.ads.googleads.v11.enums.types.AppPlaceholderFieldEnum.AppPlaceholderField):
            Immutable. App Placeholder Fields.

            This field is a member of `oneof`_ ``field``.
        location_field (google.ads.googleads.v11.enums.types.LocationPlaceholderFieldEnum.LocationPlaceholderField):
            Output only. Location Placeholder Fields.
            This field is read-only.

            This field is a member of `oneof`_ ``field``.
        affiliate_location_field (google.ads.googleads.v11.enums.types.AffiliateLocationPlaceholderFieldEnum.AffiliateLocationPlaceholderField):
            Output only. Affiliate Location Placeholder
            Fields. This field is read-only.

            This field is a member of `oneof`_ ``field``.
        callout_field (google.ads.googleads.v11.enums.types.CalloutPlaceholderFieldEnum.CalloutPlaceholderField):
            Immutable. Callout Placeholder Fields.

            This field is a member of `oneof`_ ``field``.
        structured_snippet_field (google.ads.googleads.v11.enums.types.StructuredSnippetPlaceholderFieldEnum.StructuredSnippetPlaceholderField):
            Immutable. Structured Snippet Placeholder
            Fields.

            This field is a member of `oneof`_ ``field``.
        message_field (google.ads.googleads.v11.enums.types.MessagePlaceholderFieldEnum.MessagePlaceholderField):
            Immutable. Message Placeholder Fields.

            This field is a member of `oneof`_ ``field``.
        price_field (google.ads.googleads.v11.enums.types.PricePlaceholderFieldEnum.PricePlaceholderField):
            Immutable. Price Placeholder Fields.

            This field is a member of `oneof`_ ``field``.
        promotion_field (google.ads.googleads.v11.enums.types.PromotionPlaceholderFieldEnum.PromotionPlaceholderField):
            Immutable. Promotion Placeholder Fields.

            This field is a member of `oneof`_ ``field``.
        ad_customizer_field (google.ads.googleads.v11.enums.types.AdCustomizerPlaceholderFieldEnum.AdCustomizerPlaceholderField):
            Immutable. Ad Customizer Placeholder Fields

            This field is a member of `oneof`_ ``field``.
        dsa_page_feed_field (google.ads.googleads.v11.enums.types.DsaPageFeedCriterionFieldEnum.DsaPageFeedCriterionField):
            Immutable. Dynamic Search Ad Page Feed
            Fields.

            This field is a member of `oneof`_ ``field``.
        location_extension_targeting_field (google.ads.googleads.v11.enums.types.LocationExtensionTargetingCriterionFieldEnum.LocationExtensionTargetingCriterionField):
            Immutable. Location Target Fields.

            This field is a member of `oneof`_ ``field``.
        education_field (google.ads.googleads.v11.enums.types.EducationPlaceholderFieldEnum.EducationPlaceholderField):
            Immutable. Education Placeholder Fields

            This field is a member of `oneof`_ ``field``.
        flight_field (google.ads.googleads.v11.enums.types.FlightPlaceholderFieldEnum.FlightPlaceholderField):
            Immutable. Flight Placeholder Fields

            This field is a member of `oneof`_ ``field``.
        custom_field (google.ads.googleads.v11.enums.types.CustomPlaceholderFieldEnum.CustomPlaceholderField):
            Immutable. Custom Placeholder Fields

            This field is a member of `oneof`_ ``field``.
        hotel_field (google.ads.googleads.v11.enums.types.HotelPlaceholderFieldEnum.HotelPlaceholderField):
            Immutable. Hotel Placeholder Fields

            This field is a member of `oneof`_ ``field``.
        real_estate_field (google.ads.googleads.v11.enums.types.RealEstatePlaceholderFieldEnum.RealEstatePlaceholderField):
            Immutable. Real Estate Placeholder Fields

            This field is a member of `oneof`_ ``field``.
        travel_field (google.ads.googleads.v11.enums.types.TravelPlaceholderFieldEnum.TravelPlaceholderField):
            Immutable. Travel Placeholder Fields

            This field is a member of `oneof`_ ``field``.
        local_field (google.ads.googleads.v11.enums.types.LocalPlaceholderFieldEnum.LocalPlaceholderField):
            Immutable. Local Placeholder Fields

            This field is a member of `oneof`_ ``field``.
        job_field (google.ads.googleads.v11.enums.types.JobPlaceholderFieldEnum.JobPlaceholderField):
            Immutable. Job Placeholder Fields

            This field is a member of `oneof`_ ``field``.
        image_field (google.ads.googleads.v11.enums.types.ImagePlaceholderFieldEnum.ImagePlaceholderField):
