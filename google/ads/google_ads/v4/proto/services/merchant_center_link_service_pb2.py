...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v4/proto/services/merchant_center_link_service.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_merchant__center__link__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_protobuf_dot_field__mask__pb2.DESCRIPTOR,])
...
_LISTMERCHANTCENTERLINKSRESPONSE.fields_by_name['merchant_center_links'].message_type = google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_merchant__center__link__pb2._MERCHANTCENTERLINK
...
_MERCHANTCENTERLINKOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_merchant__center__link__pb2._MERCHANTCENTERLINK
...
ListMerchantCenterLinksRequest = _reflection.GeneratedProtocolMessageType('ListMerchantCenterLinksRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v4.proto.services.merchant_center_link_service_pb2'
  ,
...
_MERCHANTCENTERLINKSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0023\0221/v4/customers/{customer_id=*}/merchantCenterLinks\332A\013customer_id'),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_merchant__center__link__pb2._MERCHANTCENTERLINK,
    serialized_options=_b('\202\323\344\223\0027\0225/v4/{resource_name=customers/*/merchantCenterLinks/*}\332A\rresource_name'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\002=\"8/v4/customers/{customer_id=*}/merchantCenterLinks:mutate:\001*\332A\025customer_id,operation'),
  ),
])
