...
"""Accesses the google.ads.googleads.v2.services GroupPlacementViewService API."""
...
from google.ads.google_ads.v2.services import group_placement_view_service_client_config
...
class GroupPlacementViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.GroupPlacementViewService'
    ...
    def get_group_placement_view(
        ...
        Args:
            resource_name (str): The resource name of the Group Placement view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.GroupPlacementView` instance.
