...
class BidModifierSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v5.common.types.BidModifierSimulationPoint]):
...
class CpcBidSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v5.common.types.CpcBidSimulationPoint]):
...
class CpvBidSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v5.common.types.CpvBidSimulationPoint]):
...
class TargetCpaSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v5.common.types.TargetCpaSimulationPoint]):
...
class TargetRoasSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v5.common.types.TargetRoasSimulationPoint]):
...
class PercentCpcBidSimulationPointList(proto.Message):
    ...
    Attributes:
        points (Sequence[google.ads.googleads.v5.common.types.PercentCpcBidSimulationPoint]):
