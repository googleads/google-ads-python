...
"""Accesses the google.ads.googleads.v1.services RecommendationService API."""
...
from google.ads.google_ads.v1.services import recommendation_service_client_config
...
class RecommendationServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.RecommendationService'
    ...
    def get_recommendation(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.Recommendation` instance.
    ...
    def dismiss_recommendation(self,
        ...
        Args:
            customer_id (str): The ID of the customer with the recommendation.
            operations (list[Union[dict, ~google.ads.googleads_v1.types.DismissRecommendationOperation]]): The list of operations to dismiss recommendations. If
                partial\_failure=false all recommendations should be of the same type
                There is a limit of 100 operations per request.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.DismissRecommendationOperation`
            partial_failure (bool): If true, successful operations will be carried out and invalid
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.DismissRecommendationResponse` instance.
