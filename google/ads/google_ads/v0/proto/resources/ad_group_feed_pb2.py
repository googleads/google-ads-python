...
AdGroupFeed = _reflection.GeneratedProtocolMessageType('AdGroupFeed', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v0.proto.resources.ad_group_feed_pb2'
  ,
