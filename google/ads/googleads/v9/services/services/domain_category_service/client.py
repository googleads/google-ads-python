...
class DomainCategoryServiceClient(metaclass=DomainCategoryServiceClientMeta):
    ...
    def get_domain_category(
        self,
        request: Union[
            domain_category_service.GetDomainCategoryRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetDomainCategoryRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.DomainCategory:
