...
class ConversionUploadServiceClient(
    ...
    def upload_click_conversions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.UploadClickConversionsRequest, dict, None]):
    ...
    def upload_call_conversions(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v19.services.types.UploadCallConversionsRequest, dict, None]):
                The request object. Request message for
