...
class FeedItemServiceClient(metaclass=FeedItemServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v17.services.FeedItemServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_feed_items(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateFeedItemsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v17.services.types.FeedItemOperation]):
