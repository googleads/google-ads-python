...
from google.ads.googleads.v25.common.types import asset_set_types
from google.ads.googleads.v25.enums.types import asset_set_status
...
class AssetSet(proto.Message):
    ...
    Attributes:
        ...
        name (str):
            ...
            length of 128.
        type_ (google.ads.googleads.v25.enums.types.AssetSetTypeEnum.AssetSetType):
            Required. Immutable. The type of the asset
            set. Required.
        status (google.ads.googleads.v25.enums.types.AssetSetStatusEnum.AssetSetStatus):
            Output only. The status of the asset set.
            Read-only.
        merchant_center_feed (google.ads.googleads.v25.resources.types.AssetSet.MerchantCenterFeed):
        ...
        location_group_parent_asset_set_id (int):
            ...
            AssetSet.
        hotel_property_data (google.ads.googleads.v25.resources.types.AssetSet.HotelPropertyData):
            Output only. For Performance Max for travel
            goals campaigns with a Hotel Center account
            link. Read-only.
        travel_feed_data (google.ads.googleads.v25.resources.types.AssetSet.TravelFeedData):
            Output only. Travel Feed data. Read-only
        location_set (google.ads.googleads.v25.common.types.LocationSet):
        ...
        business_profile_location_group (google.ads.googleads.v25.common.types.BusinessProfileLocationGroup):
            Business Profile location group asset set
            data.

            This field is a member of `oneof`_ ``asset_set_source``.
        chain_location_group (google.ads.googleads.v25.common.types.ChainLocationGroup):
    ...
    class TravelFeedData(proto.Message):
        ...
        Attributes:
            subset_id (int):
                ...
                travel feed.
            travel_feed_vertical_type (google.ads.googleads.v25.enums.types.VerticalAdsItemVerticalTypeEnum.VerticalAdsItemVerticalType):
