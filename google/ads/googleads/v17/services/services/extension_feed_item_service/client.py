...
class ExtensionFeedItemServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, ExtensionFeedItemServiceTransport]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, ExtensionFeedItemServiceTransport]]): The
    ...
    def mutate_extension_feed_items(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateExtensionFeedItemsRequest, dict, None]):
