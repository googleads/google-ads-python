...
class AdGroupCriterionServiceClient(
    ...
    def get_ad_group_criterion(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.GetAdGroupCriterionRequest`):
                The request object. Request message for
                [AdGroupCriterionService.GetAdGroupCriterion][google.ads.googleads.v8.services.AdGroupCriterionService.GetAdGroupCriterion].
        ...
        Returns:
            google.ads.googleads.v8.resources.types.AdGroupCriterion:
    ...
    def mutate_ad_group_criteria(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v8.services.types.MutateAdGroupCriteriaRequest`):
                The request object. Request message for
                [AdGroupCriterionService.MutateAdGroupCriteria][google.ads.googleads.v8.services.AdGroupCriterionService.MutateAdGroupCriteria].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.AdGroupCriterionOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateAdGroupCriteriaResponse:
