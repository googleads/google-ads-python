...
class OfflineUserDataJobServiceClient(
    ...
    def create_offline_user_data_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.CreateOfflineUserDataJobRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            job (google.ads.googleads.v15.resources.types.OfflineUserDataJob):
        ...
        Returns:
            google.ads.googleads.v15.services.types.CreateOfflineUserDataJobResponse:
    ...
    def add_offline_user_data_job_operations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.AddOfflineUserDataJobOperationsRequest, dict, None]):
                The request object. Request message for
            ...
            resource_name (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (MutableSequence[google.ads.googleads.v15.services.types.OfflineUserDataJobOperation]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.AddOfflineUserDataJobOperationsResponse:
                Response message for
                   [OfflineUserDataJobService.AddOfflineUserDataJobOperations][google.ads.googleads.v15.services.OfflineUserDataJobService.AddOfflineUserDataJobOperations].
    ...
    def run_offline_user_data_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.RunOfflineUserDataJobRequest, dict, None]):
                The request object. Request message for
