...
"""Accesses the google.ads.googleads.v2.services CampaignDraftService API."""
...
from google.ads.google_ads.v2.services import campaign_draft_service_client_config
...
class CampaignDraftServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.CampaignDraftService'
    ...
    def get_campaign_draft(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.CampaignDraft` instance.
    ...
    def mutate_campaign_drafts(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.CampaignDraftOperation]]): The list of operations to perform on individual campaign drafts.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.CampaignDraftOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateCampaignDraftsResponse` instance.
