...
from google.ads.google_ads.v0.proto.services import keyword_plan_campaign_service_pb2_grpc


class KeywordPlanCampaignServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v0.services KeywordPlanCampaignService API.
