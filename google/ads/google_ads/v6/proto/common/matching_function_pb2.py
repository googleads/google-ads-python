...
# source: google/ads/googleads_v6/proto/common/matching_function.proto
...
from google.ads.google_ads.v6.proto.enums import matching_function_context_type_pb2 as google_dot_ads_dot_googleads__v6_dot_proto_dot_enums_dot_matching__function__context__type__pb2
from google.ads.google_ads.v6.proto.enums import matching_function_operator_pb2 as google_dot_ads_dot_googleads__v6_dot_proto_dot_enums_dot_matching__function__operator__pb2
from google.api import annotations_pb2 as google_dot_api_dot_annotations__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v6/proto/common/matching_function.proto',
...
_MATCHINGFUNCTION.fields_by_name['operator'].enum_type = google_dot_ads_dot_googleads__v6_dot_proto_dot_enums_dot_matching__function__operator__pb2._MATCHINGFUNCTIONOPERATORENUM_MATCHINGFUNCTIONOPERATOR
...
_OPERAND_REQUESTCONTEXTOPERAND.fields_by_name['context_type'].enum_type = google_dot_ads_dot_googleads__v6_dot_proto_dot_enums_dot_matching__function__context__type__pb2._MATCHINGFUNCTIONCONTEXTTYPEENUM_MATCHINGFUNCTIONCONTEXTTYPE
...
MatchingFunction = _reflection.GeneratedProtocolMessageType('MatchingFunction', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads_v6.proto.common.matching_function_pb2'
  ,
  ...
  Attributes:
      function_string:
          ...
          IDENTITY(true) or IDENTITY(false). All or no feed items
          served. 2. EQUALS(CONTEXT.DEVICE,"Mobile") 3.
          ...
          XT.DEVICE,"Mobile"))  For more details, visit
          https://developers.google.com/adwords/api/docs/guides/feed-
          matching-functions  Note that because multiple strings may
          represent the same underlying function (whitespace and single
          versus double quotation marks, for example), the value
          returned may not be identical to the string sent in a mutate
          request.
      operator:
