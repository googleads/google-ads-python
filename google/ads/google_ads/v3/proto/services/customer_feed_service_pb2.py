...
# source: google/ads/googleads_v3/proto/services/customer_feed_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v3/proto/services/customer_feed_service.proto',
...
_CUSTOMERFEEDOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v3_dot_proto_dot_resources_dot_customer__feed__pb2._CUSTOMERFEED
_CUSTOMERFEEDOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v3_dot_proto_dot_resources_dot_customer__feed__pb2._CUSTOMERFEED
...
GetCustomerFeedRequest = _reflection.GeneratedProtocolMessageType('GetCustomerFeedRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v3.proto.services.customer_feed_service_pb2'
  ,
  __doc__ = """Request message for
  [CustomerFeedService.GetCustomerFeed][google.ads.googleads.v3.services.CustomerFeedService.GetCustomerFeed].
...
MutateCustomerFeedsRequest = _reflection.GeneratedProtocolMessageType('MutateCustomerFeedsRequest', (_message.Message,), dict(
  ...
  ,
  __doc__ = """Request message for
  [CustomerFeedService.MutateCustomerFeeds][google.ads.googleads.v3.services.CustomerFeedService.MutateCustomerFeeds].
...
_CUSTOMERFEEDSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v3_dot_proto_dot_resources_dot_customer__feed__pb2._CUSTOMERFEED,
    serialized_options=_b('\202\323\344\223\0021\022//v3/{resource_name=customers/*/customerFeeds/*}\332A\rresource_name'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0027\"2/v3/customers/{customer_id=*}/customerFeeds:mutate:\001*\332A\026customer_id,operations'),
  ),
])
