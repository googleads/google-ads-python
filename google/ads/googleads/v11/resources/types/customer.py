...
from google.ads.googleads.v11.enums.types import conversion_tracking_status_enum
from google.ads.googleads.v11.enums.types import (
    customer_pay_per_conversion_eligibility_failure_reason,
)
from google.ads.googleads.v11.enums.types import customer_status
...
class Customer(proto.Message):
    ...
    Attributes:
        ...
        call_reporting_setting (google.ads.googleads.v11.resources.types.CallReportingSetting):
            Call reporting setting for a customer. Only mutable in an
            ``update`` operation.
        conversion_tracking_setting (google.ads.googleads.v11.resources.types.ConversionTrackingSetting):
            Output only. Conversion tracking setting for
            a customer.
        remarketing_setting (google.ads.googleads.v11.resources.types.RemarketingSetting):
            Output only. Remarketing setting for a
            customer.
        pay_per_conversion_eligibility_failure_reasons (Sequence[google.ads.googleads.v11.enums.types.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason]):
        ...
        optimization_score_weight (float):
            ...
            This field is read-only.
        status (google.ads.googleads.v11.enums.types.CustomerStatusEnum.CustomerStatus):
...
class ConversionTrackingSetting(proto.Message):
    ...
    Attributes:
        ...
        conversion_tracking_status (google.ads.googleads.v11.enums.types.ConversionTrackingStatusEnum.ConversionTrackingStatus):
