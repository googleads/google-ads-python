...
class SharedCriterionServiceClient(metaclass=SharedCriterionServiceClientMeta):
    ...
    def mutate_shared_criteria(
        self,
        request: Union[
            shared_criterion_service.MutateSharedCriteriaRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v10.services.types.MutateSharedCriteriaRequest, dict]):
                The request object. Request message for
                [SharedCriterionService.MutateSharedCriteria][google.ads.googleads.v10.services.SharedCriterionService.MutateSharedCriteria].
            customer_id (str):
                ...
                should not be set.
            operations (Sequence[google.ads.googleads.v10.services.types.SharedCriterionOperation]):
        ...
        Returns:
            google.ads.googleads.v10.services.types.MutateSharedCriteriaResponse:
