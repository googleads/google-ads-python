...
from .transports.grpc_asyncio import FeedItemSetLinkServiceGrpcAsyncIOTransport
...
class FeedItemSetLinkServiceClient(metaclass=FeedItemSetLinkServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = FeedItemSetLinkServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                FeedItemSetLinkServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = FeedItemSetLinkServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = FeedItemSetLinkServiceClient._read_environment_variables()
        self._client_cert_source = (
            FeedItemSetLinkServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            FeedItemSetLinkServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, FeedItemSetLinkServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(FeedItemSetLinkServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or FeedItemSetLinkServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                FeedItemSetLinkServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., FeedItemSetLinkServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v18.services.FeedItemSetLinkServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_feed_item_set_links(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateFeedItemSetLinksRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v18.services.types.FeedItemSetLinkOperation]):
