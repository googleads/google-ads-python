...
class CampaignSharedSetServiceClient(
    ...
    def get_campaign_shared_set(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CampaignSharedSet:
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.CampaignSharedSetOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateCampaignSharedSetsResponse:
