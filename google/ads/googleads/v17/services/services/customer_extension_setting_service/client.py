...
class CustomerExtensionSettingServiceClient(
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = (
                CustomerExtensionSettingServiceClient._DEFAULT_UNIVERSE
            )
            ...
            api_endpoint = CustomerExtensionSettingServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        ) = CustomerExtensionSettingServiceClient._read_environment_variables()
        self._client_cert_source = (
            CustomerExtensionSettingServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = (
            CustomerExtensionSettingServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(
            transport, CustomerExtensionSettingServiceTransport
        )
        if transport_provided:
            ...
            self._transport = cast(
                CustomerExtensionSettingServiceTransport, transport
            )
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CustomerExtensionSettingServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v17.services.CustomerExtensionSettingServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customer_extension_settings(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateCustomerExtensionSettingsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v17.services.types.CustomerExtensionSettingOperation]):
