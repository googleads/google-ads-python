...
class OfflineConversionUploadClientSummary(proto.Message):
    ...
    Attributes:
        ...
        daily_summaries (MutableSequence[google.ads.googleads.v17.resources.types.OfflineConversionSummary]):
            Output only. Summary of history stats by last
            N days.
        job_summaries (MutableSequence[google.ads.googleads.v17.resources.types.OfflineConversionSummary]):
            Output only. Summary of history stats by last
            N jobs.
        alerts (MutableSequence[google.ads.googleads.v17.resources.types.OfflineConversionAlert]):
...
class OfflineConversionAlert(proto.Message):
    ...
    Attributes:
        error (google.ads.googleads.v17.resources.types.OfflineConversionError):
