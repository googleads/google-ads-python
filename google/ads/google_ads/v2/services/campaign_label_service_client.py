...
"""Accesses the google.ads.googleads.v2.services CampaignLabelService API."""
...
from google.ads.google_ads.v2.services import campaign_label_service_client_config
...
class CampaignLabelServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.CampaignLabelService'
    ...
    def __init__(self, transport=None, channel=None, credentials=None,
        ...
        Args:
            transport (Union[~.CampaignLabelServiceGrpcTransport,
                    Callable[[~.Credentials, type], ~.CampaignLabelServiceGrpcTransport]): A transport
        ...
        if client_config is not None:
            ...
            client_config = campaign_label_service_client_config.config
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=campaign_label_service_grpc_transport.CampaignLabelServiceGrpcTransport,
                )
            else:
                if credentials:
                    raise ValueError(
            ...
            self.transport = campaign_label_service_grpc_transport.CampaignLabelServiceGrpcTransport(
    ...
    def get_campaign_label(
        ...
        Args:
            resource_name (str): The resource name of the campaign-label relationship to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.CampaignLabel` instance.
        ...
        if 'get_campaign_label' not in self._inner_api_calls:
            self._inner_api_calls['get_campaign_label'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_campaign_label,
                default_retry=self._method_configs['GetCampaignLabel'].retry,
                default_timeout=self._method_configs['GetCampaignLabel'].timeout,
                client_info=self._client_info,
            )

        request = campaign_label_service_pb2.GetCampaignLabelRequest(
        ...
        return self._inner_api_calls['get_campaign_label'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def mutate_campaign_labels(
        ...
        Args:
            customer_id (str): ID of the customer whose campaign-label relationships are being modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.CampaignLabelOperation]]): The list of operations to perform on campaign-label relationships.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.CampaignLabelOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateCampaignLabelsResponse` instance.
        ...
        """
        # Wrap the transport method to add retry and timeout logic.
        if 'mutate_campaign_labels' not in self._inner_api_calls:
            self._inner_api_calls['mutate_campaign_labels'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.mutate_campaign_labels,
                default_retry=self._method_configs['MutateCampaignLabels'].retry,
                default_timeout=self._method_configs['MutateCampaignLabels'].timeout,
                client_info=self._client_info,
            )

        request = campaign_label_service_pb2.MutateCampaignLabelsRequest(
        ...
        return self._inner_api_calls['mutate_campaign_labels'](request, retry=retry, timeout=timeout, metadata=metadata)
