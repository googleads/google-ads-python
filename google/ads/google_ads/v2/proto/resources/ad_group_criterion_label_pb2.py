...
# source: google/ads/googleads_v2/proto/resources/ad_group_criterion_label.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v2/proto/resources/ad_group_criterion_label.proto',
...
AdGroupCriterionLabel = _reflection.GeneratedProtocolMessageType('AdGroupCriterionLabel', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v2.proto.resources.ad_group_criterion_label_pb2'
  ,
  ...
  Attributes:
      resource_name:
          ...
          criterion label resource names have the form: ``customers/{cus
          tomer_id}/adGroupCriterionLabels/{ad_group_id}~{criterion_id}~
          {label_id}``
      ad_group_criterion:
