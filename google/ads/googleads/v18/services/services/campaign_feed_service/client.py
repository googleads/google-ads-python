...
from .transports.grpc_asyncio import CampaignFeedServiceGrpcAsyncIOTransport
...
class CampaignFeedServiceClient(metaclass=CampaignFeedServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = CampaignFeedServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                CampaignFeedServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CampaignFeedServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        ) = CampaignFeedServiceClient._read_environment_variables()
        self._client_cert_source = (
            CampaignFeedServiceClient._get_client_cert_source(
                self._client_options.client_cert_source, self._use_client_cert
            )
        )
        self._universe_domain = CampaignFeedServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, CampaignFeedServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(CampaignFeedServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CampaignFeedServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            ...
            transport_init: Union[
                ...
                CampaignFeedServiceClient.get_transport_class(transport)
                if isinstance(transport, str) or transport is None
                else cast(
                    Callable[..., CampaignFeedServiceTransport], transport
                )
            )
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v18.services.CampaignFeedServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaign_feeds(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateCampaignFeedsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v18.services.types.CampaignFeedOperation]):
