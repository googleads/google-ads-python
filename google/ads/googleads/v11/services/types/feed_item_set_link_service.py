...
from google.ads.googleads.v11.resources.types import feed_item_set_link
...
class MutateFeedItemSetLinksRequest(proto.Message):
    ...
    [FeedItemSetLinkService.MutateFeedItemSetLinks][google.ads.googleads.v11.services.FeedItemSetLinkService.MutateFeedItemSetLinks].

    Attributes:
        customer_id (str):
            Required. The ID of the customer whose feed
            item set links are being modified.
        operations (Sequence[google.ads.googleads.v11.services.types.FeedItemSetLinkOperation]):
...
class FeedItemSetLinkOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v11.resources.types.FeedItemSetLink):
...
class MutateFeedItemSetLinksResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v11.services.types.MutateFeedItemSetLinkResult]):
