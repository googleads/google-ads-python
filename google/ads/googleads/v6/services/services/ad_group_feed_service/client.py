...
class AdGroupFeedServiceClient(metaclass=AdGroupFeedServiceClientMeta):
    ...
    def get_ad_group_feed(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetAdGroupFeedRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.AdGroupFeed:
                An ad group feed.
        """
    ...
    def mutate_ad_group_feeds(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateAdGroupFeedsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.AdGroupFeedOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateAdGroupFeedsResponse:
