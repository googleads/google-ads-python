...
class CustomInterestServiceClient(metaclass=CustomInterestServiceClientMeta):
    ...
    def get_custom_interest(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.CustomInterest:
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.CustomInterestOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateCustomInterestsResponse:
