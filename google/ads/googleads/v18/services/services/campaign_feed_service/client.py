...
class CampaignFeedServiceClient(metaclass=CampaignFeedServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, CampaignFeedServiceTransport]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, CampaignFeedServiceTransport]]): The
    ...
    def mutate_campaign_feeds(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateCampaignFeedsRequest, dict, None]):
