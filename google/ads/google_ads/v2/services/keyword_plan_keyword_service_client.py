...
"""Accesses the google.ads.googleads.v2.services KeywordPlanKeywordService API."""
...
from google.ads.google_ads.v2.services import keyword_plan_keyword_service_client_config
...
class KeywordPlanKeywordServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.KeywordPlanKeywordService'
    ...
    def get_keyword_plan_keyword(
        ...
        Args:
            resource_name (str): The resource name of the ad group keyword to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.KeywordPlanKeyword` instance.
    ...
    def mutate_keyword_plan_keywords(
        ...
        Args:
            customer_id (str): The ID of the customer whose Keyword Plan keywords are being modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.KeywordPlanKeywordOperation]]): The list of operations to perform on individual Keyword Plan keywords.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.KeywordPlanKeywordOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateKeywordPlanKeywordsResponse` instance.
