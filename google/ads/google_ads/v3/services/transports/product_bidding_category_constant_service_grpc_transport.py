...
from google.ads.google_ads.v3.proto.services import product_bidding_category_constant_service_pb2_grpc


class ProductBiddingCategoryConstantServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v3.services ProductBiddingCategoryConstantService API.
