...
class CustomerManagerLinkOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v9.resources.types.CustomerManagerLink):
...
class MutateCustomerManagerLinkResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateCustomerManagerLinkResult]):
