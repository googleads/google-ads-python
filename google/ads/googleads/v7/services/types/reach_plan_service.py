...
class ProductMetadata(proto.Message):
    ...
    Attributes:
        ...
        plannable_targeting (google.ads.googleads.v7.services.types.PlannableTargeting):
...
class GenerateProductMixIdeasRequest(proto.Message):
    ...
    Attributes:
        ...
        budget_micros (int):
            ...
            one unit.
        preferences (google.ads.googleads.v7.services.types.Preferences):
...
class GenerateReachForecastResponse(proto.Message):
    ...
    Attributes:
        ...
        reach_curve (google.ads.googleads.v7.services.types.ReachCurve):
...
class ReachForecast(proto.Message):
    ...
    Attributes:
        cost_micros (int):
            The cost in micros.
        forecast (google.ads.googleads.v7.services.types.Forecast):
            Forecasted traffic metrics for this point.
        planned_product_reach_forecasts (Sequence[google.ads.googleads.v7.services.types.PlannedProductReachForecast]):
...
class PlannedProductReachForecast(proto.Message):
    ...
    Attributes:
        ...
        planned_product_forecast (google.ads.googleads.v7.services.types.PlannedProductForecast):
