...
class KeywordPlanServiceClient(metaclass=KeywordPlanServiceClientMeta):
    ...
    def mutate_keyword_plans(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateKeywordPlansRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v15.services.types.KeywordPlanOperation]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateKeywordPlansResponse:
