...
class FeedItemSetServiceClient(metaclass=FeedItemSetServiceClientMeta):
    ...
    def get_feed_item_set(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v6.services.types.GetFeedItemSetRequest`):
        ...
        Returns:
            google.ads.googleads.v6.resources.types.FeedItemSet:
    ...
    def mutate_feed_item_sets(
        ...
        *,
        ...
        r"""Creates, updates or removes feed item sets. Operation
        statuses are returned.

        Args:
            request (:class:`google.ads.googleads.v6.services.types.MutateFeedItemSetsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v6.services.types.FeedItemSetOperation]`):
        ...
        Returns:
            google.ads.googleads.v6.services.types.MutateFeedItemSetsResponse:
