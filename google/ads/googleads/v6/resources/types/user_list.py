...
class UserList(proto.Message):
    ...
    Attributes:
        ...
        membership_status (google.ads.googleads.v6.enums.types.UserListMembershipStatusEnum.UserListMembershipStatus):
        ...
        size_for_display (int):
            ...
            This field is read-only.
        size_range_for_display (google.ads.googleads.v6.enums.types.UserListSizeRangeEnum.UserListSizeRange):
        ...
        size_for_search (int):
            ...
            This field is read-only.
        size_range_for_search (google.ads.googleads.v6.enums.types.UserListSizeRangeEnum.UserListSizeRange):
            Output only. Size range in terms of number of
            users of the UserList, for Search ads.
            This field is read-only.
        type_ (google.ads.googleads.v6.enums.types.UserListTypeEnum.UserListType):
            Output only. Type of this list.
            This field is read-only.
        closing_reason (google.ads.googleads.v6.enums.types.UserListClosingReasonEnum.UserListClosingReason):
        ...
        access_reason (google.ads.googleads.v6.enums.types.AccessReasonEnum.AccessReason):
            ...
            SUBSCRIBED.
            This field is read-only.
        account_user_list_status (google.ads.googleads.v6.enums.types.UserListAccessStatusEnum.UserListAccessStatus):
        ...
        match_rate_percentage (int):
            ...
            This field is read-only.
        crm_based_user_list (google.ads.googleads.v6.common.types.CrmBasedUserListInfo):
            User list of CRM users provided by the
            advertiser.
        similar_user_list (google.ads.googleads.v6.common.types.SimilarUserListInfo):
        ...
        rule_based_user_list (google.ads.googleads.v6.common.types.RuleBasedUserListInfo):
            User list generated by a rule.
        logical_user_list (google.ads.googleads.v6.common.types.LogicalUserListInfo):
            User list that is a custom combination of
            user lists and user interests.
        basic_user_list (google.ads.googleads.v6.common.types.BasicUserListInfo):
