...
from google.ads.google_ads.v0.proto.services import keyword_plan_negative_keyword_service_pb2_grpc


class KeywordPlanNegativeKeywordServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v0.services KeywordPlanNegativeKeywordService API.
