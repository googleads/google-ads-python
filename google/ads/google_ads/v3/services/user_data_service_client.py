...
"""Accesses the google.ads.googleads.v3.services UserDataService API."""
...
from google.ads.google_ads.v3.services import user_data_service_client_config
from google.ads.google_ads.v3.services.transports import user_data_service_grpc_transport
from google.ads.google_ads.v3.proto.services import user_data_service_pb2
...
class UserDataServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v3.services.UserDataService'
    ...
    def upload_user_data(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v3.types.UserDataOperation]]): Required. The list of operations to be done.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.UserDataOperation`
            customer_match_user_list_metadata (Union[dict, ~google.ads.googleads_v3.types.CustomerMatchUserListMetadata]): Metadata for data updates to a Customer Match user list.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v3.types.CustomerMatchUserListMetadata`
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.UploadUserDataResponse` instance.
