...
"""Accesses the google.ads.googleads.v3.services GoogleAdsService API."""
...
from google.ads.google_ads.v3.services import google_ads_service_client_config
from google.ads.google_ads.v3.services.transports import google_ads_service_grpc_transport
from google.ads.google_ads.v3.proto.services import google_ads_service_pb2
...
class GoogleAdsServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v3.services.GoogleAdsService'
    ...
    def search(
        ...
        Args:
            ...
            return_total_results_count (bool): If true, the total number of results that match the query ignoring the
                ...
                Default is false.
            summary_row_setting (~google.ads.googleads_v3.types.SummaryRowSetting): Determines whether a summary row will be returned. By default, summary row
        ...
        Returns:
            ...
            is an iterable of :class:`~google.ads.googleads_v3.types.GoogleAdsRow` instances.
    ...
    def search_stream(
        ...
        Returns:
            Iterable[~google.ads.googleads_v3.types.SearchGoogleAdsStreamResponse].
    ...
    def mutate(
        ...
        Args:
            ...
            mutate_operations (list[Union[dict, ~google.ads.googleads_v3.types.MutateOperation]]): Required. The list of operations to perform on individual resources.
        ...
        Returns:
            A :class:`~google.ads.googleads_v3.types.MutateGoogleAdsResponse` instance.
