...
class MutateCustomerUserAccessInvitationRequest(proto.Message):
    ...
    Attributes:
        ...
        operation (google.ads.googleads.v7.services.types.CustomerUserAccessInvitationOperation):
...
class CustomerUserAccessInvitationOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v7.resources.types.CustomerUserAccessInvitation):
