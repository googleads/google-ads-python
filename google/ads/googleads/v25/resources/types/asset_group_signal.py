...
class AssetGroupSignal(proto.Message):
    ...
    Attributes:
        ...
        approval_status (google.ads.googleads.v25.enums.types.AssetGroupSignalApprovalStatusEnum.AssetGroupSignalApprovalStatus):
        ...
        search_theme (google.ads.googleads.v25.common.types.SearchThemeInfo):
            ...
            This field is a member of `oneof`_ ``signal``.
        local_services_id (google.ads.googleads.v25.common.types.LocalServiceIdInfo):
            Immutable. The local services signal to be
        ...
        vertical_ads_item_group_rule_list (google.ads.googleads.v25.common.types.VerticalAdsItemGroupRuleListInfo):
            Immutable. The list of vertical ads item group rules used to
            select items from the attached vertical feed.

            This field links to a SharedSet of type
            VERTICAL_ADS_ITEM_GROUP_RULE_LIST. The rules within the
            linked SharedSet define which items from the TRAVEL_FEED
            AssetSet are eligible to be served. Items that do not match
            the rules will be excluded. This behavior is different from
            other signal types, which provide guidance to the
            optimization engine rather than determining item
            eligibility.
    ...
    local_services_id: criteria.LocalServiceIdInfo = proto.Field(
        proto.MESSAGE,
        number=8,
        oneof="signal",
