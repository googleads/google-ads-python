...
class ConversionUploadServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v19.services.ConversionUploadServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def upload_click_conversions(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.UploadClickConversionsRequest, dict]]):
            ...
            customer_id (:class:`str`):
                ...
                should not be set.
            conversions (:class:`MutableSequence[google.ads.googleads.v19.services.types.ClickConversion]`):
        ...
        Returns:
            google.ads.googleads.v19.services.types.UploadClickConversionsResponse:
    ...
    async def upload_call_conversions(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v19.services.types.UploadCallConversionsRequest, dict]]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            conversions (:class:`MutableSequence[google.ads.googleads.v19.services.types.CallConversion]`):
                Required. The conversions that are
                being uploaded.
        ...
        Returns:
            google.ads.googleads.v19.services.types.UploadCallConversionsResponse:
                Response message for
                   [ConversionUploadService.UploadCallConversions][google.ads.googleads.v19.services.ConversionUploadService.UploadCallConversions].
