...
class CustomerUserAccessServiceClient(
    ...
    def get_customer_user_access(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCustomerUserAccessRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CustomerUserAccess:
    ...
    def mutate_customer_user_access(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCustomerUserAccessRequest, dict]):
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v9.services.types.CustomerUserAccessOperation`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCustomerUserAccessResponse:
