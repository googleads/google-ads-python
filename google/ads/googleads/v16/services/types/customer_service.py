...
from google.ads.googleads.v16.enums.types import access_role as gage_access_role
...
class CreateCustomerClientRequest(proto.Message):
    ...
    Attributes:
        ...
        access_role (google.ads.googleads.v16.enums.types.AccessRoleEnum.AccessRole):
...
class CustomerOperation(proto.Message):
    ...
    Attributes:
        update (google.ads.googleads.v16.resources.types.Customer):
...
class MutateCustomerResponse(proto.Message):
    ...
    Attributes:
        result (google.ads.googleads.v16.services.types.MutateCustomerResult):
