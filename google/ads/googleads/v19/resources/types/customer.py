...
from google.ads.googleads.v19.enums.types import customer_status
from google.ads.googleads.v19.enums.types import (
...
class Customer(proto.Message):
    ...
    Attributes:
        ...
        call_reporting_setting (google.ads.googleads.v19.resources.types.CallReportingSetting):
        ...
        remarketing_setting (google.ads.googleads.v19.resources.types.RemarketingSetting):
            ...
            customer.
        pay_per_conversion_eligibility_failure_reasons (MutableSequence[google.ads.googleads.v19.enums.types.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason]):
        ...
        optimization_score_weight (float):
            ...
            This field is read-only.
        status (google.ads.googleads.v19.enums.types.CustomerStatusEnum.CustomerStatus):
        ...
        customer_agreement_setting (google.ads.googleads.v19.resources.types.CustomerAgreementSetting):
            Output only. Customer Agreement Setting for a
            customer.
        local_services_settings (google.ads.googleads.v19.resources.types.LocalServicesSettings):
...
class LocalServicesSettings(proto.Message):
    ...
    Attributes:
        ...
        granular_insurance_statuses (MutableSequence[google.ads.googleads.v19.resources.types.GranularInsuranceStatus]):
            Output only. A read-only list of geo vertical
...
class GranularLicenseStatus(proto.Message):
    ...
    Attributes:
        ...
        verification_status (google.ads.googleads.v19.enums.types.LocalServicesVerificationStatusEnum.LocalServicesVerificationStatus):
