...
FeedMappingErrorEnum = _reflection.GeneratedProtocolMessageType('FeedMappingErrorEnum', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v0.proto.errors.feed_mapping_error_pb2'
  ,
