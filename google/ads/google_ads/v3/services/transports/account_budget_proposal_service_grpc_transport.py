...
from google.ads.google_ads.v3.proto.services import account_budget_proposal_service_pb2_grpc


class AccountBudgetProposalServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v3.services AccountBudgetProposalService API.
