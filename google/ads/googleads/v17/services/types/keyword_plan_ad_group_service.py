...
from google.ads.googleads.v17.resources.types import keyword_plan_ad_group
...
class MutateKeywordPlanAdGroupsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v17.services.types.KeywordPlanAdGroupOperation]):
...
class KeywordPlanAdGroupOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v17.resources.types.KeywordPlanAdGroup):
            Create operation: No resource name is
            expected for the new Keyword Plan ad group.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v17.resources.types.KeywordPlanAdGroup):
...
class MutateKeywordPlanAdGroupsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v17.services.types.MutateKeywordPlanAdGroupResult]):
