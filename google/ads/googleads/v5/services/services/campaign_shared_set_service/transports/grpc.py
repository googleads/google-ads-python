    ...
    def get_campaign_shared_set(
        ...
        if "get_campaign_shared_set" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v5.services.CampaignSharedSetService/GetCampaignSharedSet",
    ...
    def mutate_campaign_shared_sets(
        ...
        if "mutate_campaign_shared_sets" not in self._stubs:
            self._stubs[
                ...
                "/google.ads.googleads.v5.services.CampaignSharedSetService/MutateCampaignSharedSets",
