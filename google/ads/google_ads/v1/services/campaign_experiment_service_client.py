...
"""Accesses the google.ads.googleads.v1.services CampaignExperimentService API."""
...
from google.ads.google_ads.v1.services import campaign_experiment_service_client_config
...
class CampaignExperimentServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.CampaignExperimentService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=campaign_experiment_service_grpc_transport.
    ...
    def get_campaign_experiment(
        ...
        if 'get_campaign_experiment' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_campaign_experiment'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_campaign_experiment,
                    default_retry=self.
                    _method_configs['GetCampaignExperiment'].retry,
                    default_timeout=self.
                    _method_configs['GetCampaignExperiment'].timeout,
                    client_info=self._client_info,
                )

        request = campaign_experiment_service_pb2.GetCampaignExperimentRequest(
            resource_name=resource_name, )
        return self._inner_api_calls['get_campaign_experiment'](
    ...
    def create_campaign_experiment(
        ...
        if 'create_campaign_experiment' not in self._inner_api_calls:
            self._inner_api_calls[
                'create_campaign_experiment'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.create_campaign_experiment,
                    default_retry=self.
                    _method_configs['CreateCampaignExperiment'].retry,
                    default_timeout=self.
                    _method_configs['CreateCampaignExperiment'].timeout,
                    client_info=self._client_info,
                )
        ...
        operation = self._inner_api_calls['create_campaign_experiment'](
            request, retry=retry, timeout=timeout, metadata=metadata)
        return google.api_core.operation.from_gapic(
            operation,
            self.transport._operations_client,
            empty_pb2.Empty,
            metadata_type=campaign_experiment_service_pb2.
    ...
    def mutate_campaign_experiments(
        ...
        if 'mutate_campaign_experiments' not in self._inner_api_calls:
            self._inner_api_calls[
                'mutate_campaign_experiments'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.mutate_campaign_experiments,
                    default_retry=self.
                    _method_configs['MutateCampaignExperiments'].retry,
                    default_timeout=self.
                    _method_configs['MutateCampaignExperiments'].timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['mutate_campaign_experiments'](
            request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def graduate_campaign_experiment(
        ...
        if 'graduate_campaign_experiment' not in self._inner_api_calls:
            self._inner_api_calls[
                'graduate_campaign_experiment'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.graduate_campaign_experiment,
                    default_retry=self.
                    _method_configs['GraduateCampaignExperiment'].retry,
                    default_timeout=self.
                    _method_configs['GraduateCampaignExperiment'].timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['graduate_campaign_experiment'](
            request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def promote_campaign_experiment(
        ...
        if 'promote_campaign_experiment' not in self._inner_api_calls:
            self._inner_api_calls[
                'promote_campaign_experiment'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.promote_campaign_experiment,
                    default_retry=self.
                    _method_configs['PromoteCampaignExperiment'].retry,
                    default_timeout=self.
                    _method_configs['PromoteCampaignExperiment'].timeout,
                    client_info=self._client_info,
                )

        request = campaign_experiment_service_pb2.PromoteCampaignExperimentRequest(
            campaign_experiment=campaign_experiment, )
        operation = self._inner_api_calls['promote_campaign_experiment'](
            request, retry=retry, timeout=timeout, metadata=metadata)
        return google.api_core.operation.from_gapic(
            operation,
            self.transport._operations_client,
    ...
    def end_campaign_experiment(
        ...
        if 'end_campaign_experiment' not in self._inner_api_calls:
            self._inner_api_calls[
                'end_campaign_experiment'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.end_campaign_experiment,
                    default_retry=self.
                    _method_configs['EndCampaignExperiment'].retry,
                    default_timeout=self.
                    _method_configs['EndCampaignExperiment'].timeout,
                    client_info=self._client_info,
                )

        request = campaign_experiment_service_pb2.EndCampaignExperimentRequest(
            campaign_experiment=campaign_experiment, )
        self._inner_api_calls['end_campaign_experiment'](
            request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def list_campaign_experiment_async_errors(
        ...
        if 'list_campaign_experiment_async_errors' not in self._inner_api_calls:
            self._inner_api_calls[
                'list_campaign_experiment_async_errors'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.list_campaign_experiment_async_errors,
                    default_retry=self.
                    _method_configs['ListCampaignExperimentAsyncErrors'].retry,
                    default_timeout=self._method_configs[
                        'ListCampaignExperimentAsyncErrors'].timeout,
                    client_info=self._client_info,
                )
        ...
        iterator = google.api_core.page_iterator.GRPCIterator(
            ...
            method=functools.partial(
                self._inner_api_calls['list_campaign_experiment_async_errors'],
                retry=retry,
                timeout=timeout,
                metadata=metadata),
            request=request,
