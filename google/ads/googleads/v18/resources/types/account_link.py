...
from google.ads.googleads.v18.enums.types import account_link_status
from google.ads.googleads.v18.enums.types import linked_account_type
...
class AccountLink(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v18.enums.types.AccountLinkStatusEnum.AccountLinkStatus):
            The status of the link.
        type_ (google.ads.googleads.v18.enums.types.LinkedAccountTypeEnum.LinkedAccountType):
            Output only. The type of the linked account.
        third_party_app_analytics (google.ads.googleads.v18.resources.types.ThirdPartyAppAnalyticsLinkIdentifier):
...
class ThirdPartyAppAnalyticsLinkIdentifier(proto.Message):
    ...
    Attributes:
        ...
        app_vendor (google.ads.googleads.v18.enums.types.MobileAppVendorEnum.MobileAppVendor):
