...
"""Accesses the google.ads.googleads.v5.services UserListService API."""
...
from google.ads.google_ads.v5.services import user_list_service_client_config
from google.ads.google_ads.v5.services.transports import user_list_service_grpc_transport
from google.ads.google_ads.v5.proto.services import user_list_service_pb2
...
class UserListServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v5.services.UserListService'
    ...
    def get_user_list(
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.UserList` instance.
    ...
    def mutate_user_lists(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v5.types.UserListOperation]]): Required. The list of operations to perform on individual user lists.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v5.types.UserListOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v5.types.MutateUserListsResponse` instance.
