...
class ListCampaignExperimentAsyncErrorsPager:
    ...
    :class:`google.ads.googleads.v8.services.types.ListCampaignExperimentAsyncErrorsResponse` object, and
    ...
    All the usual :class:`google.ads.googleads.v8.services.types.ListCampaignExperimentAsyncErrorsResponse`
    ...
    def __init__(
        ...
        Args:
            ...
            response (:class:`google.ads.googleads.v8.services.types.ListCampaignExperimentAsyncErrorsResponse`):
