...
class CampaignCriterionServiceClient(
    ...
    def get_campaign_criterion(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v8.resources.types.CampaignCriterion:
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v8.services.types.CampaignCriterionOperation]`):
        ...
        Returns:
            google.ads.googleads.v8.services.types.MutateCampaignCriteriaResponse:
