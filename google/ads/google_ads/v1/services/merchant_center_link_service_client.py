...
"""Accesses the google.ads.googleads.v1.services MerchantCenterLinkService API."""
...
from google.ads.google_ads.v1.services import merchant_center_link_service_client_config
...
class MerchantCenterLinkServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.MerchantCenterLinkService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=merchant_center_link_service_grpc_transport.
    ...
    def list_merchant_center_links(
        ...
        Args:
            customer_id (str): The ID of the customer onto which to apply the Merchant Center link list
                operation.
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.ListMerchantCenterLinksResponse` instance.
        ...
        if 'list_merchant_center_links' not in self._inner_api_calls:
            self._inner_api_calls[
                'list_merchant_center_links'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.list_merchant_center_links,
                    default_retry=self.
                    _method_configs['ListMerchantCenterLinks'].retry,
                    default_timeout=self.
                    _method_configs['ListMerchantCenterLinks'].timeout,
                    client_info=self._client_info,
                )

        request = merchant_center_link_service_pb2.ListMerchantCenterLinksRequest(
            customer_id=customer_id, )
        return self._inner_api_calls['list_merchant_center_links'](
    ...
    def get_merchant_center_link(
        ...
        Args:
            resource_name (str): Resource name of the Merchant Center link.
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.MerchantCenterLink` instance.
        ...
        if 'get_merchant_center_link' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_merchant_center_link'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_merchant_center_link,
                    default_retry=self.
                    _method_configs['GetMerchantCenterLink'].retry,
                    default_timeout=self.
                    _method_configs['GetMerchantCenterLink'].timeout,
                    client_info=self._client_info,
                )

        request = merchant_center_link_service_pb2.GetMerchantCenterLinkRequest(
            resource_name=resource_name, )
        return self._inner_api_calls['get_merchant_center_link'](
            request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def mutate_merchant_center_link(
        ...
        Args:
            ...
            operation_ (Union[dict, ~google.ads.googleads_v1.types.MerchantCenterLinkOperation]): The operation to perform on the link

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.MerchantCenterLinkOperation`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.MutateMerchantCenterLinkResponse` instance.
        ...
        if 'mutate_merchant_center_link' not in self._inner_api_calls:
            self._inner_api_calls[
                'mutate_merchant_center_link'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.mutate_merchant_center_link,
                    default_retry=self.
                    _method_configs['MutateMerchantCenterLink'].retry,
                    default_timeout=self.
                    _method_configs['MutateMerchantCenterLink'].timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['mutate_merchant_center_link'](
            request, retry=retry, timeout=timeout, metadata=metadata)
