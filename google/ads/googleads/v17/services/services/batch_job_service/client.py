...
class BatchJobServiceClient(metaclass=BatchJobServiceClientMeta):
    ...
    def mutate_batch_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateBatchJobRequest, dict, None]):
    ...
    def list_batch_job_results(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.ListBatchJobResultsRequest, dict, None]):
                The request object. Request message for
    ...
    def run_batch_job(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.RunBatchJobRequest, dict, None]):
                The request object. Request message for
    ...
    def add_batch_job_operations(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.AddBatchJobOperationsRequest, dict, None]):
                The request object. Request message for
