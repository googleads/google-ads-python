...
# source: google/ads/googleads_v4/proto/services/ad_group_criterion_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v4/proto/services/ad_group_criterion_service.proto',
...
_ADGROUPCRITERIONOPERATION.fields_by_name['exempt_policy_violation_keys'].message_type = google_dot_ads_dot_googleads__v4_dot_proto_dot_common_dot_policy__pb2._POLICYVIOLATIONKEY
_ADGROUPCRITERIONOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_ad__group__criterion__pb2._ADGROUPCRITERION
_ADGROUPCRITERIONOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_ad__group__criterion__pb2._ADGROUPCRITERION
...
GetAdGroupCriterionRequest = _reflection.GeneratedProtocolMessageType('GetAdGroupCriterionRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v4.proto.services.ad_group_criterion_service_pb2'
  ,
...
_ADGROUPCRITERIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v4_dot_proto_dot_resources_dot_ad__group__criterion__pb2._ADGROUPCRITERION,
    serialized_options=_b('\202\323\344\223\0023\0221/v4/{resource_name=customers/*/adGroupCriteria/*}\332A\rresource_name'),
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=_b('\202\323\344\223\0029\"4/v4/customers/{customer_id=*}/adGroupCriteria:mutate:\001*\332A\026customer_id,operations'),
  ),
])
