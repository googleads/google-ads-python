...
"""Accesses the google.ads.googleads.v2.services MediaFileService API."""
...
from google.ads.google_ads.v2.services import media_file_service_client_config
...
class MediaFileServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.MediaFileService'
    ...
    def get_media_file(
        ...
        Args:
            resource_name (str): The resource name of the media file to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MediaFile` instance.
    ...
    def mutate_media_files(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.MediaFileOperation]]): The list of operations to perform on individual media file.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.MediaFileOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateMediaFilesResponse` instance.
