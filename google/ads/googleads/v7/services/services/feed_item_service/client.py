...
class FeedItemServiceClient(metaclass=FeedItemServiceClientMeta):
    ...
    def get_feed_item(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v7.resources.types.FeedItem:
                A feed item.
        """
        ...
        *,
        ...
        Args:
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v7.services.types.FeedItemOperation]`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateFeedItemsResponse:
