...
class ConversionAdjustmentUploadServiceClient(
    ...
    def upload_conversion_adjustments(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v14.services.types.UploadConversionAdjustmentsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v14.services.types.UploadConversionAdjustmentsResponse:
