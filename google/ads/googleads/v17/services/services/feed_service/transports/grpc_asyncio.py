...
class FeedServiceGrpcAsyncIOTransport(FeedServiceTransport):
    """gRPC AsyncIO backend transport for FeedService.
    ...
    def mutate_feeds(
        ...
        if "mutate_feeds" not in self._stubs:
            self._stubs["mutate_feeds"] = self._logged_channel.unary_unary(
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_feeds: self._wrap_method(
                self.mutate_feeds,
...
__all__ = ("FeedServiceGrpcAsyncIOTransport",)
