...
class LabelServiceClient(metaclass=LabelServiceClientMeta):
    ...
    def mutate_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateLabelsRequest, dict, None]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v13.services.types.LabelOperation]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateLabelsResponse:
