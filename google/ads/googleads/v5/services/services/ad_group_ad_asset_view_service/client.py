...
class AdGroupAdAssetViewServiceClient(
    ...
    def get_ad_group_ad_asset_view(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetAdGroupAdAssetViewRequest`):
                The request object. Request message for
                [AdGroupAdAssetViewService.GetAdGroupAdAssetView][google.ads.googleads.v5.services.AdGroupAdAssetViewService.GetAdGroupAdAssetView].
        ...
        Returns:
            google.ads.googleads.v5.resources.types.AdGroupAdAssetView:
