...
"""Accesses the google.ads.googleads.v2.services AdGroupAdService API."""
...
from google.ads.google_ads.v2.services import ad_group_ad_service_client_config
...
class AdGroupAdServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.AdGroupAdService'
    ...
    def __init__(self, transport=None, channel=None, credentials=None,
        ...
        Args:
            transport (Union[~.AdGroupAdServiceGrpcTransport,
                    Callable[[~.Credentials, type], ~.AdGroupAdServiceGrpcTransport]): A transport
        ...
        if client_config is not None:
            ...
            client_config = ad_group_ad_service_client_config.config
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=ad_group_ad_service_grpc_transport.AdGroupAdServiceGrpcTransport,
                )
            else:
                if credentials:
                    raise ValueError(
            ...
            self.transport = ad_group_ad_service_grpc_transport.AdGroupAdServiceGrpcTransport(
    ...
    def get_ad_group_ad(
        ...
        Args:
            resource_name (str): The resource name of the ad to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.AdGroupAd` instance.
        ...
        if 'get_ad_group_ad' not in self._inner_api_calls:
            self._inner_api_calls['get_ad_group_ad'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.get_ad_group_ad,
                default_retry=self._method_configs['GetAdGroupAd'].retry,
                default_timeout=self._method_configs['GetAdGroupAd'].timeout,
                client_info=self._client_info,
            )

        request = ad_group_ad_service_pb2.GetAdGroupAdRequest(
        ...
        return self._inner_api_calls['get_ad_group_ad'](request, retry=retry, timeout=timeout, metadata=metadata)
    ...
    def mutate_ad_group_ads(
        ...
        Args:
            customer_id (str): The ID of the customer whose ads are being modified.
            operations (list[Union[dict, ~google.ads.googleads_v2.types.AdGroupAdOperation]]): The list of operations to perform on individual ads.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.AdGroupAdOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateAdGroupAdsResponse` instance.
        ...
        """
        # Wrap the transport method to add retry and timeout logic.
        if 'mutate_ad_group_ads' not in self._inner_api_calls:
            self._inner_api_calls['mutate_ad_group_ads'] = google.api_core.gapic_v1.method.wrap_method(
                self.transport.mutate_ad_group_ads,
                default_retry=self._method_configs['MutateAdGroupAds'].retry,
                default_timeout=self._method_configs['MutateAdGroupAds'].timeout,
                client_info=self._client_info,
            )

        request = ad_group_ad_service_pb2.MutateAdGroupAdsRequest(
