...
class KeywordPlanCampaignServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, KeywordPlanCampaignServiceTransport]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, KeywordPlanCampaignServiceTransport]]): The
    ...
    def mutate_keyword_plan_campaigns(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateKeywordPlanCampaignsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v17.services.types.MutateKeywordPlanCampaignsResponse:
