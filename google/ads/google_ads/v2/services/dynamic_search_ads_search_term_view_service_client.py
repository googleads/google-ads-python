...
"""Accesses the google.ads.googleads.v2.services DynamicSearchAdsSearchTermViewService API."""
...
from google.ads.google_ads.v2.services import dynamic_search_ads_search_term_view_service_client_config
...
class DynamicSearchAdsSearchTermViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.DynamicSearchAdsSearchTermViewService'
    ...
    def get_dynamic_search_ads_search_term_view(
        ...
        Args:
            resource_name (str): The resource name of the dynamic search ads search term view to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.DynamicSearchAdsSearchTermView` instance.
