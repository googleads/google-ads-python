...
"""Accesses the google.ads.googleads.v1.services CampaignFeedService API."""
...
from google.ads.google_ads.v1.services import campaign_feed_service_client_config
...
class CampaignFeedServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.CampaignFeedService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=campaign_feed_service_grpc_transport.
    ...
    def get_campaign_feed(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.CampaignFeed` instance.
        ...
        return self._inner_api_calls['get_campaign_feed'](
    ...
    def mutate_campaign_feeds(self,
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v1.types.CampaignFeedOperation]]): The list of operations to perform on individual campaign feeds.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.CampaignFeedOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.MutateCampaignFeedsResponse` instance.
