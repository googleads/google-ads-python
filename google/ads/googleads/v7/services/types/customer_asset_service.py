...
class MutateCustomerAssetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v7.services.types.CustomerAssetOperation]):
...
class CustomerAssetOperation(proto.Message):
    ...
    create = proto.Field(
        ...
        number=1,
        oneof="operation",
        message=customer_asset.CustomerAsset,
    )
    update = proto.Field(
        proto.MESSAGE,
        number=3,
...
class MutateCustomerAssetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v7.services.types.MutateCustomerAssetResult]):
