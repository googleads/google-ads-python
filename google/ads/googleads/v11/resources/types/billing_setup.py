...
from google.ads.googleads.v11.enums.types import billing_setup_status
...
class BillingSetup(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v11.enums.types.BillingSetupStatusEnum.BillingSetupStatus):
        ...
        payments_account_info (google.ads.googleads.v11.resources.types.BillingSetup.PaymentsAccountInfo):
        ...
        start_time_type (google.ads.googleads.v11.enums.types.TimeTypeEnum.TimeType):
