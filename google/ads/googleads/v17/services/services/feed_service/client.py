...
class FeedServiceClient(metaclass=FeedServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        self._api_endpoint = (
            self._api_endpoint
            or FeedServiceClient._get_api_endpoint(
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v17.services.FeedServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_feeds(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateFeedsRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operations (MutableSequence[google.ads.googleads.v17.services.types.FeedOperation]):
