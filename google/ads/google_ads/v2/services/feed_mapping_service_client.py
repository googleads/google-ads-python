...
"""Accesses the google.ads.googleads.v2.services FeedMappingService API."""
...
from google.ads.google_ads.v2.services import feed_mapping_service_client_config
...
class FeedMappingServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.FeedMappingService'
    ...
    def get_feed_mapping(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.FeedMapping` instance.
    ...
    def mutate_feed_mappings(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.FeedMappingOperation]]): The list of operations to perform on individual feed mappings.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.FeedMappingOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateFeedMappingsResponse` instance.
