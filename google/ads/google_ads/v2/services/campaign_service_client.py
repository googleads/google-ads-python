...
"""Accesses the google.ads.googleads.v2.services CampaignService API."""
...
from google.ads.google_ads.v2.services import campaign_service_client_config
...
class CampaignServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.CampaignService'
    ...
    def get_campaign(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.Campaign` instance.
    ...
    def mutate_campaigns(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.CampaignOperation]]): The list of operations to perform on individual campaigns.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.CampaignOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateCampaignsResponse` instance.
