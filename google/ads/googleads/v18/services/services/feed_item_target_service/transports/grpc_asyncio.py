...
class FeedItemTargetServiceGrpcAsyncIOTransport(FeedItemTargetServiceTransport):
    """gRPC AsyncIO backend transport for FeedItemTargetService.
    ...
    def mutate_feed_item_targets(
        ...
        Returns:
            Callable[[~.MutateFeedItemTargetsRequest],
                    Awaitable[~.MutateFeedItemTargetsResponse]]:
        ...
        if "mutate_feed_item_targets" not in self._stubs:
            self._stubs["mutate_feed_item_targets"] = (
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_feed_item_targets: self._wrap_method(
...
__all__ = ("FeedItemTargetServiceGrpcAsyncIOTransport",)
