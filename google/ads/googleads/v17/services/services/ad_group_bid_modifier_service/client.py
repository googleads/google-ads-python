...
class AdGroupBidModifierServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, AdGroupBidModifierServiceTransport]]): The
    ...
    def mutate_ad_group_bid_modifiers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateAdGroupBidModifiersRequest, dict, None]):
