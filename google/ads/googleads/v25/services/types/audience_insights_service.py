...
from google.ads.googleads.v25.enums.types import audience_insights_dimension
...
class GenerateInsightsFinderReportRequest(proto.Message):
    ...
    Attributes:
        ...
        baseline_audience (google.ads.googleads.v25.services.types.InsightsAudience):
            Required. A baseline audience for this
            report, typically all people in a region.
        specific_audience (google.ads.googleads.v25.services.types.InsightsAudience):
...
class GenerateAudienceCompositionInsightsRequest(proto.Message):
    ...
    Attributes:
        customer_id (str):
            Required. The ID of the customer.
        audience (google.ads.googleads.v25.services.types.InsightsAudience):
        ...
        data_month (str):
            ...
            days of data.
        dimensions (MutableSequence[google.ads.googleads.v25.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension]):
...
class GenerateSuggestedTargetingInsightsRequest(proto.Message):
    ...
    Attributes:
        ...
        insights_application_info (google.ads.googleads.v25.common.types.AdditionalApplicationInfo):
            Optional. Additional information on the
            application issuing the request.
        audience_definition (google.ads.googleads.v25.services.types.InsightsAudienceDefinition):
            Provide a seed audience to get suggestions
            for.

            This field is a member of `oneof`_ ``audience_input``.
        audience_description (google.ads.googleads.v25.services.types.InsightsAudienceDescription):
...
class GenerateSuggestedTargetingInsightsResponse(proto.Message):
    ...
    Attributes:
        suggestions (MutableSequence[google.ads.googleads.v25.services.types.TargetingSuggestionMetrics]):
...
class TargetingSuggestionMetrics(proto.Message):
    ...
    Attributes:
        locations (MutableSequence[google.ads.googleads.v25.common.types.AudienceInsightsAttributeMetadata]):
            Suggested location targeting. These attributes all have
            dimension GEO_TARGET_COUNTRY or SUB_COUNTRY_LOCATION
        age_ranges (MutableSequence[google.ads.googleads.v25.common.types.AgeRangeInfo]):
            Suggested age targeting; may be empty
            indicating no age targeting.
        gender (google.ads.googleads.v25.common.types.GenderInfo):
            Suggested gender targeting.  If present, this
            attribute has dimension GENDER.
        parental_status (google.ads.googleads.v25.common.types.ParentalStatusInfo):
            A Parental Status value (parent, or not a
            parent).
        user_interests (MutableSequence[google.ads.googleads.v25.common.types.AudienceInsightsAttributeMetadataGroup]):
...
class ListAudienceInsightsAttributesRequest(proto.Message):
    ...
    Attributes:
        ...
        query_text (str):
            ...
            ignored and all available attributes are returned. Example:
            "Millennials interested in the World Cup and soccer.".
        customer_insights_group (str):
            The name of the customer being planned for.
            This is a user-defined value.
        insights_application_info (google.ads.googleads.v25.common.types.AdditionalApplicationInfo):
            Optional. Additional information on the
            application issuing the request.
        location_country_filters (MutableSequence[google.ads.googleads.v25.common.types.LocationInfo]):
            ...
            return an error.
        youtube_reach_location (google.ads.googleads.v25.common.types.LocationInfo):
        ...
        knowledge_graph_entity_search_options (google.ads.googleads.v25.services.types.KnowledgeGraphEntitySearchOptions):
            Optional. Additional search options for
    ...
    knowledge_graph_entity_search_options: (
        ...
        proto.MESSAGE,
        number=8,
        message="KnowledgeGraphEntitySearchOptions",
    )


class KnowledgeGraphEntitySearchOptions(proto.Message):
    r"""Search options for Knowledge Graph Entities.

    Attributes:
        get_all_creator_attributes (bool):
            Optional. When true, retrieves all available Knowledge Graph
            ...
            ``ListAudienceInsightsAttributesRequest.dimensions`` and the
            ``query_text`` must be empty.

            This option cannot be used with
            [search_filter][google.ads.googleads.v25.services.KnowledgeGraphEntitySearchOptions.search_filter].
            ``search_filter`` respects the ``query_text`` when
            retrieving relevant entities while this option returns all
            creator attributes available to use as an input.
        search_filter (google.ads.googleads.v25.services.types.KnowledgeGraphEntitySearchOptions.SearchFilter):
            Optional. Filter options for narrowing down
            the scope of Knowledge Graph Entities to
            retrieve.
    """

    class SearchFilter(proto.Message):
        r"""Filter options for Knowledge Graph Entities.

        Attributes:
            entity_capability_filters (MutableSequence[google.ads.googleads.v25.enums.types.InsightsKnowledgeGraphEntityCapabilitiesEnum.InsightsKnowledgeGraphEntityCapabilities]):
                ...
                If set, returns entities relevant to the ``query_text`` and
                supported for any of the specified capabilities.

                For example, entity_capability_filters[0] and
                entity_capability_filters[1] are combined with OR so that
                entities supported for either capability are returned.
        """

        entity_capability_filters: MutableSequence[
    ...
    get_all_creator_attributes: bool = proto.Field(
        proto.BOOL,
        number=1,
    )
    search_filter: SearchFilter = proto.Field(
        proto.MESSAGE,
        number=2,
...
class ListAudienceInsightsAttributesResponse(proto.Message):
    ...
    Attributes:
        attributes (MutableSequence[google.ads.googleads.v25.common.types.AudienceInsightsAttributeMetadata]):
...
class ListInsightsEligibleDatesResponse(proto.Message):
    ...
    Attributes:
        ...
        last_thirty_days (google.ads.googleads.v25.common.types.DateRange):
...
class GenerateAudienceOverlapInsightsRequest(proto.Message):
    ...
    Attributes:
        ...
        primary_attribute (google.ads.googleads.v25.common.types.AudienceInsightsAttribute):
...
class GenerateAudienceOverlapInsightsResponse(proto.Message):
    ...
    Attributes:
        primary_attribute_metadata (google.ads.googleads.v25.common.types.AudienceInsightsAttributeMetadata):
            Metadata for the primary attribute, including
            potential YouTube reach.
        dimension_results (MutableSequence[google.ads.googleads.v25.services.types.DimensionOverlapResult]):
...
class DimensionOverlapResult(proto.Message):
    ...
    Attributes:
        dimension (google.ads.googleads.v25.enums.types.AudienceInsightsDimensionEnum.AudienceInsightsDimension):
            The dimension of all the attributes in this
            section.
        items (MutableSequence[google.ads.googleads.v25.services.types.AudienceOverlapItem]):
...
class AudienceOverlapItem(proto.Message):
    ...
    Attributes:
        attribute_metadata (google.ads.googleads.v25.common.types.AudienceInsightsAttributeMetadata):
...
class GenerateAudienceDefinitionResponse(proto.Message):
    ...
    Attributes:
        high_relevance_attributes (MutableSequence[google.ads.googleads.v25.common.types.AudienceInsightsAttributeMetadata]):
            The attributes that make up the audience
            definition.
        medium_relevance_attributes (MutableSequence[google.ads.googleads.v25.common.types.AudienceInsightsAttributeMetadata]):
...
class InsightsAudienceDescription(proto.Message):
    ...
    Attributes:
        ...
        audience_description (str):
            ...
            travel".
        marketing_objective (google.ads.googleads.v25.enums.types.AudienceInsightsMarketingObjectiveEnum.AudienceInsightsMarketingObjective):
        ...
        audience_dimensions (google.ads.googleads.v25.services.types.AudienceInsightsDimensions):
...
class InsightsAudience(proto.Message):
    ...
    Attributes:
        ...
        parental_status (google.ads.googleads.v25.common.types.ParentalStatusInfo):
            ...
            status.
        income_ranges (MutableSequence[google.ads.googleads.v25.common.types.IncomeRangeInfo]):
            Household income percentile ranges for the
            audience.  If absent, the audience does not
            restrict by household income range.
        lineups (MutableSequence[google.ads.googleads.v25.common.types.AudienceInsightsLineup]):
            Lineups representing the YouTube content
            viewed by the audience.
        user_list (google.ads.googleads.v25.common.types.UserListInfo):
            User list to be targeted by the audience.
        topic_audience_combinations (MutableSequence[google.ads.googleads.v25.common.types.InsightsAudienceAttributeGroup]):
...
class AudienceCompositionSection(proto.Message):
    ...
    Attributes:
        ...
        top_attributes (MutableSequence[google.ads.googleads.v25.services.types.AudienceCompositionAttribute]):
        ...
        clustered_attributes (MutableSequence[google.ads.googleads.v25.services.types.AudienceCompositionAttributeCluster]):
...
class AudienceCompositionAttributeCluster(proto.Message):
    ...
    Attributes:
        ...
        cluster_metrics (google.ads.googleads.v25.services.types.AudienceCompositionMetrics):
            ...
            field is unset.
        attributes (MutableSequence[google.ads.googleads.v25.services.types.AudienceCompositionAttribute]):
...
class AudienceCompositionAttribute(proto.Message):
    ...
    Attributes:
        ...
        metrics (google.ads.googleads.v25.services.types.AudienceCompositionMetrics):
