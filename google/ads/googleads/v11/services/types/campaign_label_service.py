...
from google.ads.googleads.v11.resources.types import campaign_label
...
class MutateCampaignLabelsRequest(proto.Message):
    ...
    [CampaignLabelService.MutateCampaignLabels][google.ads.googleads.v11.services.CampaignLabelService.MutateCampaignLabels].

    Attributes:
        customer_id (str):
            Required. ID of the customer whose
            campaign-label relationships are being modified.
        operations (Sequence[google.ads.googleads.v11.services.types.CampaignLabelOperation]):
...
class CampaignLabelOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v11.resources.types.CampaignLabel):
...
class MutateCampaignLabelsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            level error.
        results (Sequence[google.ads.googleads.v11.services.types.MutateCampaignLabelResult]):
