...
_CUSTOMER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='manager', full_name='google.ads.googleads.v0.resources.Customer.manager', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='test_account', full_name='google.ads.googleads.v0.resources.Customer.test_account', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='call_reporting_setting', full_name='google.ads.googleads.v0.resources.Customer.call_reporting_setting', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='conversion_tracking_setting', full_name='google.ads.googleads.v0.resources.Customer.conversion_tracking_setting', index=12,
...
_CONVERSIONTRACKINGSETTING = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v0.resources.ConversionTrackingSetting',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='conversion_tracking_id', full_name='google.ads.googleads.v0.resources.ConversionTrackingSetting.conversion_tracking_id', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cross_account_conversion_tracking_id', full_name='google.ads.googleads.v0.resources.ConversionTrackingSetting.cross_account_conversion_tracking_id', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
