...
# source: google/ads/googleads_v0/proto/errors/feed_error.proto
...
_FEEDERRORENUM_FEEDERROR = _descriptor.EnumDescriptor(
  name='FeedError',
  full_name='google.ads.googleads.v0.errors.FeedErrorEnum.FeedError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_FEEDERRORENUM = _descriptor.Descriptor(
  name='FeedErrorEnum',
  full_name='google.ads.googleads.v0.errors.FeedErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
FeedErrorEnum = _reflection.GeneratedProtocolMessageType('FeedErrorEnum', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v0.proto.errors.feed_error_pb2'
  ,
  __doc__ = """Container for enum describing possible feed errors.
  """,
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v0.errors.FeedErrorEnum)
  ))
