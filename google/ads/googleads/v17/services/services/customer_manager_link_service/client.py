...
class CustomerManagerLinkServiceClient(
    ...
    def mutate_customer_manager_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateCustomerManagerLinkRequest, dict, None]):
    ...
    def move_manager_link(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MoveManagerLinkRequest, dict, None]):
                The request object. Request message for
