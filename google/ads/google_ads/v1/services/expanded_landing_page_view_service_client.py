...
"""Accesses the google.ads.googleads.v1.services ExpandedLandingPageViewService API."""
...
from google.ads.google_ads.v1.services import expanded_landing_page_view_service_client_config
...
class ExpandedLandingPageViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.ExpandedLandingPageViewService'
    ...
    @classmethod
    def expanded_landing_page_view_path(cls, customer,
    ...
    def get_expanded_landing_page_view(
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.ExpandedLandingPageView` instance.
        ...
        if 'get_expanded_landing_page_view' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_expanded_landing_page_view'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_expanded_landing_page_view,
                    default_retry=self.
                    _method_configs['GetExpandedLandingPageView'].retry,
                    default_timeout=self.
                    _method_configs['GetExpandedLandingPageView'].timeout,
                    client_info=self._client_info,
                )

        request = expanded_landing_page_view_service_pb2.GetExpandedLandingPageViewRequest(
            resource_name=resource_name, )
        return self._inner_api_calls['get_expanded_landing_page_view'](
