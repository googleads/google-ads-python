...
class CustomerUserAccessInvitationServiceClient(
    ...
    def get_customer_user_access_invitation(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetCustomerUserAccessInvitationRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v7.resources.types.CustomerUserAccessInvitation:
    ...
    def mutate_customer_user_access_invitation(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.MutateCustomerUserAccessInvitationRequest`):
                The request object.
                Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v7.services.types.CustomerUserAccessInvitationOperation`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateCustomerUserAccessInvitationResponse:
