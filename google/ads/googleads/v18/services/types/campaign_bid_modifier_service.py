...
class MutateCampaignBidModifiersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v18.services.types.CampaignBidModifierOperation]):
...
class CampaignBidModifierOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v18.resources.types.CampaignBidModifier):
            Create operation: No resource name is
            expected for the new campaign bid modifier.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v18.resources.types.CampaignBidModifier):
...
class MutateCampaignBidModifiersResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v18.services.types.MutateCampaignBidModifierResult]):
