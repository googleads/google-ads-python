...
from google.ads.googleads.v17.enums.types import combined_audience_status
...
class CombinedAudience(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v17.enums.types.CombinedAudienceStatusEnum.CombinedAudienceStatus):
