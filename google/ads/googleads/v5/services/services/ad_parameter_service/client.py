...
class AdParameterServiceClient(metaclass=AdParameterServiceClientMeta):
    ...
    def get_ad_parameter(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetAdParameterRequest`):
        ...
        Returns:
            google.ads.googleads.v5.resources.types.AdParameter:
    ...
    def mutate_ad_parameters(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateAdParametersRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.AdParameterOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateAdParametersResponse:
