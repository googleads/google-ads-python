...
from google.ads.googleads.v25.enums.types import (
    third_party_conversion_attribution_integration_partner,
)
from google.ads.googleads.v25.enums.types import (
...
class CustomerThirdPartyIntegrationPartners(proto.Message):
    ...
    Attributes:
        viewability_integration_partners (MutableSequence[google.ads.googleads.v25.common.types.CustomerThirdPartyViewabilityIntegrationPartner]):
            Allowed third party integration partners for
            YouTube viewability verification.
        brand_lift_integration_partners (MutableSequence[google.ads.googleads.v25.common.types.CustomerThirdPartyBrandLiftIntegrationPartner]):
            Allowed third party integration partners for
            Brand Lift verification.
        brand_safety_integration_partners (MutableSequence[google.ads.googleads.v25.common.types.CustomerThirdPartyBrandSafetyIntegrationPartner]):
            Allowed third party integration partners for
            brand safety verification.
        reach_integration_partners (MutableSequence[google.ads.googleads.v25.common.types.CustomerThirdPartyReachIntegrationPartner]):
            Allowed third party integration partners for
            reach verification.
        conversion_attribution_integration_partners (MutableSequence[google.ads.googleads.v25.common.types.CustomerThirdPartyConversionAttributionIntegrationPartner]):
            Allowed third party integration partners for
    ...
    conversion_attribution_integration_partners: MutableSequence[
        ...
        proto.MESSAGE,
        number=5,
        message="CustomerThirdPartyConversionAttributionIntegrationPartner",
    )
...
class CustomerThirdPartyViewabilityIntegrationPartner(proto.Message):
    ...
    Attributes:
        viewability_integration_partner (google.ads.googleads.v25.enums.types.ThirdPartyViewabilityIntegrationPartnerEnum.ThirdPartyViewabilityIntegrationPartner):
            Allowed third party integration partners for
            YouTube viewability verification.
...
class CustomerThirdPartyBrandSafetyIntegrationPartner(proto.Message):
    ...
    Attributes:
        brand_safety_integration_partner (google.ads.googleads.v25.enums.types.ThirdPartyBrandSafetyIntegrationPartnerEnum.ThirdPartyBrandSafetyIntegrationPartner):
            Allowed third party integration partners for
            brand safety verification.
    """
...
class CustomerThirdPartyBrandLiftIntegrationPartner(proto.Message):
    ...
    Attributes:
        brand_lift_integration_partner (google.ads.googleads.v25.enums.types.ThirdPartyBrandLiftIntegrationPartnerEnum.ThirdPartyBrandLiftIntegrationPartner):
            Allowed Third Party integration partners for
            Brand Lift verification.
        allow_share_cost (bool):
            If true, cost data can be shared with this
...
class CustomerThirdPartyReachIntegrationPartner(proto.Message):
    ...
    Attributes:
        reach_integration_partner (google.ads.googleads.v25.enums.types.ThirdPartyReachIntegrationPartnerEnum.ThirdPartyReachIntegrationPartner):
            Allowed Third Party integration partners for
            reach verification.
        allow_share_cost (bool):
            If true, cost data can be shared with this
...
class CustomerThirdPartyConversionAttributionIntegrationPartner(proto.Message):
    r"""Container for third party YouTube conversion attribution
    integration data for Customer.

    Attributes:
        conversion_attribution_integration_partner (google.ads.googleads.v25.enums.types.ThirdPartyConversionAttributionIntegrationPartnerEnum.ThirdPartyConversionAttributionIntegrationPartner):
            Allowed third party integration partners for
            YouTube conversion attribution verification.
    """

    conversion_attribution_integration_partner: (
        third_party_conversion_attribution_integration_partner.ThirdPartyConversionAttributionIntegrationPartnerEnum.ThirdPartyConversionAttributionIntegrationPartner
    ) = proto.Field(
        proto.ENUM,
        number=1,
        enum=third_party_conversion_attribution_integration_partner.ThirdPartyConversionAttributionIntegrationPartnerEnum.ThirdPartyConversionAttributionIntegrationPartner,
    )
...
class CampaignThirdPartyIntegrationPartners(proto.Message):
    ...
    Attributes:
        viewability_integration_partners (MutableSequence[google.ads.googleads.v25.common.types.CampaignThirdPartyViewabilityIntegrationPartner]):
            Third party integration partners for YouTube
            viewability verification for this Campaign.
        brand_lift_integration_partners (MutableSequence[google.ads.googleads.v25.common.types.CampaignThirdPartyBrandLiftIntegrationPartner]):
            Third party integration partners for Brand
            Lift verification for this Campaign.
        brand_safety_integration_partners (MutableSequence[google.ads.googleads.v25.common.types.CampaignThirdPartyBrandSafetyIntegrationPartner]):
            Third party integration partners for brand
            safety verification for this Campaign.
        reach_integration_partners (MutableSequence[google.ads.googleads.v25.common.types.CampaignThirdPartyReachIntegrationPartner]):
            Third party integration partners for reach
            verification for this Campaign.
        conversion_attribution_integration_partners (MutableSequence[google.ads.googleads.v25.common.types.CampaignThirdPartyConversionAttributionIntegrationPartner]):
            Third party integration partners for YouTube
            conversion attribution verification for this
            Campaign.
    """
    ...
    conversion_attribution_integration_partners: MutableSequence[
        ...
        proto.MESSAGE,
        number=5,
        message="CampaignThirdPartyConversionAttributionIntegrationPartner",
    )
...
class CampaignThirdPartyViewabilityIntegrationPartner(proto.Message):
    ...
    Attributes:
        viewability_integration_partner (google.ads.googleads.v25.enums.types.ThirdPartyViewabilityIntegrationPartnerEnum.ThirdPartyViewabilityIntegrationPartner):
            Allowed third party integration partners for
            YouTube viewability verification.
        viewability_integration_partner_data (google.ads.googleads.v25.common.types.ThirdPartyIntegrationPartnerData):
...
class CampaignThirdPartyBrandSafetyIntegrationPartner(proto.Message):
    ...
    Attributes:
        brand_safety_integration_partner (google.ads.googleads.v25.enums.types.ThirdPartyBrandSafetyIntegrationPartnerEnum.ThirdPartyBrandSafetyIntegrationPartner):
            Allowed third party integration partners for
            brand safety verification.
        brand_safety_integration_partner_data (google.ads.googleads.v25.common.types.ThirdPartyIntegrationPartnerData):
...
class CampaignThirdPartyBrandLiftIntegrationPartner(proto.Message):
    ...
    Attributes:
        brand_lift_integration_partner (google.ads.googleads.v25.enums.types.ThirdPartyBrandLiftIntegrationPartnerEnum.ThirdPartyBrandLiftIntegrationPartner):
            Allowed third party integration partners for
            Brand Lift verification.
        brand_lift_integration_partner_data (google.ads.googleads.v25.common.types.ThirdPartyIntegrationPartnerData):
            Third party partner data for YouTube Brand
...
class CampaignThirdPartyReachIntegrationPartner(proto.Message):
    ...
    Attributes:
        reach_integration_partner (google.ads.googleads.v25.enums.types.ThirdPartyReachIntegrationPartnerEnum.ThirdPartyReachIntegrationPartner):
            Allowed third party integration partners for
            reach verification.
        reach_integration_partner_data (google.ads.googleads.v25.common.types.ThirdPartyIntegrationPartnerData):
...
class CampaignThirdPartyConversionAttributionIntegrationPartner(proto.Message):
    ...
    Attributes:
        conversion_attribution_integration_partner (google.ads.googleads.v25.enums.types.ThirdPartyConversionAttributionIntegrationPartnerEnum.ThirdPartyConversionAttributionIntegrationPartner):
            Allowed third party integration partners for
            YouTube conversion attribution verification.
        conversion_attribution_integration_partner_data (google.ads.googleads.v25.common.types.ThirdPartyIntegrationPartnerData):
            Third party partner data for YouTube
