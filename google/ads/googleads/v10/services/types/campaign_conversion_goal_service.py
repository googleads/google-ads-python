...
from google.ads.googleads.v10.resources.types import campaign_conversion_goal
...
class MutateCampaignConversionGoalsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v10.services.types.CampaignConversionGoalOperation]):
...
class CampaignConversionGoalOperation(proto.Message):
    ...
    Attributes:
        ...
        update (google.ads.googleads.v10.resources.types.CampaignConversionGoal):
...
class MutateCampaignConversionGoalsResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v10.services.types.MutateCampaignConversionGoalResult]):
