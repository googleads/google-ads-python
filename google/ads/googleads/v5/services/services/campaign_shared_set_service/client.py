...
class CampaignSharedSetServiceClient(
    ...
    def get_campaign_shared_set(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetCampaignSharedSetRequest`):
                The request object. Request message for
                [CampaignSharedSetService.GetCampaignSharedSet][google.ads.googleads.v5.services.CampaignSharedSetService.GetCampaignSharedSet].
        ...
        Returns:
            google.ads.googleads.v5.resources.types.CampaignSharedSet:
    ...
    def mutate_campaign_shared_sets(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.MutateCampaignSharedSetsRequest`):
                The request object. Request message for
                [CampaignSharedSetService.MutateCampaignSharedSets][google.ads.googleads.v5.services.CampaignSharedSetService.MutateCampaignSharedSets].
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v5.services.types.CampaignSharedSetOperation]`):
        ...
        Returns:
            google.ads.googleads.v5.services.types.MutateCampaignSharedSetsResponse:
