...
def main(client: GoogleAdsClient, customer_id: str) -> None:
    ...
    # Define a type alias for the union of all possible resource types.
    # This will be used to type hint old_resource and new_resource.
    ResourceType = Union[
        Ad,
        AdGroup,
        AdGroupAd,
    ...
    for row in results:
        ...
        old_resource: ResourceType
        new_resource: ResourceType
        if resource_type == "AD":
