...
class AssetGroupSignalServiceClient(
    ...
    def mutate_asset_group_signals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v15.services.types.MutateAssetGroupSignalsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v15.services.types.MutateAssetGroupSignalsResponse:
