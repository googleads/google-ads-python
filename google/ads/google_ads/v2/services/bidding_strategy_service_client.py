...
"""Accesses the google.ads.googleads.v2.services BiddingStrategyService API."""
...
from google.ads.google_ads.v2.services import bidding_strategy_service_client_config
...
class BiddingStrategyServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.BiddingStrategyService'
    ...
    def get_bidding_strategy(
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.BiddingStrategy` instance.
    ...
    def mutate_bidding_strategies(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v2.types.BiddingStrategyOperation]]): The list of operations to perform on individual bidding strategies.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v2.types.BiddingStrategyOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.MutateBiddingStrategiesResponse` instance.
