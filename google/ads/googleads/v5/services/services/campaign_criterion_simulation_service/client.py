...
class CampaignCriterionSimulationServiceClient(
    ...
    def get_campaign_criterion_simulation(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v5.services.types.GetCampaignCriterionSimulationRequest`):
        ...
        Returns:
            google.ads.googleads.v5.resources.types.CampaignCriterionSimulation:
