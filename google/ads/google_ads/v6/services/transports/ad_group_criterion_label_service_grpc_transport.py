...
from google.ads.google_ads.v6.proto.services import ad_group_criterion_label_service_pb2_grpc


class AdGroupCriterionLabelServiceGrpcTransport(object):
    """gRPC transport class providing stubs for
    google.ads.googleads.v6.services AdGroupCriterionLabelService API.
