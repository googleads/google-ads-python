...
class SharedCriterionServiceClient(object):
    ...
    def get_shared_criterion(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.SharedCriterion` instance.
    ...
    def mutate_shared_criteria(self,
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v0.types.SharedCriterionOperation]]): The list of operations to perform on individual shared criteria.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v0.types.SharedCriterionOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.MutateSharedCriteriaResponse` instance.
