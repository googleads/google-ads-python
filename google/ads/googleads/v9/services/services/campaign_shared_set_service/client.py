...
class CampaignSharedSetServiceClient(
    ...
    def get_campaign_shared_set(
        self,
        request: Union[
            campaign_shared_set_service.GetCampaignSharedSetRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetCampaignSharedSetRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.CampaignSharedSet:
    ...
    def mutate_campaign_shared_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateCampaignSharedSetsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.CampaignSharedSetOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateCampaignSharedSetsResponse:
