...
class FeedItemSetServiceClient(metaclass=FeedItemSetServiceClientMeta):
    ...
    def get_feed_item_set(
        self,
        request: Union[
            feed_item_set_service.GetFeedItemSetRequest, dict
        ] = None,
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.GetFeedItemSetRequest, dict]):
        ...
        Returns:
            google.ads.googleads.v9.resources.types.FeedItemSet:
    ...
    def mutate_feed_item_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v9.services.types.MutateFeedItemSetsRequest, dict]):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v9.services.types.FeedItemSetOperation]`):
        ...
        Returns:
            google.ads.googleads.v9.services.types.MutateFeedItemSetsResponse:
