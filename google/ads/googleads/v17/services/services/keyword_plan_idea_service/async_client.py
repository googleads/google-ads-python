...
from google.ads.googleads.v17.services.services.keyword_plan_idea_service import (
    pagers,
)
...
class KeywordPlanIdeaServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.ads.googleads.v17.services.KeywordPlanIdeaServiceAsyncClient`.",
                extra=(
                    {
    ...
    async def generate_keyword_ideas(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v17.services.types.GenerateKeywordIdeasRequest, dict]]):
        ...
        Returns:
            google.ads.googleads.v17.services.services.keyword_plan_idea_service.pagers.GenerateKeywordIdeasAsyncPager:
    ...
    async def generate_keyword_historical_metrics(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v17.services.types.GenerateKeywordHistoricalMetricsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v17.services.types.GenerateKeywordHistoricalMetricsResponse:
                Response message for
                   [KeywordPlanIdeaService.GenerateKeywordHistoricalMetrics][google.ads.googleads.v17.services.KeywordPlanIdeaService.GenerateKeywordHistoricalMetrics].
    ...
    async def generate_ad_group_themes(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v17.services.types.GenerateAdGroupThemesRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v17.services.types.GenerateAdGroupThemesResponse:
                Response message for
                   [KeywordPlanIdeaService.GenerateAdGroupThemes][google.ads.googleads.v17.services.KeywordPlanIdeaService.GenerateAdGroupThemes].
    ...
    async def generate_keyword_forecast_metrics(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.ads.googleads.v17.services.types.GenerateKeywordForecastMetricsRequest, dict]]):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v17.services.types.GenerateKeywordForecastMetricsResponse:
                Response message for
                [KeywordPlanIdeaService.GenerateKeywordForecastMetrics].
