...
class MutateFeedItemTargetsRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v15.services.types.FeedItemTargetOperation]):
...
class FeedItemTargetOperation(proto.Message):
    ...
    Attributes:
        create (google.ads.googleads.v15.resources.types.FeedItemTarget):
...
class MutateFeedItemTargetsResponse(proto.Message):
    ...
    Attributes:
        partial_failure_error (google.rpc.status_pb2.Status):
            ...
            an RPC level error.
        results (MutableSequence[google.ads.googleads.v15.services.types.MutateFeedItemTargetResult]):
