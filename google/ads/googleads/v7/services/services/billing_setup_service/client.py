...
class BillingSetupServiceClient(metaclass=BillingSetupServiceClientMeta):
    ...
    def get_billing_setup(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.GetBillingSetupRequest`):
                The request object.
                Request message for
        ...
        Returns:
            google.ads.googleads.v7.resources.types.BillingSetup:
    ...
    def mutate_billing_setup(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v7.services.types.MutateBillingSetupRequest`):
                The request object.
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operation (:class:`google.ads.googleads.v7.services.types.BillingSetupOperation`):
        ...
        Returns:
            google.ads.googleads.v7.services.types.MutateBillingSetupResponse:
