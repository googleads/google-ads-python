...
"""Accesses the google.ads.googleads.v6.services ClickViewService API."""
...
from google.ads.google_ads.v6.services import click_view_service_client_config
from google.ads.google_ads.v6.services.transports import click_view_service_grpc_transport
from google.ads.google_ads.v6.proto.services import click_view_service_pb2
...
class ClickViewServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v6.services.ClickViewService'
    ...
    def get_click_view(
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.ClickView` instance.
