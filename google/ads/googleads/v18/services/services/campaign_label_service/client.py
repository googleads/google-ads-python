...
class CampaignLabelServiceClient(metaclass=CampaignLabelServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v18.services.CampaignLabelServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_campaign_labels(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateCampaignLabelsRequest, dict]):
