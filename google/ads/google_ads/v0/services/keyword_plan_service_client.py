...
class KeywordPlanServiceClient(object):
    ...
    def get_keyword_plan(self,
        ...
        Returns:
            A :class:`~google.ads.google_ads.v0.types.KeywordPlan` instance.
    ...
    def mutate_keyword_plans(self,
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.google_ads.v0.types.KeywordPlanOperation]]): The list of operations to perform on individual keyword plans.
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.google_ads.v0.types.KeywordPlanOperation`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will not
                be retried.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.google_ads.v0.types.MutateKeywordPlansResponse` instance.
    ...
    def generate_forecast_metrics(
        ...
        Returns:
            A :class:`~google.ads.google_ads.v0.types.GenerateForecastMetricsResponse` instance.
        ...
        if 'generate_forecast_metrics' not in self._inner_api_calls:
            self._inner_api_calls[
                'generate_forecast_metrics'] = google.api_core.gapic_v1.method.wrap_method(
                    ...
                    default_retry=self._method_configs[
                        'GenerateForecastMetrics'].retry,
                    default_timeout=self._method_configs[
                        'GenerateForecastMetrics'].timeout,
                    client_info=self._client_info,
                )
    ...
    def generate_historical_metrics(
        ...
        Returns:
            A :class:`~google.ads.google_ads.v0.types.GenerateHistoricalMetricsResponse` instance.
        ...
        if 'generate_historical_metrics' not in self._inner_api_calls:
            self._inner_api_calls[
                'generate_historical_metrics'] = google.api_core.gapic_v1.method.wrap_method(
                    ...
                    default_retry=self._method_configs[
                        'GenerateHistoricalMetrics'].retry,
                    default_timeout=self._method_configs[
                        'GenerateHistoricalMetrics'].timeout,
                    client_info=self._client_info,
                )
