...
class CampaignExtensionSettingServiceGrpcAsyncIOTransport(
    CampaignExtensionSettingServiceTransport
):
    """gRPC AsyncIO backend transport for CampaignExtensionSettingService.
    ...
    def mutate_campaign_extension_settings(
        ...
        Returns:
            Callable[[~.MutateCampaignExtensionSettingsRequest],
                    Awaitable[~.MutateCampaignExtensionSettingsResponse]]:
        ...
        if "mutate_campaign_extension_settings" not in self._stubs:
            self._stubs["mutate_campaign_extension_settings"] = (
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.mutate_campaign_extension_settings: self._wrap_method(
...
__all__ = ("CampaignExtensionSettingServiceGrpcAsyncIOTransport",)
