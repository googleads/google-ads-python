...
class MutateAdGroupCustomizersRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (Sequence[google.ads.googleads.v9.services.types.AdGroupCustomizerOperation]):
...
class MutateAdGroupCustomizersResponse(proto.Message):
    ...
    Attributes:
        results (Sequence[google.ads.googleads.v9.services.types.MutateAdGroupCustomizerResult]):
