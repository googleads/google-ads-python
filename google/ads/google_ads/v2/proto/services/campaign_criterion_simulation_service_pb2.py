...
# source: google/ads/googleads_v2/proto/services/campaign_criterion_simulation_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads_v2/proto/services/campaign_criterion_simulation_service.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads__v2_dot_proto_dot_resources_dot_campaign__criterion__simulation__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,])
...
GetCampaignCriterionSimulationRequest = _reflection.GeneratedProtocolMessageType('GetCampaignCriterionSimulationRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.ads.googleads_v2.proto.services.campaign_criterion_simulation_service_pb2'
  ,
...
_CAMPAIGNCRITERIONSIMULATIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads__v2_dot_proto_dot_resources_dot_campaign__criterion__simulation__pb2._CAMPAIGNCRITERIONSIMULATION,
    serialized_options=_b('\202\323\344\223\002@\022>/v2/{resource_name=customers/*/campaignCriterionSimulations/*}'),
  ),
])
