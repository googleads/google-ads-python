...
from google.ads.googleads.v13.enums.types import keyword_plan_keyword_annotation
...
class GenerateKeywordIdeasRequest(proto.Message):
    ...
    Attributes:
        ...
        keyword_plan_network (google.ads.googleads.v13.enums.types.KeywordPlanNetworkEnum.KeywordPlanNetwork):
            ...
            will be used.
        keyword_annotation (MutableSequence[google.ads.googleads.v13.enums.types.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotation]):
        ...
        keyword_and_url_seed (google.ads.googleads.v13.services.types.KeywordAndUrlSeed):
        ...
        keyword_seed (google.ads.googleads.v13.services.types.KeywordSeed):
            A Keyword or phrase to generate ideas from,
            for example, cars.

            This field is a member of `oneof`_ ``seed``.
        url_seed (google.ads.googleads.v13.services.types.UrlSeed):
            A specific url to generate ideas from, for
            example, www.example.com/cars.

            This field is a member of `oneof`_ ``seed``.
        site_seed (google.ads.googleads.v13.services.types.SiteSeed):
...
class GenerateKeywordIdeaResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v13.services.types.GenerateKeywordIdeaResult]):
...
class GenerateKeywordIdeaResult(proto.Message):
    ...
    Attributes:
        ...
        keyword_idea_metrics (google.ads.googleads.v13.common.types.KeywordPlanHistoricalMetrics):
            The historical metrics for the keyword.
        keyword_annotations (google.ads.googleads.v13.common.types.KeywordAnnotations):
...
class GenerateKeywordHistoricalMetricsResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v13.services.types.GenerateKeywordHistoricalMetricsResult]):
...
class GenerateAdGroupThemesResponse(proto.Message):
    ...
    Attributes:
        ad_group_keyword_suggestions (MutableSequence[google.ads.googleads.v13.services.types.AdGroupKeywordSuggestion]):
            A list of suggested AdGroup/keyword pairings.
        unusable_ad_groups (MutableSequence[google.ads.googleads.v13.services.types.UnusableAdGroup]):
...
class AdGroupKeywordSuggestion(proto.Message):
    ...
    Attributes:
        ...
        suggested_match_type (google.ads.googleads.v13.enums.types.KeywordMatchTypeEnum.KeywordMatchType):
