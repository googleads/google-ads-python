...
class MutateCustomizerAttributesRequest(proto.Message):
    ...
    Attributes:
        ...
        operations (MutableSequence[google.ads.googleads.v25.services.types.CustomizerAttributeOperation]):
...
class CustomizerAttributeOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v25.resources.types.CustomizerAttribute):
...
class MutateCustomizerAttributesResponse(proto.Message):
    ...
    Attributes:
        results (MutableSequence[google.ads.googleads.v25.services.types.MutateCustomizerAttributeResult]):
