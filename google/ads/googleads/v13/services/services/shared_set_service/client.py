...
class SharedSetServiceClient(metaclass=SharedSetServiceClientMeta):
    ...
    def mutate_shared_sets(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v13.services.types.MutateSharedSetsRequest, dict, None]):
        ...
        Returns:
            google.ads.googleads.v13.services.types.MutateSharedSetsResponse:
