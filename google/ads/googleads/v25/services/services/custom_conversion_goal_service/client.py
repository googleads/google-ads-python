...
class CustomConversionGoalServiceClient(
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v25.services.CustomConversionGoalServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_custom_conversion_goals(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.MutateCustomConversionGoalsRequest, dict]):
