...
class AdTextAsset(proto.Message):
    ...
    Attributes:
        ...
        asset_performance_label (google.ads.googleads.v18.enums.types.AssetPerformanceLabelEnum.AssetPerformanceLabel):
            The performance label of this text asset.
        policy_summary_info (google.ads.googleads.v18.common.types.AdAssetPolicySummary):
...
class AdVideoAsset(proto.Message):
    ...
    Attributes:
        asset (str):
            ...
            This field is a member of `oneof`_ ``_asset``.
        ad_video_asset_info (google.ads.googleads.v18.common.types.AdVideoAssetInfo):
    ...
    ad_video_asset_info: "AdVideoAssetInfo" = proto.Field(
        proto.MESSAGE, number=4, optional=True, message="AdVideoAssetInfo",
    )
...
class AdVideoAssetInfo(proto.Message):
    ...
    Attributes:
        ad_video_asset_inventory_preferences (google.ads.googleads.v18.common.types.AdVideoAssetInventoryPreferences):
    ...
    ad_video_asset_inventory_preferences: "AdVideoAssetInventoryPreferences" = proto.Field(
        proto.MESSAGE,
        number=1,
        optional=True,
