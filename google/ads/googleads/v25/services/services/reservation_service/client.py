...
class ReservationServiceClient(metaclass=ReservationServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v25.services.ReservationServiceClient`.",
                    extra=(
                        {
    ...
    def quote_campaigns(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.QuoteCampaignsRequest, dict]):
    ...
    def book_campaigns(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.BookCampaignsRequest, dict]):
                The request object. Request message for
