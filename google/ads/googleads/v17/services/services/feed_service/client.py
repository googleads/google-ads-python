...
class FeedServiceClient(metaclass=FeedServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, FeedServiceTransport]] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str, FeedServiceTransport]]): The
    ...
    def mutate_feeds(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateFeedsRequest, dict, None]):
