...
class CustomerServiceClient(metaclass=CustomerServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.ads.googleads.v25.services.CustomerServiceClient`.",
                    extra=(
                        {
    ...
    def mutate_customer(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.MutateCustomerRequest, dict]):
            ...
            customer_id (str):
                ...
                should not be set.
            operation (google.ads.googleads.v25.services.types.CustomerOperation):
    ...
    def list_accessible_customers(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.ListAccessibleCustomersRequest, dict]):
                The request object. Request message for
    ...
    def create_customer_client(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v25.services.types.CreateCustomerClientRequest, dict]):
                The request object. Request message for
            ...
            customer_id (str):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            customer_client (google.ads.googleads.v25.resources.types.Customer):
