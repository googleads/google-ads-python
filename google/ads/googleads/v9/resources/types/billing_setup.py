...
class BillingSetup(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.googleads.v9.enums.types.BillingSetupStatusEnum.BillingSetupStatus):
        ...
        payments_account_info (google.ads.googleads.v9.resources.types.BillingSetup.PaymentsAccountInfo):
        ...
        start_time_type (google.ads.googleads.v9.enums.types.TimeTypeEnum.TimeType):
