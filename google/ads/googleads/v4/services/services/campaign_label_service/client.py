...
class CampaignLabelServiceClient(metaclass=CampaignLabelServiceClientMeta):
    ...
    def get_campaign_label(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.GetCampaignLabelRequest`):
        ...
        Returns:
            google.ads.googleads.v4.resources.types.CampaignLabel:
    ...
    def mutate_campaign_labels(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateCampaignLabelsRequest`):
                The request object. Request message for
            ...
            customer_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            operations (:class:`Sequence[google.ads.googleads.v4.services.types.CampaignLabelOperation]`):
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateCampaignLabelsResponse:
