...
"""Accesses the google.ads.googleads.v6.services SharedSetService API."""
...
from google.ads.google_ads.v6.services import shared_set_service_client_config
from google.ads.google_ads.v6.services.transports import shared_set_service_grpc_transport
from google.ads.google_ads.v6.proto.services import shared_set_service_pb2
...
class SharedSetServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v6.services.SharedSetService'
    ...
    def get_shared_set(
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.SharedSet` instance.
    ...
    def mutate_shared_sets(
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v6.types.SharedSetOperation]]): Required. The list of operations to perform on individual shared sets.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v6.types.SharedSetOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.MutateSharedSetsResponse` instance.
