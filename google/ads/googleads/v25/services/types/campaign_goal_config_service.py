...
from google.ads.googleads.v25.resources.types import campaign_goal_config
...
class CampaignGoalConfigOperation(proto.Message):
    ...
    Attributes:
        ...
        create (google.ads.googleads.v25.resources.types.CampaignGoalConfig):
            Create a new campaign goal config.

            This field is a member of `oneof`_ ``operation``.
        update (google.ads.googleads.v25.resources.types.CampaignGoalConfig):
...
class MutateCampaignGoalConfigsResponse(proto.Message):
    ...
    Attributes:
        ...
        results (MutableSequence[google.ads.googleads.v25.services.types.MutateCampaignGoalConfigResult]):
