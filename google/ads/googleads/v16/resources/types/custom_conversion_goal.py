...
from google.ads.googleads.v16.enums.types import custom_conversion_goal_status
...
class CustomConversionGoal(proto.Message):
    ...
    Attributes:
        ...
        conversion_actions (MutableSequence[str]):
            ...
            goal makes biddable.
        status (google.ads.googleads.v16.enums.types.CustomConversionGoalStatusEnum.CustomConversionGoalStatus):
