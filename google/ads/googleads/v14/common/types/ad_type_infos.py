...
from google.ads.googleads.v14.common.types import ad_asset
from google.ads.googleads.v14.enums.types import call_conversion_reporting_state
from google.ads.googleads.v14.enums.types import display_ad_format_setting
from google.ads.googleads.v14.enums.types import (
    display_upload_product_type as gage_display_upload_product_type,
)
from google.ads.googleads.v14.enums.types import legacy_app_install_ad_app_store
from google.ads.googleads.v14.enums.types import mime_type as gage_mime_type
from google.ads.googleads.v14.enums.types import video_thumbnail
...
class VideoBumperInStreamAdInfo(proto.Message):
    ...
    Attributes:
        companion_banner (google.ads.googleads.v14.common.types.AdImageAsset):
...
class InFeedVideoAdInfo(proto.Message):
    ...
    Attributes:
        ...
        thumbnail (google.ads.googleads.v14.enums.types.VideoThumbnailEnum.VideoThumbnail):
...
class VideoAdInfo(proto.Message):
    ...
    Attributes:
        video (google.ads.googleads.v14.common.types.AdVideoAsset):
            The YouTube video assets used for the ad.
        in_stream (google.ads.googleads.v14.common.types.VideoTrueViewInStreamAdInfo):
            Video TrueView in-stream ad format.

            This field is a member of `oneof`_ ``format``.
        bumper (google.ads.googleads.v14.common.types.VideoBumperInStreamAdInfo):
            Video bumper in-stream ad format.

            This field is a member of `oneof`_ ``format``.
        out_stream (google.ads.googleads.v14.common.types.VideoOutstreamAdInfo):
            Video out-stream ad format.

            This field is a member of `oneof`_ ``format``.
        non_skippable (google.ads.googleads.v14.common.types.VideoNonSkippableInStreamAdInfo):
            Video non-skippable in-stream ad format.

            This field is a member of `oneof`_ ``format``.
        in_feed (google.ads.googleads.v14.common.types.InFeedVideoAdInfo):
...
class VideoResponsiveAdInfo(proto.Message):
    ...
    Attributes:
        ...
        call_to_actions (MutableSequence[google.ads.googleads.v14.common.types.AdTextAsset]):
        ...
        companion_banners (MutableSequence[google.ads.googleads.v14.common.types.AdImageAsset]):
...
class LegacyResponsiveDisplayAdInfo(proto.Message):
    ...
    Attributes:
        ...
        format_setting (google.ads.googleads.v14.enums.types.DisplayAdFormatSettingEnum.DisplayAdFormatSetting):
...
class AppAdInfo(proto.Message):
    r"""An app ad.
    Attributes:
        mandatory_ad_text (google.ads.googleads.v14.common.types.AdTextAsset):
            Mandatory ad text.
        headlines (MutableSequence[google.ads.googleads.v14.common.types.AdTextAsset]):
            List of text assets for headlines. When the
            ad serves the headlines will be selected from
        ...
        descriptions (MutableSequence[google.ads.googleads.v14.common.types.AdTextAsset]):
            ...
            the ad serves the descriptions will be selected
            from this list.
        images (MutableSequence[google.ads.googleads.v14.common.types.AdImageAsset]):
            List of image assets that may be displayed
            with the ad.
        youtube_videos (MutableSequence[google.ads.googleads.v14.common.types.AdVideoAsset]):
            List of YouTube video assets that may be
            displayed with the ad.
        html5_media_bundles (MutableSequence[google.ads.googleads.v14.common.types.AdMediaBundleAsset]):
...
class LegacyAppInstallAdInfo(proto.Message):
    ...
    Attributes:
        ...
        app_store (google.ads.googleads.v14.enums.types.LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStore):
...
class ResponsiveDisplayAdInfo(proto.Message):
    ...
    Attributes:
        marketing_images (MutableSequence[google.ads.googleads.v14.common.types.AdImageAsset]):
        ...
        square_marketing_images (MutableSequence[google.ads.googleads.v14.common.types.AdImageAsset]):
        ...
        square_logo_images (MutableSequence[google.ads.googleads.v14.common.types.AdImageAsset]):
        ...
        long_headline (google.ads.googleads.v14.common.types.AdTextAsset):
        ...
        format_setting (google.ads.googleads.v14.enums.types.DisplayAdFormatSettingEnum.DisplayAdFormatSetting):
            Specifies which format the ad will be served in. Default is
            ALL_FORMATS.
        control_spec (google.ads.googleads.v14.common.types.ResponsiveDisplayAdControlSpec):
...
class DisplayUploadAdInfo(proto.Message):
    ...
    Attributes:
        display_upload_product_type (google.ads.googleads.v14.enums.types.DisplayUploadProductTypeEnum.DisplayUploadProductType):
            The product type of this ad. See comments on
            the enum for details.
        media_bundle (google.ads.googleads.v14.common.types.AdMediaBundleAsset):
...
class CallAdInfo(proto.Message):
    ...
    Attributes:
        ...
        conversion_reporting_state (google.ads.googleads.v14.enums.types.CallConversionReportingStateEnum.CallConversionReportingState):
...
class DiscoveryMultiAssetAdInfo(proto.Message):
    ...
    Attributes:
        ...
        square_marketing_images (MutableSequence[google.ads.googleads.v14.common.types.AdImageAsset]):
            ...
            maximum is 20.
        portrait_marketing_images (MutableSequence[google.ads.googleads.v14.common.types.AdImageAsset]):
...
class DiscoveryCarouselAdInfo(proto.Message):
    ...
    Attributes:
        ...
        logo_image (google.ads.googleads.v14.common.types.AdImageAsset):
            Required. Logo image to be used in the ad.
            The minimum size is 128x128 and the aspect ratio
            must be 1:1(+-1%).
        headline (google.ads.googleads.v14.common.types.AdTextAsset):
            Required. Headline of the ad.
        description (google.ads.googleads.v14.common.types.AdTextAsset):
            Required. The descriptive text of the ad.
        call_to_action_text (str):
            Call to action text.
        carousel_cards (MutableSequence[google.ads.googleads.v14.common.types.AdDiscoveryCarouselCardAsset]):
