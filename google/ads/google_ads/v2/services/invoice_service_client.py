...
"""Accesses the google.ads.googleads.v2.services InvoiceService API."""
...
from google.ads.google_ads.v2.services import invoice_service_client_config
...
class InvoiceServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.InvoiceService'
    ...
    def list_invoices(
        ...
        Args:
            customer_id (str): The ID of the customer to fetch invoices for.
            ...
            issue_month (~google.ads.googleads_v2.types.MonthOfYear): Required. The issue month to retrieve invoices.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.ListInvoicesResponse` instance.
