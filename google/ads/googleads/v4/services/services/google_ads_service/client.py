...
class GoogleAdsServiceClient(metaclass=GoogleAdsServiceClientMeta):
    ...
    def search(
        ...
        *,
        ...
        Returns:
            google.ads.googleads.v4.services.services.google_ads_service.pagers.SearchPager:
    ...
    def search_stream(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.SearchGoogleAdsStreamRequest`):
                The request object. Request message for
        ...
        Returns:
            Iterable[google.ads.googleads.v4.services.types.SearchGoogleAdsStreamResponse]:
                Response message for
                [GoogleAdsService.SearchStream][google.ads.googleads.v4.services.GoogleAdsService.SearchStream].
    ...
    def mutate(
        ...
        *,
        ...
        Args:
            request (:class:`google.ads.googleads.v4.services.types.MutateGoogleAdsRequest`):
                The request object. Request message for
        ...
        Returns:
            google.ads.googleads.v4.services.types.MutateGoogleAdsResponse:
                Response message for
                [GoogleAdsService.Mutate][google.ads.googleads.v4.services.GoogleAdsService.Mutate].
