...
_QUERYERRORENUM_QUERYERROR = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REQUESTED_METRICS_FOR_MANAGER', index=51, number=59,
      serialized_options=None,
      type=None),
  ],
