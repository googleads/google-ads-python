...
class KeywordPlanAdGroupServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, KeywordPlanAdGroupServiceTransport]]): The
    ...
    def mutate_keyword_plan_ad_groups(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v18.services.types.MutateKeywordPlanAdGroupsRequest, dict, None]):
