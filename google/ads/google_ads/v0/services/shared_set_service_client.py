...
"""Accesses the google.ads.googleads.v0.services SharedSetService API."""
...
from google.ads.google_ads.v0.services import shared_set_service_client_config
...
class SharedSetServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v0.services.SharedSetService'
    ...
    def get_shared_set(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.SharedSet` instance.
    ...
    def mutate_shared_sets(self,
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v0.types.SharedSetOperation]]): The list of operations to perform on individual shared sets.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v0.types.SharedSetOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v0.types.MutateSharedSetsResponse` instance.
