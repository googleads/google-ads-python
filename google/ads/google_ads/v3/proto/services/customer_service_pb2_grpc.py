...
class CustomerServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetCustomer = channel.unary_unary(
        ...
        request_serializer=google_dot_ads_dot_googleads__v3_dot_proto_dot_services_dot_customer__service__pb2.GetCustomerRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads__v3_dot_proto_dot_resources_dot_customer__pb2.Customer.FromString,
        )
    self.MutateCustomer = channel.unary_unary(
        '/google.ads.googleads.v3.services.CustomerService/MutateCustomer',
        request_serializer=google_dot_ads_dot_googleads__v3_dot_proto_dot_services_dot_customer__service__pb2.MutateCustomerRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads__v3_dot_proto_dot_services_dot_customer__service__pb2.MutateCustomerResponse.FromString,
        )
    self.ListAccessibleCustomers = channel.unary_unary(
        '/google.ads.googleads.v3.services.CustomerService/ListAccessibleCustomers',
        request_serializer=google_dot_ads_dot_googleads__v3_dot_proto_dot_services_dot_customer__service__pb2.ListAccessibleCustomersRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads__v3_dot_proto_dot_services_dot_customer__service__pb2.ListAccessibleCustomersResponse.FromString,
        )
    self.CreateCustomerClient = channel.unary_unary(
        '/google.ads.googleads.v3.services.CustomerService/CreateCustomerClient',
        request_serializer=google_dot_ads_dot_googleads__v3_dot_proto_dot_services_dot_customer__service__pb2.CreateCustomerClientRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads__v3_dot_proto_dot_services_dot_customer__service__pb2.CreateCustomerClientResponse.FromString,
        )
