...
"""Accesses the google.ads.googleads.v1.services AdGroupLabelService API."""
...
from google.ads.google_ads.v1.services import ad_group_label_service_client_config
...
class AdGroupLabelServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v1.services.AdGroupLabelService'
        ...
        if transport:
            if callable(transport):
                self.transport = transport(
                    ...
                    default_class=ad_group_label_service_grpc_transport.
    ...
    def get_ad_group_label(self,
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.AdGroupLabel` instance.
        ...
        if 'get_ad_group_label' not in self._inner_api_calls:
            self._inner_api_calls[
                'get_ad_group_label'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.get_ad_group_label,
                    default_retry=self._method_configs['GetAdGroupLabel'].
                    retry,
                    default_timeout=self._method_configs['GetAdGroupLabel'].
                    timeout,
        ...
        return self._inner_api_calls['get_ad_group_label'](
    ...
    def mutate_ad_group_labels(self,
        ...
        Args:
            ...
            operations (list[Union[dict, ~google.ads.googleads_v1.types.AdGroupLabelOperation]]): The list of operations to perform on ad group labels.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v1.types.AdGroupLabelOperation`
        ...
        Returns:
            A :class:`~google.ads.googleads_v1.types.MutateAdGroupLabelsResponse` instance.
        ...
        if 'mutate_ad_group_labels' not in self._inner_api_calls:
            self._inner_api_calls[
                'mutate_ad_group_labels'] = google.api_core.gapic_v1.method.wrap_method(
                    self.transport.mutate_ad_group_labels,
                    default_retry=self._method_configs['MutateAdGroupLabels'].
                    retry,
                    default_timeout=self.
                    _method_configs['MutateAdGroupLabels'].timeout,
                    client_info=self._client_info,
                )
        ...
        return self._inner_api_calls['mutate_ad_group_labels'](
            request, retry=retry, timeout=timeout, metadata=metadata)
