...
class AssetGroupListingGroupFilterServiceClient(
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            transport (Optional[Union[str, AssetGroupListingGroupFilterServiceTransport]]): The
    ...
    def mutate_asset_group_listing_group_filters(
        ...
        *,
        ...
        Args:
            request (Union[google.ads.googleads.v17.services.types.MutateAssetGroupListingGroupFiltersRequest, dict, None]):
