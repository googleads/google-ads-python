...
class AssetSetTypeView(proto.Message):
    ...
    Attributes:
        ...
        asset_set_type (google.ads.googleads.v18.enums.types.AssetSetTypeEnum.AssetSetType):
    ...
    asset_set_type: gage_asset_set_type.AssetSetTypeEnum.AssetSetType = proto.Field(
        proto.ENUM,
        number=3,
