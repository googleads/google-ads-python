...
"""Accesses the google.ads.googleads.v6.services ReachPlanService API."""
...
from google.ads.google_ads.v6.services import reach_plan_service_client_config
from google.ads.google_ads.v6.services.transports import reach_plan_service_grpc_transport
from google.ads.google_ads.v6.proto.services import reach_plan_service_pb2
...
class ReachPlanServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v6.services.ReachPlanService'
    ...
    def list_plannable_locations(
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.ListPlannableLocationsResponse` instance.
    ...
    def list_plannable_products(
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.ListPlannableProductsResponse` instance.
    ...
    def generate_product_mix_ideas(
        ...
        Args:
            ...
            plannable_location_id (str): Required. The ID of the location, this is one of the ids returned by
                ListPlannableLocations.
            currency_code (str): Required. Currency code.
                Three-character ISO 4217 currency code.
            budget_micros (long): Required. Total budget.
                Amount in micros. One million is equivalent to one unit.
            preferences (Union[dict, ~google.ads.googleads_v6.types.Preferences]): The preferences of the suggested product mix.
                An unset preference is interpreted as all possible values are allowed,
                unless explicitly specified.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v6.types.Preferences`
            retry (Optional[google.api_core.retry.Retry]):  A retry object used
                to retry requests. If ``None`` is specified, requests will
                be retried using a default configuration.
            timeout (Optional[float]): The amount of time, in seconds, to wait
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.GenerateProductMixIdeasResponse` instance.
    ...
    def generate_reach_forecast(
        ...
        Args:
            ...
            campaign_duration (Union[dict, ~google.ads.googleads_v6.types.CampaignDuration]): Required. Campaign duration.
                ...
                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v6.types.CampaignDuration`
            planned_products (list[Union[dict, ~google.ads.googleads_v6.types.PlannedProduct]]): Required. The products to be forecast.
                The max number of allowed planned products is 15.

                If a dict is provided, it must be of the same form as the protobuf
                message :class:`~google.ads.googleads_v6.types.PlannedProduct`
            currency_code (str): The currency code.
                Three-character ISO 4217 currency code.
            cookie_frequency_cap (int): Desired cookie frequency cap that will be applied to each planned
        ...
        Returns:
            A :class:`~google.ads.googleads_v6.types.GenerateReachForecastResponse` instance.
