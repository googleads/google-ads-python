...
"""Accesses the google.ads.googleads.v2.services CarrierConstantService API."""
...
from google.ads.google_ads.v2.services import carrier_constant_service_client_config
...
class CarrierConstantServiceClient(object):
    ...
    _INTERFACE_NAME = 'google.ads.googleads.v2.services.CarrierConstantService'
    ...
    def get_carrier_constant(
        ...
        Args:
            resource_name (str): Resource name of the carrier constant to fetch.
        ...
        Returns:
            A :class:`~google.ads.googleads_v2.types.CarrierConstant` instance.
